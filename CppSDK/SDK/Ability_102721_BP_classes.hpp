...
static_assert(sizeof(UAbility_102721_BP_C) == 0x002A48, "Wrong size on UAbility_102721_BP_C");
static_assert(offsetof(UAbility_102721_BP_C, UberGraphFrame) == 0x002A40, "Member 'UAbility_102721_BP_C::UberGraphFrame' has a wrong offset!");
