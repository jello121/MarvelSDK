...
static_assert(sizeof(APySummoned_10454101) == 0x000A30, "Wrong size on APySummoned_10454101");
...
{
public:
	FMulticastInlineDelegateProperty_             OnAbilityReadyEndDelegate;                         // 0x2A38(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_104541) == 0x002A48, "Wrong size on UPyAbility_104541");
static_assert(offsetof(UPyAbility_104541, OnAbilityReadyEndDelegate) == 0x002A38, "Member 'UPyAbility_104541::OnAbilityReadyEndDelegate' has a wrong offset!");
...
{
public:
	struct FReticleStyle                          ReticleHideStyle;                                  // 0x0CD0(0x00E4)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyUIController_104541) == 0x000DB8, "Wrong size on UPyUIController_104541");
static_assert(offsetof(UPyUIController_104541, ReticleHideStyle) == 0x000CD0, "Member 'UPyUIController_104541::ReticleHideStyle' has a wrong offset!");
