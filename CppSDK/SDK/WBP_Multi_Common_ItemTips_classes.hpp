...
static_assert(sizeof(UWBP_Multi_Common_ItemTips_C) == 0x000620, "Wrong size on UWBP_Multi_Common_ItemTips_C");
static_assert(offsetof(UWBP_Multi_Common_ItemTips_C, VBox_ItemTips_List) == 0x000610, "Member 'UWBP_Multi_Common_ItemTips_C::VBox_ItemTips_List' has a wrong offset!");
static_assert(offsetof(UWBP_Multi_Common_ItemTips_C, WBP_Common_ItemTips) == 0x000618, "Member 'UWBP_Multi_Common_ItemTips_C::WBP_Common_ItemTips' has a wrong offset!");
