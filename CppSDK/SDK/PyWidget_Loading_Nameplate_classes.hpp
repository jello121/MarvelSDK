...
{
public:
	bool                                          ShowRankIcon;                                      // 0x05E2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_Loading_Nameplate, ShowRankIcon) == 0x0005E2, "Member 'UPyWidget_Loading_Nameplate::ShowRankIcon' has a wrong offset!");
