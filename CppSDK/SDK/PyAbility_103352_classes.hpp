...
{
public:
	class UFXSystemAsset*                         GroundFX;                                          // 0x0360(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DecalCheckHeight;                                  // 0x0368(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_36C[0x4];                                      // 0x036C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         Ignores;                                           // 0x0370(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyCue_Scope_Start_10335201) == 0x000380, "Wrong size on UPyCue_Scope_Start_10335201");
static_assert(offsetof(UPyCue_Scope_Start_10335201, GroundFX) == 0x000360, "Member 'UPyCue_Scope_Start_10335201::GroundFX' has a wrong offset!");
static_assert(offsetof(UPyCue_Scope_Start_10335201, DecalCheckHeight) == 0x000368, "Member 'UPyCue_Scope_Start_10335201::DecalCheckHeight' has a wrong offset!");
static_assert(offsetof(UPyCue_Scope_Start_10335201, Ignores) == 0x000370, "Member 'UPyCue_Scope_Start_10335201::Ignores' has a wrong offset!");
...
static_assert(sizeof(UPyEffectiveComponent_10335201) == 0x001C10, "Wrong size on UPyEffectiveComponent_10335201");
...
static_assert(offsetof(UPyConfig_103352, ResetToBulletLoadedAtMissile) == 0x0000F8, "Member 'UPyConfig_103352::ResetToBulletLoadedAtMissile' has a wrong offset!");
static_assert(offsetof(UPyConfig_103352, DebugNoRandomAngle) == 0x0000F9, "Member 'UPyConfig_103352::DebugNoRandomAngle' has a wrong offset!");
...
{
public:
	float                                         ChargeDuration;                                    // 0x3260(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ChargePercent;                                     // 0x3264(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyProjectile_10335201) == 0x003270, "Wrong size on APyProjectile_10335201");
static_assert(offsetof(APyProjectile_10335201, ChargeDuration) == 0x003260, "Member 'APyProjectile_10335201::ChargeDuration' has a wrong offset!");
static_assert(offsetof(APyProjectile_10335201, ChargePercent) == 0x003264, "Member 'APyProjectile_10335201::ChargePercent' has a wrong offset!");
...
{
public:
	int32                                         ScopeId;                                           // 0x0A30(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ChargeDuration;                                    // 0x0A34(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APySummoned_10335201) == 0x000A40, "Wrong size on APySummoned_10335201");
static_assert(offsetof(APySummoned_10335201, ScopeId) == 0x000A30, "Member 'APySummoned_10335201::ScopeId' has a wrong offset!");
static_assert(offsetof(APySummoned_10335201, ChargeDuration) == 0x000A34, "Member 'APySummoned_10335201::ChargeDuration' has a wrong offset!");
...
static_assert(sizeof(UPyTraceComponent_10335201) == 0x0018B0, "Wrong size on UPyTraceComponent_10335201");

// PythonClass PyAbility_103352.PyProjectile_10335202
// 0x0000 (0x3270 - 0x3270)
...
static_assert(sizeof(APyProjectile_10335202) == 0x003270, "Wrong size on APyProjectile_10335202");
...
{
public:
	TSubclassOf<class AMarvelSummonerBase>        SummonedClass;                                     // 0x2A48(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class AMarvelAbilityTargetActor_Projectile> ProjectileClass;                                   // 0x2A50(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_103352) == 0x002A58, "Wrong size on UPyAbility_103352");
static_assert(offsetof(UPyAbility_103352, SummonedClass) == 0x002A48, "Member 'UPyAbility_103352::SummonedClass' has a wrong offset!");
static_assert(offsetof(UPyAbility_103352, ProjectileClass) == 0x002A50, "Member 'UPyAbility_103352::ProjectileClass' has a wrong offset!");
...
{
public:
	int32                                         MaxEnergyAudioID;                                  // 0x0FF0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Ability_Loop_10335201) == 0x000FF8, "Wrong size on APyCue_Ability_Loop_10335201");
static_assert(offsetof(APyCue_Ability_Loop_10335201, MaxEnergyAudioID) == 0x000FF0, "Member 'APyCue_Ability_Loop_10335201::MaxEnergyAudioID' has a wrong offset!");
...
static_assert(sizeof(APyCue_Projectile_Loop_10335201) == 0x000F70, "Wrong size on APyCue_Projectile_Loop_10335201");
