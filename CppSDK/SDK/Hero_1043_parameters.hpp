...
{
public:
	struct FHitResult                             Impact;                                            // 0x0000(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(Ability_104331_OnMoveBlock) == 0x000008, "Wrong alignment on Ability_104331_OnMoveBlock");
static_assert(sizeof(Ability_104331_OnMoveBlock) == 0x000178, "Wrong size on Ability_104331_OnMoveBlock");
...
static_assert(sizeof(Ability_Glide_OnMoveBlock) == 0x000178, "Wrong size on Ability_Glide_OnMoveBlock");
