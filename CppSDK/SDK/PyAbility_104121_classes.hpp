...
static_assert(sizeof(UPyEffectiveComponent_10412101) == 0x001C10, "Wrong size on UPyEffectiveComponent_10412101");

// PythonClass PyAbility_104121.PyConfig_104121
// 0x1168 (0x1230 - 0x00C8)
...
public:
	...
	struct FMarvelAbilityTraceContext             GroundTraceContext;                                // 0x01B0(0x1080)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyConfig_104121) == 0x001230, "Wrong size on UPyConfig_104121");
...
static_assert(sizeof(UPyAbility_104121) == 0x002B50, "Wrong size on UPyAbility_104121");
...
static_assert(sizeof(APyCue_Weapon_Loop_104121) == 0x001258, "Wrong size on APyCue_Weapon_Loop_104121");
...
{
public:
	struct FGameplayTagContainer                  EndFXRequiredTags;                                 // 0x0F70(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class UFXSystemAsset*                         ScopeFX;                                           // 0x0FD8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_ProjectileLoop_104121) == 0x000FE0, "Wrong size on APyCue_ProjectileLoop_104121");
static_assert(offsetof(APyCue_ProjectileLoop_104121, EndFXRequiredTags) == 0x000F70, "Member 'APyCue_ProjectileLoop_104121::EndFXRequiredTags' has a wrong offset!");
static_assert(offsetof(APyCue_ProjectileLoop_104121, ScopeFX) == 0x000FD8, "Member 'APyCue_ProjectileLoop_104121::ScopeFX' has a wrong offset!");
...
static_assert(sizeof(APyProjectile_10412101) == 0x003260, "Wrong size on APyProjectile_10412101");
...
static_assert(sizeof(UPyCue_ScopeStart_104121) == 0x000360, "Wrong size on UPyCue_ScopeStart_104121");
