...
static_assert(alignof(BuiltInDynamicBindingResolverLibrary_ResolveToShowActor) == 0x000008, "Wrong alignment on BuiltInDynamicBindingResolverLibrary_ResolveToShowActor");
static_assert(sizeof(BuiltInDynamicBindingResolverLibrary_ResolveToShowActor) == 0x000018, "Wrong size on BuiltInDynamicBindingResolverLibrary_ResolveToShowActor");
static_assert(offsetof(BuiltInDynamicBindingResolverLibrary_ResolveToShowActor, WorldContextObject) == 0x000000, "Member 'BuiltInDynamicBindingResolverLibrary_ResolveToShowActor::WorldContextObject' has a wrong offset!");
static_assert(offsetof(BuiltInDynamicBindingResolverLibrary_ResolveToShowActor, ReturnValue) == 0x000008, "Member 'BuiltInDynamicBindingResolverLibrary_ResolveToShowActor::ReturnValue' has a wrong offset!");

// Function MovieScene.BuiltInDynamicBindingResolverLibrary.ResolveToShowCamera
// 0x0030 (0x0030 - 0x0000)
struct BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera final
{
public:
	class UObject*                                WorldContextObjectt;                               // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   CameraName;                                        // 0x0008(0x0018)(Parm, NativeAccessSpecifierPublic)
	struct FMovieSceneDynamicBindingResolveResult ReturnValue;                                       // 0x0020(0x0010)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera) == 0x000008, "Wrong alignment on BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera");
static_assert(sizeof(BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera) == 0x000030, "Wrong size on BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera");
static_assert(offsetof(BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera, WorldContextObjectt) == 0x000000, "Member 'BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera::WorldContextObjectt' has a wrong offset!");
static_assert(offsetof(BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera, CameraName) == 0x000008, "Member 'BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera::CameraName' has a wrong offset!");
static_assert(offsetof(BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera, ReturnValue) == 0x000020, "Member 'BuiltInDynamicBindingResolverLibrary_ResolveToShowCamera::ReturnValue' has a wrong offset!");
...
public:
	struct FMovieSceneSequencePlaybackParams      PlaybackParams;                                    // 0x0000(0x0028)(Parm, NativeAccessSpecifierPublic)
	bool                                          InSkipSpawn;                                       // 0x0028(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(MovieSceneSequencePlayer_SetPlaybackPosition) == 0x000030, "Wrong size on MovieSceneSequencePlayer_SetPlaybackPosition");
...
static_assert(offsetof(MovieSceneSequencePlayer_SetPlaybackPosition, InSkipSpawn) == 0x000028, "Member 'MovieSceneSequencePlayer_SetPlaybackPosition::InSkipSpawn' has a wrong offset!");
