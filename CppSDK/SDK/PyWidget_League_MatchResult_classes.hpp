...
{
public:
	ELeagueRankingTitle                           Initial_State;                                     // 0x05E2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_League_RankingTitle, Initial_State) == 0x0005E2, "Member 'UPyWidget_League_RankingTitle::Initial_State' has a wrong offset!");
...
public:
	...
	class UTexture2D*                             ImgFrameMRC;                                       // 0x0608(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             ImgFrameClash;                                     // 0x0610(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             ImgDecorateMRC;                                    // 0x0618(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             ImgDecorateClash;                                  // 0x0620(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           ColorMRC;                                          // 0x0628(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           ColorClash;                                        // 0x0638(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_League_MatchResult) == 0x000648, "Wrong size on UPyWidget_League_MatchResult");
...
static_assert(offsetof(UPyWidget_League_MatchResult, ImgFrameMRC) == 0x000608, "Member 'UPyWidget_League_MatchResult::ImgFrameMRC' has a wrong offset!");
static_assert(offsetof(UPyWidget_League_MatchResult, ImgFrameClash) == 0x000610, "Member 'UPyWidget_League_MatchResult::ImgFrameClash' has a wrong offset!");
static_assert(offsetof(UPyWidget_League_MatchResult, ImgDecorateMRC) == 0x000618, "Member 'UPyWidget_League_MatchResult::ImgDecorateMRC' has a wrong offset!");
static_assert(offsetof(UPyWidget_League_MatchResult, ImgDecorateClash) == 0x000620, "Member 'UPyWidget_League_MatchResult::ImgDecorateClash' has a wrong offset!");
static_assert(offsetof(UPyWidget_League_MatchResult, ColorMRC) == 0x000628, "Member 'UPyWidget_League_MatchResult::ColorMRC' has a wrong offset!");
static_assert(offsetof(UPyWidget_League_MatchResult, ColorClash) == 0x000638, "Member 'UPyWidget_League_MatchResult::ColorClash' has a wrong offset!");
