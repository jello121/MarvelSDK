...
// 0x0040 (0x32F0 - 0x32B0)
class APyProjectile_10181111 final : public AProjectile_101811
{
public:
	int32                                         ProjectileIndex;                                   // 0x32B0(0x0004)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32B4[0x4];                                     // 0x32B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                AimStartReplicated;                                // 0x32B8(0x0018)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                AimDirectionReplicated;                            // 0x32D0(0x0018)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyProjectile_10181111) == 0x0032F0, "Wrong size on APyProjectile_10181111");
static_assert(offsetof(APyProjectile_10181111, ProjectileIndex) == 0x0032B0, "Member 'APyProjectile_10181111::ProjectileIndex' has a wrong offset!");
static_assert(offsetof(APyProjectile_10181111, AimStartReplicated) == 0x0032B8, "Member 'APyProjectile_10181111::AimStartReplicated' has a wrong offset!");
static_assert(offsetof(APyProjectile_10181111, AimDirectionReplicated) == 0x0032D0, "Member 'APyProjectile_10181111::AimDirectionReplicated' has a wrong offset!");
...
public:
	...
	int32                                         ProjectileID;                                      // 0x1130(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyConfig_101811) == 0x001140, "Wrong size on UPyConfig_101811");
...
static_assert(offsetof(UPyConfig_101811, ProjectileID) == 0x001130, "Member 'UPyConfig_101811::ProjectileID' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_101811) == 0x002A40, "Wrong size on UPyAbility_101811");
