...
public:
	...
	struct FSelectTaskParam                       SelectParam;                                       // 0x0020(0x11A0)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bAutoBeginSelect;                                  // 0x11C0(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldCheckActivate;                              // 0x11C1(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11C2[0x6];                                     // 0x11C2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UGASpecTask_SelectTarget*               ReturnValue;                                       // 0x11C8(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GASpecTask_SelectTarget_AsSelectTargetAbility) == 0x0011D0, "Wrong size on GASpecTask_SelectTarget_AsSelectTargetAbility");
...
static_assert(offsetof(GASpecTask_SelectTarget_AsSelectTargetAbility, bAutoBeginSelect) == 0x0011C0, "Member 'GASpecTask_SelectTarget_AsSelectTargetAbility::bAutoBeginSelect' has a wrong offset!");
static_assert(offsetof(GASpecTask_SelectTarget_AsSelectTargetAbility, bShouldCheckActivate) == 0x0011C1, "Member 'GASpecTask_SelectTarget_AsSelectTargetAbility::bShouldCheckActivate' has a wrong offset!");
static_assert(offsetof(GASpecTask_SelectTarget_AsSelectTargetAbility, ReturnValue) == 0x0011C8, "Member 'GASpecTask_SelectTarget_AsSelectTargetAbility::ReturnValue' has a wrong offset!");
...
{
public:
	struct FHitResult                             HitInfo;                                           // 0x0000(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bResult;                                           // 0x0178(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GASpecTask_SelectTarget_FilterDelegate__DelegateSignature) == 0x000180, "Wrong size on GASpecTask_SelectTarget_FilterDelegate__DelegateSignature");
...
static_assert(offsetof(GASpecTask_SelectTarget_FilterDelegate__DelegateSignature, bResult) == 0x000178, "Member 'GASpecTask_SelectTarget_FilterDelegate__DelegateSignature::bResult' has a wrong offset!");
...
public:
	...
	struct FHitResult                             HitInfo;                                           // 0x0008(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GATask_ApplyDash_OnDashEndEventDelegate__DelegateSignature) == 0x000180, "Wrong size on GATask_ApplyDash_OnDashEndEventDelegate__DelegateSignature");
...
static_assert(sizeof(GATask_ApplyDash_OnDashHit) == 0x0001A0, "Wrong size on GATask_ApplyDash_OnDashHit");
...
static_assert(sizeof(GATask_ApplyDash_OnDashHitEventDelegate__DelegateSignature) == 0x000180, "Wrong size on GATask_ApplyDash_OnDashHitEventDelegate__DelegateSignature");
...
{
public:
	struct FHitResult                             HitTarget;                                         // 0x0000(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GATask_SpawnProjectile_OnHitOrTraceTarget) == 0x000178, "Wrong size on GATask_SpawnProjectile_OnHitOrTraceTarget");
...
public:
	...
	struct FFindGroundParam                       TraceParams_0;                                     // 0x0010(0x10D0)(Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FGameplayTag                           PlacementCueTag_0;                                 // 0x10E0(0x000C)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10EC[0x4];                                     // 0x10EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UGATask_WaitTargetData*                 ReturnValue;                                       // 0x10F0(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GATask_WaitTargetData_WaitTargetData_PawnPlacement) == 0x001100, "Wrong size on GATask_WaitTargetData_WaitTargetData_PawnPlacement");
...
static_assert(offsetof(GATask_WaitTargetData_WaitTargetData_PawnPlacement, PlacementCueTag_0) == 0x0010E0, "Member 'GATask_WaitTargetData_WaitTargetData_PawnPlacement::PlacementCueTag_0' has a wrong offset!");
static_assert(offsetof(GATask_WaitTargetData_WaitTargetData_PawnPlacement, ReturnValue) == 0x0010F0, "Member 'GATask_WaitTargetData_WaitTargetData_PawnPlacement::ReturnValue' has a wrong offset!");
...
public:
	class UObject*                                SelfObj;                                           // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FHitResult                             HitResult;                                         // 0x0008(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FMarvelTraceRule                       TraceRule;                                         // 0x0180(0x0390)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0510(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GraphAbilityFuncNodes_IsHitResultValidAbilityTarget_Filter) == 0x000518, "Wrong size on GraphAbilityFuncNodes_IsHitResultValidAbilityTarget_Filter");
...
static_assert(offsetof(GraphAbilityFuncNodes_IsHitResultValidAbilityTarget_Filter, TraceRule) == 0x000180, "Member 'GraphAbilityFuncNodes_IsHitResultValidAbilityTarget_Filter::TraceRule' has a wrong offset!");
static_assert(offsetof(GraphAbilityFuncNodes_IsHitResultValidAbilityTarget_Filter, ReturnValue) == 0x000510, "Member 'GraphAbilityFuncNodes_IsHitResultValidAbilityTarget_Filter::ReturnValue' has a wrong offset!");
