...
static_assert(sizeof(UPyConfig_105252) == 0x000FD8, "Wrong size on UPyConfig_105252");
static_assert(offsetof(UPyConfig_105252, DashInfo) == 0x000098, "Member 'UPyConfig_105252::DashInfo' has a wrong offset!");
static_assert(offsetof(UPyConfig_105252, ScopeTraceRule) == 0x000C40, "Member 'UPyConfig_105252::ScopeTraceRule' has a wrong offset!");
static_assert(offsetof(UPyConfig_105252, DamageCurve) == 0x000FD0, "Member 'UPyConfig_105252::DamageCurve' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_105252) == 0x002A38, "Wrong size on UPyAbility_105252");
