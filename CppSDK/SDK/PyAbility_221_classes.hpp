...
// 0x0030 (0x2A80 - 0x2A50)
class UPyAbility_221 : public UMarvelAbility_LongPressTrigger
{
public:
	FMulticastInlineDelegateProperty_             AbilityActivate;                                   // 0x2A50(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             AbilityHoldEnd;                                    // 0x2A60(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             AbilityHoldTriggered;                              // 0x2A70(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_221) == 0x002A80, "Wrong size on UPyAbility_221");
static_assert(offsetof(UPyAbility_221, AbilityActivate) == 0x002A50, "Member 'UPyAbility_221::AbilityActivate' has a wrong offset!");
static_assert(offsetof(UPyAbility_221, AbilityHoldEnd) == 0x002A60, "Member 'UPyAbility_221::AbilityHoldEnd' has a wrong offset!");
static_assert(offsetof(UPyAbility_221, AbilityHoldTriggered) == 0x002A70, "Member 'UPyAbility_221::AbilityHoldTriggered' has a wrong offset!");
