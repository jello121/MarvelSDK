...
{
public:
	class UPhysicsControlComponent*               ControlComponent;                                  // 0x05F8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPhysicsControlInitializerComponent*    ControlInitializerComponent;                       // 0x0600(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APhysicsControlActor) == 0x000608, "Wrong size on APhysicsControlActor");
static_assert(offsetof(APhysicsControlActor, ControlComponent) == 0x0005F8, "Member 'APhysicsControlActor::ControlComponent' has a wrong offset!");
static_assert(offsetof(APhysicsControlActor, ControlInitializerComponent) == 0x000600, "Member 'APhysicsControlActor::ControlInitializerComponent' has a wrong offset!");
