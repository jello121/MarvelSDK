...
static_assert(sizeof(FAnimNode_StageCoachWheelController) == 0x000110, "Wrong size on FAnimNode_StageCoachWheelController");
static_assert(offsetof(FAnimNode_StageCoachWheelController, WheelSpokeCount) == 0x0000E8, "Member 'FAnimNode_StageCoachWheelController::WheelSpokeCount' has a wrong offset!");
static_assert(offsetof(FAnimNode_StageCoachWheelController, MaxAngularVelocity) == 0x0000EC, "Member 'FAnimNode_StageCoachWheelController::MaxAngularVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_StageCoachWheelController, ShutterSpeed) == 0x0000F0, "Member 'FAnimNode_StageCoachWheelController::ShutterSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_StageCoachWheelController, StageCoachBlend) == 0x0000F4, "Member 'FAnimNode_StageCoachWheelController::StageCoachBlend' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_WheelController) == 0x000100, "Wrong size on FAnimNode_WheelController");
...
static_assert(sizeof(FChaosWheelSetup) == 0x000030, "Wrong size on FChaosWheelSetup");
...
static_assert(offsetof(FChaosWheelSetup, AdditionalOffset) == 0x000018, "Member 'FChaosWheelSetup::AdditionalOffset' has a wrong offset!");
...
static_assert(sizeof(FVehicleAnimationInstanceProxy) == 0x0007F0, "Wrong size on FVehicleAnimationInstanceProxy");
