...
static_assert(sizeof(FStructSerializerObjectTestStruct) == 0x0000E0, "Wrong size on FStructSerializerObjectTestStruct");
...
static_assert(offsetof(FStructSerializerObjectTestStruct, ObjectPath) == 0x0000B8, "Member 'FStructSerializerObjectTestStruct::ObjectPath' has a wrong offset!");
...
static_assert(sizeof(FStructSerializerTestStruct) == 0x000830, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, Builtins) == 0x000120, "Member 'FStructSerializerTestStruct::Builtins' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Arrays) == 0x0001F0, "Member 'FStructSerializerTestStruct::Arrays' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Maps) == 0x000250, "Member 'FStructSerializerTestStruct::Maps' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Sets) == 0x000390, "Member 'FStructSerializerTestStruct::Sets' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, LWCTypes) == 0x0004D0, "Member 'FStructSerializerTestStruct::LWCTypes' has a wrong offset!");
