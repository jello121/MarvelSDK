...
{
public:
	class UWBP_Common_Btn_Icon_C*                 Ben_Reset;                                         // 0x05F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UWBP_GMCmd_CustomBox_C, Ben_Reset) == 0x0005F8, "Member 'UWBP_GMCmd_CustomBox_C::Ben_Reset' has a wrong offset!");
