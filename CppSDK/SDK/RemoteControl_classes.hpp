...
{
public:
	class URemoteControlPreset*                   Preset;                                            // 0x05F8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ARemoteControlPresetActor) == 0x000608, "Wrong size on ARemoteControlPresetActor");
static_assert(offsetof(ARemoteControlPresetActor, Preset) == 0x0005F8, "Member 'ARemoteControlPresetActor::Preset' has a wrong offset!");
