...
{
public:
	struct FDeclarationHolder                     ViewTargetWatcher;                                 // 0x0108(0x0010)(BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyLevelTeamDeathMatchArcadeAudioComponent) == 0x000118, "Wrong size on UPyLevelTeamDeathMatchArcadeAudioComponent");
static_assert(offsetof(UPyLevelTeamDeathMatchArcadeAudioComponent, ViewTargetWatcher) == 0x000108, "Member 'UPyLevelTeamDeathMatchArcadeAudioComponent::ViewTargetWatcher' has a wrong offset!");
