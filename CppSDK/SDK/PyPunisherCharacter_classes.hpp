...
static_assert(sizeof(APyPunisherChildActor) == 0x000BF8, "Wrong size on APyPunisherChildActor");
...
{
public:
	struct FGameplayTag                           ShowGatlingTag;                                    // 0x1C10(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyPunisherCharacter) == 0x001C20, "Wrong size on APyPunisherCharacter");
static_assert(offsetof(APyPunisherCharacter, ShowGatlingTag) == 0x001C10, "Member 'APyPunisherCharacter::ShowGatlingTag' has a wrong offset!");
