...
// 0x0030 (0x2280 - 0x2250)
class UPyConfig_104781 final : public UConfig_104781
{
public:
	int32                                         FlyBuff;                                           // 0x2250(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         JeffMarkBuff;                                      // 0x2254(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         GrootMarkBuff;                                     // 0x2258(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_225C[0x4];                                     // 0x225C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CapsuleLocationOffset;                             // 0x2260(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LaunchVerticalVelocity;                            // 0x2278(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LaunchHorizontalVelocity;                          // 0x227C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyConfig_104781) == 0x002280, "Wrong size on UPyConfig_104781");
static_assert(offsetof(UPyConfig_104781, FlyBuff) == 0x002250, "Member 'UPyConfig_104781::FlyBuff' has a wrong offset!");
static_assert(offsetof(UPyConfig_104781, JeffMarkBuff) == 0x002254, "Member 'UPyConfig_104781::JeffMarkBuff' has a wrong offset!");
static_assert(offsetof(UPyConfig_104781, GrootMarkBuff) == 0x002258, "Member 'UPyConfig_104781::GrootMarkBuff' has a wrong offset!");
static_assert(offsetof(UPyConfig_104781, CapsuleLocationOffset) == 0x002260, "Member 'UPyConfig_104781::CapsuleLocationOffset' has a wrong offset!");
static_assert(offsetof(UPyConfig_104781, LaunchVerticalVelocity) == 0x002278, "Member 'UPyConfig_104781::LaunchVerticalVelocity' has a wrong offset!");
static_assert(offsetof(UPyConfig_104781, LaunchHorizontalVelocity) == 0x00227C, "Member 'UPyConfig_104781::LaunchHorizontalVelocity' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_104781) == 0x002D48, "Wrong size on UPyAbility_104781");
