...
public:
	...
	float                                         _____0_0;                                          // 0x2A48(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(UAbility_103343_BP_C) == 0x000008, "Wrong alignment on UAbility_103343_BP_C");
static_assert(sizeof(UAbility_103343_BP_C) == 0x002A50, "Wrong size on UAbility_103343_BP_C");
static_assert(offsetof(UAbility_103343_BP_C, UberGraphFrame) == 0x002A40, "Member 'UAbility_103343_BP_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAbility_103343_BP_C, _____0_0) == 0x002A48, "Member 'UAbility_103343_BP_C::_____0_0' has a wrong offset!");
