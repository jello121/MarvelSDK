...
static_assert(sizeof(UJarvisDemoNetConnection) == 0x0022C0, "Wrong size on UJarvisDemoNetConnection");
...
{
public:
	class UInputMappingContext*                   DefaultMappingContext;                             // 0x0CC0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AJarvisReplayCharacter) == 0x000CD0, "Wrong size on AJarvisReplayCharacter");
static_assert(offsetof(AJarvisReplayCharacter, DefaultMappingContext) == 0x000CC0, "Member 'AJarvisReplayCharacter::DefaultMappingContext' has a wrong offset!");
...
static_assert(sizeof(UJarvisReplayConnection) == 0x002340, "Wrong size on UJarvisReplayConnection");
...
static_assert(sizeof(UJarvisReplayGameInstance) == 0x0003A8, "Wrong size on UJarvisReplayGameInstance");
...
static_assert(sizeof(UJarvisReplayNetDriver) == 0x000C40, "Wrong size on UJarvisReplayNetDriver");
...
static_assert(sizeof(AJarvisReplayPlayerController) == 0x000C28, "Wrong size on AJarvisReplayPlayerController");

// Class JarvisReplay.JarvisReplayDemoNetDriver
// 0x0040 (0x1B60 - 0x1B20)
#pragma pack(push, 0x1)
class alignas(0x10) UJarvisReplayDemoNetDriver : public UDemoNetDriver
{
public:
	uint8                                         Pad_1B20[0x30];                                    // 0x1B20(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class UJarvisReplaySubsystem*                 JarvisReplaySubsystem;                             // 0x1B50(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UJarvisReplayDemoNetDriver) == 0x001B60, "Wrong size on UJarvisReplayDemoNetDriver");
static_assert(offsetof(UJarvisReplayDemoNetDriver, JarvisReplaySubsystem) == 0x001B50, "Member 'UJarvisReplayDemoNetDriver::JarvisReplaySubsystem' has a wrong offset!");
...
public:
	...
	void LocalRecordWidgetEventReplay(const class FString& Name_0, const class FString& FriendlyName);
	...
	void RecordJarvisReplay(bool bInIsInGameRecord);
	void RecordWidgetEventReplay(bool bInIsInGameRecord);
