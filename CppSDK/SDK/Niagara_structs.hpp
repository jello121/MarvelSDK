...
static_assert(sizeof(FNiagaraScriptUObjectCompileInfo) == 0x000060, "Wrong size on FNiagaraScriptUObjectCompileInfo");
...
static_assert(offsetof(FNiagaraScriptUObjectCompileInfo, RegisteredParameterMapRead) == 0x000040, "Member 'FNiagaraScriptUObjectCompileInfo::RegisteredParameterMapRead' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptUObjectCompileInfo, RegisteredParameterMapWrites) == 0x000050, "Member 'FNiagaraScriptUObjectCompileInfo::RegisteredParameterMapWrites' has a wrong offset!");
...
static_assert(alignof(FCombineTriggerFXInstanceData) == 0x000008, "Wrong alignment on FCombineTriggerFXInstanceData");
static_assert(sizeof(FCombineTriggerFXInstanceData) == 0x000040, "Wrong size on FCombineTriggerFXInstanceData");
static_assert(offsetof(FCombineTriggerFXInstanceData, VectorData) == 0x000000, "Member 'FCombineTriggerFXInstanceData::VectorData' has a wrong offset!");
static_assert(offsetof(FCombineTriggerFXInstanceData, FloatData) == 0x000010, "Member 'FCombineTriggerFXInstanceData::FloatData' has a wrong offset!");
static_assert(offsetof(FCombineTriggerFXInstanceData, IntAndEnumData) == 0x000020, "Member 'FCombineTriggerFXInstanceData::IntAndEnumData' has a wrong offset!");
static_assert(offsetof(FCombineTriggerFXInstanceData, UniqueIDData) == 0x000030, "Member 'FCombineTriggerFXInstanceData::UniqueIDData' has a wrong offset!");
static_assert(offsetof(FCombineTriggerFXInstanceData, InstanceCount) == 0x000034, "Member 'FCombineTriggerFXInstanceData::InstanceCount' has a wrong offset!");
static_assert(offsetof(FCombineTriggerFXInstanceData, TriggerFXType) == 0x000038, "Member 'FCombineTriggerFXInstanceData::TriggerFXType' has a wrong offset!");
...
static_assert(alignof(FNiagaraSystemSpawnParameters) == 0x000008, "Wrong alignment on FNiagaraSystemSpawnParameters");
static_assert(sizeof(FNiagaraSystemSpawnParameters) == 0x000088, "Wrong size on FNiagaraSystemSpawnParameters");
static_assert(offsetof(FNiagaraSystemSpawnParameters, ParameterCollectionOverride) == 0x000080, "Member 'FNiagaraSystemSpawnParameters::ParameterCollectionOverride' has a wrong offset!");
...
static_assert(offsetof(FNiagaraFunctionSignature, MiscUsageBitMask) == 0x000044, "Member 'FNiagaraFunctionSignature::MiscUsageBitMask' has a wrong offset!");
static_assert(offsetof(FNiagaraFunctionSignature, ContextStageIndex) == 0x000048, "Member 'FNiagaraFunctionSignature::ContextStageIndex' has a wrong offset!");
static_assert(offsetof(FNiagaraFunctionSignature, RequiredInputs) == 0x00004C, "Member 'FNiagaraFunctionSignature::RequiredInputs' has a wrong offset!");
static_assert(offsetof(FNiagaraFunctionSignature, RequiredOutputs) == 0x00004E, "Member 'FNiagaraFunctionSignature::RequiredOutputs' has a wrong offset!");
...
static_assert(sizeof(FNiagaraResolvedUObjectInfo) == 0x000028, "Wrong size on FNiagaraResolvedUObjectInfo");
...
static_assert(offsetof(FNiagaraResolvedUObjectInfo, ResolvedVariable) == 0x00000C, "Member 'FNiagaraResolvedUObjectInfo::ResolvedVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraResolvedUObjectInfo, Object) == 0x000020, "Member 'FNiagaraResolvedUObjectInfo::Object' has a wrong offset!");
...
static_assert(sizeof(FNiagaraExternalUObjectInfo) == 0x00001C, "Wrong size on FNiagaraExternalUObjectInfo");
...
static_assert(offsetof(FNiagaraExternalUObjectInfo, ExternalName) == 0x000010, "Member 'FNiagaraExternalUObjectInfo::ExternalName' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptDataInterfaceInfo) == 0x000060, "Wrong size on FNiagaraScriptDataInterfaceInfo");
...
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, CompileName) == 0x000014, "Member 'FNiagaraScriptDataInterfaceInfo::CompileName' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, UserPtrIdx) == 0x000020, "Member 'FNiagaraScriptDataInterfaceInfo::UserPtrIdx' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, Type) == 0x000028, "Member 'FNiagaraScriptDataInterfaceInfo::Type' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, RegisteredParameterMapRead) == 0x000038, "Member 'FNiagaraScriptDataInterfaceInfo::RegisteredParameterMapRead' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, RegisteredParameterMapWrite) == 0x000044, "Member 'FNiagaraScriptDataInterfaceInfo::RegisteredParameterMapWrite' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, SourceEmitterName) == 0x000050, "Member 'FNiagaraScriptDataInterfaceInfo::SourceEmitterName' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptResolvedDataInterfaceInfo) == 0x000060, "Wrong size on FNiagaraScriptResolvedDataInterfaceInfo");
...
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, CompileName) == 0x00000C, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::CompileName' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ResolvedSourceEmitterName) == 0x000018, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ResolvedSourceEmitterName' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ResolvedVariable) == 0x000028, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ResolvedVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ParameterStoreVariable) == 0x000038, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ParameterStoreVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, bIsInternal) == 0x000048, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::bIsInternal' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ResolvedDataInterface) == 0x000050, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ResolvedDataInterface' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, UserPtrIdx) == 0x000058, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::UserPtrIdx' has a wrong offset!");
...
static_assert(offsetof(FNiagaraScriptDataInterfaceCompileInfo, SourceEmitterName) == 0x000040, "Member 'FNiagaraScriptDataInterfaceCompileInfo::SourceEmitterName' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVariableAttributeBinding) == 0x000040, "Wrong size on FNiagaraVariableAttributeBinding");
...
static_assert(offsetof(FNiagaraVariableAttributeBinding, DataSetName) == 0x000030, "Member 'FNiagaraVariableAttributeBinding::DataSetName' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableAttributeBinding, BindingSourceMode) == 0x00003C, "Member 'FNiagaraVariableAttributeBinding::BindingSourceMode' has a wrong offset!");
...
static_assert(alignof(FNiagaraMaterialAttributeBinding) == 0x000008, "Wrong alignment on FNiagaraMaterialAttributeBinding");
static_assert(sizeof(FNiagaraMaterialAttributeBinding) == 0x000048, "Wrong size on FNiagaraMaterialAttributeBinding");
...
static_assert(offsetof(FNiagaraMaterialAttributeBinding, SourceParameterCollection) == 0x000040, "Member 'FNiagaraMaterialAttributeBinding::SourceParameterCollection' has a wrong offset!");
...
static_assert(sizeof(FNiagaraCompileDependency) == 0x000058, "Wrong size on FNiagaraCompileDependency");
...
static_assert(offsetof(FNiagaraCompileDependency, bDependentVariableFromCustomIterationNamespace) == 0x000050, "Member 'FNiagaraCompileDependency::bDependentVariableFromCustomIterationNamespace' has a wrong offset!");
...
static_assert(alignof(FChaosSecondaryFragmentBrokenMessage) == 0x000008, "Wrong alignment on FChaosSecondaryFragmentBrokenMessage");
static_assert(sizeof(FChaosSecondaryFragmentBrokenMessage) == 0x000018, "Wrong size on FChaosSecondaryFragmentBrokenMessage");
...
static_assert(sizeof(FNiagaraParameterBinding) == 0x000010, "Wrong size on FNiagaraParameterBinding");
...
static_assert(alignof(FNiagaraParticlesNumManager) == 0x000008, "Wrong alignment on FNiagaraParticlesNumManager");
static_assert(sizeof(FNiagaraParticlesNumManager) == 0x000030, "Wrong size on FNiagaraParticlesNumManager");
...
static_assert(sizeof(FNiagaraStackSection) == 0x000058, "Wrong size on FNiagaraStackSection");
...
static_assert(offsetof(FNiagaraStackSection, SectionDisplayName) == 0x000010, "Member 'FNiagaraStackSection::SectionDisplayName' has a wrong offset!");
static_assert(offsetof(FNiagaraStackSection, Categories) == 0x000028, "Member 'FNiagaraStackSection::Categories' has a wrong offset!");
static_assert(offsetof(FNiagaraStackSection, ToolTip) == 0x000038, "Member 'FNiagaraStackSection::ToolTip' has a wrong offset!");
static_assert(offsetof(FNiagaraStackSection, bEnabled) == 0x000050, "Member 'FNiagaraStackSection::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FNiagaraUObjectPropertyReaderRemap) == 0x000018, "Wrong size on FNiagaraUObjectPropertyReaderRemap");
...
static_assert(offsetof(FNiagaraUObjectPropertyReaderRemap, RemapName) == 0x00000C, "Member 'FNiagaraUObjectPropertyReaderRemap::RemapName' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneNiagaraSystemTrackImplementation, bRestoreState) == 0x000026, "Member 'FMovieSceneNiagaraSystemTrackImplementation::bRestoreState' has a wrong offset!");
...
static_assert(alignof(FMovieSceneNiagaraObjectParameterSectionTemplate) == 0x000008, "Wrong alignment on FMovieSceneNiagaraObjectParameterSectionTemplate");
static_assert(sizeof(FMovieSceneNiagaraObjectParameterSectionTemplate) == 0x000178, "Wrong size on FMovieSceneNiagaraObjectParameterSectionTemplate");
static_assert(offsetof(FMovieSceneNiagaraObjectParameterSectionTemplate, ObjectChannel) == 0x000040, "Member 'FMovieSceneNiagaraObjectParameterSectionTemplate::ObjectChannel' has a wrong offset!");
...
static_assert(sizeof(FNiagaraBakerTextureSource) == 0x000020, "Wrong size on FNiagaraBakerTextureSource");
...
static_assert(sizeof(FNiagaraBakerTextureSettings) == 0x000050, "Wrong size on FNiagaraBakerTextureSettings");
...
static_assert(offsetof(FNiagaraBakerTextureSettings, SourceBinding) == 0x000010, "Member 'FNiagaraBakerTextureSettings::SourceBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerTextureSettings, FrameSize) == 0x000034, "Member 'FNiagaraBakerTextureSettings::FrameSize' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerTextureSettings, TextureSize) == 0x00003C, "Member 'FNiagaraBakerTextureSettings::TextureSize' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerTextureSettings, GeneratedTexture) == 0x000048, "Member 'FNiagaraBakerTextureSettings::GeneratedTexture' has a wrong offset!");
...
static_assert(sizeof(FNiagaraComponentPropertyBinding) == 0x0000C0, "Wrong size on FNiagaraComponentPropertyBinding");
...
static_assert(offsetof(FNiagaraComponentPropertyBinding, PropertyName) == 0x000040, "Member 'FNiagaraComponentPropertyBinding::PropertyName' has a wrong offset!");
static_assert(offsetof(FNiagaraComponentPropertyBinding, PropertyType) == 0x000050, "Member 'FNiagaraComponentPropertyBinding::PropertyType' has a wrong offset!");
static_assert(offsetof(FNiagaraComponentPropertyBinding, MetadataSetterName) == 0x000060, "Member 'FNiagaraComponentPropertyBinding::MetadataSetterName' has a wrong offset!");
static_assert(offsetof(FNiagaraComponentPropertyBinding, PropertySetterParameterDefaults) == 0x000070, "Member 'FNiagaraComponentPropertyBinding::PropertySetterParameterDefaults' has a wrong offset!");
...
static_assert(sizeof(FNiagaraDataInterfaceEmitterBinding) == 0x000010, "Wrong size on FNiagaraDataInterfaceEmitterBinding");
...
static_assert(sizeof(FNiagaraSystemSimCacheCaptureRequest) == 0x000014, "Wrong size on FNiagaraSystemSimCacheCaptureRequest");
...
static_assert(offsetof(FNiagaraSystemSimCacheCaptureRequest, CaptureDelayFrames) == 0x00000C, "Member 'FNiagaraSystemSimCacheCaptureRequest::CaptureDelayFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemSimCacheCaptureRequest, CaptureFrames) == 0x000010, "Member 'FNiagaraSystemSimCacheCaptureRequest::CaptureFrames' has a wrong offset!");
...
static_assert(sizeof(FNiagaraSystemSimCacheCaptureReply) == 0x000020, "Wrong size on FNiagaraSystemSimCacheCaptureReply");
...
static_assert(offsetof(FNiagaraSystemSimCacheCaptureReply, SimCacheData) == 0x000010, "Member 'FNiagaraSystemSimCacheCaptureReply::SimCacheData' has a wrong offset!");
...
static_assert(sizeof(FNiagaraPlatformSetCVarCondition) == 0x000038, "Wrong size on FNiagaraPlatformSetCVarCondition");
...
static_assert(offsetof(FNiagaraPlatformSetCVarCondition, PassResponse) == 0x00000C, "Member 'FNiagaraPlatformSetCVarCondition::PassResponse' has a wrong offset!");
static_assert(offsetof(FNiagaraPlatformSetCVarCondition, FailResponse) == 0x00000D, "Member 'FNiagaraPlatformSetCVarCondition::FailResponse' has a wrong offset!");
static_assert(offsetof(FNiagaraPlatformSetCVarCondition, Value) == 0x00000E, "Member 'FNiagaraPlatformSetCVarCondition::Value' has a wrong offset!");
...
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MinAgeCanCull) == 0x000038, "Member 'FNiagaraSystemScalabilitySettings::MinAgeCanCull' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MaxInstances) == 0x000040, "Member 'FNiagaraSystemScalabilitySettings::MaxInstances' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MaxSystemInstances) == 0x000044, "Member 'FNiagaraSystemScalabilitySettings::MaxSystemInstances' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MaxTimeWithoutRender) == 0x000048, "Member 'FNiagaraSystemScalabilitySettings::MaxTimeWithoutRender' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, CullProxyMode) == 0x00004C, "Member 'FNiagaraSystemScalabilitySettings::CullProxyMode' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MaxSystemProxies) == 0x000050, "Member 'FNiagaraSystemScalabilitySettings::MaxSystemProxies' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, VisibilityCulling) == 0x000054, "Member 'FNiagaraSystemScalabilitySettings::VisibilityCulling' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, BudgetScaling) == 0x000060, "Member 'FNiagaraSystemScalabilitySettings::BudgetScaling' has a wrong offset!");
...
static_assert(alignof(FNiagaraShowModeSetting) == 0x000001, "Wrong alignment on FNiagaraShowModeSetting");
static_assert(sizeof(FNiagaraShowModeSetting) == 0x000001, "Wrong size on FNiagaraShowModeSetting");
static_assert(offsetof(FNiagaraShowModeSetting, bDisableRemoteEnd) == 0x000000, "Member 'FNiagaraShowModeSetting::bDisableRemoteEnd' has a wrong offset!");
...
static_assert(alignof(FNiagaraEmitterShowModeSetting) == 0x000004, "Wrong alignment on FNiagaraEmitterShowModeSetting");
static_assert(sizeof(FNiagaraEmitterShowModeSetting) == 0x00000C, "Wrong size on FNiagaraEmitterShowModeSetting");
static_assert(offsetof(FNiagaraEmitterShowModeSetting, SpawnCountScale) == 0x000008, "Member 'FNiagaraEmitterShowModeSetting::SpawnCountScale' has a wrong offset!");
...
static_assert(sizeof(FNiagaraEventScriptProperties) == 0x000060, "Wrong size on FNiagaraEventScriptProperties");
...
static_assert(offsetof(FNiagaraEventScriptProperties, UpdateAttributeInitialValues) == 0x000058, "Member 'FNiagaraEventScriptProperties::UpdateAttributeInitialValues' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVariableWithOffset) == 0x000030, "Wrong size on FNiagaraVariableWithOffset");
...
static_assert(offsetof(FNiagaraVariableWithOffset, StructConverter) == 0x000018, "Member 'FNiagaraVariableWithOffset::StructConverter' has a wrong offset!");
...
static_assert(sizeof(FNiagaraPositionSource) == 0x000028, "Wrong size on FNiagaraPositionSource");
static_assert(offsetof(FNiagaraPositionSource, Name) == 0x000000, "Member 'FNiagaraPositionSource::Name' has a wrong offset!");
static_assert(offsetof(FNiagaraPositionSource, Value) == 0x000010, "Member 'FNiagaraPositionSource::Value' has a wrong offset!");
...
static_assert(sizeof(FNiagaraParameterStore) == 0x000090, "Wrong size on FNiagaraParameterStore");
...
public:
	...
	uint8                                         Pad_2A0[0xA0];                                     // 0x02A0(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FVersionedNiagaraEmitterData, ShowModeSetting) == 0x0000D8, "Member 'FVersionedNiagaraEmitterData::ShowModeSetting' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, MaxGPUParticlesSpawnPerFrame) == 0x0000E4, "Member 'FVersionedNiagaraEmitterData::MaxGPUParticlesSpawnPerFrame' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, AllocationMode) == 0x0000E8, "Member 'FVersionedNiagaraEmitterData::AllocationMode' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, PreAllocationCount) == 0x0000EC, "Member 'FVersionedNiagaraEmitterData::PreAllocationCount' has a wrong offset!");
...
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererBindingsExternalObjects) == 0x0001D0, "Member 'FVersionedNiagaraEmitterData::RendererBindingsExternalObjects' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, ResolvedDIBindings) == 0x0001E0, "Member 'FVersionedNiagaraEmitterData::ResolvedDIBindings' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererProperties) == 0x000230, "Member 'FVersionedNiagaraEmitterData::RendererProperties' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SimulationStages) == 0x000240, "Member 'FVersionedNiagaraEmitterData::SimulationStages' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, GPUComputeScript) == 0x000250, "Member 'FVersionedNiagaraEmitterData::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SharedEventGeneratorIds) == 0x000258, "Member 'FVersionedNiagaraEmitterData::SharedEventGeneratorIds' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, CurrentScalabilitySettings) == 0x000268, "Member 'FVersionedNiagaraEmitterData::CurrentScalabilitySettings' has a wrong offset!");
...
static_assert(sizeof(FNiagaraBoundParameter) == 0x000018, "Wrong size on FNiagaraBoundParameter");
...
static_assert(offsetof(FNiagaraBoundParameter, SrcOffset) == 0x000010, "Member 'FNiagaraBoundParameter::SrcOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraBoundParameter, DestOffset) == 0x000014, "Member 'FNiagaraBoundParameter::DestOffset' has a wrong offset!");
...
static_assert(sizeof(FNiagaraPlatformSetRedirect) == 0x000090, "Wrong size on FNiagaraPlatformSetRedirect");
...
static_assert(offsetof(FNiagaraPlatformSetRedirect, CVarConditionDisabled) == 0x000058, "Member 'FNiagaraPlatformSetRedirect::CVarConditionDisabled' has a wrong offset!");
...
static_assert(sizeof(FNiagaraRendererMaterialScalarParameter) == 0x000010, "Wrong size on FNiagaraRendererMaterialScalarParameter");
...
static_assert(offsetof(FNiagaraRendererMaterialScalarParameter, Value) == 0x00000C, "Member 'FNiagaraRendererMaterialScalarParameter::Value' has a wrong offset!");
...
static_assert(sizeof(FNiagaraRendererMaterialVectorParameter) == 0x00001C, "Wrong size on FNiagaraRendererMaterialVectorParameter");
...
static_assert(offsetof(FNiagaraRendererMaterialVectorParameter, Value) == 0x00000C, "Member 'FNiagaraRendererMaterialVectorParameter::Value' has a wrong offset!");
...
static_assert(sizeof(FNiagaraRendererMaterialTextureParameter) == 0x000018, "Wrong size on FNiagaraRendererMaterialTextureParameter");
...
static_assert(offsetof(FNiagaraRendererMaterialTextureParameter, Texture) == 0x000010, "Member 'FNiagaraRendererMaterialTextureParameter::Texture' has a wrong offset!");
...
static_assert(sizeof(FNiagaraRendererMaterialStaticBoolParameter) == 0x000018, "Wrong size on FNiagaraRendererMaterialStaticBoolParameter");
...
static_assert(offsetof(FNiagaraRendererMaterialStaticBoolParameter, StaticVariableName) == 0x00000C, "Member 'FNiagaraRendererMaterialStaticBoolParameter::StaticVariableName' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVMExecutableData) == 0x000180, "Wrong size on FNiagaraVMExecutableData");
...
static_assert(offsetof(FNiagaraVMExecutableData, NumTempRegisters) == 0x000048, "Member 'FNiagaraVMExecutableData::NumTempRegisters' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, NumUserPtrs) == 0x00004C, "Member 'FNiagaraVMExecutableData::NumUserPtrs' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, CompileTags) == 0x000050, "Member 'FNiagaraVMExecutableData::CompileTags' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ScriptLiterals) == 0x000060, "Member 'FNiagaraVMExecutableData::ScriptLiterals' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, Attributes) == 0x000070, "Member 'FNiagaraVMExecutableData::Attributes' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, DataUsage) == 0x000080, "Member 'FNiagaraVMExecutableData::DataUsage' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, UObjectInfos) == 0x000088, "Member 'FNiagaraVMExecutableData::UObjectInfos' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, DataInterfaceInfo) == 0x000098, "Member 'FNiagaraVMExecutableData::DataInterfaceInfo' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, CalledVMExternalFunctions) == 0x0000A8, "Member 'FNiagaraVMExecutableData::CalledVMExternalFunctions' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ReadDataSets) == 0x0000C8, "Member 'FNiagaraVMExecutableData::ReadDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, WriteDataSets) == 0x0000D8, "Member 'FNiagaraVMExecutableData::WriteDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, StatScopes) == 0x0000E8, "Member 'FNiagaraVMExecutableData::StatScopes' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ShaderScriptParametersMetadata) == 0x0000F8, "Member 'FNiagaraVMExecutableData::ShaderScriptParametersMetadata' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, LastCompileStatus) == 0x000150, "Member 'FNiagaraVMExecutableData::LastCompileStatus' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, SimulationStageMetaData) == 0x000158, "Member 'FNiagaraVMExecutableData::SimulationStageMetaData' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ExperimentalContextData) == 0x000168, "Member 'FNiagaraVMExecutableData::ExperimentalContextData' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptExecutionParameterStore) == 0x0000B0, "Wrong size on FNiagaraScriptExecutionParameterStore");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, ParameterSize) == 0x000090, "Member 'FNiagaraScriptExecutionParameterStore::ParameterSize' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, PaddedParameterSize) == 0x000094, "Member 'FNiagaraScriptExecutionParameterStore::PaddedParameterSize' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, PaddingInfo) == 0x000098, "Member 'FNiagaraScriptExecutionParameterStore::PaddingInfo' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptInstanceParameterStore) == 0x0000A0, "Wrong size on FNiagaraScriptInstanceParameterStore");
...
static_assert(sizeof(FNiagaraSimCacheVariable) == 0x00001C, "Wrong size on FNiagaraSimCacheVariable");
...
static_assert(offsetof(FNiagaraSimCacheVariable, FloatOffset) == 0x000010, "Member 'FNiagaraSimCacheVariable::FloatOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheVariable, FloatCount) == 0x000012, "Member 'FNiagaraSimCacheVariable::FloatCount' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheVariable, HalfOffset) == 0x000014, "Member 'FNiagaraSimCacheVariable::HalfOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheVariable, HalfCount) == 0x000016, "Member 'FNiagaraSimCacheVariable::HalfCount' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheVariable, Int32Offset) == 0x000018, "Member 'FNiagaraSimCacheVariable::Int32Offset' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheVariable, Int32Count) == 0x00001A, "Member 'FNiagaraSimCacheVariable::Int32Count' has a wrong offset!");
...
static_assert(offsetof(FNiagaraSimCacheDataBuffersLayout, SimTarget) == 0x00000C, "Member 'FNiagaraSimCacheDataBuffersLayout::SimTarget' has a wrong offset!");
...
static_assert(sizeof(FNiagaraSystemCompiledData) == 0x000248, "Wrong size on FNiagaraSystemCompiledData");
...
static_assert(offsetof(FNiagaraSystemCompiledData, DataSetCompiledData) == 0x000090, "Member 'FNiagaraSystemCompiledData::DataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceParamsDataSetCompiledData) == 0x0000D8, "Member 'FNiagaraSystemCompiledData::SpawnInstanceParamsDataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceParamsDataSetCompiledData) == 0x000120, "Member 'FNiagaraSystemCompiledData::UpdateInstanceParamsDataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceGlobalBinding) == 0x000168, "Member 'FNiagaraSystemCompiledData::SpawnInstanceGlobalBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceSystemBinding) == 0x000188, "Member 'FNiagaraSystemCompiledData::SpawnInstanceSystemBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceOwnerBinding) == 0x0001A8, "Member 'FNiagaraSystemCompiledData::SpawnInstanceOwnerBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceEmitterBindings) == 0x0001C8, "Member 'FNiagaraSystemCompiledData::SpawnInstanceEmitterBindings' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceGlobalBinding) == 0x0001D8, "Member 'FNiagaraSystemCompiledData::UpdateInstanceGlobalBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceSystemBinding) == 0x0001F8, "Member 'FNiagaraSystemCompiledData::UpdateInstanceSystemBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceOwnerBinding) == 0x000218, "Member 'FNiagaraSystemCompiledData::UpdateInstanceOwnerBinding' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceEmitterBindings) == 0x000238, "Member 'FNiagaraSystemCompiledData::UpdateInstanceEmitterBindings' has a wrong offset!");
...
static_assert(alignof(FNiagaraLifeCycleSetting) == 0x000001, "Wrong alignment on FNiagaraLifeCycleSetting");
static_assert(sizeof(FNiagaraLifeCycleSetting) == 0x000001, "Wrong size on FNiagaraLifeCycleSetting");
...
static_assert(sizeof(FNiagaraEnumParameterMetaData) == 0x000030, "Wrong size on FNiagaraEnumParameterMetaData");
...
static_assert(offsetof(FNiagaraEnumParameterMetaData, IconOverride) == 0x000010, "Member 'FNiagaraEnumParameterMetaData::IconOverride' has a wrong offset!");
static_assert(offsetof(FNiagaraEnumParameterMetaData, bUseColorOverride) == 0x000018, "Member 'FNiagaraEnumParameterMetaData::bUseColorOverride' has a wrong offset!");
static_assert(offsetof(FNiagaraEnumParameterMetaData, ColorOverride) == 0x00001C, "Member 'FNiagaraEnumParameterMetaData::ColorOverride' has a wrong offset!");
...
static_assert(sizeof(FNiagaraBoolParameterMetaData) == 0x000030, "Wrong size on FNiagaraBoolParameterMetaData");
...
static_assert(offsetof(FNiagaraBoolParameterMetaData, OverrideNameFalse) == 0x000010, "Member 'FNiagaraBoolParameterMetaData::OverrideNameFalse' has a wrong offset!");
static_assert(offsetof(FNiagaraBoolParameterMetaData, IconOverrideTrue) == 0x000020, "Member 'FNiagaraBoolParameterMetaData::IconOverrideTrue' has a wrong offset!");
static_assert(offsetof(FNiagaraBoolParameterMetaData, IconOverrideFalse) == 0x000028, "Member 'FNiagaraBoolParameterMetaData::IconOverrideFalse' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVariableMetaData) == 0x0001A8, "Wrong size on FNiagaraVariableMetaData");
...
static_assert(offsetof(FNiagaraVariableMetaData, EditorSortPriority) == 0x000098, "Member 'FNiagaraVariableMetaData::EditorSortPriority' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bInlineEditConditionToggle) == 0x00009C, "Member 'FNiagaraVariableMetaData::bInlineEditConditionToggle' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, EditCondition) == 0x0000A0, "Member 'FNiagaraVariableMetaData::EditCondition' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, VisibleCondition) == 0x0000C0, "Member 'FNiagaraVariableMetaData::VisibleCondition' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, PropertyMetaData) == 0x0000E0, "Member 'FNiagaraVariableMetaData::PropertyMetaData' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, ParentAttribute) == 0x000130, "Member 'FNiagaraVariableMetaData::ParentAttribute' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, AlternateAliases) == 0x000140, "Member 'FNiagaraVariableMetaData::AlternateAliases' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, WidgetCustomization) == 0x000150, "Member 'FNiagaraVariableMetaData::WidgetCustomization' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, VariableGuid) == 0x000190, "Member 'FNiagaraVariableMetaData::VariableGuid' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bIsStaticSwitch) == 0x0001A0, "Member 'FNiagaraVariableMetaData::bIsStaticSwitch' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, StaticSwitchDefaultValue) == 0x0001A4, "Member 'FNiagaraVariableMetaData::StaticSwitchDefaultValue' has a wrong offset!");
...
static_assert(sizeof(FNiagaraUserRedirectionParameterStore) == 0x0000E0, "Wrong size on FNiagaraUserRedirectionParameterStore");
static_assert(offsetof(FNiagaraUserRedirectionParameterStore, UserParameterRedirects) == 0x000090, "Member 'FNiagaraUserRedirectionParameterStore::UserParameterRedirects' has a wrong offset!");
