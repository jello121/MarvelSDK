...
static_assert(sizeof(UPyAICondition_SurroundCharacterCheck) == 0x0000F8, "Wrong size on UPyAICondition_SurroundCharacterCheck");
...
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CenterSelect) == 0x000040, "Member 'UPyAICondition_SurroundCharacterCheck::CenterSelect' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CustomCharacterSide) == 0x000041, "Member 'UPyAICondition_SurroundCharacterCheck::CustomCharacterSide' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CustomCharacterAlive) == 0x000042, "Member 'UPyAICondition_SurroundCharacterCheck::CustomCharacterAlive' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CustomNeedVisible) == 0x000043, "Member 'UPyAICondition_SurroundCharacterCheck::CustomNeedVisible' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CustomScreenByHeroID) == 0x000044, "Member 'UPyAICondition_SurroundCharacterCheck::CustomScreenByHeroID' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CustomCharacterList) == 0x000048, "Member 'UPyAICondition_SurroundCharacterCheck::CustomCharacterList' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CharacterDistRange) == 0x000098, "Member 'UPyAICondition_SurroundCharacterCheck::CharacterDistRange' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CharacterSide) == 0x0000A0, "Member 'UPyAICondition_SurroundCharacterCheck::CharacterSide' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CharacterAlive) == 0x0000A1, "Member 'UPyAICondition_SurroundCharacterCheck::CharacterAlive' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, NeedVisible) == 0x0000A2, "Member 'UPyAICondition_SurroundCharacterCheck::NeedVisible' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, ScreenByHeroID) == 0x0000A3, "Member 'UPyAICondition_SurroundCharacterCheck::ScreenByHeroID' has a wrong offset!");
static_assert(offsetof(UPyAICondition_SurroundCharacterCheck, CharacterList) == 0x0000A8, "Member 'UPyAICondition_SurroundCharacterCheck::CharacterList' has a wrong offset!");
...
static_assert(sizeof(UPyAICondition_CheckSkillEnergyRemain) == 0x000048, "Wrong size on UPyAICondition_CheckSkillEnergyRemain");
...
static_assert(offsetof(UPyAICondition_CheckSkillEnergyRemain, Type) == 0x000040, "Member 'UPyAICondition_CheckSkillEnergyRemain::Type' has a wrong offset!");
