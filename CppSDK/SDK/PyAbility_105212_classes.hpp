...
static_assert(sizeof(UPyAbility_105212) == 0x002B30, "Wrong size on UPyAbility_105212");
...
static_assert(sizeof(UPyUIController_105212) == 0x000CD0, "Wrong size on UPyUIController_105212");
