...
void UPyWidget_HeroSystem_Skin::OnSwitchItem__DelegateSignature(const class FString& ItemId)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_HeroSystem_Skin", "OnSwitchItem__DelegateSignature");

	Params::PyWidget_HeroSystem_Skin_OnSwitchItem__DelegateSignature Parms{};
