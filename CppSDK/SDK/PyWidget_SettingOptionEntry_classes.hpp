...
class UPyWidget_SettingOptionEntry_Clan final : public UPyWidget_SettingOptionEntry
{
public:
	bool                                          bOverrideBtnSize;                                  // 0x0748(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_749[0x7];                                      // 0x0749(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              BtnSize;                                           // 0x0750(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   TxtName;                                           // 0x0760(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"PyWidget_SettingOptionEntry_Clan">();
	}
...
static_assert(alignof(UPyWidget_SettingOptionEntry_Clan) == 0x000008, "Wrong alignment on UPyWidget_SettingOptionEntry_Clan");
static_assert(sizeof(UPyWidget_SettingOptionEntry_Clan) == 0x000778, "Wrong size on UPyWidget_SettingOptionEntry_Clan");
static_assert(offsetof(UPyWidget_SettingOptionEntry_Clan, bOverrideBtnSize) == 0x000748, "Member 'UPyWidget_SettingOptionEntry_Clan::bOverrideBtnSize' has a wrong offset!");
static_assert(offsetof(UPyWidget_SettingOptionEntry_Clan, BtnSize) == 0x000750, "Member 'UPyWidget_SettingOptionEntry_Clan::BtnSize' has a wrong offset!");
static_assert(offsetof(UPyWidget_SettingOptionEntry_Clan, TxtName) == 0x000760, "Member 'UPyWidget_SettingOptionEntry_Clan::TxtName' has a wrong offset!");
