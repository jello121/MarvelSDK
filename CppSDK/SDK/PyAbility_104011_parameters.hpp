...
static_assert(alignof(PyCue_Ability_Loop_10401102_OnActiveFX) == 0x000008, "Wrong alignment on PyCue_Ability_Loop_10401102_OnActiveFX");
static_assert(sizeof(PyCue_Ability_Loop_10401102_OnActiveFX) == 0x0001C0, "Wrong size on PyCue_Ability_Loop_10401102_OnActiveFX");
static_assert(offsetof(PyCue_Ability_Loop_10401102_OnActiveFX, MyTarget) == 0x000000, "Member 'PyCue_Ability_Loop_10401102_OnActiveFX::MyTarget' has a wrong offset!");
static_assert(offsetof(PyCue_Ability_Loop_10401102_OnActiveFX, Parameters) == 0x000008, "Member 'PyCue_Ability_Loop_10401102_OnActiveFX::Parameters' has a wrong offset!");
...
static_assert(alignof(PyCue_Ability_Loop_10401102_OnRemoveFX) == 0x000008, "Wrong alignment on PyCue_Ability_Loop_10401102_OnRemoveFX");
static_assert(sizeof(PyCue_Ability_Loop_10401102_OnRemoveFX) == 0x0001C0, "Wrong size on PyCue_Ability_Loop_10401102_OnRemoveFX");
static_assert(offsetof(PyCue_Ability_Loop_10401102_OnRemoveFX, MyTarget) == 0x000000, "Member 'PyCue_Ability_Loop_10401102_OnRemoveFX::MyTarget' has a wrong offset!");
static_assert(offsetof(PyCue_Ability_Loop_10401102_OnRemoveFX, Parameters) == 0x000008, "Member 'PyCue_Ability_Loop_10401102_OnRemoveFX::Parameters' has a wrong offset!");
