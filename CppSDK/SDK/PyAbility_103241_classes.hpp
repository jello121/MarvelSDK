...
static_assert(sizeof(APyCue_Ability_Loop_10324101) == 0x000FF0, "Wrong size on APyCue_Ability_Loop_10324101");
...
{
public:
	float                                         FadeTime;                                          // 0x0FF0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Ability_Loop_10324103) == 0x000FF8, "Wrong size on APyCue_Ability_Loop_10324103");
static_assert(offsetof(APyCue_Ability_Loop_10324103, FadeTime) == 0x000FF0, "Member 'APyCue_Ability_Loop_10324103::FadeTime' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnRefreshAbility;                                  // 0x2A40(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_103241) == 0x002A50, "Wrong size on UPyAbility_103241");
static_assert(offsetof(UPyAbility_103241, OnRefreshAbility) == 0x002A40, "Member 'UPyAbility_103241::OnRefreshAbility' has a wrong offset!");
...
static_assert(sizeof(UPyUIController_103241) == 0x000CD0, "Wrong size on UPyUIController_103241");
