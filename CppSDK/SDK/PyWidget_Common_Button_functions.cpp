...
// struct FSlateColor                      Disable_color                                          (ConstParm, Parm, OutParm, ReferenceParm)

void UPyWidget_BaseCommonButton::SetBtnNameColor(const struct FSlateColor& Color, const struct FSlateColor& Disable_color)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_BaseCommonButton", "SetBtnNameColor");

	Params::PyWidget_BaseCommonButton_SetBtnNameColor Parms{};

	Parms.Color = std::move(Color);
	Parms.Disable_color = std::move(Disable_color);
