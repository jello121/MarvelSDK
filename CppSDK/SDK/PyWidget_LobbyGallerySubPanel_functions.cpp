...
// PythonFunction PyWidget_LobbyGallerySubPanel.PyWidget_LobbyGallerySubPanel.Destruct
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_LobbyGallerySubPanel::Destruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_LobbyGallerySubPanel", "Destruct");
