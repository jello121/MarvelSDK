...
static_assert(sizeof(PyProjectile_133_Base_K2_OnProcessHit) == 0x000178, "Wrong size on PyProjectile_133_Base_K2_OnProcessHit");
...
static_assert(sizeof(PyProjectile_133_Base_K2_OnFlyOverMaxDistance) == 0x000178, "Wrong size on PyProjectile_133_Base_K2_OnFlyOverMaxDistance");
...
static_assert(sizeof(PyAbility_133_Delegate_ProjetileHitDispatcher__DelegateSignature) == 0x000178, "Wrong size on PyAbility_133_Delegate_ProjetileHitDispatcher__DelegateSignature");
...
public:
	struct FHitResult                             InHitResult;                                       // 0x0000(0x0178)(ConstParm, Parm, OutParm, ReferenceParm)
	bool                                          bNeedSpecialMove;                                  // 0x0178(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bIsHitGround;                                      // 0x0179(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(PyAbility_133_K2_OnServerReceiveClientMissileData) == 0x000180, "Wrong size on PyAbility_133_K2_OnServerReceiveClientMissileData");
...
static_assert(offsetof(PyAbility_133_K2_OnServerReceiveClientMissileData, bNeedSpecialMove) == 0x000178, "Member 'PyAbility_133_K2_OnServerReceiveClientMissileData::bNeedSpecialMove' has a wrong offset!");
static_assert(offsetof(PyAbility_133_K2_OnServerReceiveClientMissileData, bIsHitGround) == 0x000179, "Member 'PyAbility_133_K2_OnServerReceiveClientMissileData::bIsHitGround' has a wrong offset!");
...
{
public:
	struct FSwingInfo                             InSwingInfo;                                       // 0x0000(0x0198)(ConstParm, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(PyAbility_133_K2_ReadySimpleSwing) == 0x000008, "Wrong alignment on PyAbility_133_K2_ReadySimpleSwing");
static_assert(sizeof(PyAbility_133_K2_ReadySimpleSwing) == 0x000198, "Wrong size on PyAbility_133_K2_ReadySimpleSwing");
