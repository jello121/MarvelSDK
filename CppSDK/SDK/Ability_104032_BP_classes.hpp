...
static_assert(sizeof(UAbility_104032_BP_C) == 0x002AD8, "Wrong size on UAbility_104032_BP_C");
static_assert(offsetof(UAbility_104032_BP_C, UberGraphFrame) == 0x002AD0, "Member 'UAbility_104032_BP_C::UberGraphFrame' has a wrong offset!");
