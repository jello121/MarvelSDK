...
{
public:
	FMulticastInlineDelegateProperty_             OnProjectileReachMaxDistance;                      // 0x3260(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyProjectile_10334101) == 0x003270, "Wrong size on APyProjectile_10334101");
static_assert(offsetof(APyProjectile_10334101, OnProjectileReachMaxDistance) == 0x003260, "Member 'APyProjectile_10334101::OnProjectileReachMaxDistance' has a wrong offset!");
...
static_assert(sizeof(APyCue_Ability_Loop_10334102) == 0x000FF0, "Wrong size on APyCue_Ability_Loop_10334102");
...
static_assert(sizeof(APyCue_Projectile_Loop_10334101) == 0x000F90, "Wrong size on APyCue_Projectile_Loop_10334101");
...
{
public:
	int32                                         JumpAbilityID;                                     // 0x2A38(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_103341) == 0x002A40, "Wrong size on UPyAbility_103341");
static_assert(offsetof(UPyAbility_103341, JumpAbilityID) == 0x002A38, "Member 'UPyAbility_103341::JumpAbilityID' has a wrong offset!");
