...
public:
	...
	TSubclassOf<class UUserWidget>                SettlementDataUnit_Normal;                         // 0x0608(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_SettlementDataListPanel) == 0x000610, "Wrong size on UPyWidget_SettlementDataListPanel");
...
static_assert(offsetof(UPyWidget_SettlementDataListPanel, SettlementDataUnit_Normal) == 0x000608, "Member 'UPyWidget_SettlementDataListPanel::SettlementDataUnit_Normal' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_SettlementDataListPanel_PersonalDeath) == 0x000610, "Wrong size on UPyWidget_SettlementDataListPanel_PersonalDeath");

// PythonClass PyWidget_SettlementDataPanel.PyWidget_SettlementResultInfo
// 0x0000 (0x05E8 - 0x05E8)
class UPyWidget_SettlementResultInfo final : public UPyMarvelUserWidget
{
public:
	void OnInitialized();
...
static_assert(sizeof(UPyWidget_SettlementDataListPanel_TeamDeath) == 0x000610, "Wrong size on UPyWidget_SettlementDataListPanel_TeamDeath");
...
static_assert(sizeof(UPyWidget_SettlementDataListPanel_SpringFestival) == 0x000610, "Wrong size on UPyWidget_SettlementDataListPanel_SpringFestival");
