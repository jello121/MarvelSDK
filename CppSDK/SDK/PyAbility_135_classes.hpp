...
public:
	...
	float                                         FadeoutTime;                                       // 0x0FF4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCurveFloat*                            AlphaCurve;                                        // 0x0FF8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TimerInterval;                                     // 0x1000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Ability_Loop_13501) == 0x001008, "Wrong size on APyCue_Ability_Loop_13501");
static_assert(offsetof(APyCue_Ability_Loop_13501, AbilityID) == 0x000FF0, "Member 'APyCue_Ability_Loop_13501::AbilityID' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_13501, FadeoutTime) == 0x000FF4, "Member 'APyCue_Ability_Loop_13501::FadeoutTime' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_13501, AlphaCurve) == 0x000FF8, "Member 'APyCue_Ability_Loop_13501::AlphaCurve' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_13501, TimerInterval) == 0x001000, "Member 'APyCue_Ability_Loop_13501::TimerInterval' has a wrong offset!");
...
static_assert(sizeof(UPyConfig_135) == 0x001190, "Wrong size on UPyConfig_135");
...
static_assert(sizeof(APyCue_Summoner_Loop_13502) == 0x001050, "Wrong size on APyCue_Summoner_Loop_13502");
...
static_assert(sizeof(UPyAbility_135) == 0x002A38, "Wrong size on UPyAbility_135");
...
static_assert(sizeof(APyCue_Ability_Loop_13503) == 0x000FF0, "Wrong size on APyCue_Ability_Loop_13503");
