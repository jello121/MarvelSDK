...
static_assert(sizeof(UPyUIController_103321) == 0x000CD0, "Wrong size on UPyUIController_103321");
...
// 0x0028 (0x2AC8 - 0x2AA0)
class UPyAbility_103321 : public UMarvelAbility_AimDownSights
{
public:
	int32                                         AimingShootingMode;                                // 0x2AA0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NormalShootingMode;                                // 0x2AA4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SnipperRifleID;                                    // 0x2AA8(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SwitchWeaponAbilityID;                             // 0x2AAC(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LoadBulletAbilityID;                               // 0x2AB0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2AB4[0x4];                                     // 0x2AB4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnUIStateChanged;                                  // 0x2AB8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_103321) == 0x002AC8, "Wrong size on UPyAbility_103321");
static_assert(offsetof(UPyAbility_103321, AimingShootingMode) == 0x002AA0, "Member 'UPyAbility_103321::AimingShootingMode' has a wrong offset!");
static_assert(offsetof(UPyAbility_103321, NormalShootingMode) == 0x002AA4, "Member 'UPyAbility_103321::NormalShootingMode' has a wrong offset!");
static_assert(offsetof(UPyAbility_103321, SnipperRifleID) == 0x002AA8, "Member 'UPyAbility_103321::SnipperRifleID' has a wrong offset!");
static_assert(offsetof(UPyAbility_103321, SwitchWeaponAbilityID) == 0x002AAC, "Member 'UPyAbility_103321::SwitchWeaponAbilityID' has a wrong offset!");
static_assert(offsetof(UPyAbility_103321, LoadBulletAbilityID) == 0x002AB0, "Member 'UPyAbility_103321::LoadBulletAbilityID' has a wrong offset!");
static_assert(offsetof(UPyAbility_103321, OnUIStateChanged) == 0x002AB8, "Member 'UPyAbility_103321::OnUIStateChanged' has a wrong offset!");
