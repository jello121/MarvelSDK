...
void APyPayload::PayloadRpcActivate__DelegateSignature(class AActor* Control_base)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyPayload", "PayloadRpcActivate__DelegateSignature");

	Params::PyPayload_PayloadRpcActivate__DelegateSignature Parms{};
