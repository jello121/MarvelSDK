...
const TArray<struct FAIHeroTagLogicConfig> UMarvelAILibrary::GetAIHeroTagLogics(int32 HeroID)
{
	static class UFunction* Func = nullptr;
...
// TSet<int32>                             HighPrioritySummoners                                  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UMarvelAILibrary::StoreTargetFinalScoreForDebug(class AMarvelAIController* AIController, class AActor* Target, const class FString& NodeName, float FinalScore, const TSet<int32>& HighPrioritySummoners)
{
	static class UFunction* Func = nullptr;
