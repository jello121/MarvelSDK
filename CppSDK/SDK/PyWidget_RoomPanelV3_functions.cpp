...
// PythonFunction PyWidget_RoomPanelV3.PyWidget_RoomPanel_V4.Destruct
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_RoomPanel_V4::Destruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_RoomPanel_V4", "Destruct");
...
void UPyWidget_RoomPanel_V4::OnSelectMapVisibleChanged(bool bVisible_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_RoomPanel_V4", "OnSelectMapVisibleChanged");

	Params::PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged Parms{};
