...
{
public:
	class UMarveSculptConfigComponent*            HulkHeroSculptConfigComponent;                     // 0x1C70(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMarveSculptConfigComponent*            HulkMonsterSculptConfigComponent;                  // 0x1C78(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyHulkBannerCharacter) == 0x001C80, "Wrong size on APyHulkBannerCharacter");
static_assert(offsetof(APyHulkBannerCharacter, HulkHeroSculptConfigComponent) == 0x001C70, "Member 'APyHulkBannerCharacter::HulkHeroSculptConfigComponent' has a wrong offset!");
static_assert(offsetof(APyHulkBannerCharacter, HulkMonsterSculptConfigComponent) == 0x001C78, "Member 'APyHulkBannerCharacter::HulkMonsterSculptConfigComponent' has a wrong offset!");
...
static_assert(sizeof(APyBannerBaseChildActor) == 0x000BF8, "Wrong size on APyBannerBaseChildActor");
...
{
public:
	struct FGameplayTag                           CueTagOnBeginPlay;                                 // 0x0BD0(0x000C)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyHulkMonsterChildActor) == 0x000BE0, "Wrong size on APyHulkMonsterChildActor");
static_assert(offsetof(APyHulkMonsterChildActor, CueTagOnBeginPlay) == 0x000BD0, "Member 'APyHulkMonsterChildActor::CueTagOnBeginPlay' has a wrong offset!");
