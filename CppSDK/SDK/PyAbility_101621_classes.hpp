...
static_assert(sizeof(APyProjectile_10162101) == 0x003280, "Wrong size on APyProjectile_10162101");
...
{
public:
	FMulticastInlineDelegateProperty_             OnSourceCharacterProjectileSuccess;                // 0x2A38(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_101621) == 0x002A48, "Wrong size on UPyAbility_101621");
static_assert(offsetof(UPyAbility_101621, OnSourceCharacterProjectileSuccess) == 0x002A38, "Member 'UPyAbility_101621::OnSourceCharacterProjectileSuccess' has a wrong offset!");
...
static_assert(sizeof(UPyEffectiveComponent_10162101) == 0x001C10, "Wrong size on UPyEffectiveComponent_10162101");
...
static_assert(sizeof(UPyEffectiveComponent_10162102) == 0x001C10, "Wrong size on UPyEffectiveComponent_10162102");
...
static_assert(sizeof(APyCue_Projectile_Loop_10162101) == 0x000F70, "Wrong size on APyCue_Projectile_Loop_10162101");
