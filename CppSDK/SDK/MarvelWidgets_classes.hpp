...
// Class MarvelWidgets.UIInputAutoTestSubsystem
// 0x03B0 (0x03E8 - 0x0038)
class UUIInputAutoTestSubsystem final : public UWorldSubsystem
{
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class FString>                           BlackListActionBinding;                            // 0x0040(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TSet<class FString>                           BlackListButton;                                   // 0x0090(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TSet<class FString>                           WhiteListActionBinding;                            // 0x00E0(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TSet<class FString>                           WidgetToRemoveSuffix;                              // 0x0130(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             ClickButtonDispatcher;                             // 0x0180(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bAlreadyFinished;                                  // 0x0190(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_191[0x3];                                      // 0x0191(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TriggerButtonTimes;                                // 0x0194(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_198[0x250];                                    // 0x0198(0x0250)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void AddBlackListActionBinding(const class FString& ActionName);
	void AddBlackListButton(const class FString& ButtonName);
	void AddWhiteListActionBinding(const class FString& ActionName);
	void AddWidgetToRemoveSuffix(const class FString& ActionName);
	void OnButtonClicked(const class FString& WidgetPath);
	void RestartTest();
	void StopTest();
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"UIInputAutoTestSubsystem">();
	}
	static class UUIInputAutoTestSubsystem* GetDefaultObj()
	{
		return GetDefaultObjImpl<UUIInputAutoTestSubsystem>();
	}
};
static_assert(alignof(UUIInputAutoTestSubsystem) == 0x000008, "Wrong alignment on UUIInputAutoTestSubsystem");
static_assert(sizeof(UUIInputAutoTestSubsystem) == 0x0003E8, "Wrong size on UUIInputAutoTestSubsystem");
static_assert(offsetof(UUIInputAutoTestSubsystem, BlackListActionBinding) == 0x000040, "Member 'UUIInputAutoTestSubsystem::BlackListActionBinding' has a wrong offset!");
static_assert(offsetof(UUIInputAutoTestSubsystem, BlackListButton) == 0x000090, "Member 'UUIInputAutoTestSubsystem::BlackListButton' has a wrong offset!");
static_assert(offsetof(UUIInputAutoTestSubsystem, WhiteListActionBinding) == 0x0000E0, "Member 'UUIInputAutoTestSubsystem::WhiteListActionBinding' has a wrong offset!");
static_assert(offsetof(UUIInputAutoTestSubsystem, WidgetToRemoveSuffix) == 0x000130, "Member 'UUIInputAutoTestSubsystem::WidgetToRemoveSuffix' has a wrong offset!");
static_assert(offsetof(UUIInputAutoTestSubsystem, ClickButtonDispatcher) == 0x000180, "Member 'UUIInputAutoTestSubsystem::ClickButtonDispatcher' has a wrong offset!");
static_assert(offsetof(UUIInputAutoTestSubsystem, bAlreadyFinished) == 0x000190, "Member 'UUIInputAutoTestSubsystem::bAlreadyFinished' has a wrong offset!");
static_assert(offsetof(UUIInputAutoTestSubsystem, TriggerButtonTimes) == 0x000194, "Member 'UUIInputAutoTestSubsystem::TriggerButtonTimes' has a wrong offset!");
