...
public:
	...
	struct FAttributeModifierParameter            ModifierParameter;                                 // 0x0010(0x06C0)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(EpicMomentAction_1046_OnActorResurrected) == 0x0006D0, "Wrong size on EpicMomentAction_1046_OnActorResurrected");
