...
{
public:
	class UConstraintsManager*                    ConstraintsManager;                                // 0x05F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AConstraintsActor) == 0x000600, "Wrong size on AConstraintsActor");
static_assert(offsetof(AConstraintsActor, ConstraintsManager) == 0x0005F8, "Member 'AConstraintsActor::ConstraintsManager' has a wrong offset!");
