...
static_assert(alignof(AWeapon_PsylockeCrossbow_C) == 0x000008, "Wrong alignment on AWeapon_PsylockeCrossbow_C");
static_assert(sizeof(AWeapon_PsylockeCrossbow_C) == 0x000DE8, "Wrong size on AWeapon_PsylockeCrossbow_C");
