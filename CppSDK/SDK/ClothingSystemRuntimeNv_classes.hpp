...
static_assert(offsetof(UClothConfigNv, bUseOfflineFabricCooked) == 0x000104, "Member 'UClothConfigNv::bUseOfflineFabricCooked' has a wrong offset!");
static_assert(offsetof(UClothConfigNv, WindMethod) == 0x000105, "Member 'UClothConfigNv::WindMethod' has a wrong offset!");
