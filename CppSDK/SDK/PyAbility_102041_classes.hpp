...
static_assert(alignof(APyCue_Buff_10204101) == 0x000008, "Wrong alignment on APyCue_Buff_10204101");
static_assert(sizeof(APyCue_Buff_10204101) == 0x001210, "Wrong size on APyCue_Buff_10204101");
...
static_assert(sizeof(UPyUIController_1020_Common) == 0x000CD0, "Wrong size on UPyUIController_1020_Common");
...
static_assert(sizeof(UPyWidget_1020Leaf) == 0x000610, "Wrong size on UPyWidget_1020Leaf");
...
static_assert(sizeof(UPyWidget3D_BuffMarker_10204101) == 0x0008D0, "Wrong size on UPyWidget3D_BuffMarker_10204101");
static_assert(offsetof(UPyWidget3D_BuffMarker_10204101, BuffDurationBindHandle) == 0x000890, "Member 'UPyWidget3D_BuffMarker_10204101::BuffDurationBindHandle' has a wrong offset!");
