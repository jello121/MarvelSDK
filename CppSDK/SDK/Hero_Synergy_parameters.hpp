...
static_assert(alignof(MarvelBackTrackAbility_OnCharTranslatedByLevelPortal) == 0x000010, "Wrong alignment on MarvelBackTrackAbility_OnCharTranslatedByLevelPortal");
static_assert(sizeof(MarvelBackTrackAbility_OnCharTranslatedByLevelPortal) == 0x0000C0, "Wrong size on MarvelBackTrackAbility_OnCharTranslatedByLevelPortal");
static_assert(offsetof(MarvelBackTrackAbility_OnCharTranslatedByLevelPortal, OriginTransform) == 0x000000, "Member 'MarvelBackTrackAbility_OnCharTranslatedByLevelPortal::OriginTransform' has a wrong offset!");
static_assert(offsetof(MarvelBackTrackAbility_OnCharTranslatedByLevelPortal, TargetTransform) == 0x000060, "Member 'MarvelBackTrackAbility_OnCharTranslatedByLevelPortal::TargetTransform' has a wrong offset!");
...
public:
	...
	struct FHitResult                             OutHit;                                            // 0x0018(0x0178)(Parm, OutParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bSweep;                                            // 0x0190(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MarvelBackTrackAbility_SafeMoveTo) == 0x000198, "Wrong size on MarvelBackTrackAbility_SafeMoveTo");
...
static_assert(offsetof(MarvelBackTrackAbility_SafeMoveTo, bSweep) == 0x000190, "Member 'MarvelBackTrackAbility_SafeMoveTo::bSweep' has a wrong offset!");
static_assert(offsetof(MarvelBackTrackAbility_SafeMoveTo, ReturnValue) == 0x000191, "Member 'MarvelBackTrackAbility_SafeMoveTo::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(TraceComponent_100009_OnPreOutTraceResults) == 0x000180, "Wrong size on TraceComponent_100009_OnPreOutTraceResults");
...
static_assert(offsetof(TraceComponent_100009_OnPreOutTraceResults, ReturnValue) == 0x000178, "Member 'TraceComponent_100009_OnPreOutTraceResults::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BuffManagerAbility_100009_OnOwnerCollide) == 0x0001A8, "Wrong size on BuffManagerAbility_100009_OnOwnerCollide");
...
{
public:
	struct FHitResult                             InHitResult;                                       // 0x0000(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(Ability_100015_AddWavingData) == 0x000008, "Wrong alignment on Ability_100015_AddWavingData");
static_assert(sizeof(Ability_100015_AddWavingData) == 0x000178, "Wrong size on Ability_100015_AddWavingData");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayEffectSpec                    DamageSpec;                                        // 0x0008(0x0760)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0768(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(SynergyAbility_100026_OnCheckDontKill) == 0x000770, "Wrong size on SynergyAbility_100026_OnCheckDontKill");
...
static_assert(offsetof(SynergyAbility_100026_OnCheckDontKill, ReturnValue) == 0x000768, "Member 'SynergyAbility_100026_OnCheckDontKill::ReturnValue' has a wrong offset!");
