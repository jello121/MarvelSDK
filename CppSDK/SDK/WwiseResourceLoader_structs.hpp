...
static_assert(sizeof(FWwiseAudioDeviceShareSetCookedData) == 0x000010, "Wrong size on FWwiseAudioDeviceShareSetCookedData");
...
static_assert(sizeof(FWwiseObjectInfo) == 0x000028, "Wrong size on FWwiseObjectInfo");
...
static_assert(offsetof(FWwiseObjectInfo, bSnapFinger) == 0x000024, "Member 'FWwiseObjectInfo::bSnapFinger' has a wrong offset!");
...
static_assert(sizeof(FWwiseEventInfo) == 0x00002C, "Wrong size on FWwiseEventInfo");
static_assert(offsetof(FWwiseEventInfo, SwitchContainerLoading) == 0x000028, "Member 'FWwiseEventInfo::SwitchContainerLoading' has a wrong offset!");
static_assert(offsetof(FWwiseEventInfo, DestroyOptions) == 0x000029, "Member 'FWwiseEventInfo::DestroyOptions' has a wrong offset!");
...
static_assert(sizeof(FWwiseGroupValueInfo) == 0x00002C, "Wrong size on FWwiseGroupValueInfo");
static_assert(offsetof(FWwiseGroupValueInfo, GroupShortId) == 0x000028, "Member 'FWwiseGroupValueInfo::GroupShortId' has a wrong offset!");
...
static_assert(sizeof(FWwiseInitBankCookedData) == 0x000058, "Wrong size on FWwiseInitBankCookedData");
static_assert(offsetof(FWwiseInitBankCookedData, SoundBanks) == 0x000028, "Member 'FWwiseInitBankCookedData::SoundBanks' has a wrong offset!");
static_assert(offsetof(FWwiseInitBankCookedData, Media) == 0x000038, "Member 'FWwiseInitBankCookedData::Media' has a wrong offset!");
static_assert(offsetof(FWwiseInitBankCookedData, Language) == 0x000048, "Member 'FWwiseInitBankCookedData::Language' has a wrong offset!");
