...
static_assert(sizeof(Projectile_10483101_AttachToTarget) == 0x000178, "Wrong size on Projectile_10483101_AttachToTarget");
...
static_assert(alignof(Summoned_104892_SetSummonedRemoteViewPitch) == 0x000004, "Wrong alignment on Summoned_104892_SetSummonedRemoteViewPitch");
static_assert(sizeof(Summoned_104892_SetSummonedRemoteViewPitch) == 0x000004, "Wrong size on Summoned_104892_SetSummonedRemoteViewPitch");
static_assert(offsetof(Summoned_104892_SetSummonedRemoteViewPitch, NewSummonedRemoteViewPitch) == 0x000000, "Member 'Summoned_104892_SetSummonedRemoteViewPitch::NewSummonedRemoteViewPitch' has a wrong offset!");
