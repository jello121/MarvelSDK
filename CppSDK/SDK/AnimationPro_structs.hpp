...
static_assert(alignof(FMarvelAnimNode_SwitchableCopyBoneCache) == 0x000004, "Wrong alignment on FMarvelAnimNode_SwitchableCopyBoneCache");
static_assert(sizeof(FMarvelAnimNode_SwitchableCopyBoneCache) == 0x000008, "Wrong size on FMarvelAnimNode_SwitchableCopyBoneCache");
...
static_assert(alignof(FMarvelAnimNode_SwitchableCopyBone) == 0x000008, "Wrong alignment on FMarvelAnimNode_SwitchableCopyBone");
static_assert(sizeof(FMarvelAnimNode_SwitchableCopyBone) == 0x0001F8, "Wrong size on FMarvelAnimNode_SwitchableCopyBone");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, AnotherSourceBone) == 0x000148, "Member 'FMarvelAnimNode_SwitchableCopyBone::AnotherSourceBone' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, ActualSourceBoneAlpha) == 0x00015C, "Member 'FMarvelAnimNode_SwitchableCopyBone::ActualSourceBoneAlpha' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, SwitchInputType) == 0x000160, "Member 'FMarvelAnimNode_SwitchableCopyBone::SwitchInputType' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, bUseSourceBone) == 0x000161, "Member 'FMarvelAnimNode_SwitchableCopyBone::bUseSourceBone' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, SourceBoneAlpha) == 0x000164, "Member 'FMarvelAnimNode_SwitchableCopyBone::SourceBoneAlpha' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, SwitchScaleBias) == 0x000168, "Member 'FMarvelAnimNode_SwitchableCopyBone::SwitchScaleBias' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, SwitchBoolBlend) == 0x000170, "Member 'FMarvelAnimNode_SwitchableCopyBone::SwitchBoolBlend' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, SwitchCurveName) == 0x0001B8, "Member 'FMarvelAnimNode_SwitchableCopyBone::SwitchCurveName' has a wrong offset!");
static_assert(offsetof(FMarvelAnimNode_SwitchableCopyBone, SwitchScaleBiasClamp) == 0x0001C4, "Member 'FMarvelAnimNode_SwitchableCopyBone::SwitchScaleBiasClamp' has a wrong offset!");
