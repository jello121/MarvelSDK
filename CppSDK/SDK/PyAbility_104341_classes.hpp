...
static_assert(sizeof(UPyConfig_104341) == 0x000CB8, "Wrong size on UPyConfig_104341");
...
static_assert(offsetof(UPyConfig_104341, ControlTags) == 0x000C50, "Member 'UPyConfig_104341::ControlTags' has a wrong offset!");
...
static_assert(sizeof(APyCue_Weapon_Loop_10434101) == 0x001250, "Wrong size on APyCue_Weapon_Loop_10434101");
...
{
public:
	float                                         MaxDurationTime;                                   // 0x2A38(0x0004)(BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_104341) == 0x002A40, "Wrong size on UPyAbility_104341");
static_assert(offsetof(UPyAbility_104341, MaxDurationTime) == 0x002A38, "Member 'UPyAbility_104341::MaxDurationTime' has a wrong offset!");
