...
static_assert(sizeof(APyMagikChildActor) == 0x000BD0, "Wrong size on APyMagikChildActor");
...
static_assert(sizeof(APyDarkchyldeChildActor) == 0x000BD0, "Wrong size on APyDarkchyldeChildActor");
...
{
public:
	class UMarveSculptConfigComponent*            SonOfDarknessSculptConfigComponent;                // 0x1BE0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyMagikCharacter) == 0x001BF0, "Wrong size on APyMagikCharacter");
static_assert(offsetof(APyMagikCharacter, SonOfDarknessSculptConfigComponent) == 0x001BE0, "Member 'APyMagikCharacter::SonOfDarknessSculptConfigComponent' has a wrong offset!");
