...
static_assert(sizeof(UPyAbility_211) == 0x002A50, "Wrong size on UPyAbility_211");
...
{
public:
	int32                                         MinResponseDistanceSquare;                         // 0x0CD0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyUIController_211) == 0x000CD8, "Wrong size on UPyUIController_211");
static_assert(offsetof(UPyUIController_211, MinResponseDistanceSquare) == 0x000CD0, "Member 'UPyUIController_211::MinResponseDistanceSquare' has a wrong offset!");
