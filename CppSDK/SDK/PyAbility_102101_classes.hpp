...
static_assert(sizeof(UPyAbility_102101) == 0x002B30, "Wrong size on UPyAbility_102101");
...
static_assert(sizeof(APyCue_Ability_Loop_10210101) == 0x000FF0, "Wrong size on APyCue_Ability_Loop_10210101");
