...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"PyWidget_FriendsTips">();
	}
...
static_assert(alignof(UPyWidget_FriendsTips) == 0x000008, "Wrong alignment on UPyWidget_FriendsTips");
static_assert(sizeof(UPyWidget_FriendsTips) == 0x0003D8, "Wrong size on UPyWidget_FriendsTips");
static_assert(offsetof(UPyWidget_FriendsTips, TipsText) == 0x0003B8, "Member 'UPyWidget_FriendsTips::TipsText' has a wrong offset!");
static_assert(offsetof(UPyWidget_FriendsTips, IsArrowTop) == 0x0003D0, "Member 'UPyWidget_FriendsTips::IsArrowTop' has a wrong offset!");
