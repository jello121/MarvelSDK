...
{
public:
	class UDataflowComponent*                     DataflowComponent;                                 // 0x05F8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADataflowActor) == 0x000600, "Wrong size on ADataflowActor");
static_assert(offsetof(ADataflowActor, DataflowComponent) == 0x0005F8, "Member 'ADataflowActor::DataflowComponent' has a wrong offset!");
...
static_assert(sizeof(UDataflowComponent) == 0x000A10, "Wrong size on UDataflowComponent");
