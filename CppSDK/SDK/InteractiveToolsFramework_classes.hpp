...
static_assert(sizeof(IAssetBackedTarget) == 0x000030, "Wrong size on IAssetBackedTarget");
...
static_assert(sizeof(UGizmoBaseComponent) == 0x000900, "Wrong size on UGizmoBaseComponent");
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x0008C8, "Member 'UGizmoBaseComponent::Color' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, HoverSizeMultiplier) == 0x0008D8, "Member 'UGizmoBaseComponent::HoverSizeMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, PixelHitDistanceThreshold) == 0x0008DC, "Member 'UGizmoBaseComponent::PixelHitDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, GizmoViewContext) == 0x0008E8, "Member 'UGizmoBaseComponent::GizmoViewContext' has a wrong offset!");
...
{
public:
	bool                                          bIsSelectableInEditor;                             // 0x05F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AInternalToolFrameworkActor) == 0x000600, "Wrong size on AInternalToolFrameworkActor");
static_assert(offsetof(AInternalToolFrameworkActor, bIsSelectableInEditor) == 0x0005F8, "Member 'AInternalToolFrameworkActor::bIsSelectableInEditor' has a wrong offset!");
...
static_assert(sizeof(IInteractiveToolCameraFocusAPI) == 0x000030, "Wrong size on IInteractiveToolCameraFocusAPI");
...
static_assert(sizeof(IInteractiveToolNestedAcceptCancelAPI) == 0x000030, "Wrong size on IInteractiveToolNestedAcceptCancelAPI");
...
static_assert(sizeof(IInteractiveToolExclusiveToolAPI) == 0x000030, "Wrong size on IInteractiveToolExclusiveToolAPI");
...
static_assert(sizeof(IInteractiveToolEditorGizmoAPI) == 0x000030, "Wrong size on IInteractiveToolEditorGizmoAPI");
...
static_assert(sizeof(IMaterialProvider) == 0x000030, "Wrong size on IMaterialProvider");
...
static_assert(sizeof(IMeshDescriptionCommitter) == 0x000030, "Wrong size on IMeshDescriptionCommitter");
...
static_assert(sizeof(IMeshDescriptionProvider) == 0x000030, "Wrong size on IMeshDescriptionProvider");
...
static_assert(sizeof(IPhysicsDataSource) == 0x000030, "Wrong size on IPhysicsDataSource");
...
static_assert(sizeof(IPrimitiveComponentBackedTarget) == 0x000030, "Wrong size on IPrimitiveComponentBackedTarget");
...
static_assert(sizeof(ISkeletalMeshBackedTarget) == 0x000030, "Wrong size on ISkeletalMeshBackedTarget");
...
static_assert(sizeof(IStaticMeshBackedTarget) == 0x000030, "Wrong size on IStaticMeshBackedTarget");
...
static_assert(sizeof(IWidgetBaseBehavior) == 0x000030, "Wrong size on IWidgetBaseBehavior");
...
static_assert(sizeof(AGizmoActor) == 0x000600, "Wrong size on AGizmoActor");
...
{
public:
	class UPrimitiveComponent*                    TranslateX;                                        // 0x0600(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateY;                                        // 0x0608(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateZ;                                        // 0x0610(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateYZ;                                       // 0x0618(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXZ;                                       // 0x0620(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXY;                                       // 0x0628(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateX;                                           // 0x0630(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateY;                                           // 0x0638(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateZ;                                           // 0x0640(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotationSphere;                                    // 0x0648(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    UniformScale;                                      // 0x0650(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleX;                                        // 0x0658(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleY;                                        // 0x0660(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleZ;                                        // 0x0668(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleYZ;                                      // 0x0670(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXZ;                                      // 0x0678(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXY;                                      // 0x0680(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ACombinedTransformGizmoActor) == 0x000688, "Wrong size on ACombinedTransformGizmoActor");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateX) == 0x000600, "Member 'ACombinedTransformGizmoActor::TranslateX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateY) == 0x000608, "Member 'ACombinedTransformGizmoActor::TranslateY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateZ) == 0x000610, "Member 'ACombinedTransformGizmoActor::TranslateZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateYZ) == 0x000618, "Member 'ACombinedTransformGizmoActor::TranslateYZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateXZ) == 0x000620, "Member 'ACombinedTransformGizmoActor::TranslateXZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateXY) == 0x000628, "Member 'ACombinedTransformGizmoActor::TranslateXY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateX) == 0x000630, "Member 'ACombinedTransformGizmoActor::RotateX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateY) == 0x000638, "Member 'ACombinedTransformGizmoActor::RotateY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateZ) == 0x000640, "Member 'ACombinedTransformGizmoActor::RotateZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotationSphere) == 0x000648, "Member 'ACombinedTransformGizmoActor::RotationSphere' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, UniformScale) == 0x000650, "Member 'ACombinedTransformGizmoActor::UniformScale' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleX) == 0x000658, "Member 'ACombinedTransformGizmoActor::AxisScaleX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleY) == 0x000660, "Member 'ACombinedTransformGizmoActor::AxisScaleY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleZ) == 0x000668, "Member 'ACombinedTransformGizmoActor::AxisScaleZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleYZ) == 0x000670, "Member 'ACombinedTransformGizmoActor::PlaneScaleYZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleXZ) == 0x000678, "Member 'ACombinedTransformGizmoActor::PlaneScaleXZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleXY) == 0x000680, "Member 'ACombinedTransformGizmoActor::PlaneScaleXY' has a wrong offset!");
...
static_assert(sizeof(UGizmoArrowComponent) == 0x000920, "Wrong size on UGizmoArrowComponent");
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x0008F8, "Member 'UGizmoArrowComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Gap) == 0x000910, "Member 'UGizmoArrowComponent::Gap' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Length) == 0x000914, "Member 'UGizmoArrowComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Thickness) == 0x000918, "Member 'UGizmoArrowComponent::Thickness' has a wrong offset!");
...
static_assert(sizeof(UGizmoBoxComponent) == 0x000950, "Wrong size on UGizmoBoxComponent");
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x0008F8, "Member 'UGizmoBoxComponent::Origin' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, Rotation) == 0x000910, "Member 'UGizmoBoxComponent::Rotation' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x000930, "Member 'UGizmoBoxComponent::Dimensions' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, LineThickness) == 0x000948, "Member 'UGizmoBoxComponent::LineThickness' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, bRemoveHiddenLines) == 0x00094C, "Member 'UGizmoBoxComponent::bRemoveHiddenLines' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, bEnableAxisFlip) == 0x00094D, "Member 'UGizmoBoxComponent::bEnableAxisFlip' has a wrong offset!");
...
static_assert(sizeof(UGizmoCircleComponent) == 0x000920, "Wrong size on UGizmoCircleComponent");
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x0008F8, "Member 'UGizmoCircleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Radius) == 0x000910, "Member 'UGizmoCircleComponent::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Thickness) == 0x000914, "Member 'UGizmoCircleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, NumSides) == 0x000918, "Member 'UGizmoCircleComponent::NumSides' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bViewAligned) == 0x00091C, "Member 'UGizmoCircleComponent::bViewAligned' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bDrawFullCircle) == 0x00091D, "Member 'UGizmoCircleComponent::bDrawFullCircle' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bOnlyAllowFrontFacingHits) == 0x00091E, "Member 'UGizmoCircleComponent::bOnlyAllowFrontFacingHits' has a wrong offset!");
...
static_assert(sizeof(IGizmoClickMultiTarget) == 0x000030, "Wrong size on IGizmoClickMultiTarget");
...
static_assert(sizeof(IGizmoRenderTarget) == 0x000030, "Wrong size on IGizmoRenderTarget");
...
static_assert(sizeof(IGizmoRenderMultiTarget) == 0x000030, "Wrong size on IGizmoRenderMultiTarget");
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x000940, "Wrong size on UGizmoLineHandleComponent");
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x0008F8, "Member 'UGizmoLineHandleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, HandleSize) == 0x000910, "Member 'UGizmoLineHandleComponent::HandleSize' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Thickness) == 0x000914, "Member 'UGizmoLineHandleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x000918, "Member 'UGizmoLineHandleComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Length) == 0x000930, "Member 'UGizmoLineHandleComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, bImageScale) == 0x000934, "Member 'UGizmoLineHandleComponent::bImageScale' has a wrong offset!");
...
static_assert(sizeof(UGizmoRectangleComponent) == 0x000950, "Wrong size on UGizmoRectangleComponent");
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x0008F8, "Member 'UGizmoRectangleComponent::DirectionX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x000910, "Member 'UGizmoRectangleComponent::DirectionY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, bOrientYAccordingToCamera) == 0x000928, "Member 'UGizmoRectangleComponent::bOrientYAccordingToCamera' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetX) == 0x00092C, "Member 'UGizmoRectangleComponent::OffsetX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetY) == 0x000930, "Member 'UGizmoRectangleComponent::OffsetY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthX) == 0x000934, "Member 'UGizmoRectangleComponent::LengthX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthY) == 0x000938, "Member 'UGizmoRectangleComponent::LengthY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, Thickness) == 0x00093C, "Member 'UGizmoRectangleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, SegmentFlags) == 0x000940, "Member 'UGizmoRectangleComponent::SegmentFlags' has a wrong offset!");
...
{
public:
	class UGizmoLineHandleComponent*              UpIntervalComponent;                               // 0x0600(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              DownIntervalComponent;                             // 0x0608(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              ForwardIntervalComponent;                          // 0x0610(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AIntervalGizmoActor) == 0x000618, "Wrong size on AIntervalGizmoActor");
static_assert(offsetof(AIntervalGizmoActor, UpIntervalComponent) == 0x000600, "Member 'AIntervalGizmoActor::UpIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, DownIntervalComponent) == 0x000608, "Member 'AIntervalGizmoActor::DownIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, ForwardIntervalComponent) == 0x000610, "Member 'AIntervalGizmoActor::ForwardIntervalComponent' has a wrong offset!");
...
public:
	...
	struct FBrushStampData                        LastBrushStamp;                                    // 0x0120(0x01B8)(NativeAccessSpecifierPublic)
	uint8                                         Pad_2D8[0x10];                                     // 0x02D8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   PropertyClass;                                     // 0x02E8(0x0030)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBrushStampIndicator*                   BrushStampIndicator;                               // 0x0318(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBaseBrushTool) == 0x000330, "Wrong size on UBaseBrushTool");
...
static_assert(offsetof(UBaseBrushTool, PropertyClass) == 0x0002E8, "Member 'UBaseBrushTool::PropertyClass' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, BrushStampIndicator) == 0x000318, "Member 'UBaseBrushTool::BrushStampIndicator' has a wrong offset!");
