...
// (MulticastDelegate, Public, Delegate)
// Parameters:
// bool                                    IsAscend                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    IsDefault                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPyWidgetListTitleBtn::OnClickedSort__DelegateSignature(bool IsAscend, bool IsDefault)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidgetListTitleBtn", "OnClickedSort__DelegateSignature");

	Params::PyWidgetListTitleBtn_OnClickedSort__DelegateSignature Parms{};
