...
// 0x0020 (0x22A0 - 0x2280)
class UPyConfig_102361 final : public UConfig_102361
{
public:
	struct FVector                                CapsuleLocationOffset;                             // 0x2280(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LaunchVerticalVelocity;                            // 0x2298(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LaunchHorizontalVelocity;                          // 0x229C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyConfig_102361) == 0x0022A0, "Wrong size on UPyConfig_102361");
static_assert(offsetof(UPyConfig_102361, CapsuleLocationOffset) == 0x002280, "Member 'UPyConfig_102361::CapsuleLocationOffset' has a wrong offset!");
static_assert(offsetof(UPyConfig_102361, LaunchVerticalVelocity) == 0x002298, "Member 'UPyConfig_102361::LaunchVerticalVelocity' has a wrong offset!");
static_assert(offsetof(UPyConfig_102361, LaunchHorizontalVelocity) == 0x00229C, "Member 'UPyConfig_102361::LaunchHorizontalVelocity' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_102361) == 0x002D08, "Wrong size on UPyAbility_102361");
