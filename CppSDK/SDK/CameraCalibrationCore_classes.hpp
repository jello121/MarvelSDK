...
{
public:
	TMap<class FString, struct FVector>           SubPoints;                                         // 0x09C0(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bVisualizePointsInEditor;                          // 0x0A10(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A11[0x3];                                      // 0x0A11(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PointVisualizationScale;                           // 0x0A14(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECalibrationPointVisualization                VisualizationShape;                                // 0x0A18(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCalibrationPointComponent) == 0x000A20, "Wrong size on UCalibrationPointComponent");
static_assert(offsetof(UCalibrationPointComponent, SubPoints) == 0x0009C0, "Member 'UCalibrationPointComponent::SubPoints' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, bVisualizePointsInEditor) == 0x000A10, "Member 'UCalibrationPointComponent::bVisualizePointsInEditor' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, PointVisualizationScale) == 0x000A14, "Member 'UCalibrationPointComponent::PointVisualizationScale' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, VisualizationShape) == 0x000A18, "Member 'UCalibrationPointComponent::VisualizationShape' has a wrong offset!");
...
{
public:
	class USceneComponent*                        Root;                                              // 0x05F8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             TopLeft;                                           // 0x0600(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             TopRight;                                          // 0x0608(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             BottomLeft;                                        // 0x0610(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             BottomRight;                                       // 0x0618(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             Center;                                            // 0x0620(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumCornerRows;                                     // 0x0628(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumCornerCols;                                     // 0x062C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SquareSideLength;                                  // 0x0630(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x0634(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UStaticMesh*                            CubeMesh;                                          // 0x0638(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     OddCubeMaterial;                                   // 0x0640(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     EvenCubeMaterial;                                  // 0x0648(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ACameraCalibrationCheckerboard) == 0x000650, "Wrong size on ACameraCalibrationCheckerboard");
static_assert(offsetof(ACameraCalibrationCheckerboard, Root) == 0x0005F8, "Member 'ACameraCalibrationCheckerboard::Root' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, TopLeft) == 0x000600, "Member 'ACameraCalibrationCheckerboard::TopLeft' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, TopRight) == 0x000608, "Member 'ACameraCalibrationCheckerboard::TopRight' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, BottomLeft) == 0x000610, "Member 'ACameraCalibrationCheckerboard::BottomLeft' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, BottomRight) == 0x000618, "Member 'ACameraCalibrationCheckerboard::BottomRight' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, Center) == 0x000620, "Member 'ACameraCalibrationCheckerboard::Center' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerRows) == 0x000628, "Member 'ACameraCalibrationCheckerboard::NumCornerRows' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerCols) == 0x00062C, "Member 'ACameraCalibrationCheckerboard::NumCornerCols' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, SquareSideLength) == 0x000630, "Member 'ACameraCalibrationCheckerboard::SquareSideLength' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, Thickness) == 0x000634, "Member 'ACameraCalibrationCheckerboard::Thickness' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, CubeMesh) == 0x000638, "Member 'ACameraCalibrationCheckerboard::CubeMesh' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, OddCubeMaterial) == 0x000640, "Member 'ACameraCalibrationCheckerboard::OddCubeMaterial' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, EvenCubeMaterial) == 0x000648, "Member 'ACameraCalibrationCheckerboard::EvenCubeMaterial' has a wrong offset!");
...
static_assert(sizeof(ULensComponent) == 0x0002D0, "Wrong size on ULensComponent");
static_assert(offsetof(ULensComponent, LensFilePicker) == 0x0000F0, "Member 'ULensComponent::LensFilePicker' has a wrong offset!");
static_assert(offsetof(ULensComponent, EvaluationMode) == 0x000100, "Member 'ULensComponent::EvaluationMode' has a wrong offset!");
static_assert(offsetof(ULensComponent, TargetCameraComponent) == 0x000108, "Member 'ULensComponent::TargetCameraComponent' has a wrong offset!");
static_assert(offsetof(ULensComponent, EvalInputs) == 0x000138, "Member 'ULensComponent::EvalInputs' has a wrong offset!");
static_assert(offsetof(ULensComponent, DistortionStateSource) == 0x000154, "Member 'ULensComponent::DistortionStateSource' has a wrong offset!");
static_assert(offsetof(ULensComponent, bApplyDistortion) == 0x000155, "Member 'ULensComponent::bApplyDistortion' has a wrong offset!");
static_assert(offsetof(ULensComponent, LensModel) == 0x000158, "Member 'ULensComponent::LensModel' has a wrong offset!");
static_assert(offsetof(ULensComponent, DistortionState) == 0x000160, "Member 'ULensComponent::DistortionState' has a wrong offset!");
static_assert(offsetof(ULensComponent, bScaleOverscan) == 0x000190, "Member 'ULensComponent::bScaleOverscan' has a wrong offset!");
static_assert(offsetof(ULensComponent, OverscanMultiplier) == 0x000194, "Member 'ULensComponent::OverscanMultiplier' has a wrong offset!");
static_assert(offsetof(ULensComponent, FilmbackOverride) == 0x000198, "Member 'ULensComponent::FilmbackOverride' has a wrong offset!");
static_assert(offsetof(ULensComponent, CroppedFilmback) == 0x00019C, "Member 'ULensComponent::CroppedFilmback' has a wrong offset!");
static_assert(offsetof(ULensComponent, bApplyNodalOffsetOnTick) == 0x0001A8, "Member 'ULensComponent::bApplyNodalOffsetOnTick' has a wrong offset!");
static_assert(offsetof(ULensComponent, OriginalTrackedComponentTransform) == 0x0001B0, "Member 'ULensComponent::OriginalTrackedComponentTransform' has a wrong offset!");
static_assert(offsetof(ULensComponent, bIsDistortionSetup) == 0x000210, "Member 'ULensComponent::bIsDistortionSetup' has a wrong offset!");
static_assert(offsetof(ULensComponent, OriginalFocalLength) == 0x000214, "Member 'ULensComponent::OriginalFocalLength' has a wrong offset!");
static_assert(offsetof(ULensComponent, LastDistortionMID) == 0x000218, "Member 'ULensComponent::LastDistortionMID' has a wrong offset!");
static_assert(offsetof(ULensComponent, LastCameraComponent) == 0x000220, "Member 'ULensComponent::LastCameraComponent' has a wrong offset!");
static_assert(offsetof(ULensComponent, LensDistortionHandlerMap) == 0x000228, "Member 'ULensComponent::LensDistortionHandlerMap' has a wrong offset!");
static_assert(offsetof(ULensComponent, TrackedComponent) == 0x000278, "Member 'ULensComponent::TrackedComponent' has a wrong offset!");
static_assert(offsetof(ULensComponent, TrackedComponentName) == 0x000280, "Member 'ULensComponent::TrackedComponentName' has a wrong offset!");
