...
public:
	...
	float                                         WomanAnimTimer;                                    // 0x0938(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ValentinesAnimTimer;                               // 0x093C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAkAudioEvent*                          AkEvent_Valentines_L;                              // 0x0940(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAkAudioEvent*                          AkEvent_Valentines_R;                              // 0x0948(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_Nameplate, WomanAnimTimer) == 0x000938, "Member 'UPyWidget_Nameplate::WomanAnimTimer' has a wrong offset!");
static_assert(offsetof(UPyWidget_Nameplate, ValentinesAnimTimer) == 0x00093C, "Member 'UPyWidget_Nameplate::ValentinesAnimTimer' has a wrong offset!");
static_assert(offsetof(UPyWidget_Nameplate, AkEvent_Valentines_L) == 0x000940, "Member 'UPyWidget_Nameplate::AkEvent_Valentines_L' has a wrong offset!");
static_assert(offsetof(UPyWidget_Nameplate, AkEvent_Valentines_R) == 0x000948, "Member 'UPyWidget_Nameplate::AkEvent_Valentines_R' has a wrong offset!");
