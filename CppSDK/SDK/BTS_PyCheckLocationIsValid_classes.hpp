...
public:
	...
	bool                                          ShutSpeedAndSpawnPointCheck;                       // 0x00FC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBTS_PyCheckLocationIsValid, ShutSpeedAndSpawnPointCheck) == 0x0000FC, "Member 'UBTS_PyCheckLocationIsValid::ShutSpeedAndSpawnPointCheck' has a wrong offset!");
