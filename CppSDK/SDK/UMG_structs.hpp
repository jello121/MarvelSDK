...
static_assert(sizeof(FWidgetChild) == 0x000014, "Wrong size on FWidgetChild");
static_assert(offsetof(FWidgetChild, WidgetName) == 0x000000, "Member 'FWidgetChild::WidgetName' has a wrong offset!");
static_assert(offsetof(FWidgetChild, WidgetPtr) == 0x00000C, "Member 'FWidgetChild::WidgetPtr' has a wrong offset!");
...
static_assert(alignof(FWidgetAnimationCachedData) == 0x000008, "Wrong alignment on FWidgetAnimationCachedData");
static_assert(sizeof(FWidgetAnimationCachedData) == 0x000010, "Wrong size on FWidgetAnimationCachedData");
static_assert(offsetof(FWidgetAnimationCachedData, VarData) == 0x000000, "Member 'FWidgetAnimationCachedData::VarData' has a wrong offset!");
...
static_assert(alignof(FWidgetAnimationCachedDataStore) == 0x000008, "Wrong alignment on FWidgetAnimationCachedDataStore");
static_assert(sizeof(FWidgetAnimationCachedDataStore) == 0x0000A0, "Wrong size on FWidgetAnimationCachedDataStore");
static_assert(offsetof(FWidgetAnimationCachedDataStore, Binding) == 0x000000, "Member 'FWidgetAnimationCachedDataStore::Binding' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationCachedDataStore, BrushName) == 0x00002C, "Member 'FWidgetAnimationCachedDataStore::BrushName' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationCachedDataStore, FrameTime) == 0x000038, "Member 'FWidgetAnimationCachedDataStore::FrameTime' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationCachedDataStore, PropertyCachedData) == 0x000040, "Member 'FWidgetAnimationCachedDataStore::PropertyCachedData' has a wrong offset!");
...
static_assert(alignof(FWidgetAnimationCachedTimesAndStore) == 0x000008, "Wrong alignment on FWidgetAnimationCachedTimesAndStore");
static_assert(sizeof(FWidgetAnimationCachedTimesAndStore) == 0x000028, "Wrong size on FWidgetAnimationCachedTimesAndStore");
static_assert(offsetof(FWidgetAnimationCachedTimesAndStore, Times) == 0x000000, "Member 'FWidgetAnimationCachedTimesAndStore::Times' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationCachedTimesAndStore, CachedStores) == 0x000010, "Member 'FWidgetAnimationCachedTimesAndStore::CachedStores' has a wrong offset!");
...
static_assert(alignof(FWidgetAnimationCachedState) == 0x000008, "Wrong alignment on FWidgetAnimationCachedState");
static_assert(sizeof(FWidgetAnimationCachedState) == 0x000020, "Wrong size on FWidgetAnimationCachedState");
static_assert(offsetof(FWidgetAnimationCachedState, Animation) == 0x000000, "Member 'FWidgetAnimationCachedState::Animation' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationCachedState, CachedTimesAndStores) == 0x000008, "Member 'FWidgetAnimationCachedState::CachedTimesAndStores' has a wrong offset!");
...
static_assert(sizeof(FDelegateRuntimeBinding) == 0x000068, "Wrong size on FDelegateRuntimeBinding");
...
static_assert(offsetof(FDelegateRuntimeBinding, Kind) == 0x000060, "Member 'FDelegateRuntimeBinding::Kind' has a wrong offset!");
...
static_assert(alignof(FUMGSequencePlayerPool) == 0x000008, "Wrong alignment on FUMGSequencePlayerPool");
static_assert(sizeof(FUMGSequencePlayerPool) == 0x000050, "Wrong size on FUMGSequencePlayerPool");
static_assert(offsetof(FUMGSequencePlayerPool, AllCachedPlayers) == 0x000000, "Member 'FUMGSequencePlayerPool::AllCachedPlayers' has a wrong offset!");
...
// ScriptStruct UMG.RichTextDecoratorStyleRow
// 0x0350 (0x0360 - 0x0010)
struct FRichTextDecoratorStyleRow final : public FTableRowBase
{
public:
	struct FTextBlockStyle                        TextStyle;                                         // 0x0010(0x0350)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichTextDecoratorStyleRow) == 0x000010, "Wrong alignment on FRichTextDecoratorStyleRow");
static_assert(sizeof(FRichTextDecoratorStyleRow) == 0x000360, "Wrong size on FRichTextDecoratorStyleRow");
static_assert(offsetof(FRichTextDecoratorStyleRow, TextStyle) == 0x000010, "Member 'FRichTextDecoratorStyleRow::TextStyle' has a wrong offset!");

// ScriptStruct UMG.RichTextDecoratorStyleConfig
// 0x0008 (0x0008 - 0x0000)
struct FRichTextDecoratorStyleConfig
{
public:
	class UDataTable*                             DecoratorStyleSet;                                 // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichTextDecoratorStyleConfig) == 0x000008, "Wrong alignment on FRichTextDecoratorStyleConfig");
static_assert(sizeof(FRichTextDecoratorStyleConfig) == 0x000008, "Wrong size on FRichTextDecoratorStyleConfig");
static_assert(offsetof(FRichTextDecoratorStyleConfig, DecoratorStyleSet) == 0x000000, "Member 'FRichTextDecoratorStyleConfig::DecoratorStyleSet' has a wrong offset!");
...
// 0x0460 (0x0470 - 0x0010)
struct FRichImageTextRow final : public FTableRowBase
{
public:
	struct FTextBlockStyle                        TextStyle;                                         // 0x0010(0x0350)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            Brush;                                             // 0x0360(0x00D0)(Edit, NativeAccessSpecifierPublic)
	struct FMargin                                Padding;                                           // 0x0430(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                TextPadding;                                       // 0x0440(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          IsAdaptive;                                        // 0x0450(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_451[0x3];                                      // 0x0451(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WidthPadding;                                      // 0x0454(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MinFontSize;                                       // 0x0458(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinWidth;                                          // 0x045C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxWidth;                                          // 0x0460(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRichImageTextRow) == 0x000470, "Wrong size on FRichImageTextRow");
static_assert(offsetof(FRichImageTextRow, TextStyle) == 0x000010, "Member 'FRichImageTextRow::TextStyle' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, Brush) == 0x000360, "Member 'FRichImageTextRow::Brush' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, Padding) == 0x000430, "Member 'FRichImageTextRow::Padding' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, TextPadding) == 0x000440, "Member 'FRichImageTextRow::TextPadding' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, IsAdaptive) == 0x000450, "Member 'FRichImageTextRow::IsAdaptive' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, WidthPadding) == 0x000454, "Member 'FRichImageTextRow::WidthPadding' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, MinFontSize) == 0x000458, "Member 'FRichImageTextRow::MinFontSize' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, MinWidth) == 0x00045C, "Member 'FRichImageTextRow::MinWidth' has a wrong offset!");
static_assert(offsetof(FRichImageTextRow, MaxWidth) == 0x000460, "Member 'FRichImageTextRow::MaxWidth' has a wrong offset!");
