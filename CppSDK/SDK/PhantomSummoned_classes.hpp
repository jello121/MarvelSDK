...
public:
	...
	TArray<TScriptInterface<class IPhantomInterface>> Phantoms;                                          // 0x2A40(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPhantomInputSyncAbility) == 0x002A50, "Wrong size on UPhantomInputSyncAbility");
static_assert(offsetof(UPhantomInputSyncAbility, Phantoms) == 0x002A40, "Member 'UPhantomInputSyncAbility::Phantoms' has a wrong offset!");

// Class PhantomSummoned.PhantomSummonedController
// 0x0530 (0x1100 - 0x0BD0)
class APhantomSummonedController : public AMarvelAIController
{
public:
	bool                                          bInvertRightMove;                                  // 0x0BD0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_BD1[0x7];                                      // 0x0BD1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMarvelAbilityTargetFilter             PhantomAimTargetFilter;                            // 0x0BD8(0x0500)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPhantomAbilitySetting>         PhantomAbilitySettings;                            // 0x10D8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APhantomSummonedController) == 0x001100, "Wrong size on APhantomSummonedController");
static_assert(offsetof(APhantomSummonedController, bInvertRightMove) == 0x000BD0, "Member 'APhantomSummonedController::bInvertRightMove' has a wrong offset!");
static_assert(offsetof(APhantomSummonedController, PhantomAimTargetFilter) == 0x000BD8, "Member 'APhantomSummonedController::PhantomAimTargetFilter' has a wrong offset!");
static_assert(offsetof(APhantomSummonedController, PhantomAbilitySettings) == 0x0010D8, "Member 'APhantomSummonedController::PhantomAbilitySettings' has a wrong offset!");
