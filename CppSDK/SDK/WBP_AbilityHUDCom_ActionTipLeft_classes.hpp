...
{
public:
	class USpacer*                                Spacer;                                            // 0x05B0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_AbilityHUDCom_ActionTipLeft_C) == 0x0005B8, "Wrong size on UWBP_AbilityHUDCom_ActionTipLeft_C");
static_assert(offsetof(UWBP_AbilityHUDCom_ActionTipLeft_C, Spacer) == 0x0005B0, "Member 'UWBP_AbilityHUDCom_ActionTipLeft_C::Spacer' has a wrong offset!");
