...
{
public:
	bool                                          IsLooseBow;                                        // 0x2A38(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A39[0x7];                                     // 0x2A39(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnPreShootingDelegate;                             // 0x2A40(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLooseBow;                                        // 0x2A50(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             QATestArrowData;                                   // 0x2A60(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102131) == 0x002A70, "Wrong size on UPyAbility_102131");
static_assert(offsetof(UPyAbility_102131, IsLooseBow) == 0x002A38, "Member 'UPyAbility_102131::IsLooseBow' has a wrong offset!");
static_assert(offsetof(UPyAbility_102131, OnPreShootingDelegate) == 0x002A40, "Member 'UPyAbility_102131::OnPreShootingDelegate' has a wrong offset!");
static_assert(offsetof(UPyAbility_102131, OnLooseBow) == 0x002A50, "Member 'UPyAbility_102131::OnLooseBow' has a wrong offset!");
static_assert(offsetof(UPyAbility_102131, QATestArrowData) == 0x002A60, "Member 'UPyAbility_102131::QATestArrowData' has a wrong offset!");
...
{
public:
	float                                         ChargeTime;                                        // 0x3260(0x0004)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3264[0x4];                                     // 0x3264(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             DelegateShowArrowMesh;                             // 0x3268(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyProjectile_10213101) == 0x003280, "Wrong size on APyProjectile_10213101");
static_assert(offsetof(APyProjectile_10213101, ChargeTime) == 0x003260, "Member 'APyProjectile_10213101::ChargeTime' has a wrong offset!");
static_assert(offsetof(APyProjectile_10213101, DelegateShowArrowMesh) == 0x003268, "Member 'APyProjectile_10213101::DelegateShowArrowMesh' has a wrong offset!");

// PythonClass PyAbility_102131.PyCue_Projectile_Loop_10213101
// 0x0048 (0x0FB8 - 0x0F70)
class APyCue_Projectile_Loop_10213101 final : public AMarvelCueNotify_Projectile
{
public:
	bool                                          bIsAttach;                                         // 0x0F70(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F71[0x3];                                      // 0x0F71(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   ReleaseFxPoint;                                    // 0x0F74(0x000C)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         ReleaseFx;                                         // 0x0F80(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ArrowFxCDOLoc;                                     // 0x0F88(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               ArrowFxCDORot;                                     // 0x0FA0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Projectile_Loop_10213101) == 0x000FB8, "Wrong size on APyCue_Projectile_Loop_10213101");
static_assert(offsetof(APyCue_Projectile_Loop_10213101, bIsAttach) == 0x000F70, "Member 'APyCue_Projectile_Loop_10213101::bIsAttach' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10213101, ReleaseFxPoint) == 0x000F74, "Member 'APyCue_Projectile_Loop_10213101::ReleaseFxPoint' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10213101, ReleaseFx) == 0x000F80, "Member 'APyCue_Projectile_Loop_10213101::ReleaseFx' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10213101, ArrowFxCDOLoc) == 0x000F88, "Member 'APyCue_Projectile_Loop_10213101::ArrowFxCDOLoc' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10213101, ArrowFxCDORot) == 0x000FA0, "Member 'APyCue_Projectile_Loop_10213101::ArrowFxCDORot' has a wrong offset!");
...
{
public:
	class UTexture2D*                             ThumpArrowIcon;                                    // 0x0CD0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             BurstArrowIcon;                                    // 0x0CD8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UUserWidget>                WeaponWidget;                                      // 0x0CE0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FUIActionData                          ThumpActionData;                                   // 0x0CE8(0x0058)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FUIActionData                          BurstActionData;                                   // 0x0D40(0x0058)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	float                                         MaxAccumulateNeedTime;                             // 0x0D98(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyUIController_102131) == 0x000DA0, "Wrong size on UPyUIController_102131");
static_assert(offsetof(UPyUIController_102131, ThumpArrowIcon) == 0x000CD0, "Member 'UPyUIController_102131::ThumpArrowIcon' has a wrong offset!");
static_assert(offsetof(UPyUIController_102131, BurstArrowIcon) == 0x000CD8, "Member 'UPyUIController_102131::BurstArrowIcon' has a wrong offset!");
static_assert(offsetof(UPyUIController_102131, WeaponWidget) == 0x000CE0, "Member 'UPyUIController_102131::WeaponWidget' has a wrong offset!");
static_assert(offsetof(UPyUIController_102131, ThumpActionData) == 0x000CE8, "Member 'UPyUIController_102131::ThumpActionData' has a wrong offset!");
static_assert(offsetof(UPyUIController_102131, BurstActionData) == 0x000D40, "Member 'UPyUIController_102131::BurstActionData' has a wrong offset!");
static_assert(offsetof(UPyUIController_102131, MaxAccumulateNeedTime) == 0x000D98, "Member 'UPyUIController_102131::MaxAccumulateNeedTime' has a wrong offset!");
...
public:
	...
	int32                                         AbilityAudioID;                                    // 0x0FF4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Ability_Loop_10213101) == 0x000FF8, "Wrong size on APyCue_Ability_Loop_10213101");
static_assert(offsetof(APyCue_Ability_Loop_10213101, AbilityID) == 0x000FF0, "Member 'APyCue_Ability_Loop_10213101::AbilityID' has a wrong offset!");
static_assert(offsetof(APyCue_Ability_Loop_10213101, AbilityAudioID) == 0x000FF4, "Member 'APyCue_Ability_Loop_10213101::AbilityAudioID' has a wrong offset!");
