...
static_assert(sizeof(HulkBannerCharacter_TryToClimbWhenHit) == 0x0001A8, "Wrong size on HulkBannerCharacter_TryToClimbWhenHit");
...
static_assert(alignof(HulkBannerMoveLogicBaseComponent_ClientOnLanded) == 0x000001, "Wrong alignment on HulkBannerMoveLogicBaseComponent_ClientOnLanded");
static_assert(sizeof(HulkBannerMoveLogicBaseComponent_ClientOnLanded) == 0x000002, "Wrong size on HulkBannerMoveLogicBaseComponent_ClientOnLanded");
static_assert(offsetof(HulkBannerMoveLogicBaseComponent_ClientOnLanded, bBlock) == 0x000000, "Member 'HulkBannerMoveLogicBaseComponent_ClientOnLanded::bBlock' has a wrong offset!");
static_assert(offsetof(HulkBannerMoveLogicBaseComponent_ClientOnLanded, IsServerShiftJumpCancelled) == 0x000001, "Member 'HulkBannerMoveLogicBaseComponent_ClientOnLanded::IsServerShiftJumpCancelled' has a wrong offset!");
...
static_assert(sizeof(HulkBannerMoveLogicBaseComponent_OnFallingBlockedCallback) == 0x000178, "Wrong size on HulkBannerMoveLogicBaseComponent_OnFallingBlockedCallback");
...
static_assert(sizeof(HulkBannerMoveLogicBaseComponent_OnLandedCallback) == 0x000178, "Wrong size on HulkBannerMoveLogicBaseComponent_OnLandedCallback");
