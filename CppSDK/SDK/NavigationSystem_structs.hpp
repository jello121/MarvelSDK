...
{
public:
	struct FIntVector2                            TileA;                                             // 0x0000(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FIntVector2                            TileB;                                             // 0x0008(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int32>                                 TileALayers;                                       // 0x0010(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<int32>                                 TileBLayers;                                       // 0x0020(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	struct FVector                                WorldLocationA;                                    // 0x0030(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WorldLocationB;                                    // 0x0048(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FExtraOffMeshCons) == 0x000008, "Wrong alignment on FExtraOffMeshCons");
static_assert(sizeof(FExtraOffMeshCons) == 0x000060, "Wrong size on FExtraOffMeshCons");
static_assert(offsetof(FExtraOffMeshCons, TileA) == 0x000000, "Member 'FExtraOffMeshCons::TileA' has a wrong offset!");
static_assert(offsetof(FExtraOffMeshCons, TileB) == 0x000008, "Member 'FExtraOffMeshCons::TileB' has a wrong offset!");
static_assert(offsetof(FExtraOffMeshCons, TileALayers) == 0x000010, "Member 'FExtraOffMeshCons::TileALayers' has a wrong offset!");
static_assert(offsetof(FExtraOffMeshCons, TileBLayers) == 0x000020, "Member 'FExtraOffMeshCons::TileBLayers' has a wrong offset!");
static_assert(offsetof(FExtraOffMeshCons, WorldLocationA) == 0x000030, "Member 'FExtraOffMeshCons::WorldLocationA' has a wrong offset!");
static_assert(offsetof(FExtraOffMeshCons, WorldLocationB) == 0x000048, "Member 'FExtraOffMeshCons::WorldLocationB' has a wrong offset!");
