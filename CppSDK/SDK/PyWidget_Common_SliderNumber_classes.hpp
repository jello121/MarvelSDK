...
public:
	...
	TSubclassOf<class UUserWidget>                Class_Common_Slider_Color;                         // 0x0608(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnHovered;                                         // 0x0610(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUnhovered;                                       // 0x0620(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_Common_SliderNumber) == 0x000630, "Wrong size on UPyWidget_Common_SliderNumber");
...
static_assert(offsetof(UPyWidget_Common_SliderNumber, Class_Common_Slider_Color) == 0x000608, "Member 'UPyWidget_Common_SliderNumber::Class_Common_Slider_Color' has a wrong offset!");
static_assert(offsetof(UPyWidget_Common_SliderNumber, OnHovered) == 0x000610, "Member 'UPyWidget_Common_SliderNumber::OnHovered' has a wrong offset!");
static_assert(offsetof(UPyWidget_Common_SliderNumber, OnUnhovered) == 0x000620, "Member 'UPyWidget_Common_SliderNumber::OnUnhovered' has a wrong offset!");
