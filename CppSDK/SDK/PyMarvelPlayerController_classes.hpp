...
// 0x0038 (0x1320 - 0x12E8)
class APyMarvelPlayerController : public AMarvelPlayerController
{
public:
	class APyMarvelAIController*                  ClientAIController;                                // 0x12E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInputMappingContext*                   AbilityActionMappingContextBP;                     // 0x12F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInputMappingContext*                   OneSubmitActionMappingContextBP;                   // 0x12F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnClientReceiveJson;                               // 0x1300(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLevelNPCVoice;                                   // 0x1310(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyMarvelPlayerController) == 0x001320, "Wrong size on APyMarvelPlayerController");
static_assert(offsetof(APyMarvelPlayerController, ClientAIController) == 0x0012E8, "Member 'APyMarvelPlayerController::ClientAIController' has a wrong offset!");
static_assert(offsetof(APyMarvelPlayerController, AbilityActionMappingContextBP) == 0x0012F0, "Member 'APyMarvelPlayerController::AbilityActionMappingContextBP' has a wrong offset!");
static_assert(offsetof(APyMarvelPlayerController, OneSubmitActionMappingContextBP) == 0x0012F8, "Member 'APyMarvelPlayerController::OneSubmitActionMappingContextBP' has a wrong offset!");
static_assert(offsetof(APyMarvelPlayerController, OnClientReceiveJson) == 0x001300, "Member 'APyMarvelPlayerController::OnClientReceiveJson' has a wrong offset!");
static_assert(offsetof(APyMarvelPlayerController, OnLevelNPCVoice) == 0x001310, "Member 'APyMarvelPlayerController::OnLevelNPCVoice' has a wrong offset!");
