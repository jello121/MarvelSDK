...
static_assert(alignof(PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer) == 0x000008, "Wrong alignment on PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer");
static_assert(sizeof(PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer) == 0x000020, "Wrong size on PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer");
static_assert(offsetof(PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer, HitResults) == 0x000000, "Member 'PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer::HitResults' has a wrong offset!");
static_assert(offsetof(PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer, ReturnValue) == 0x000010, "Member 'PyEffectiveComponent_10497101_Base_K2_OnPreApplyContainer::ReturnValue' has a wrong offset!");
...
static_assert(alignof(PyAbility_104971_OnPredictingClientGrabTargetPredictFailed) == 0x000008, "Wrong alignment on PyAbility_104971_OnPredictingClientGrabTargetPredictFailed");
static_assert(sizeof(PyAbility_104971_OnPredictingClientGrabTargetPredictFailed) == 0x000008, "Wrong size on PyAbility_104971_OnPredictingClientGrabTargetPredictFailed");
static_assert(offsetof(PyAbility_104971_OnPredictingClientGrabTargetPredictFailed, InCharacter) == 0x000000, "Member 'PyAbility_104971_OnPredictingClientGrabTargetPredictFailed::InCharacter' has a wrong offset!");
...
static_assert(sizeof(PyAbility_104971_OnLanded) == 0x000178, "Wrong size on PyAbility_104971_OnLanded");
