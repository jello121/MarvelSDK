...
static_assert(sizeof(UPyUIController_103142) == 0x000CD0, "Wrong size on UPyUIController_103142");
...
static_assert(sizeof(UPyAbility_103141) == 0x002A40, "Wrong size on UPyAbility_103141");
...
{
public:
	class UTexture2D*                             EnhancedIcon;                                      // 0x0CD0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             NormalIcon;                                        // 0x0CD8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyUIController_103141) == 0x000CE0, "Wrong size on UPyUIController_103141");
static_assert(offsetof(UPyUIController_103141, EnhancedIcon) == 0x000CD0, "Member 'UPyUIController_103141::EnhancedIcon' has a wrong offset!");
static_assert(offsetof(UPyUIController_103141, NormalIcon) == 0x000CD8, "Member 'UPyUIController_103141::NormalIcon' has a wrong offset!");
