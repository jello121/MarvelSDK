...
static_assert(alignof(PyWidget_SettingOptionEntry_Clan_PreConstruct) == 0x000001, "Wrong alignment on PyWidget_SettingOptionEntry_Clan_PreConstruct");
static_assert(sizeof(PyWidget_SettingOptionEntry_Clan_PreConstruct) == 0x000001, "Wrong size on PyWidget_SettingOptionEntry_Clan_PreConstruct");
static_assert(offsetof(PyWidget_SettingOptionEntry_Clan_PreConstruct, IsDesignTime) == 0x000000, "Member 'PyWidget_SettingOptionEntry_Clan_PreConstruct::IsDesignTime' has a wrong offset!");
