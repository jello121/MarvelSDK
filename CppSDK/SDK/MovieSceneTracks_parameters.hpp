...
static_assert(sizeof(MovieSceneParameterSection_AddColorParameterKey) == 0x000024, "Wrong size on MovieSceneParameterSection_AddColorParameterKey");
...
static_assert(offsetof(MovieSceneParameterSection_AddColorParameterKey, InterpMode) == 0x000020, "Member 'MovieSceneParameterSection_AddColorParameterKey::InterpMode' has a wrong offset!");
...
static_assert(alignof(MovieSceneParameterSection_AddTextureParameterKey) == 0x000008, "Wrong alignment on MovieSceneParameterSection_AddTextureParameterKey");
static_assert(sizeof(MovieSceneParameterSection_AddTextureParameterKey) == 0x000018, "Wrong size on MovieSceneParameterSection_AddTextureParameterKey");
static_assert(offsetof(MovieSceneParameterSection_AddTextureParameterKey, InParameterName) == 0x000000, "Member 'MovieSceneParameterSection_AddTextureParameterKey::InParameterName' has a wrong offset!");
static_assert(offsetof(MovieSceneParameterSection_AddTextureParameterKey, InTime) == 0x00000C, "Member 'MovieSceneParameterSection_AddTextureParameterKey::InTime' has a wrong offset!");
static_assert(offsetof(MovieSceneParameterSection_AddTextureParameterKey, InValue) == 0x000010, "Member 'MovieSceneParameterSection_AddTextureParameterKey::InValue' has a wrong offset!");
...
static_assert(alignof(MovieSceneParameterSection_RemoveTextureParameter) == 0x000004, "Wrong alignment on MovieSceneParameterSection_RemoveTextureParameter");
static_assert(sizeof(MovieSceneParameterSection_RemoveTextureParameter) == 0x000010, "Wrong size on MovieSceneParameterSection_RemoveTextureParameter");
static_assert(offsetof(MovieSceneParameterSection_RemoveTextureParameter, InParameterName) == 0x000000, "Member 'MovieSceneParameterSection_RemoveTextureParameter::InParameterName' has a wrong offset!");
static_assert(offsetof(MovieSceneParameterSection_RemoveTextureParameter, ReturnValue) == 0x00000C, "Member 'MovieSceneParameterSection_RemoveTextureParameter::ReturnValue' has a wrong offset!");
