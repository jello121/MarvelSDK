...
static_assert(sizeof(UPyWidget_GamepadTriggerDeadZoneWidget) == 0x0005E8, "Wrong size on UPyWidget_GamepadTriggerDeadZoneWidget");
...
public:
	...
	float                                         DelayTimeRange;                                    // 0x05E4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AccTimeRange;                                      // 0x05E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_DeadZoneExtraSensiCurve) == 0x0005F0, "Wrong size on UPyWidget_DeadZoneExtraSensiCurve");
static_assert(offsetof(UPyWidget_DeadZoneExtraSensiCurve, DelayTimeRange) == 0x0005E4, "Member 'UPyWidget_DeadZoneExtraSensiCurve::DelayTimeRange' has a wrong offset!");
static_assert(offsetof(UPyWidget_DeadZoneExtraSensiCurve, AccTimeRange) == 0x0005E8, "Member 'UPyWidget_DeadZoneExtraSensiCurve::AccTimeRange' has a wrong offset!");
