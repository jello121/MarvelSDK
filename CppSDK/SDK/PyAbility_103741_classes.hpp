...
{
public:
	class UCurveFloat*                            SphereScaleCurve;                                  // 0x1270(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyConfig_103741) == 0x001280, "Wrong size on UPyConfig_103741");
static_assert(offsetof(UPyConfig_103741, SphereScaleCurve) == 0x001270, "Member 'UPyConfig_103741::SphereScaleCurve' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_103741) == 0x002AB0, "Wrong size on UPyAbility_103741");
...
static_assert(sizeof(UPyAbility_103743) == 0x002AB0, "Wrong size on UPyAbility_103743");
...
{
public:
	FMulticastInlineDelegateProperty_             OnSummonedScaleChange;                             // 0x0B10(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APySummoned_10374101) == 0x000B20, "Wrong size on APySummoned_10374101");
static_assert(offsetof(APySummoned_10374101, OnSummonedScaleChange) == 0x000B10, "Member 'APySummoned_10374101::OnSummonedScaleChange' has a wrong offset!");
...
static_assert(sizeof(UPySummonedComp_10374101) == 0x000CB0, "Wrong size on UPySummonedComp_10374101");

// PythonClass PyAbility_103741.PyCue_Summoner_Loop_10374101
// 0x0010 (0x1068 - 0x1058)
class APyCue_Summoner_Loop_10374101 final : public ACueSummonerLoopCue_10374101
{
public:
	class UFXSystemAsset*                         StartFX2;                                          // 0x1058(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ShieldHitAudioID;                                  // 0x1060(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Summoner_Loop_10374101) == 0x001068, "Wrong size on APyCue_Summoner_Loop_10374101");
static_assert(offsetof(APyCue_Summoner_Loop_10374101, StartFX2) == 0x001058, "Member 'APyCue_Summoner_Loop_10374101::StartFX2' has a wrong offset!");
static_assert(offsetof(APyCue_Summoner_Loop_10374101, ShieldHitAudioID) == 0x001060, "Member 'APyCue_Summoner_Loop_10374101::ShieldHitAudioID' has a wrong offset!");
