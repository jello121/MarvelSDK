...
static_assert(sizeof(UPyAbility_104221) == 0x002A40, "Wrong size on UPyAbility_104221");

// PythonClass PyAbility_104221.PyBuffCue_10422101
// 0x0068 (0x1300 - 0x1298)
class APyBuffCue_10422101 final : public ACue_Buff_WebTying
{
public:
	struct FGameplayTagContainer                  ChangedSculptAbilityTags;                          // 0x1298(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyBuffCue_10422101) == 0x001300, "Wrong size on APyBuffCue_10422101");
static_assert(offsetof(APyBuffCue_10422101, ChangedSculptAbilityTags) == 0x001298, "Member 'APyBuffCue_10422101::ChangedSculptAbilityTags' has a wrong offset!");
...
static_assert(sizeof(APyProjectile_10422101) == 0x003260, "Wrong size on APyProjectile_10422101");
