...
static_assert(offsetof(UISettingEntryVoiceEnhancementHandler_BP_OnChanged, Params_0) == 0x000018, "Member 'UISettingEntryVoiceEnhancementHandler_BP_OnChanged::Params_0' has a wrong offset!");
