...
void UJarvisReplaySubsystem::LocalRecordWidgetEventReplay(const class FString& Name_0, const class FString& FriendlyName)
{
	static class UFunction* Func = nullptr;
...
void UJarvisReplaySubsystem::RecordJarvisReplay(bool bInIsInGameRecord)
{
	static class UFunction* Func = nullptr;
...
void UJarvisReplaySubsystem::RecordWidgetEventReplay(bool bInIsInGameRecord)
{
	static class UFunction* Func = nullptr;
