...
static_assert(sizeof(UPyEffectiveComponent_10161101) == 0x001C10, "Wrong size on UPyEffectiveComponent_10161101");
...
static_assert(sizeof(UPyAbility_101611) == 0x002A38, "Wrong size on UPyAbility_101611");
