...
public:
	...
	bool                                          IsShowDeclining;                                   // 0x0908(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          IsNeedAdjustZorderWhenHover;                       // 0x092B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_CommonItem, IsShowDeclining) == 0x000908, "Member 'UPyWidget_CommonItem::IsShowDeclining' has a wrong offset!");
...
static_assert(offsetof(UPyWidget_CommonItem, IsNeedAdjustZorderWhenHover) == 0x00092B, "Member 'UPyWidget_CommonItem::IsNeedAdjustZorderWhenHover' has a wrong offset!");
