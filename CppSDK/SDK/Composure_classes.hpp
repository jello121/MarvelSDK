...
{
public:
	bool                                          bAutoRun;                                          // 0x05F8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoRunChildElementsAndSelf;                      // 0x05F9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_5FA[0x16];                                     // 0x05FA(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AComposurePipelineBaseActor) == 0x000610, "Wrong size on AComposurePipelineBaseActor");
static_assert(offsetof(AComposurePipelineBaseActor, bAutoRun) == 0x0005F8, "Member 'AComposurePipelineBaseActor::bAutoRun' has a wrong offset!");
static_assert(offsetof(AComposurePipelineBaseActor, bAutoRunChildElementsAndSelf) == 0x0005F9, "Member 'AComposurePipelineBaseActor::bAutoRunChildElementsAndSelf' has a wrong offset!");
...
public:
	...
	class UComposureCompositingTargetComponent*   CompositingTarget;                                 // 0x0618(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UComposurePostProcessingPassProxy*      PostProcessProxy;                                  // 0x0620(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UCompositingElementInput*>       Inputs;                                            // 0x0628(0x0010)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UCompositingElementTransform*>   TransformPasses;                                   // 0x0638(0x0010)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UCompositingElementOutput*>      Outputs;                                           // 0x0648(0x0010)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	ESceneCameraLinkType                          CameraSource;                                      // 0x0658(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TLazyObjectPtr<class ACameraActor>            TargetCameraActor;                                 // 0x065C(0x0018)(Edit, DisableEditOnTemplate, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInheritedSourceType                          ResolutionSource;                                  // 0x0674(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FIntPoint                              RenderResolution;                                  // 0x0678(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ETextureRenderTargetFormat                    RenderFormat;                                      // 0x0680(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseSharedTargetPool;                              // 0x0681(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_682[0x36];                                     // 0x0682(0x0036)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         FreezeFrameMask;                                   // 0x06B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_6BC[0x4];                                      // 0x06BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnTransformPassRendered_BP;                        // 0x06C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFinalPassRendered_BP;                            // 0x06D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	class FName                                   CompShotIdName;                                    // 0x06E0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_6EC[0x4];                                      // 0x06EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class ACompositingElement*                    Parent;                                            // 0x06F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class ACompositingElement*>            ChildLayers;                                       // 0x06F8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_708[0x4];                                      // 0x0708(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OutputOpacity;                                     // 0x070C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TMap<class UCompositingElementInput*, ECompPassConstructionType> UserConstructedInputs;                             // 0x0710(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class UCompositingElementTransform*, ECompPassConstructionType> UserConstructedTransforms;                         // 0x0760(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class UCompositingElementOutput*, ECompPassConstructionType> UserConstructedOutputs;                            // 0x07B0(0x0050)(NativeAccessSpecifierPrivate)
	TArray<class UCompositingElementInput*>       InternalInputs;                                    // 0x0800(0x0010)(ExportObject, ZeroConstructor, Transient, DuplicateTransient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UCompositingElementTransform*>   InternalTransformPasses;                           // 0x0810(0x0010)(ExportObject, ZeroConstructor, Transient, DuplicateTransient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UCompositingElementOutput*>      InternalOutputs;                                   // 0x0820(0x0010)(ExportObject, ZeroConstructor, Transient, DuplicateTransient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UAlphaTransformPass*                    InternalAlphaPass;                                 // 0x0830(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_838[0xB8];                                     // 0x0838(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ACompositingElement) == 0x0008F0, "Wrong size on ACompositingElement");
static_assert(offsetof(ACompositingElement, CompositingTarget) == 0x000618, "Member 'ACompositingElement::CompositingTarget' has a wrong offset!");
static_assert(offsetof(ACompositingElement, PostProcessProxy) == 0x000620, "Member 'ACompositingElement::PostProcessProxy' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Inputs) == 0x000628, "Member 'ACompositingElement::Inputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, TransformPasses) == 0x000638, "Member 'ACompositingElement::TransformPasses' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Outputs) == 0x000648, "Member 'ACompositingElement::Outputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, CameraSource) == 0x000658, "Member 'ACompositingElement::CameraSource' has a wrong offset!");
static_assert(offsetof(ACompositingElement, TargetCameraActor) == 0x00065C, "Member 'ACompositingElement::TargetCameraActor' has a wrong offset!");
static_assert(offsetof(ACompositingElement, ResolutionSource) == 0x000674, "Member 'ACompositingElement::ResolutionSource' has a wrong offset!");
static_assert(offsetof(ACompositingElement, RenderResolution) == 0x000678, "Member 'ACompositingElement::RenderResolution' has a wrong offset!");
static_assert(offsetof(ACompositingElement, RenderFormat) == 0x000680, "Member 'ACompositingElement::RenderFormat' has a wrong offset!");
static_assert(offsetof(ACompositingElement, bUseSharedTargetPool) == 0x000681, "Member 'ACompositingElement::bUseSharedTargetPool' has a wrong offset!");
static_assert(offsetof(ACompositingElement, FreezeFrameMask) == 0x0006B8, "Member 'ACompositingElement::FreezeFrameMask' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OnTransformPassRendered_BP) == 0x0006C0, "Member 'ACompositingElement::OnTransformPassRendered_BP' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OnFinalPassRendered_BP) == 0x0006D0, "Member 'ACompositingElement::OnFinalPassRendered_BP' has a wrong offset!");
static_assert(offsetof(ACompositingElement, CompShotIdName) == 0x0006E0, "Member 'ACompositingElement::CompShotIdName' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Parent) == 0x0006F0, "Member 'ACompositingElement::Parent' has a wrong offset!");
static_assert(offsetof(ACompositingElement, ChildLayers) == 0x0006F8, "Member 'ACompositingElement::ChildLayers' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OutputOpacity) == 0x00070C, "Member 'ACompositingElement::OutputOpacity' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedInputs) == 0x000710, "Member 'ACompositingElement::UserConstructedInputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedTransforms) == 0x000760, "Member 'ACompositingElement::UserConstructedTransforms' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedOutputs) == 0x0007B0, "Member 'ACompositingElement::UserConstructedOutputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalInputs) == 0x000800, "Member 'ACompositingElement::InternalInputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalTransformPasses) == 0x000810, "Member 'ACompositingElement::InternalTransformPasses' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalOutputs) == 0x000820, "Member 'ACompositingElement::InternalOutputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalAlphaPass) == 0x000830, "Member 'ACompositingElement::InternalAlphaPass' has a wrong offset!");
...
{
public:
	class USceneCaptureComponent2D*               SceneCaptureComponent2D;                           // 0x08F0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bApplyDistortion;                                  // 0x08F8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8F9[0x7];                                      // 0x08F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FComponentReference                    LensComponentPicker;                               // 0x0900(0x0030)(Edit, DisableEditOnTemplate, Protected, NativeAccessSpecifierProtected)
	float                                         OverscanFactor;                                    // 0x0930(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         OriginalFocalLength;                               // 0x0934(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               LastDistortionMID;                                 // 0x0938(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ACompositingCaptureBase) == 0x000940, "Wrong size on ACompositingCaptureBase");
static_assert(offsetof(ACompositingCaptureBase, SceneCaptureComponent2D) == 0x0008F0, "Member 'ACompositingCaptureBase::SceneCaptureComponent2D' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, bApplyDistortion) == 0x0008F8, "Member 'ACompositingCaptureBase::bApplyDistortion' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, LensComponentPicker) == 0x000900, "Member 'ACompositingCaptureBase::LensComponentPicker' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, OverscanFactor) == 0x000930, "Member 'ACompositingCaptureBase::OverscanFactor' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, OriginalFocalLength) == 0x000934, "Member 'ACompositingCaptureBase::OriginalFocalLength' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, LastDistortionMID) == 0x000938, "Member 'ACompositingCaptureBase::LastDistortionMID' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPick;                                            // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCancel;                                          // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAccept;                                          // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComposurePostProcessPass) == 0x000490, "Wrong size on UComposurePostProcessPass");
static_assert(offsetof(UComposurePostProcessPass, SceneCapture) == 0x000470, "Member 'UComposurePostProcessPass::SceneCapture' has a wrong offset!");
static_assert(offsetof(UComposurePostProcessPass, BlendableInterface) == 0x000478, "Member 'UComposurePostProcessPass::BlendableInterface' has a wrong offset!");
static_assert(offsetof(UComposurePostProcessPass, SetupMaterial) == 0x000480, "Member 'UComposurePostProcessPass::SetupMaterial' has a wrong offset!");
static_assert(offsetof(UComposurePostProcessPass, TonemapperReplacement) == 0x000488, "Member 'UComposurePostProcessPass::TonemapperReplacement' has a wrong offset!");
...
static_assert(sizeof(UComposureLensBloomPass) == 0x000560, "Wrong size on UComposureLensBloomPass");
static_assert(offsetof(UComposureLensBloomPass, Settings) == 0x000490, "Member 'UComposureLensBloomPass::Settings' has a wrong offset!");
static_assert(offsetof(UComposureLensBloomPass, TonemapperReplacingMID) == 0x000550, "Member 'UComposureLensBloomPass::TonemapperReplacingMID' has a wrong offset!");
...
static_assert(sizeof(UComposureTonemapperPass) == 0x000740, "Wrong size on UComposureTonemapperPass");
static_assert(offsetof(UComposureTonemapperPass, ColorGradingSettings) == 0x000490, "Member 'UComposureTonemapperPass::ColorGradingSettings' has a wrong offset!");
static_assert(offsetof(UComposureTonemapperPass, FilmStockSettings) == 0x000720, "Member 'UComposureTonemapperPass::FilmStockSettings' has a wrong offset!");
static_assert(offsetof(UComposureTonemapperPass, ChromaticAberration) == 0x000734, "Member 'UComposureTonemapperPass::ChromaticAberration' has a wrong offset!");
...
static_assert(sizeof(UComposureCompositingTargetComponent) == 0x000100, "Wrong size on UComposureCompositingTargetComponent");
static_assert(offsetof(UComposureCompositingTargetComponent, DisplayTexture) == 0x0000F8, "Member 'UComposureCompositingTargetComponent::DisplayTexture' has a wrong offset!");
...
static_assert(sizeof(UComposurePostProcessingPassProxy) == 0x0004A0, "Wrong size on UComposurePostProcessingPassProxy");
static_assert(offsetof(UComposurePostProcessingPassProxy, SetupMID) == 0x000490, "Member 'UComposurePostProcessingPassProxy::SetupMID' has a wrong offset!");
