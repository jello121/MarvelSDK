...
{
public:
	class USummonedMovementComponent*             SummonedMovement;                                  // 0x0AA0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ASummoned_10247101_BP_C) == 0x000AB0, "Wrong size on ASummoned_10247101_BP_C");
static_assert(offsetof(ASummoned_10247101_BP_C, SummonedMovement) == 0x000AA0, "Member 'ASummoned_10247101_BP_C::SummonedMovement' has a wrong offset!");
