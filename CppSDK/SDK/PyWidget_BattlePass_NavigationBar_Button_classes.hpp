...
class UPyWidget_BattlePass_NavigationBar_Button final : public UPyWidget_Common_NavigationBar_Button
{
public:
	void Construct();
...
static_assert(sizeof(UPyWidget_BattlePass_NavigationBar_Button) == 0x0007E0, "Wrong size on UPyWidget_BattlePass_NavigationBar_Button");
