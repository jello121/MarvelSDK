...
public:
	...
	struct FAttributeModifierParameter            ModifierParam;                                     // 0x0010(0x06C0)(ConstParm, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(PyLevelSubsystem_TrySpawnPlayer) == 0x000008, "Wrong alignment on PyLevelSubsystem_TrySpawnPlayer");
static_assert(sizeof(PyLevelSubsystem_TrySpawnPlayer) == 0x0006D0, "Wrong size on PyLevelSubsystem_TrySpawnPlayer");
