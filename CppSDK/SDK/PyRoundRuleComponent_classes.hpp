...
public:
	...
	float                                         VictoryProgressMax;                                // 0x0158(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyRoundRuleComponent) == 0x000160, "Wrong size on UPyRoundRuleComponent");
...
static_assert(offsetof(UPyRoundRuleComponent, VictoryProgressMax) == 0x000158, "Member 'UPyRoundRuleComponent::VictoryProgressMax' has a wrong offset!");
