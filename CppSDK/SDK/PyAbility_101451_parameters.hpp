...
static_assert(sizeof(PyProjectile_10145101_OnProjectileHit__DelegateSignature) == 0x000178, "Wrong size on PyProjectile_10145101_OnProjectileHit__DelegateSignature");
...
static_assert(sizeof(PyProjectile_10145101_K2_OnProcessHit) == 0x000178, "Wrong size on PyProjectile_10145101_K2_OnProcessHit");
...
static_assert(sizeof(PyProjectile_10145101_K2_OnFlyOverMaxDistance) == 0x000178, "Wrong size on PyProjectile_10145101_K2_OnFlyOverMaxDistance");
...
public:
	...
	EZiplineLaunchResult                          ReturnValue;                                       // 0x0178(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(PyAbility_101451_IsValidToSetupZipline) == 0x000180, "Wrong size on PyAbility_101451_IsValidToSetupZipline");
...
static_assert(offsetof(PyAbility_101451_IsValidToSetupZipline, ReturnValue) == 0x000178, "Member 'PyAbility_101451_IsValidToSetupZipline::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(PySummoned_10145101_AuthorityOnClawHit) == 0x000178, "Wrong size on PySummoned_10145101_AuthorityOnClawHit");
