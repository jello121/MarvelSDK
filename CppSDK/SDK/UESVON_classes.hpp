...
static_assert(sizeof(USvonNavDataRenderingComponent) == 0x000910, "Wrong size on USvonNavDataRenderingComponent");
static_assert(offsetof(USvonNavDataRenderingComponent, DrawFlagName) == 0x0008C8, "Member 'USvonNavDataRenderingComponent::DrawFlagName' has a wrong offset!");
static_assert(offsetof(USvonNavDataRenderingComponent, DebugMeshMaterialFakeLight) == 0x0008E0, "Member 'USvonNavDataRenderingComponent::DebugMeshMaterialFakeLight' has a wrong offset!");
...
public:
	...
	bool                                          DebugDrawRawPath;                                  // 0x00F2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DebugDrawFinalPath;                                // 0x00F3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DebugDrawDuration;                                 // 0x00F4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USVONNavigationComponent, DebugDrawRawPath) == 0x0000F2, "Member 'USVONNavigationComponent::DebugDrawRawPath' has a wrong offset!");
static_assert(offsetof(USVONNavigationComponent, DebugDrawFinalPath) == 0x0000F3, "Member 'USVONNavigationComponent::DebugDrawFinalPath' has a wrong offset!");
static_assert(offsetof(USVONNavigationComponent, DebugDrawDuration) == 0x0000F4, "Member 'USVONNavigationComponent::DebugDrawDuration' has a wrong offset!");
...
static_assert(sizeof(ASVONReachableTestPoint) == 0x0005F8, "Wrong size on ASVONReachableTestPoint");

// Class UESVON.SVONVolume
// 0x0618 (0x0C48 - 0x0630)
class ASVONVolume final : public AVolume
{
public:
	float                                         MyDebugDistance;                                   // 0x0630(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MyShowVoxels;                                      // 0x0634(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MyShowLeafVoxels;                                  // 0x0635(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MyDrawSolidLeafNode;                               // 0x0636(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MyShowMortonCodes;                                 // 0x0637(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MyShowNeighbourLinks;                              // 0x0638(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MyShowParentChildLinks;                            // 0x0639(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableRebuildDebug;                                // 0x063A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UseAsyncBuild;                                     // 0x063B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RebuildMillisecondDelta;                           // 0x063C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableDebugRendering;                             // 0x0640(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_641[0x7];                                      // 0x0641(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSvonDebugRenderingSettings            DebugRenderingSettings;                            // 0x0648(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	int32                                         MyVoxelPower;                                      // 0x0668(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             MyCollisionChannel;                                // 0x066C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_66D[0x3];                                      // 0x066D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MyClearance;                                       // 0x0670(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESVOGenerationStrategy                        MyGenerationStrategy;                              // 0x0674(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseForNav;                                        // 0x0675(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bConcernReachable;                                 // 0x0676(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         MyNumLayers;                                       // 0x0677(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MyNumBytes;                                        // 0x0678(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MyLeafVoxelSize;                                   // 0x067C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverridePathFindingSetting;                       // 0x0680(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseUnitCost;                                      // 0x0681(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_682[0x6];                                      // 0x0682(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<uint32, uint32>                          MyOffSVOLinkMap;                                   // 0x0688(0x0050)(NativeAccessSpecifierPublic)
	TMap<uint32, uint64>                          MyOffSVOLinkIdMap;                                 // 0x06D8(0x0050)(NativeAccessSpecifierPublic)
	TMap<uint64, struct FVectorPair>              MyOffSVOLinkLocationMap;                           // 0x0728(0x0050)(Edit, EditConst, NativeAccessSpecifierPublic)
	bool                                          bHasOffSVOLink;                                    // 0x0778(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         DebugLayerIndex;                                   // 0x0779(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_77A[0x2];                                      // 0x077A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         DebugNodeIndex;                                    // 0x077C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         DebugSubNodeIndex;                                 // 0x0780(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDebugForceLeafNode;                               // 0x0781(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int8                                          DebugDirection;                                    // 0x0782(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDebugShowNeighbours;                              // 0x0783(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoFlushWhenDebugLink;                           // 0x0784(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_785[0x3];                                      // 0x0785(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class USvonNavDataRenderingComponent*         RenderingComponent;                                // 0x0788(0x0008)(Edit, ExportObject, ZeroConstructor, Transient, EditConst, InstancedReference, DuplicateTransient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_790[0x80];                                     // 0x0790(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                MyOrigin;                                          // 0x0810(0x0018)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                MyExtent;                                          // 0x0828(0x0018)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                MyDebugPosition;                                   // 0x0840(0x0018)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_858[0x3F0];                                    // 0x0858(0x03F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ASVONVolume) == 0x000C48, "Wrong size on ASVONVolume");
static_assert(offsetof(ASVONVolume, MyDebugDistance) == 0x000630, "Member 'ASVONVolume::MyDebugDistance' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyShowVoxels) == 0x000634, "Member 'ASVONVolume::MyShowVoxels' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyShowLeafVoxels) == 0x000635, "Member 'ASVONVolume::MyShowLeafVoxels' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyDrawSolidLeafNode) == 0x000636, "Member 'ASVONVolume::MyDrawSolidLeafNode' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyShowMortonCodes) == 0x000637, "Member 'ASVONVolume::MyShowMortonCodes' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyShowNeighbourLinks) == 0x000638, "Member 'ASVONVolume::MyShowNeighbourLinks' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyShowParentChildLinks) == 0x000639, "Member 'ASVONVolume::MyShowParentChildLinks' has a wrong offset!");
static_assert(offsetof(ASVONVolume, EnableRebuildDebug) == 0x00063A, "Member 'ASVONVolume::EnableRebuildDebug' has a wrong offset!");
static_assert(offsetof(ASVONVolume, UseAsyncBuild) == 0x00063B, "Member 'ASVONVolume::UseAsyncBuild' has a wrong offset!");
static_assert(offsetof(ASVONVolume, RebuildMillisecondDelta) == 0x00063C, "Member 'ASVONVolume::RebuildMillisecondDelta' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bEnableDebugRendering) == 0x000640, "Member 'ASVONVolume::bEnableDebugRendering' has a wrong offset!");
static_assert(offsetof(ASVONVolume, DebugRenderingSettings) == 0x000648, "Member 'ASVONVolume::DebugRenderingSettings' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyVoxelPower) == 0x000668, "Member 'ASVONVolume::MyVoxelPower' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyCollisionChannel) == 0x00066C, "Member 'ASVONVolume::MyCollisionChannel' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyClearance) == 0x000670, "Member 'ASVONVolume::MyClearance' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyGenerationStrategy) == 0x000674, "Member 'ASVONVolume::MyGenerationStrategy' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bUseForNav) == 0x000675, "Member 'ASVONVolume::bUseForNav' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bConcernReachable) == 0x000676, "Member 'ASVONVolume::bConcernReachable' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyNumLayers) == 0x000677, "Member 'ASVONVolume::MyNumLayers' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyNumBytes) == 0x000678, "Member 'ASVONVolume::MyNumBytes' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyLeafVoxelSize) == 0x00067C, "Member 'ASVONVolume::MyLeafVoxelSize' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bOverridePathFindingSetting) == 0x000680, "Member 'ASVONVolume::bOverridePathFindingSetting' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bUseUnitCost) == 0x000681, "Member 'ASVONVolume::bUseUnitCost' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyOffSVOLinkMap) == 0x000688, "Member 'ASVONVolume::MyOffSVOLinkMap' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyOffSVOLinkIdMap) == 0x0006D8, "Member 'ASVONVolume::MyOffSVOLinkIdMap' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyOffSVOLinkLocationMap) == 0x000728, "Member 'ASVONVolume::MyOffSVOLinkLocationMap' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bHasOffSVOLink) == 0x000778, "Member 'ASVONVolume::bHasOffSVOLink' has a wrong offset!");
static_assert(offsetof(ASVONVolume, DebugLayerIndex) == 0x000779, "Member 'ASVONVolume::DebugLayerIndex' has a wrong offset!");
static_assert(offsetof(ASVONVolume, DebugNodeIndex) == 0x00077C, "Member 'ASVONVolume::DebugNodeIndex' has a wrong offset!");
static_assert(offsetof(ASVONVolume, DebugSubNodeIndex) == 0x000780, "Member 'ASVONVolume::DebugSubNodeIndex' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bDebugForceLeafNode) == 0x000781, "Member 'ASVONVolume::bDebugForceLeafNode' has a wrong offset!");
static_assert(offsetof(ASVONVolume, DebugDirection) == 0x000782, "Member 'ASVONVolume::DebugDirection' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bDebugShowNeighbours) == 0x000783, "Member 'ASVONVolume::bDebugShowNeighbours' has a wrong offset!");
static_assert(offsetof(ASVONVolume, bAutoFlushWhenDebugLink) == 0x000784, "Member 'ASVONVolume::bAutoFlushWhenDebugLink' has a wrong offset!");
static_assert(offsetof(ASVONVolume, RenderingComponent) == 0x000788, "Member 'ASVONVolume::RenderingComponent' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyOrigin) == 0x000810, "Member 'ASVONVolume::MyOrigin' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyExtent) == 0x000828, "Member 'ASVONVolume::MyExtent' has a wrong offset!");
static_assert(offsetof(ASVONVolume, MyDebugPosition) == 0x000840, "Member 'ASVONVolume::MyDebugPosition' has a wrong offset!");
