...
static_assert(alignof(NavigationSystemV1_ReCreateNavigationSystem) == 0x000008, "Wrong alignment on NavigationSystemV1_ReCreateNavigationSystem");
static_assert(sizeof(NavigationSystemV1_ReCreateNavigationSystem) == 0x000008, "Wrong size on NavigationSystemV1_ReCreateNavigationSystem");
static_assert(offsetof(NavigationSystemV1_ReCreateNavigationSystem, WorldContextObject) == 0x000000, "Member 'NavigationSystemV1_ReCreateNavigationSystem::WorldContextObject' has a wrong offset!");

// Function NavigationSystem.NavigationSystemV1.StaticDisableSkipRebuildDirtyAreas
// 0x0008 (0x0008 - 0x0000)
struct NavigationSystemV1_StaticDisableSkipRebuildDirtyAreas final
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(NavigationSystemV1_StaticDisableSkipRebuildDirtyAreas) == 0x000008, "Wrong alignment on NavigationSystemV1_StaticDisableSkipRebuildDirtyAreas");
static_assert(sizeof(NavigationSystemV1_StaticDisableSkipRebuildDirtyAreas) == 0x000008, "Wrong size on NavigationSystemV1_StaticDisableSkipRebuildDirtyAreas");
static_assert(offsetof(NavigationSystemV1_StaticDisableSkipRebuildDirtyAreas, WorldContextObject) == 0x000000, "Member 'NavigationSystemV1_StaticDisableSkipRebuildDirtyAreas::WorldContextObject' has a wrong offset!");
