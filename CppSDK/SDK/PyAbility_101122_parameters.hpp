...
static_assert(alignof(PyProjectile_10112302_K2_OnProcessHit) == 0x000008, "Wrong alignment on PyProjectile_10112302_K2_OnProcessHit");
static_assert(sizeof(PyProjectile_10112302_K2_OnProcessHit) == 0x000178, "Wrong size on PyProjectile_10112302_K2_OnProcessHit");
static_assert(offsetof(PyProjectile_10112302_K2_OnProcessHit, ImpactResult) == 0x000000, "Member 'PyProjectile_10112302_K2_OnProcessHit::ImpactResult' has a wrong offset!");
...
static_assert(alignof(PyProjectile_10112302_K2_OnPenetrate) == 0x000008, "Wrong alignment on PyProjectile_10112302_K2_OnPenetrate");
static_assert(sizeof(PyProjectile_10112302_K2_OnPenetrate) == 0x000190, "Wrong size on PyProjectile_10112302_K2_OnPenetrate");
static_assert(offsetof(PyProjectile_10112302_K2_OnPenetrate, ImpactResult) == 0x000000, "Member 'PyProjectile_10112302_K2_OnPenetrate::ImpactResult' has a wrong offset!");
static_assert(offsetof(PyProjectile_10112302_K2_OnPenetrate, ImpactVelocity) == 0x000178, "Member 'PyProjectile_10112302_K2_OnPenetrate::ImpactVelocity' has a wrong offset!");
...
static_assert(alignof(PyEffectiveComponent_10112302_K2_OnPreApplyContainer) == 0x000008, "Wrong alignment on PyEffectiveComponent_10112302_K2_OnPreApplyContainer");
static_assert(sizeof(PyEffectiveComponent_10112302_K2_OnPreApplyContainer) == 0x000020, "Wrong size on PyEffectiveComponent_10112302_K2_OnPreApplyContainer");
static_assert(offsetof(PyEffectiveComponent_10112302_K2_OnPreApplyContainer, HitResults) == 0x000000, "Member 'PyEffectiveComponent_10112302_K2_OnPreApplyContainer::HitResults' has a wrong offset!");
static_assert(offsetof(PyEffectiveComponent_10112302_K2_OnPreApplyContainer, ReturnValue) == 0x000010, "Member 'PyEffectiveComponent_10112302_K2_OnPreApplyContainer::ReturnValue' has a wrong offset!");
