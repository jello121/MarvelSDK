...
static_assert(sizeof(Summoned_V2_10325101_IsWallClimbing) == 0x000180, "Wrong size on Summoned_V2_10325101_IsWallClimbing");
...
static_assert(offsetof(Summoned_V2_10325101_IsWallClimbing, ReturnValue) == 0x000178, "Member 'Summoned_V2_10325101_IsWallClimbing::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Summoned_V2_10325101_OnSquirrelHit) == 0x0001A0, "Wrong size on Summoned_V2_10325101_OnSquirrelHit");
...
static_assert(sizeof(Summoned_V2_10325101_SquirrelClimbingWall) == 0x000178, "Wrong size on Summoned_V2_10325101_SquirrelClimbingWall");
...
public:
	struct FHitResult                             Hit;                                               // 0x0000(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	float                                         Angle;                                             // 0x0178(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ForceTurn;                                         // 0x017C(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Summoned_V2_10325101_SquirrelTurn) == 0x000008, "Wrong alignment on Summoned_V2_10325101_SquirrelTurn");
static_assert(sizeof(Summoned_V2_10325101_SquirrelTurn) == 0x000180, "Wrong size on Summoned_V2_10325101_SquirrelTurn");
...
static_assert(offsetof(Summoned_V2_10325101_SquirrelTurn, Angle) == 0x000178, "Member 'Summoned_V2_10325101_SquirrelTurn::Angle' has a wrong offset!");
static_assert(offsetof(Summoned_V2_10325101_SquirrelTurn, ForceTurn) == 0x00017C, "Member 'Summoned_V2_10325101_SquirrelTurn::ForceTurn' has a wrong offset!");
...
public:
	struct FHitResult                             Hit;                                               // 0x0000(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVector                                Vector;                                            // 0x0178(0x0018)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Summoned_V2_10325101_SquirrelTurnInternal) == 0x000008, "Wrong alignment on Summoned_V2_10325101_SquirrelTurnInternal");
static_assert(sizeof(Summoned_V2_10325101_SquirrelTurnInternal) == 0x000190, "Wrong size on Summoned_V2_10325101_SquirrelTurnInternal");
static_assert(offsetof(Summoned_V2_10325101_SquirrelTurnInternal, Hit) == 0x000000, "Member 'Summoned_V2_10325101_SquirrelTurnInternal::Hit' has a wrong offset!");
static_assert(offsetof(Summoned_V2_10325101_SquirrelTurnInternal, Vector) == 0x000178, "Member 'Summoned_V2_10325101_SquirrelTurnInternal::Vector' has a wrong offset!");
