...
static_assert(sizeof(LandscapeBlueprintBrushBase_RenderLayer) == 0x000028, "Wrong size on LandscapeBlueprintBrushBase_RenderLayer");
...
static_assert(offsetof(LandscapeBlueprintBrushBase_RenderLayer, ReturnValue) == 0x000020, "Member 'LandscapeBlueprintBrushBase_RenderLayer::ReturnValue' has a wrong offset!");
