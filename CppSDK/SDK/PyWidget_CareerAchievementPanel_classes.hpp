...
public:
	...
	TSubclassOf<class UUserWidget>                AchievementNaviBtn;                                // 0x05E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UProgressBar*                           Bar_AchievementBar;                                // 0x05F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UProgressBar*                           Bar_AchievementBar_Add;                            // 0x05F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UProgressBar*                           Bar_AchievementBar_RealTime;                       // 0x0600(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USlider*                                Slider_Achievement;                                // 0x0608(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMarvelListView*                        ListView_UnitList;                                 // 0x0610(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMarvelVerticalBox*                     VBox_NaviBtn_List;                                 // 0x0618(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USizeBox*                               SizeBox_UnitList;                                  // 0x0620(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Toggle;                                       // 0x0628(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Bar;                                          // 0x0630(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Bar_Exp;                                      // 0x0638(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Bar_Exp_Opacity;                              // 0x0640(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Career_Fade_In;                               // 0x0648(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInputAction*                           NavUpAction;                                       // 0x0650(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInputAction*                           NavDownAction;                                     // 0x0658(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_CareerAchievementPanel) == 0x000660, "Wrong size on UPyWidget_CareerAchievementPanel");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, AchievementNaviBtn) == 0x0005E8, "Member 'UPyWidget_CareerAchievementPanel::AchievementNaviBtn' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Bar_AchievementBar) == 0x0005F0, "Member 'UPyWidget_CareerAchievementPanel::Bar_AchievementBar' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Bar_AchievementBar_Add) == 0x0005F8, "Member 'UPyWidget_CareerAchievementPanel::Bar_AchievementBar_Add' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Bar_AchievementBar_RealTime) == 0x000600, "Member 'UPyWidget_CareerAchievementPanel::Bar_AchievementBar_RealTime' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Slider_Achievement) == 0x000608, "Member 'UPyWidget_CareerAchievementPanel::Slider_Achievement' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, ListView_UnitList) == 0x000610, "Member 'UPyWidget_CareerAchievementPanel::ListView_UnitList' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, VBox_NaviBtn_List) == 0x000618, "Member 'UPyWidget_CareerAchievementPanel::VBox_NaviBtn_List' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, SizeBox_UnitList) == 0x000620, "Member 'UPyWidget_CareerAchievementPanel::SizeBox_UnitList' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Anim_Toggle) == 0x000628, "Member 'UPyWidget_CareerAchievementPanel::Anim_Toggle' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Anim_Bar) == 0x000630, "Member 'UPyWidget_CareerAchievementPanel::Anim_Bar' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Anim_Bar_Exp) == 0x000638, "Member 'UPyWidget_CareerAchievementPanel::Anim_Bar_Exp' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Anim_Bar_Exp_Opacity) == 0x000640, "Member 'UPyWidget_CareerAchievementPanel::Anim_Bar_Exp_Opacity' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, Anim_Career_Fade_In) == 0x000648, "Member 'UPyWidget_CareerAchievementPanel::Anim_Career_Fade_In' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, NavUpAction) == 0x000650, "Member 'UPyWidget_CareerAchievementPanel::NavUpAction' has a wrong offset!");
static_assert(offsetof(UPyWidget_CareerAchievementPanel, NavDownAction) == 0x000658, "Member 'UPyWidget_CareerAchievementPanel::NavDownAction' has a wrong offset!");
