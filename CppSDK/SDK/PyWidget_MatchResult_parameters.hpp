...
static_assert(alignof(PyWidget_MatchResult_OnAnimationStarted) == 0x000008, "Wrong alignment on PyWidget_MatchResult_OnAnimationStarted");
static_assert(sizeof(PyWidget_MatchResult_OnAnimationStarted) == 0x000008, "Wrong size on PyWidget_MatchResult_OnAnimationStarted");
static_assert(offsetof(PyWidget_MatchResult_OnAnimationStarted, Animation) == 0x000000, "Member 'PyWidget_MatchResult_OnAnimationStarted::Animation' has a wrong offset!");
