...
static_assert(sizeof(FAIStimulus) == 0x000060, "Wrong size on FAIStimulus");
...
static_assert(sizeof(FActorPerceptionUpdateInfo) == 0x000070, "Wrong size on FActorPerceptionUpdateInfo");
...
static_assert(offsetof(FEnvTraceData, TraceShape) == 0x000038, "Member 'FEnvTraceData::TraceShape' has a wrong offset!");
static_assert(offsetof(FEnvTraceData, TraceMode) == 0x000039, "Member 'FEnvTraceData::TraceMode' has a wrong offset!");
...
static_assert(sizeof(FEnvQueryInstanceCache) == 0x000190, "Wrong size on FEnvQueryInstanceCache");
...
static_assert(sizeof(FAIDamageEvent) == 0x000058, "Wrong size on FAIDamageEvent");
