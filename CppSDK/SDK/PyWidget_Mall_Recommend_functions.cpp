...
void UPyWidget_Mall_Recommend_Panel::MarvelSetVisible(bool Visible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_Mall_Recommend_Panel", "MarvelSetVisible");

	Params::PyWidget_Mall_Recommend_Panel_MarvelSetVisible Parms{};
