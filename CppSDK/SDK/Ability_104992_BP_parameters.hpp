...
public:
	...
	struct FHitResult                             CallFunc_K2_SetActorRelativeRotation_SweepHitResult; // 0x0128(0x0178)(ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetActorRelativeLocation_SweepHitResult; // 0x02A0(0x0178)(ContainsInstancedReference)
	bool                                          CallFunc_K2_AttachToActor_ReturnValue;             // 0x0418(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Ability_104992_BP_C_OnRep_AttachToChar) == 0x000420, "Wrong size on Ability_104992_BP_C_OnRep_AttachToChar");
...
static_assert(offsetof(Ability_104992_BP_C_OnRep_AttachToChar, CallFunc_K2_SetActorRelativeLocation_SweepHitResult) == 0x0002A0, "Member 'Ability_104992_BP_C_OnRep_AttachToChar::CallFunc_K2_SetActorRelativeLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Ability_104992_BP_C_OnRep_AttachToChar, CallFunc_K2_AttachToActor_ReturnValue) == 0x000418, "Member 'Ability_104992_BP_C_OnRep_AttachToChar::CallFunc_K2_AttachToActor_ReturnValue' has a wrong offset!");
