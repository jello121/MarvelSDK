...
static_assert(sizeof(UPyConfig_102941) == 0x000C60, "Wrong size on UPyConfig_102941");
...
static_assert(offsetof(UPyConfig_102941, LeftAbilityId) == 0x000C48, "Member 'UPyConfig_102941::LeftAbilityId' has a wrong offset!");
static_assert(offsetof(UPyConfig_102941, RightAbilityID) == 0x000C4C, "Member 'UPyConfig_102941::RightAbilityID' has a wrong offset!");
static_assert(offsetof(UPyConfig_102941, MaterialCueTag) == 0x000C50, "Member 'UPyConfig_102941::MaterialCueTag' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           DashingTag;                                        // 0x2A40(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102941) == 0x002A50, "Wrong size on UPyAbility_102941");
static_assert(offsetof(UPyAbility_102941, DashingTag) == 0x002A40, "Member 'UPyAbility_102941::DashingTag' has a wrong offset!");
