...
static_assert(sizeof(UPyAbility_102961) == 0x002A40, "Wrong size on UPyAbility_102961");
...
{
public:
	class UAnimMontage*                           MTAppearLoop;                                      // 0x1050(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAnimMontage*                           MTDisappear;                                       // 0x1058(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Summoner_Loop_10296101) == 0x001060, "Wrong size on APyCue_Summoner_Loop_10296101");
static_assert(offsetof(APyCue_Summoner_Loop_10296101, MTAppearLoop) == 0x001050, "Member 'APyCue_Summoner_Loop_10296101::MTAppearLoop' has a wrong offset!");
static_assert(offsetof(APyCue_Summoner_Loop_10296101, MTDisappear) == 0x001058, "Member 'APyCue_Summoner_Loop_10296101::MTDisappear' has a wrong offset!");
