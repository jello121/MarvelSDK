...
// DelegateFunction PyPayload.PyPayload.PayloadRpcActivate__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct PyPayload_PayloadRpcActivate__DelegateSignature final
{
public:
	class AActor*                                 Control_base;                                      // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PyPayload_PayloadRpcActivate__DelegateSignature) == 0x000008, "Wrong alignment on PyPayload_PayloadRpcActivate__DelegateSignature");
static_assert(sizeof(PyPayload_PayloadRpcActivate__DelegateSignature) == 0x000008, "Wrong size on PyPayload_PayloadRpcActivate__DelegateSignature");
static_assert(offsetof(PyPayload_PayloadRpcActivate__DelegateSignature, Control_base) == 0x000000, "Member 'PyPayload_PayloadRpcActivate__DelegateSignature::Control_base' has a wrong offset!");
