...
static_assert(sizeof(UAnimSequenceLevelSequenceLink) == 0x000068, "Wrong size on UAnimSequenceLevelSequenceLink");
...
static_assert(sizeof(ULevelSequence) == 0x000228, "Wrong size on ULevelSequence");
static_assert(offsetof(ULevelSequence, MovieScene) == 0x000078, "Member 'ULevelSequence::MovieScene' has a wrong offset!");
static_assert(offsetof(ULevelSequence, ObjectReferences) == 0x000080, "Member 'ULevelSequence::ObjectReferences' has a wrong offset!");
static_assert(offsetof(ULevelSequence, BindingReferences) == 0x0000D0, "Member 'ULevelSequence::BindingReferences' has a wrong offset!");
static_assert(offsetof(ULevelSequence, PossessedObjects) == 0x0001C0, "Member 'ULevelSequence::PossessedObjects' has a wrong offset!");
static_assert(offsetof(ULevelSequence, DirectorClass) == 0x000210, "Member 'ULevelSequence::DirectorClass' has a wrong offset!");
static_assert(offsetof(ULevelSequence, AssetUserData) == 0x000218, "Member 'ULevelSequence::AssetUserData' has a wrong offset!");
...
static_assert(sizeof(ULevelSequenceBurnInOptions) == 0x000068, "Wrong size on ULevelSequenceBurnInOptions");
...
static_assert(offsetof(ULevelSequenceBurnInOptions, Settings) == 0x000060, "Member 'ULevelSequenceBurnInOptions::Settings' has a wrong offset!");
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x0610(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
	class ULevelSequencePlayer*                   SequencePlayer;                                    // 0x0630(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, Transient, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULevelSequence*                         LevelSequenceAsset;                                // 0x0638(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLevelSequenceCameraSettings           CameraSettings;                                    // 0x0640(0x0002)(Edit, BlueprintVisible, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
	uint8                                         Pad_642[0x6];                                      // 0x0642(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class ULevelSequenceBurnInOptions*            BurnInOptions;                                     // 0x0648(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMovieSceneBindingOverrides*            BindingOverrides;                                  // 0x0650(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bAutoPlay : 1;                                     // 0x0658(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideInstanceData : 1;                         // 0x0658(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReplicatePlayback : 1;                            // 0x0658(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_659[0x7];                                      // 0x0659(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                DefaultInstanceData;                               // 0x0660(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_668[0x1];                                      // 0x0668(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bBanEndPlayTearDown;                               // 0x0669(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_66A[0x6];                                      // 0x066A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class ULevelSequenceBurnIn*                   BurnInInstance;                                    // 0x0670(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bShowBurnin;                                       // 0x0678(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_679[0x7];                                      // 0x0679(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FWorldPartitionResolveData             WorldPartitionResolveData;                         // 0x0680(0x0020)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ALevelSequenceActor) == 0x0006A0, "Wrong size on ALevelSequenceActor");
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x000610, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, SequencePlayer) == 0x000630, "Member 'ALevelSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, LevelSequenceAsset) == 0x000638, "Member 'ALevelSequenceActor::LevelSequenceAsset' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, CameraSettings) == 0x000640, "Member 'ALevelSequenceActor::CameraSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInOptions) == 0x000648, "Member 'ALevelSequenceActor::BurnInOptions' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BindingOverrides) == 0x000650, "Member 'ALevelSequenceActor::BindingOverrides' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, DefaultInstanceData) == 0x000660, "Member 'ALevelSequenceActor::DefaultInstanceData' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, bBanEndPlayTearDown) == 0x000669, "Member 'ALevelSequenceActor::bBanEndPlayTearDown' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x000670, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, bShowBurnin) == 0x000678, "Member 'ALevelSequenceActor::bShowBurnin' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, WorldPartitionResolveData) == 0x000680, "Member 'ALevelSequenceActor::WorldPartitionResolveData' has a wrong offset!");
...
static_assert(sizeof(AReplicatedLevelSequenceActor) == 0x0006A0, "Wrong size on AReplicatedLevelSequenceActor");
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x000490, "Wrong size on ULevelSequenceBurnIn");
static_assert(offsetof(ULevelSequenceBurnIn, FrameInformation) == 0x0003B8, "Member 'ULevelSequenceBurnIn::FrameInformation' has a wrong offset!");
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x000488, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
...
static_assert(sizeof(ULevelSequenceDirector) == 0x000040, "Wrong size on ULevelSequenceDirector");
static_assert(offsetof(ULevelSequenceDirector, Player) == 0x000030, "Member 'ULevelSequenceDirector::Player' has a wrong offset!");
static_assert(offsetof(ULevelSequenceDirector, SubSequenceID) == 0x000038, "Member 'ULevelSequenceDirector::SubSequenceID' has a wrong offset!");
static_assert(offsetof(ULevelSequenceDirector, MovieScenePlayerIndex) == 0x00003C, "Member 'ULevelSequenceDirector::MovieScenePlayerIndex' has a wrong offset!");
...
static_assert(sizeof(ULegacyLevelSequenceDirectorBlueprint) == 0x0000B0, "Wrong size on ULegacyLevelSequenceDirectorBlueprint");
...
{
public:
	FMulticastInlineDelegateProperty_             OnCameraCut;                                       // 0x04E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULevelSequencePlayer) == 0x000630, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0004E0, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
...
static_assert(sizeof(ULevelSequenceProjectSettings) == 0x000078, "Wrong size on ULevelSequenceProjectSettings");
static_assert(offsetof(ULevelSequenceProjectSettings, bDefaultLockEngineToDisplayRate) == 0x000048, "Member 'ULevelSequenceProjectSettings::bDefaultLockEngineToDisplayRate' has a wrong offset!");
static_assert(offsetof(ULevelSequenceProjectSettings, DefaultDisplayRate) == 0x000050, "Member 'ULevelSequenceProjectSettings::DefaultDisplayRate' has a wrong offset!");
static_assert(offsetof(ULevelSequenceProjectSettings, DefaultTickResolution) == 0x000060, "Member 'ULevelSequenceProjectSettings::DefaultTickResolution' has a wrong offset!");
static_assert(offsetof(ULevelSequenceProjectSettings, DefaultClockSource) == 0x000070, "Member 'ULevelSequenceProjectSettings::DefaultClockSource' has a wrong offset!");
...
public:
	...
	class ALevelSequenceActor*                    Sequence;                                          // 0x0600(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMediaComponent*                        MediaComponent;                                    // 0x0608(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ServerStartTimeSeconds;                            // 0x0610(0x0004)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ALevelSequenceMediaController) == 0x000620, "Wrong size on ALevelSequenceMediaController");
static_assert(offsetof(ALevelSequenceMediaController, Sequence) == 0x000600, "Member 'ALevelSequenceMediaController::Sequence' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, MediaComponent) == 0x000608, "Member 'ALevelSequenceMediaController::MediaComponent' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, ServerStartTimeSeconds) == 0x000610, "Member 'ALevelSequenceMediaController::ServerStartTimeSeconds' has a wrong offset!");
