...
static_assert(sizeof(UPyUIController_103351) == 0x000CD0, "Wrong size on UPyUIController_103351");
...
// 0x0020 (0x2AC0 - 0x2AA0)
class UPyAbility_103351 : public UMarvelAbility_AimDownSights
{
public:
	FMulticastInlineDelegateProperty_             OnAbilityCommit;                                   // 0x2AA0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAbilityCancel;                                   // 0x2AB0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_103351) == 0x002AC0, "Wrong size on UPyAbility_103351");
static_assert(offsetof(UPyAbility_103351, OnAbilityCommit) == 0x002AA0, "Member 'UPyAbility_103351::OnAbilityCommit' has a wrong offset!");
static_assert(offsetof(UPyAbility_103351, OnAbilityCancel) == 0x002AB0, "Member 'UPyAbility_103351::OnAbilityCancel' has a wrong offset!");
