...
{
public:
	class USummonedAbilitySystemComponent*        AbilitySystemComponent;                            // 0x1370(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ATracePortalCameraActor_101861_BP_C) == 0x001380, "Wrong size on ATracePortalCameraActor_101861_BP_C");
static_assert(offsetof(ATracePortalCameraActor_101861_BP_C, AbilitySystemComponent) == 0x001370, "Member 'ATracePortalCameraActor_101861_BP_C::AbilitySystemComponent' has a wrong offset!");
