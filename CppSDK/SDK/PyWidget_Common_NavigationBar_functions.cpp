...
void UPyWidget_Common_NavigationBar::OnNavWidgetShow__DelegateSignature(int32 Index_0, class UUserWidget* NavWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_Common_NavigationBar", "OnNavWidgetShow__DelegateSignature");

	Params::PyWidget_Common_NavigationBar_OnNavWidgetShow__DelegateSignature Parms{};
...
void UPyWidget_Common_NavigationBar::OnSubNavWidgetShow__DelegateSignature(int32 ParentIndex, int32 ChildIndex, class UUserWidget* NavWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_Common_NavigationBar", "OnSubNavWidgetShow__DelegateSignature");

	Params::PyWidget_Common_NavigationBar_OnSubNavWidgetShow__DelegateSignature Parms{};
