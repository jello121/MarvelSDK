...
static_assert(alignof(UAbility_103231_BP_C) == 0x000008, "Wrong alignment on UAbility_103231_BP_C");
static_assert(sizeof(UAbility_103231_BP_C) == 0x002A58, "Wrong size on UAbility_103231_BP_C");
static_assert(offsetof(UAbility_103231_BP_C, UberGraphFrame) == 0x002A50, "Member 'UAbility_103231_BP_C::UberGraphFrame' has a wrong offset!");
