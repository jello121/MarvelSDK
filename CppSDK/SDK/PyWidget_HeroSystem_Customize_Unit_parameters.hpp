...
static_assert(alignof(PyWidget_HeroSystem_Customize_Unit_OnItemHovered__DelegateSignature) == 0x000008, "Wrong alignment on PyWidget_HeroSystem_Customize_Unit_OnItemHovered__DelegateSignature");
static_assert(sizeof(PyWidget_HeroSystem_Customize_Unit_OnItemHovered__DelegateSignature) == 0x000018, "Wrong size on PyWidget_HeroSystem_Customize_Unit_OnItemHovered__DelegateSignature");
...
static_assert(offsetof(PyWidget_HeroSystem_Customize_Unit_OnItemHovered__DelegateSignature, ItemId) == 0x000008, "Member 'PyWidget_HeroSystem_Customize_Unit_OnItemHovered__DelegateSignature::ItemId' has a wrong offset!");
