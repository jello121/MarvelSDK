...
{
public:
	int32                                         UnitAmount;                                        // 0x1B38(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_AbilityDuration_Top) == 0x001B40, "Wrong size on UPyWidget_AbilityDuration_Top");
static_assert(offsetof(UPyWidget_AbilityDuration_Top, UnitAmount) == 0x001B38, "Member 'UPyWidget_AbilityDuration_Top::UnitAmount' has a wrong offset!");
