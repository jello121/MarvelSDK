...
TArray<struct FHitResult> UEffectiveComponent_10477101_Base::K2_OnPreApplyContainer(const TArray<struct FHitResult>& HitResults)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EffectiveComponent_10477101_Base", "K2_OnPreApplyContainer");

	Params::EffectiveComponent_10477101_Base_K2_OnPreApplyContainer Parms{};
