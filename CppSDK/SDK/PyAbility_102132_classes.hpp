...
static_assert(sizeof(UPyEffectiveComponent_10213201) == 0x001C10, "Wrong size on UPyEffectiveComponent_10213201");
...
static_assert(sizeof(APyProjectile_10213201) == 0x003280, "Wrong size on APyProjectile_10213201");

// PythonClass PyAbility_102132.PyAbility_102132
// 0x0008 (0x2A78 - 0x2A70)
class UPyAbility_102132 : public UPyAbility_102131
{
public:
	bool                                          NeedRedrawSingleWhenLowAmmo;                       // 0x2A70(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102132) == 0x002A78, "Wrong size on UPyAbility_102132");
static_assert(offsetof(UPyAbility_102132, NeedRedrawSingleWhenLowAmmo) == 0x002A70, "Member 'UPyAbility_102132::NeedRedrawSingleWhenLowAmmo' has a wrong offset!");
...
static_assert(sizeof(UPyUIController_102132) == 0x000CD0, "Wrong size on UPyUIController_102132");
...
static_assert(sizeof(APyCue_Projectile_Loop_10213201) == 0x000F88, "Wrong size on APyCue_Projectile_Loop_10213201");
static_assert(offsetof(APyCue_Projectile_Loop_10213201, bIsAttach) == 0x000F70, "Member 'APyCue_Projectile_Loop_10213201::bIsAttach' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10213201, ReleaseFxPoint) == 0x000F74, "Member 'APyCue_Projectile_Loop_10213201::ReleaseFxPoint' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10213201, ReleaseFx) == 0x000F80, "Member 'APyCue_Projectile_Loop_10213201::ReleaseFx' has a wrong offset!");
