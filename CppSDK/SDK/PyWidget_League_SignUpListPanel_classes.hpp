...
static_assert(sizeof(UPyWidget_League_SignUpListPanel) == 0x000610, "Wrong size on UPyWidget_League_SignUpListPanel");
...
static_assert(sizeof(UPyWidget_League_SignUpList_Item) == 0x0005A8, "Wrong size on UPyWidget_League_SignUpList_Item");
