...
// 0x0000 (0x0038 - 0x0038)
class UPyAIAbilityActivation_AbortMoveWhenActive final : public UPyAIAbilityActivationLogicBase
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(sizeof(UPyAIAbilityActivation_CheckCancelSpiderNest) == 0x000050, "Wrong size on UPyAIAbilityActivation_CheckCancelSpiderNest");
