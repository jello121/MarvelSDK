...
{
public:
	class UStaticMeshComponent*                   Shield_StaticMesh3;                                // 0x0B90(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ASummoned_10373101_BP_C) == 0x000BA0, "Wrong size on ASummoned_10373101_BP_C");
static_assert(offsetof(ASummoned_10373101_BP_C, Shield_StaticMesh3) == 0x000B90, "Member 'ASummoned_10373101_BP_C::Shield_StaticMesh3' has a wrong offset!");
