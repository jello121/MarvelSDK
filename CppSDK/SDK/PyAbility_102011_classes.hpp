...
{
public:
	FMulticastInlineDelegateProperty_             OnAddEnergyDispatcher;                             // 0x2A40(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102011) == 0x002A50, "Wrong size on UPyAbility_102011");
static_assert(offsetof(UPyAbility_102011, OnAddEnergyDispatcher) == 0x002A40, "Member 'UPyAbility_102011::OnAddEnergyDispatcher' has a wrong offset!");
