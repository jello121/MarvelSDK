...
static_assert(sizeof(UPyAbility_103852) == 0x002DF0, "Wrong size on UPyAbility_103852");
...
static_assert(sizeof(UPyAbility_103851) == 0x002A40, "Wrong size on UPyAbility_103851");
...
{
public:
	class UFXSystemAsset*                         ExplodeFxSelf;                                     // 0x03F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFXSystemAsset*                         ExplodeFxOther;                                    // 0x0400(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ExpldeFxOffset;                                    // 0x0408(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyCue_Scope_Start_10385101) == 0x000420, "Wrong size on UPyCue_Scope_Start_10385101");
static_assert(offsetof(UPyCue_Scope_Start_10385101, ExplodeFxSelf) == 0x0003F8, "Member 'UPyCue_Scope_Start_10385101::ExplodeFxSelf' has a wrong offset!");
static_assert(offsetof(UPyCue_Scope_Start_10385101, ExplodeFxOther) == 0x000400, "Member 'UPyCue_Scope_Start_10385101::ExplodeFxOther' has a wrong offset!");
static_assert(offsetof(UPyCue_Scope_Start_10385101, ExpldeFxOffset) == 0x000408, "Member 'UPyCue_Scope_Start_10385101::ExpldeFxOffset' has a wrong offset!");
...
static_assert(sizeof(APyCue_Ability_Loop_10385101) == 0x001190, "Wrong size on APyCue_Ability_Loop_10385101");
