...
static_assert(sizeof(UPyUIController_101661) == 0x000CD0, "Wrong size on UPyUIController_101661");
...
static_assert(sizeof(UPyAbility_101661) == 0x002C00, "Wrong size on UPyAbility_101661");
