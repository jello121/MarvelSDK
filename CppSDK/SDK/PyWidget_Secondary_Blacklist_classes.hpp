...
{
public:
	bool                                          IsAvoidTeam;                                       // 0x05E2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_Blacklist_Item, IsAvoidTeam) == 0x0005E2, "Member 'UPyWidget_Blacklist_Item::IsAvoidTeam' has a wrong offset!");
