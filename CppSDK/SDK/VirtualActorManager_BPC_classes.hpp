...
static_assert(sizeof(AVirtualActorManager_BPC_C) == 0x000658, "Wrong size on AVirtualActorManager_BPC_C");
static_assert(offsetof(AVirtualActorManager_BPC_C, DefaultSceneRoot) == 0x000650, "Member 'AVirtualActorManager_BPC_C::DefaultSceneRoot' has a wrong offset!");
