...
// 0x0010 (0x1A10 - 0x1A00)
class ASummoned_10425101_BP_C final : public ASummoned_10425101
{
public:
	class USummonedMovementComponent*             SummonedMovement;                                  // 0x1A00(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ASummoned_10425101_BP_C) == 0x001A10, "Wrong size on ASummoned_10425101_BP_C");
static_assert(offsetof(ASummoned_10425101_BP_C, SummonedMovement) == 0x001A00, "Member 'ASummoned_10425101_BP_C::SummonedMovement' has a wrong offset!");
