...
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x0078(0x0178)(ContainsInstancedReference)
};
...
static_assert(sizeof(BP_ConstraintEmitter_C_SetWebRotation) == 0x0001F0, "Wrong size on BP_ConstraintEmitter_C_SetWebRotation");
