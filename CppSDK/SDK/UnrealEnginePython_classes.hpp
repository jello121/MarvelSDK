...
{
public:
	class FString                                 PythonModule;                                      // 0x05F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PythonClass;                                       // 0x0608(0x0010)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonTickForceDisabled;                           // 0x0618(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonDisableAutoBinding;                          // 0x0619(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyActor) == 0x000630, "Wrong size on APyActor");
static_assert(offsetof(APyActor, PythonModule) == 0x0005F8, "Member 'APyActor::PythonModule' has a wrong offset!");
static_assert(offsetof(APyActor, PythonClass) == 0x000608, "Member 'APyActor::PythonClass' has a wrong offset!");
static_assert(offsetof(APyActor, PythonTickForceDisabled) == 0x000618, "Member 'APyActor::PythonTickForceDisabled' has a wrong offset!");
static_assert(offsetof(APyActor, PythonDisableAutoBinding) == 0x000619, "Member 'APyActor::PythonDisableAutoBinding' has a wrong offset!");
...
{
public:
	class FString                                 PythonModule;                                      // 0x0CC0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PythonClass;                                       // 0x0CD0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonTickForceDisabled;                           // 0x0CE0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonDisableAutoBinding;                          // 0x0CE1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_CE2[0x1E];                                     // 0x0CE2(0x001E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APyCharacter) == 0x000D00, "Wrong size on APyCharacter");
static_assert(offsetof(APyCharacter, PythonModule) == 0x000CC0, "Member 'APyCharacter::PythonModule' has a wrong offset!");
static_assert(offsetof(APyCharacter, PythonClass) == 0x000CD0, "Member 'APyCharacter::PythonClass' has a wrong offset!");
static_assert(offsetof(APyCharacter, PythonTickForceDisabled) == 0x000CE0, "Member 'APyCharacter::PythonTickForceDisabled' has a wrong offset!");
static_assert(offsetof(APyCharacter, PythonDisableAutoBinding) == 0x000CE1, "Member 'APyCharacter::PythonDisableAutoBinding' has a wrong offset!");
...
{
public:
	class FString                                 PythonModule;                                      // 0x06E8(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PythonClass;                                       // 0x06F8(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonTickForceDisabled;                           // 0x0708(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonDisableAutoBinding;                          // 0x0709(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyHUD) == 0x000720, "Wrong size on APyHUD");
static_assert(offsetof(APyHUD, PythonModule) == 0x0006E8, "Member 'APyHUD::PythonModule' has a wrong offset!");
static_assert(offsetof(APyHUD, PythonClass) == 0x0006F8, "Member 'APyHUD::PythonClass' has a wrong offset!");
static_assert(offsetof(APyHUD, PythonTickForceDisabled) == 0x000708, "Member 'APyHUD::PythonTickForceDisabled' has a wrong offset!");
static_assert(offsetof(APyHUD, PythonDisableAutoBinding) == 0x000709, "Member 'APyHUD::PythonDisableAutoBinding' has a wrong offset!");
...
{
public:
	class FString                                 PythonModule;                                      // 0x0698(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PythonClass;                                       // 0x06A8(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonTickForceDisabled;                           // 0x06B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonDisableAutoBinding;                          // 0x06B9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6BA[0x16];                                     // 0x06BA(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APyPawn) == 0x0006D0, "Wrong size on APyPawn");
static_assert(offsetof(APyPawn, PythonModule) == 0x000698, "Member 'APyPawn::PythonModule' has a wrong offset!");
static_assert(offsetof(APyPawn, PythonClass) == 0x0006A8, "Member 'APyPawn::PythonClass' has a wrong offset!");
static_assert(offsetof(APyPawn, PythonTickForceDisabled) == 0x0006B8, "Member 'APyPawn::PythonTickForceDisabled' has a wrong offset!");
static_assert(offsetof(APyPawn, PythonDisableAutoBinding) == 0x0006B9, "Member 'APyPawn::PythonDisableAutoBinding' has a wrong offset!");
