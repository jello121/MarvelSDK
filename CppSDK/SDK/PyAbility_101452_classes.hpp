...
static_assert(sizeof(UPyAbility_101452) == 0x003C80, "Wrong size on UPyAbility_101452");
...
static_assert(sizeof(UPySummonedComp_10145201) == 0x000C30, "Wrong size on UPySummonedComp_10145201");
...
{
public:
	TArray<class AActor*>                         SweepIgnoreActors;                                 // 0x0A70(0x0010)(NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSlideStateChanged;                               // 0x0A80(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APySummoned_10145201) == 0x000A90, "Wrong size on APySummoned_10145201");
static_assert(offsetof(APySummoned_10145201, SweepIgnoreActors) == 0x000A70, "Member 'APySummoned_10145201::SweepIgnoreActors' has a wrong offset!");
static_assert(offsetof(APySummoned_10145201, OnSlideStateChanged) == 0x000A80, "Member 'APySummoned_10145201::OnSlideStateChanged' has a wrong offset!");
...
static_assert(sizeof(APySummoned_Cue_10145201_Loop) == 0x001050, "Wrong size on APySummoned_Cue_10145201_Loop");
