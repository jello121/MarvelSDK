...
public:
	...
	struct FMarvelAbilityTraceContext             TraceContext;                                      // 0x0020(0x1080)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWebScopeDetectInfo) == 0x000010, "Wrong alignment on FWebScopeDetectInfo");
static_assert(sizeof(FWebScopeDetectInfo) == 0x0010A0, "Wrong size on FWebScopeDetectInfo");
