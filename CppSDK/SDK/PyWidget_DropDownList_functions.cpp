...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TArray<struct FLinearColor>             Item_color_list                                        (ConstParm, Parm, OutParm, ReferenceParm)
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TArray<class FString>                   Item_custom_tag_list                                   (ConstParm, Parm, OutParm, ReferenceParm)

void UPyWidget_DropDownList::SetItemCustomeTagList(const TArray<class FString>& Item_custom_tag_list)
{
	static class UFunction* Func = nullptr;
