...
static_assert(sizeof(PyWidget_GMCmdButton_OnCmdRightClicked__DelegateSignature) == 0x000008, "Wrong size on PyWidget_GMCmdButton_OnCmdRightClicked__DelegateSignature");
static_assert(offsetof(PyWidget_GMCmdButton_OnCmdRightClicked__DelegateSignature, ItemObject_0) == 0x000000, "Member 'PyWidget_GMCmdButton_OnCmdRightClicked__DelegateSignature::ItemObject_0' has a wrong offset!");
