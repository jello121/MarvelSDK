...
static_assert(alignof(UPyAbility_103962) == 0x000008, "Wrong alignment on UPyAbility_103962");
static_assert(sizeof(UPyAbility_103962) == 0x002DF0, "Wrong size on UPyAbility_103962");
