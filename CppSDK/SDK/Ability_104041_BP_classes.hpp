...
// 0x0008 (0x2C90 - 0x2C88)
class UAbility_104041_BP_C final : public UAbility_104041
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x2C88(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(alignof(UAbility_104041_BP_C) == 0x000008, "Wrong alignment on UAbility_104041_BP_C");
static_assert(sizeof(UAbility_104041_BP_C) == 0x002C90, "Wrong size on UAbility_104041_BP_C");
static_assert(offsetof(UAbility_104041_BP_C, UberGraphFrame) == 0x002C88, "Member 'UAbility_104041_BP_C::UberGraphFrame' has a wrong offset!");
