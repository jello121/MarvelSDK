...
{
public:
	float                                         LastShootTime;                                     // 0x2A40(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_104553) == 0x002A48, "Wrong size on UPyAbility_104553");
static_assert(offsetof(UPyAbility_104553, LastShootTime) == 0x002A40, "Member 'UPyAbility_104553::LastShootTime' has a wrong offset!");
