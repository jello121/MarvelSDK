...
static_assert(sizeof(UPyAbility_105021) == 0x002B30, "Wrong size on UPyAbility_105021");
...
{
public:
	struct FStaticCue_NiagaraInfo_Instant         EnterStealthNiagaraInfo;                           // 0x0360(0x0038)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyCue_Ability_Instant_10502101) == 0x000398, "Wrong size on UPyCue_Ability_Instant_10502101");
static_assert(offsetof(UPyCue_Ability_Instant_10502101, EnterStealthNiagaraInfo) == 0x000360, "Member 'UPyCue_Ability_Instant_10502101::EnterStealthNiagaraInfo' has a wrong offset!");
