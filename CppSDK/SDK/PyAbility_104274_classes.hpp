...
public:
	...
	struct FMarvelAbilityTraceContext             GroundTraceContext;                                // 0x00A0(0x1080)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMarvelAbilityTraceContext             SpiderWebTraceContext;                             // 0x1120(0x1080)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyConfig_104274) == 0x0021A0, "Wrong size on UPyConfig_104274");
...
static_assert(offsetof(UPyConfig_104274, SpiderWebTraceContext) == 0x001120, "Member 'UPyConfig_104274::SpiderWebTraceContext' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_104274) == 0x002A38, "Wrong size on UPyAbility_104274");
