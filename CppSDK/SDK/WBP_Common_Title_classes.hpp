...
public:
	...
	class UMarvelTextBlock*                       Text_Title_Small;                                  // 0x0610(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Common_Title_C) == 0x000618, "Wrong size on UWBP_Common_Title_C");
...
static_assert(offsetof(UWBP_Common_Title_C, Text_Title_Small) == 0x000610, "Member 'UWBP_Common_Title_C::Text_Title_Small' has a wrong offset!");
