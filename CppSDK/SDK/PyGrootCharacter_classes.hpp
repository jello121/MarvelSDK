...
{
public:
	bool                                          IsBeAttached;                                      // 0x1BE0(0x0001)(BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyGrootCharacter) == 0x001BF0, "Wrong size on APyGrootCharacter");
static_assert(offsetof(APyGrootCharacter, IsBeAttached) == 0x001BE0, "Member 'APyGrootCharacter::IsBeAttached' has a wrong offset!");
