...
{
public:
	class UCanvasPanel*                           Canvas_Panel;                                      // 0x05B8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_SynergyAbility_Tips_Panel_C) == 0x0005C0, "Wrong size on UWBP_SynergyAbility_Tips_Panel_C");
static_assert(offsetof(UWBP_SynergyAbility_Tips_Panel_C, Canvas_Panel) == 0x0005B8, "Member 'UWBP_SynergyAbility_Tips_Panel_C::Canvas_Panel' has a wrong offset!");
