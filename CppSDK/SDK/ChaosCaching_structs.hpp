...
static_assert(sizeof(FCacheEventTrack) == 0x000040, "Wrong size on FCacheEventTrack");
static_assert(offsetof(FCacheEventTrack, Name) == 0x000000, "Member 'FCacheEventTrack::Name' has a wrong offset!");
static_assert(offsetof(FCacheEventTrack, Struct) == 0x000010, "Member 'FCacheEventTrack::Struct' has a wrong offset!");
static_assert(offsetof(FCacheEventTrack, TimeStamps) == 0x000018, "Member 'FCacheEventTrack::TimeStamps' has a wrong offset!");
...
static_assert(sizeof(FObservedComponent) == 0x000190, "Wrong size on FObservedComponent");
static_assert(offsetof(FObservedComponent, CacheName) == 0x000000, "Member 'FObservedComponent::CacheName' has a wrong offset!");
static_assert(offsetof(FObservedComponent, ComponentRef) == 0x000010, "Member 'FObservedComponent::ComponentRef' has a wrong offset!");
static_assert(offsetof(FObservedComponent, SoftComponentRef) == 0x000040, "Member 'FObservedComponent::SoftComponentRef' has a wrong offset!");
static_assert(offsetof(FObservedComponent, bIsSimulating) == 0x000098, "Member 'FObservedComponent::bIsSimulating' has a wrong offset!");
static_assert(offsetof(FObservedComponent, bPlaybackEnabled) == 0x000099, "Member 'FObservedComponent::bPlaybackEnabled' has a wrong offset!");
