...
static_assert(sizeof(APyProjectile_102461) == 0x003270, "Wrong size on APyProjectile_102461");
static_assert(offsetof(APyProjectile_102461, ScopeId) == 0x003260, "Member 'APyProjectile_102461::ScopeId' has a wrong offset!");
...
{
public:
	int32                                         BuffID;                                            // 0x17F0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyScope_10246101) == 0x001800, "Wrong size on APyScope_10246101");
static_assert(offsetof(APyScope_10246101, BuffID) == 0x0017F0, "Member 'APyScope_10246101::BuffID' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnSoulLinkEnemy;                                   // 0x2A40(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102461) == 0x002A50, "Wrong size on UPyAbility_102461");
static_assert(offsetof(UPyAbility_102461, OnSoulLinkEnemy) == 0x002A40, "Member 'UPyAbility_102461::OnSoulLinkEnemy' has a wrong offset!");
...
{
public:
	class UFXSystemAsset*                         LinkLineFXAsset;                                   // 0x1210(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   LinkLineFXPramName;                                // 0x1218(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Buff_10246103) == 0x001228, "Wrong size on APyCue_Buff_10246103");
static_assert(offsetof(APyCue_Buff_10246103, LinkLineFXAsset) == 0x001210, "Member 'APyCue_Buff_10246103::LinkLineFXAsset' has a wrong offset!");
static_assert(offsetof(APyCue_Buff_10246103, LinkLineFXPramName) == 0x001218, "Member 'APyCue_Buff_10246103::LinkLineFXPramName' has a wrong offset!");
...
{
public:
	class UFXSystemAsset*                         GroundFX;                                          // 0x0F70(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         Ignores;                                           // 0x0F78(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	float                                         DecalCheckHeight;                                  // 0x0F88(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Projectile_Loop_10246101) == 0x000F90, "Wrong size on APyCue_Projectile_Loop_10246101");
static_assert(offsetof(APyCue_Projectile_Loop_10246101, GroundFX) == 0x000F70, "Member 'APyCue_Projectile_Loop_10246101::GroundFX' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10246101, Ignores) == 0x000F78, "Member 'APyCue_Projectile_Loop_10246101::Ignores' has a wrong offset!");
static_assert(offsetof(APyCue_Projectile_Loop_10246101, DecalCheckHeight) == 0x000F88, "Member 'APyCue_Projectile_Loop_10246101::DecalCheckHeight' has a wrong offset!");
