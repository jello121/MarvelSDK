...
static_assert(sizeof(IMovieSceneConsoleVariableTrackInterface) == 0x000030, "Wrong size on IMovieSceneConsoleVariableTrackInterface");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnAudioFinished;                                   // 0x0620(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnAudioPlaybackPercent;                            // 0x0630(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
class UMovieSceneMaterialTagTrack final : public UMovieSceneMaterialTrack
{
public:
	uint8                                         Pad_B8[0x10];                                      // 0x00B8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   MaterialTagName;                                   // 0x00C8(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(IMovieSceneConstrainedSection) == 0x000030, "Wrong size on IMovieSceneConstrainedSection");
...
static_assert(sizeof(IMovieSceneParameterSectionExtender) == 0x000030, "Wrong size on IMovieSceneParameterSectionExtender");
...
// 0x0020 (0x0068 - 0x0048)
class UMovieSceneMaterialTagSystem final : public UMovieSceneEntitySystem
{
public:
	uint8                                         Pad_48[0x20];                                      // 0x0048(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             Result;                                            // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             Failure;                                           // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
