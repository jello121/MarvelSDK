...
public:
	...
	TSubclassOf<class UPyWidget_LeagueMRCSignUpCard> WidgetClassSignupCard;                             // 0x06E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UPyWidget_LeagueMRCObverseCard> WidgetClassWatchCard;                              // 0x06E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_LeagueMRCPanel) == 0x0006F0, "Wrong size on UPyWidget_LeagueMRCPanel");
...
static_assert(offsetof(UPyWidget_LeagueMRCPanel, WidgetClassSignupCard) == 0x0006E0, "Member 'UPyWidget_LeagueMRCPanel::WidgetClassSignupCard' has a wrong offset!");
static_assert(offsetof(UPyWidget_LeagueMRCPanel, WidgetClassWatchCard) == 0x0006E8, "Member 'UPyWidget_LeagueMRCPanel::WidgetClassWatchCard' has a wrong offset!");
