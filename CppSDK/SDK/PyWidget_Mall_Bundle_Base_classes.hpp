...
{
public:
	EStoreRowCardType                             WindowType;                                        // 0x05E2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_Mall_Bundle_Base, WindowType) == 0x0005E2, "Member 'UPyWidget_Mall_Bundle_Base::WindowType' has a wrong offset!");
