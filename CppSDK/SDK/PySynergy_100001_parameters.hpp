...
static_assert(sizeof(PyAbility_10000101_OnBondStateChanged) == 0x000138, "Wrong size on PyAbility_10000101_OnBondStateChanged");
...
static_assert(offsetof(PyAbility_10000101_OnBondStateChanged, Triggers) == 0x000128, "Member 'PyAbility_10000101_OnBondStateChanged::Triggers' has a wrong offset!");
...
{
public:
	struct FAttributeModifierParameter            Param;                                             // 0x0000(0x06C0)(ConstParm, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(PyAbility_10000101_OnPlayerKilled) == 0x000008, "Wrong alignment on PyAbility_10000101_OnPlayerKilled");
static_assert(sizeof(PyAbility_10000101_OnPlayerKilled) == 0x0006C0, "Wrong size on PyAbility_10000101_OnPlayerKilled");
