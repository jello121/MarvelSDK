...
static_assert(sizeof(APySpiderManChildActor) == 0x000BD0, "Wrong size on APySpiderManChildActor");
...
static_assert(sizeof(APySpiderManCharacter) == 0x001C30, "Wrong size on APySpiderManCharacter");
