...
public:
	...
	struct FTransform                             Transform;                                         // 0x0180(0x0060)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                LocalLocation;                                     // 0x01E0(0x0018)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPortalSegments                        PortalSegments;                                    // 0x01F8(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
	EWallBuildingEdge                             BuildingEdge;                                      // 0x0248(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFindBuildingPlace) == 0x000250, "Wrong size on FFindBuildingPlace");
static_assert(offsetof(FFindBuildingPlace, HitResult) == 0x000000, "Member 'FFindBuildingPlace::HitResult' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, Transform) == 0x000180, "Member 'FFindBuildingPlace::Transform' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, LocalLocation) == 0x0001E0, "Member 'FFindBuildingPlace::LocalLocation' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, PortalSegments) == 0x0001F8, "Member 'FFindBuildingPlace::PortalSegments' has a wrong offset!");
static_assert(offsetof(FFindBuildingPlace, BuildingEdge) == 0x000248, "Member 'FFindBuildingPlace::BuildingEdge' has a wrong offset!");
