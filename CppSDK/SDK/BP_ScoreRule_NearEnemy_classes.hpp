...
// Package: BP_ScoreRule_NearEnemy
...
// BlueprintGeneratedClass BP_ScoreRule_NearEnemy.BP_ScoreRule_NearEnemy_C
// 0x0000 (0x0060 - 0x0060)
class UBP_ScoreRule_NearEnemy_C final : public UAIScoreModuleRule
{
public:
