...
static_assert(sizeof(ModularSynthLibrary_AddModularSynthPresetToBankAsset) == 0x000100, "Wrong size on ModularSynthLibrary_AddModularSynthPresetToBankAsset");
...
static_assert(offsetof(ModularSynthLibrary_AddModularSynthPresetToBankAsset, PresetName) == 0x0000F0, "Member 'ModularSynthLibrary_AddModularSynthPresetToBankAsset::PresetName' has a wrong offset!");
...
static_assert(sizeof(ModularSynthComponent_SetSynthPreset) == 0x0000E8, "Wrong size on ModularSynthComponent_SetSynthPreset");
