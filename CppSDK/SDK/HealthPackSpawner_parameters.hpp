...
public:
	...
	struct FHitResult                             CallFunc_K2_SetActorLocation_SweepHitResult;       // 0x0048(0x0178)(ContainsInstancedReference)
	...
	struct FHitResult                             CallFunc_K2_SetActorLocation_SweepHitResult_1;     // 0x01F8(0x0178)(ContainsInstancedReference)
	bool                                          CallFunc_K2_SetActorLocation_ReturnValue_1;        // 0x0370(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner) == 0x000378, "Wrong size on HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner");
...
static_assert(offsetof(HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner, CallFunc_K2_SetActorLocation_ReturnValue) == 0x0001C0, "Member 'HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner::CallFunc_K2_SetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner, CallFunc_IsValid_ReturnValue_1) == 0x0001C1, "Member 'HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x0001C8, "Member 'HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner, CallFunc_Subtract_VectorVector_ReturnValue) == 0x0001E0, "Member 'HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner, CallFunc_K2_SetActorLocation_SweepHitResult_1) == 0x0001F8, "Member 'HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner::CallFunc_K2_SetActorLocation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner, CallFunc_K2_SetActorLocation_ReturnValue_1) == 0x000370, "Member 'HealthPackSpawner_C_ExecuteUbergraph_HealthPackSpawner::CallFunc_K2_SetActorLocation_ReturnValue_1' has a wrong offset!");
