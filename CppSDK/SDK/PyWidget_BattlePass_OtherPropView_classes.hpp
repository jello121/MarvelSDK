...
static_assert(offsetof(UPyWidget_BattlePass_OtherPropView, CanvasPanel_Main) == 0x000610, "Member 'UPyWidget_BattlePass_OtherPropView::CanvasPanel_Main' has a wrong offset!");
