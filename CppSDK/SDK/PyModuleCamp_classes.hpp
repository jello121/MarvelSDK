...
public:
	...
	EBattleSide                                   WinnerSide;                                        // 0x0620(0x0001)(BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBattleSide                                   AttackSide;                                        // 0x0621(0x0001)(BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyModuleCamp) == 0x000628, "Wrong size on APyModuleCamp");
static_assert(offsetof(APyModuleCamp, Name_0) == 0x000610, "Member 'APyModuleCamp::Name_0' has a wrong offset!");
static_assert(offsetof(APyModuleCamp, WinnerSide) == 0x000620, "Member 'APyModuleCamp::WinnerSide' has a wrong offset!");
static_assert(offsetof(APyModuleCamp, AttackSide) == 0x000621, "Member 'APyModuleCamp::AttackSide' has a wrong offset!");
