...
void UPyWidget_League_Room::OnSelectMapVisibleChanged(bool bVisible_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_League_Room", "OnSelectMapVisibleChanged");

	Params::PyWidget_League_Room_OnSelectMapVisibleChanged Parms{};
