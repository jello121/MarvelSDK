...
static_assert(sizeof(UPyAbility_104601) == 0x002D80, "Wrong size on UPyAbility_104601");

// PythonClass PyAbility_104601.PyCue_Death_104601
// 0x0058 (0x1818 - 0x17C0)
class APyCue_Death_104601 final : public APyCue_Death_134
{
public:
	TMap<class FString, class UCurveFloat*>       CurveSoulCocoonChangeCloak;                        // 0x17C0(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	int32                                         CloakSlotIndex;                                    // 0x1810(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APyCue_Death_104601) == 0x001818, "Wrong size on APyCue_Death_104601");
static_assert(offsetof(APyCue_Death_104601, CurveSoulCocoonChangeCloak) == 0x0017C0, "Member 'APyCue_Death_104601::CurveSoulCocoonChangeCloak' has a wrong offset!");
static_assert(offsetof(APyCue_Death_104601, CloakSlotIndex) == 0x001810, "Member 'APyCue_Death_104601::CloakSlotIndex' has a wrong offset!");
