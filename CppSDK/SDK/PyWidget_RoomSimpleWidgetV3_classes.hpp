...
public:
	...
	FMulticastInlineDelegateProperty_             OnClickedSort;                                     // 0x0620(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)

public:
	void OnClickedSort__DelegateSignature(bool IsAscend, bool IsDefault);
	void OnInitialized();
...
static_assert(sizeof(UPyWidgetListTitleBtn) == 0x000630, "Wrong size on UPyWidgetListTitleBtn");
...
static_assert(offsetof(UPyWidgetListTitleBtn, OnClickedSort) == 0x000620, "Member 'UPyWidgetListTitleBtn::OnClickedSort' has a wrong offset!");
