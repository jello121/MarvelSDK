...
static_assert(sizeof(APyCue_Ability_Loop_10499101) == 0x001120, "Wrong size on APyCue_Ability_Loop_10499101");

// PythonClass PyAbility_104991.PyConfig_104991
// 0x10A0 (0x35F0 - 0x2550)
class UPyConfig_104991 final : public UConfig_104991
{
public:
	struct FVector                                CapsuleLocationOffset;                             // 0x2550(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2568[0x8];                                     // 0x2568(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMarvelAbilityTraceContext             TraceContext;                                      // 0x2570(0x1080)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyConfig_104991) == 0x0035F0, "Wrong size on UPyConfig_104991");
static_assert(offsetof(UPyConfig_104991, CapsuleLocationOffset) == 0x002550, "Member 'UPyConfig_104991::CapsuleLocationOffset' has a wrong offset!");
static_assert(offsetof(UPyConfig_104991, TraceContext) == 0x002570, "Member 'UPyConfig_104991::TraceContext' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_104991) == 0x003350, "Wrong size on UPyAbility_104991");
