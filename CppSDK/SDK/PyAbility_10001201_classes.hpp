...
static_assert(sizeof(APyCue_Buff_Loop_10001201) == 0x001210, "Wrong size on APyCue_Buff_Loop_10001201");
...
{
public:
	TArray<int32>                                 GiftedAbilityIDs;                                  // 0x1408(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyBuffAbility_10001201) == 0x001418, "Wrong size on UPyBuffAbility_10001201");
static_assert(offsetof(UPyBuffAbility_10001201, GiftedAbilityIDs) == 0x001408, "Member 'UPyBuffAbility_10001201::GiftedAbilityIDs' has a wrong offset!");
