...
static_assert(sizeof(ANiagaraUIActor) == 0x0005F8, "Wrong size on ANiagaraUIActor");
...
static_assert(sizeof(UNiagaraUIComponent) == 0x000C10, "Wrong size on UNiagaraUIComponent");
