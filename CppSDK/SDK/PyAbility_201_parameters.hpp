...
public:
	...
	struct FHitResult                             InHitResult;                                       // 0x0010(0x0178)(ConstParm, Parm, OutParm, ReferenceParm)
	class AActor*                                 InActor;                                           // 0x0188(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          IsHandleCoolingdown;                               // 0x0190(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_191[0x3];                                      // 0x0191(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           InAbilityTag;                                      // 0x0194(0x000C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
	class FString                                 Handle_type_tag;                                   // 0x01A0(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(PyAbility_201_SetSignalInfo) == 0x000008, "Wrong alignment on PyAbility_201_SetSignalInfo");
static_assert(sizeof(PyAbility_201_SetSignalInfo) == 0x0001B0, "Wrong size on PyAbility_201_SetSignalInfo");
...
static_assert(offsetof(PyAbility_201_SetSignalInfo, InActor) == 0x000188, "Member 'PyAbility_201_SetSignalInfo::InActor' has a wrong offset!");
static_assert(offsetof(PyAbility_201_SetSignalInfo, IsHandleCoolingdown) == 0x000190, "Member 'PyAbility_201_SetSignalInfo::IsHandleCoolingdown' has a wrong offset!");
static_assert(offsetof(PyAbility_201_SetSignalInfo, InAbilityTag) == 0x000194, "Member 'PyAbility_201_SetSignalInfo::InAbilityTag' has a wrong offset!");
static_assert(offsetof(PyAbility_201_SetSignalInfo, Handle_type_tag) == 0x0001A0, "Member 'PyAbility_201_SetSignalInfo::Handle_type_tag' has a wrong offset!");
