...
static_assert(sizeof(AGC_WakandaC02Building003A_Part_BP_C) == 0x000F40, "Wrong size on AGC_WakandaC02Building003A_Part_BP_C");
static_assert(offsetof(AGC_WakandaC02Building003A_Part_BP_C, MainMSField) == 0x000F30, "Member 'AGC_WakandaC02Building003A_Part_BP_C::MainMSField' has a wrong offset!");
