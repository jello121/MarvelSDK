...
{
public:
	ECommonBGType                                 CommonBGType;                                      // 0x05E2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_SecondaryPopupBGUnit, CommonBGType) == 0x0005E2, "Member 'UPyWidget_SecondaryPopupBGUnit::CommonBGType' has a wrong offset!");
