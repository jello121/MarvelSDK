...
static_assert(sizeof(AIAbilityCondition_CouldPass) == 0x000038, "Wrong size on AIAbilityCondition_CouldPass");
...
static_assert(offsetof(AIAbilityCondition_CouldPass, ReturnValue) == 0x000030, "Member 'AIAbilityCondition_CouldPass::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AIAbilityCondition_SummonerCheck_ReceiveCheckIsValidSummoner) == 0x000040, "Wrong size on AIAbilityCondition_SummonerCheck_ReceiveCheckIsValidSummoner");
...
static_assert(offsetof(AIAbilityCondition_SummonerCheck_ReceiveCheckIsValidSummoner, SummonerActor) == 0x000030, "Member 'AIAbilityCondition_SummonerCheck_ReceiveCheckIsValidSummoner::SummonerActor' has a wrong offset!");
static_assert(offsetof(AIAbilityCondition_SummonerCheck_ReceiveCheckIsValidSummoner, ReturnValue) == 0x000038, "Member 'AIAbilityCondition_SummonerCheck_ReceiveCheckIsValidSummoner::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FMarvelAIAutoAbilityTable              AbilityConfig;                                     // 0x0030(0x0240)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FAIAbilityUsage                        AbilityUsage;                                      // 0x0270(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AIAbilitySelectCheckBase_ReceivePostCheck) == 0x000360, "Wrong size on AIAbilitySelectCheckBase_ReceivePostCheck");
...
static_assert(offsetof(AIAbilitySelectCheckBase_ReceivePostCheck, AbilityConfig) == 0x000030, "Member 'AIAbilitySelectCheckBase_ReceivePostCheck::AbilityConfig' has a wrong offset!");
static_assert(offsetof(AIAbilitySelectCheckBase_ReceivePostCheck, AbilityUsage) == 0x000270, "Member 'AIAbilitySelectCheckBase_ReceivePostCheck::AbilityUsage' has a wrong offset!");
static_assert(offsetof(AIAbilitySelectCheckBase_ReceivePostCheck, ReturnValue) == 0x000358, "Member 'AIAbilitySelectCheckBase_ReceivePostCheck::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AIAbilitySelectCheckBase_ReceivePreCheck) == 0x000278, "Wrong size on AIAbilitySelectCheckBase_ReceivePreCheck");
...
static_assert(offsetof(AIAbilitySelectCheckBase_ReceivePreCheck, AbilityConfig) == 0x000030, "Member 'AIAbilitySelectCheckBase_ReceivePreCheck::AbilityConfig' has a wrong offset!");
static_assert(offsetof(AIAbilitySelectCheckBase_ReceivePreCheck, ReturnValue) == 0x000270, "Member 'AIAbilitySelectCheckBase_ReceivePreCheck::ReturnValue' has a wrong offset!");
...
{
public:
	struct FMarvelAIAutoAbilityTable              ReturnValue;                                       // 0x0000(0x0240)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AIAbilityUsageObject_GetUsageConfig) == 0x000240, "Wrong size on AIAbilityUsageObject_GetUsageConfig");
...
static_assert(alignof(AIHeroCustomComponent_OnGameplayTagUpdate) == 0x000004, "Wrong alignment on AIHeroCustomComponent_OnGameplayTagUpdate");
static_assert(sizeof(AIHeroCustomComponent_OnGameplayTagUpdate) == 0x000010, "Wrong size on AIHeroCustomComponent_OnGameplayTagUpdate");
static_assert(offsetof(AIHeroCustomComponent_OnGameplayTagUpdate, TagUpdated) == 0x000000, "Member 'AIHeroCustomComponent_OnGameplayTagUpdate::TagUpdated' has a wrong offset!");
static_assert(offsetof(AIHeroCustomComponent_OnGameplayTagUpdate, TagExists) == 0x00000C, "Member 'AIHeroCustomComponent_OnGameplayTagUpdate::TagExists' has a wrong offset!");
...
static_assert(sizeof(AISelectTargetLogicBase_SelectTargetForAbilityCheck) == 0x000098, "Wrong size on AISelectTargetLogicBase_SelectTargetForAbilityCheck");
...
static_assert(offsetof(AISelectTargetLogicBase_SelectTargetForAbilityCheck, OutAITarget) == 0x000030, "Member 'AISelectTargetLogicBase_SelectTargetForAbilityCheck::OutAITarget' has a wrong offset!");
static_assert(offsetof(AISelectTargetLogicBase_SelectTargetForAbilityCheck, ReturnValue) == 0x000090, "Member 'AISelectTargetLogicBase_SelectTargetForAbilityCheck::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AISelectTargetLogicBase_UpdateProjectilePredicateSpeed) == 0x0010C0, "Wrong size on AISelectTargetLogicBase_UpdateProjectilePredicateSpeed");
...
static_assert(offsetof(AISelectTargetLogicBase_UpdateProjectilePredicateSpeed, ReturnValue) == 0x0010B8, "Member 'AISelectTargetLogicBase_UpdateProjectilePredicateSpeed::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AIAbilityUsageLibrary_GetAbilityFromContext) == 0x000038, "Wrong size on AIAbilityUsageLibrary_GetAbilityFromContext");
...
static_assert(offsetof(AIAbilityUsageLibrary_GetAbilityFromContext, ReturnValue) == 0x000030, "Member 'AIAbilityUsageLibrary_GetAbilityFromContext::ReturnValue' has a wrong offset!");
...
public:
	struct FAIAbilityUsage                        AbilityUsage;                                      // 0x0000(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMarvelAIAutoAbilityTable              ReturnValue;                                       // 0x00E8(0x0240)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AIAbilityUsageLibrary_GetUsageConfig) == 0x000328, "Wrong size on AIAbilityUsageLibrary_GetUsageConfig");
...
public:
	struct FRequiredAIDataForAutoAbility          AutoAbilityContext;                                // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	struct FMarvelAIAutoAbilityTable              OutUsageConfig;                                    // 0x0030(0x0240)(Parm, OutParm, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0270(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_271[0x7];                                      // 0x0271(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(AIAbilityUsageLibrary_GetUsageConfigFromContext) == 0x000278, "Wrong size on AIAbilityUsageLibrary_GetUsageConfigFromContext");
...
static_assert(offsetof(AIAbilityUsageLibrary_GetUsageConfigFromContext, OutUsageConfig) == 0x000030, "Member 'AIAbilityUsageLibrary_GetUsageConfigFromContext::OutUsageConfig' has a wrong offset!");
static_assert(offsetof(AIAbilityUsageLibrary_GetUsageConfigFromContext, ReturnValue) == 0x000270, "Member 'AIAbilityUsageLibrary_GetUsageConfigFromContext::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AIAutoAbilitySolver_TryGetAbilityUsage) == 0x000120, "Wrong size on AIAutoAbilitySolver_TryGetAbilityUsage");
...
static_assert(offsetof(AIAutoAbilitySolver_TryGetAbilityUsage, OutAbilityUsage) == 0x000030, "Member 'AIAutoAbilitySolver_TryGetAbilityUsage::OutAbilityUsage' has a wrong offset!");
static_assert(offsetof(AIAutoAbilitySolver_TryGetAbilityUsage, ReturnValue) == 0x000118, "Member 'AIAutoAbilitySolver_TryGetAbilityUsage::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BTS_UpdateEscortStateNew_OnPreGameMatchEvent) == 0x000001, "Wrong alignment on BTS_UpdateEscortStateNew_OnPreGameMatchEvent");
static_assert(sizeof(BTS_UpdateEscortStateNew_OnPreGameMatchEvent) == 0x000001, "Wrong size on BTS_UpdateEscortStateNew_OnPreGameMatchEvent");
static_assert(offsetof(BTS_UpdateEscortStateNew_OnPreGameMatchEvent, MatchState) == 0x000000, "Member 'BTS_UpdateEscortStateNew_OnPreGameMatchEvent::MatchState' has a wrong offset!");
...
public:
	...
	struct FHitResult                             Hit;                                               // 0x0028(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(BTTask_ChaseTarget_OnActorBump) == 0x000008, "Wrong alignment on BTTask_ChaseTarget_OnActorBump");
static_assert(sizeof(BTTask_ChaseTarget_OnActorBump) == 0x0001A0, "Wrong size on BTTask_ChaseTarget_OnActorBump");
...
static_assert(alignof(MarvelAIAlarmSubsystem_OnActorActivateAbility) == 0x000008, "Wrong alignment on MarvelAIAlarmSubsystem_OnActorActivateAbility");
static_assert(sizeof(MarvelAIAlarmSubsystem_OnActorActivateAbility) == 0x000028, "Wrong size on MarvelAIAlarmSubsystem_OnActorActivateAbility");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorActivateAbility, Source) == 0x000000, "Member 'MarvelAIAlarmSubsystem_OnActorActivateAbility::Source' has a wrong offset!");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorActivateAbility, AbilityID) == 0x000008, "Member 'MarvelAIAlarmSubsystem_OnActorActivateAbility::AbilityID' has a wrong offset!");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorActivateAbility, SessionID) == 0x000010, "Member 'MarvelAIAlarmSubsystem_OnActorActivateAbility::SessionID' has a wrong offset!");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorActivateAbility, SourceAbility) == 0x000020, "Member 'MarvelAIAlarmSubsystem_OnActorActivateAbility::SourceAbility' has a wrong offset!");
...
static_assert(alignof(MarvelAIAlarmSubsystem_OnActorEndAbility) == 0x000008, "Wrong alignment on MarvelAIAlarmSubsystem_OnActorEndAbility");
static_assert(sizeof(MarvelAIAlarmSubsystem_OnActorEndAbility) == 0x000028, "Wrong size on MarvelAIAlarmSubsystem_OnActorEndAbility");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorEndAbility, Source) == 0x000000, "Member 'MarvelAIAlarmSubsystem_OnActorEndAbility::Source' has a wrong offset!");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorEndAbility, AbilityID) == 0x000008, "Member 'MarvelAIAlarmSubsystem_OnActorEndAbility::AbilityID' has a wrong offset!");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorEndAbility, SessionID) == 0x000010, "Member 'MarvelAIAlarmSubsystem_OnActorEndAbility::SessionID' has a wrong offset!");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnActorEndAbility, SourceAbility) == 0x000020, "Member 'MarvelAIAlarmSubsystem_OnActorEndAbility::SourceAbility' has a wrong offset!");
...
static_assert(alignof(MarvelAIAlarmSubsystem_OnMatchStateChange) == 0x000001, "Wrong alignment on MarvelAIAlarmSubsystem_OnMatchStateChange");
static_assert(sizeof(MarvelAIAlarmSubsystem_OnMatchStateChange) == 0x000001, "Wrong size on MarvelAIAlarmSubsystem_OnMatchStateChange");
static_assert(offsetof(MarvelAIAlarmSubsystem_OnMatchStateChange, NewState) == 0x000000, "Member 'MarvelAIAlarmSubsystem_OnMatchStateChange::NewState' has a wrong offset!");
...
static_assert(sizeof(MarvelAIController_K2_GetAIDifficultyConfig) == 0x000210, "Wrong size on MarvelAIController_K2_GetAIDifficultyConfig");
...
static_assert(offsetof(MarvelAIController_K2_GetAIDifficultyConfig, ReturnValue) == 0x000208, "Member 'MarvelAIController_K2_GetAIDifficultyConfig::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_ActivateAbilityUsage) == 0x000040, "Wrong size on MarvelAILibrary_ActivateAbilityUsage");
...
static_assert(offsetof(MarvelAILibrary_ActivateAbilityUsage, UsageID) == 0x000038, "Member 'MarvelAILibrary_ActivateAbilityUsage::UsageID' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_ActivateAbilityUsage, ImitateAILab) == 0x00003C, "Member 'MarvelAILibrary_ActivateAbilityUsage::ImitateAILab' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_ActivateAIUltra) == 0x000008, "Wrong alignment on MarvelAILibrary_ActivateAIUltra");
static_assert(sizeof(MarvelAILibrary_ActivateAIUltra) == 0x000008, "Wrong size on MarvelAILibrary_ActivateAIUltra");
static_assert(offsetof(MarvelAILibrary_ActivateAIUltra, AIController) == 0x000000, "Member 'MarvelAILibrary_ActivateAIUltra::AIController' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_CanFindNavPathBetweenLocations) == 0x000008, "Wrong alignment on MarvelAILibrary_CanFindNavPathBetweenLocations");
static_assert(sizeof(MarvelAILibrary_CanFindNavPathBetweenLocations) == 0x000040, "Wrong size on MarvelAILibrary_CanFindNavPathBetweenLocations");
static_assert(offsetof(MarvelAILibrary_CanFindNavPathBetweenLocations, Controller) == 0x000000, "Member 'MarvelAILibrary_CanFindNavPathBetweenLocations::Controller' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_CanFindNavPathBetweenLocations, StartLocation) == 0x000008, "Member 'MarvelAILibrary_CanFindNavPathBetweenLocations::StartLocation' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_CanFindNavPathBetweenLocations, EndLocation) == 0x000020, "Member 'MarvelAILibrary_CanFindNavPathBetweenLocations::EndLocation' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_CanFindNavPathBetweenLocations, ReturnValue) == 0x000038, "Member 'MarvelAILibrary_CanFindNavPathBetweenLocations::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_CheckInIntRange) == 0x000004, "Wrong alignment on MarvelAILibrary_CheckInIntRange");
static_assert(sizeof(MarvelAILibrary_CheckInIntRange) == 0x000018, "Wrong size on MarvelAILibrary_CheckInIntRange");
static_assert(offsetof(MarvelAILibrary_CheckInIntRange, Range) == 0x000000, "Member 'MarvelAILibrary_CheckInIntRange::Range' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_CheckInIntRange, Num) == 0x000010, "Member 'MarvelAILibrary_CheckInIntRange::Num' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_CheckInIntRange, ReturnValue) == 0x000014, "Member 'MarvelAILibrary_CheckInIntRange::ReturnValue' has a wrong offset!");
...
{
public:
	struct FMarvelAIAutoAbilityTable              Data;                                              // 0x0000(0x0240)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	const class AMarvelAIController*              OwnerController;                                   // 0x0240(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ReturnValue;                                       // 0x0248(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MarvelAILibrary_GetAbilityIDByConfig) == 0x000250, "Wrong size on MarvelAILibrary_GetAbilityIDByConfig");
...
static_assert(offsetof(MarvelAILibrary_GetAbilityIDByConfig, OwnerController) == 0x000240, "Member 'MarvelAILibrary_GetAbilityIDByConfig::OwnerController' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetAbilityIDByConfig, ReturnValue) == 0x000248, "Member 'MarvelAILibrary_GetAbilityIDByConfig::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMarvelAIAutoAbilityTable              ReturnValue;                                       // 0x0008(0x0240)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(MarvelAILibrary_GetAIAutoAbilityConfig) == 0x000248, "Wrong size on MarvelAILibrary_GetAIAutoAbilityConfig");
...
static_assert(sizeof(MarvelAILibrary_GetAIDifficultyConfigByModeAndLevel) == 0x000218, "Wrong size on MarvelAILibrary_GetAIDifficultyConfigByModeAndLevel");
...
static_assert(offsetof(MarvelAILibrary_GetAIDifficultyConfigByModeAndLevel, ReturnValue) == 0x000210, "Member 'MarvelAILibrary_GetAIDifficultyConfigByModeAndLevel::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_GetAIHeroTagLogics) == 0x000008, "Wrong alignment on MarvelAILibrary_GetAIHeroTagLogics");
static_assert(sizeof(MarvelAILibrary_GetAIHeroTagLogics) == 0x000018, "Wrong size on MarvelAILibrary_GetAIHeroTagLogics");
static_assert(offsetof(MarvelAILibrary_GetAIHeroTagLogics, HeroID) == 0x000000, "Member 'MarvelAILibrary_GetAIHeroTagLogics::HeroID' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetAIHeroTagLogics, ReturnValue) == 0x000008, "Member 'MarvelAILibrary_GetAIHeroTagLogics::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_GetMarvelHeroAutoAITable) == 0x000028, "Wrong size on MarvelAILibrary_GetMarvelHeroAutoAITable");
...
static_assert(sizeof(MarvelAILibrary_GetRandomJumpIntervalsScale) == 0x000210, "Wrong size on MarvelAILibrary_GetRandomJumpIntervalsScale");
...
static_assert(offsetof(MarvelAILibrary_GetRandomJumpIntervalsScale, DynamicDifficultyFactor) == 0x000208, "Member 'MarvelAILibrary_GetRandomJumpIntervalsScale::DynamicDifficultyFactor' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetRandomJumpIntervalsScale, ReturnValue) == 0x00020C, "Member 'MarvelAILibrary_GetRandomJumpIntervalsScale::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_IntArrayToString) == 0x000008, "Wrong alignment on MarvelAILibrary_IntArrayToString");
static_assert(sizeof(MarvelAILibrary_IntArrayToString) == 0x000020, "Wrong size on MarvelAILibrary_IntArrayToString");
static_assert(offsetof(MarvelAILibrary_IntArrayToString, IntArray) == 0x000000, "Member 'MarvelAILibrary_IntArrayToString::IntArray' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_IntArrayToString, ReturnValue) == 0x000010, "Member 'MarvelAILibrary_IntArrayToString::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_IsValidAIAutoAbilityConfig) == 0x000248, "Wrong size on MarvelAILibrary_IsValidAIAutoAbilityConfig");
...
static_assert(offsetof(MarvelAILibrary_IsValidAIAutoAbilityConfig, ReturnValue) == 0x000240, "Member 'MarvelAILibrary_IsValidAIAutoAbilityConfig::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_StoreTargetFinalScoreForDebug) == 0x000078, "Wrong size on MarvelAILibrary_StoreTargetFinalScoreForDebug");
...
static_assert(offsetof(MarvelAILibrary_StoreTargetFinalScoreForDebug, HighPrioritySummoners) == 0x000028, "Member 'MarvelAILibrary_StoreTargetFinalScoreForDebug::HighPrioritySummoners' has a wrong offset!");
...
static_assert(alignof(MarvelAISystem_LockNavigationUpdate) == 0x000008, "Wrong alignment on MarvelAISystem_LockNavigationUpdate");
static_assert(sizeof(MarvelAISystem_LockNavigationUpdate) == 0x000010, "Wrong size on MarvelAISystem_LockNavigationUpdate");
static_assert(offsetof(MarvelAISystem_LockNavigationUpdate, WorldContextObject) == 0x000000, "Member 'MarvelAISystem_LockNavigationUpdate::WorldContextObject' has a wrong offset!");
static_assert(offsetof(MarvelAISystem_LockNavigationUpdate, bLock) == 0x000008, "Member 'MarvelAISystem_LockNavigationUpdate::bLock' has a wrong offset!");
...
static_assert(alignof(MarvelAISystem_IsGameOver) == 0x000001, "Wrong alignment on MarvelAISystem_IsGameOver");
static_assert(sizeof(MarvelAISystem_IsGameOver) == 0x000001, "Wrong size on MarvelAISystem_IsGameOver");
static_assert(offsetof(MarvelAISystem_IsGameOver, ReturnValue) == 0x000000, "Member 'MarvelAISystem_IsGameOver::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAISystem_IsInRound) == 0x000001, "Wrong alignment on MarvelAISystem_IsInRound");
static_assert(sizeof(MarvelAISystem_IsInRound) == 0x000001, "Wrong size on MarvelAISystem_IsInRound");
static_assert(offsetof(MarvelAISystem_IsInRound, ReturnValue) == 0x000000, "Member 'MarvelAISystem_IsInRound::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsActor::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsBool::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsEnum::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsFloat::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsInt::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName) == 0x000048, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsName::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsObject::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator) == 0x000050, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsRotator::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString) == 0x000048, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsString::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector) == 0x000050, "Wrong size on MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector, ReturnValue) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelGetBlackboardValueAsVector::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsBool::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsEnum::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsFloat::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsInt::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName) == 0x000048, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsName::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject) == 0x000040, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsObject::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator) == 0x000050, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsRotator::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString) == 0x000048, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsString::Value' has a wrong offset!");
...
static_assert(alignof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector) == 0x000008, "Wrong alignment on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector");
static_assert(sizeof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector) == 0x000050, "Wrong size on MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector, Controller) == 0x000000, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector::Controller' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector, Key) == 0x000008, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector::Key' has a wrong offset!");
static_assert(offsetof(MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector, Value) == 0x000038, "Member 'MarvelBTFunctionLibrary_MarvelSetBlackboardValueAsVector::Value' has a wrong offset!");
