...
static_assert(offsetof(InterchangeShaderPortsAPI_HasInput, ReturnValue) == 0x000014, "Member 'InterchangeShaderPortsAPI_HasInput::ReturnValue' has a wrong offset!");
