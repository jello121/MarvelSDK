...
static_assert(alignof(PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter) == 0x000008, "Wrong alignment on PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter");
static_assert(sizeof(PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter) == 0x0001C8, "Wrong size on PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter");
static_assert(offsetof(PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter, InFXComponent) == 0x000000, "Member 'PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter::InFXComponent' has a wrong offset!");
static_assert(offsetof(PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter, MyTarget) == 0x000008, "Member 'PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter::MyTarget' has a wrong offset!");
static_assert(offsetof(PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter, Parameters) == 0x000010, "Member 'PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter::Parameters' has a wrong offset!");
...
static_assert(sizeof(PyProjectile_10335201_K2_OnProcessHit) == 0x000178, "Wrong size on PyProjectile_10335201_K2_OnProcessHit");
...
static_assert(sizeof(PyProjectile_10335202_K2_OnBounce) == 0x000190, "Wrong size on PyProjectile_10335202_K2_OnBounce");
...
static_assert(offsetof(PyProjectile_10335202_K2_OnBounce, ImpactVelocity) == 0x000178, "Member 'PyProjectile_10335202_K2_OnBounce::ImpactVelocity' has a wrong offset!");
