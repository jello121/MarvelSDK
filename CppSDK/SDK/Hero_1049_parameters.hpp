...
static_assert(alignof(EffectiveComponent_10491101_Base_GetConfig_104911) == 0x000008, "Wrong alignment on EffectiveComponent_10491101_Base_GetConfig_104911");
static_assert(sizeof(EffectiveComponent_10491101_Base_GetConfig_104911) == 0x000008, "Wrong size on EffectiveComponent_10491101_Base_GetConfig_104911");
static_assert(offsetof(EffectiveComponent_10491101_Base_GetConfig_104911, ReturnValue) == 0x000000, "Member 'EffectiveComponent_10491101_Base_GetConfig_104911::ReturnValue' has a wrong offset!");
...
static_assert(alignof(Ability_104971_OnPredictingClientGrabTargetPredictFailed) == 0x000008, "Wrong alignment on Ability_104971_OnPredictingClientGrabTargetPredictFailed");
static_assert(sizeof(Ability_104971_OnPredictingClientGrabTargetPredictFailed) == 0x000008, "Wrong size on Ability_104971_OnPredictingClientGrabTargetPredictFailed");
static_assert(offsetof(Ability_104971_OnPredictingClientGrabTargetPredictFailed, InCharacter) == 0x000000, "Member 'Ability_104971_OnPredictingClientGrabTargetPredictFailed::InCharacter' has a wrong offset!");
...
static_assert(alignof(Ability_104971_ResetShiftJumpParameters) == 0x000001, "Wrong alignment on Ability_104971_ResetShiftJumpParameters");
static_assert(sizeof(Ability_104971_ResetShiftJumpParameters) == 0x000001, "Wrong size on Ability_104971_ResetShiftJumpParameters");
static_assert(offsetof(Ability_104971_ResetShiftJumpParameters, bUsePredictionKey) == 0x000000, "Member 'Ability_104971_ResetShiftJumpParameters::bUsePredictionKey' has a wrong offset!");
