...
{
public:
	int32                                         AIDiff;                                            // 0x08F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8FC[0x4];                                      // 0x08FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             AIDiffChange;                                      // 0x0900(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_Squad_RecommendAIDifficulty) == 0x000910, "Wrong size on UPyWidget_Squad_RecommendAIDifficulty");
static_assert(offsetof(UPyWidget_Squad_RecommendAIDifficulty, AIDiff) == 0x0008F8, "Member 'UPyWidget_Squad_RecommendAIDifficulty::AIDiff' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_RecommendAIDifficulty, AIDiffChange) == 0x000900, "Member 'UPyWidget_Squad_RecommendAIDifficulty::AIDiffChange' has a wrong offset!");
...
public:
	...
	class UWidgetAnimation*                       Anim_NormalToHover;                                // 0x0620(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_HoverToNormal;                                // 0x0628(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Loop_Stream;                                  // 0x0630(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKey                                   RuleKey_Gamepad;                                   // 0x0638(0x0020)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Text_SkewAmount;                                   // 0x0658(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_Squad_MatchInfo_Card) == 0x000660, "Wrong size on UPyWidget_Squad_MatchInfo_Card");
...
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, ScaleBox_Stream) == 0x000608, "Member 'UPyWidget_Squad_MatchInfo_Card::ScaleBox_Stream' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, Anim_Cancel) == 0x000610, "Member 'UPyWidget_Squad_MatchInfo_Card::Anim_Cancel' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, Anim_Success) == 0x000618, "Member 'UPyWidget_Squad_MatchInfo_Card::Anim_Success' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, Anim_NormalToHover) == 0x000620, "Member 'UPyWidget_Squad_MatchInfo_Card::Anim_NormalToHover' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, Anim_HoverToNormal) == 0x000628, "Member 'UPyWidget_Squad_MatchInfo_Card::Anim_HoverToNormal' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, Anim_Loop_Stream) == 0x000630, "Member 'UPyWidget_Squad_MatchInfo_Card::Anim_Loop_Stream' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, RuleKey_Gamepad) == 0x000638, "Member 'UPyWidget_Squad_MatchInfo_Card::RuleKey_Gamepad' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo_Card, Text_SkewAmount) == 0x000658, "Member 'UPyWidget_Squad_MatchInfo_Card::Text_SkewAmount' has a wrong offset!");
...
public:
	...
	class UWidget*                                Overlay_Match_Time;                                // 0x0618(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Cancel;                                       // 0x0620(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Success;                                      // 0x0628(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidgetAnimation*                       Anim_Press;                                        // 0x0630(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          IsLeagueMatch;                                     // 0x0640(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_641[0x3];                                      // 0x0641(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           Color_Btn_Cancel_Normal;                           // 0x0644(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           Color_Btn_Cancel_Hover;                            // 0x0654(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           Color_Btn_Cancel_Click;                            // 0x0664(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_Squad_MatchInfo) == 0x000678, "Wrong size on UPyWidget_Squad_MatchInfo");
...
static_assert(offsetof(UPyWidget_Squad_MatchInfo, ScaleBox_Stream) == 0x000610, "Member 'UPyWidget_Squad_MatchInfo::ScaleBox_Stream' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Overlay_Match_Time) == 0x000618, "Member 'UPyWidget_Squad_MatchInfo::Overlay_Match_Time' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Anim_Cancel) == 0x000620, "Member 'UPyWidget_Squad_MatchInfo::Anim_Cancel' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Anim_Success) == 0x000628, "Member 'UPyWidget_Squad_MatchInfo::Anim_Success' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Anim_Press) == 0x000630, "Member 'UPyWidget_Squad_MatchInfo::Anim_Press' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Anim_Loop_Stream) == 0x000638, "Member 'UPyWidget_Squad_MatchInfo::Anim_Loop_Stream' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, IsLeagueMatch) == 0x000640, "Member 'UPyWidget_Squad_MatchInfo::IsLeagueMatch' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Color_Btn_Cancel_Normal) == 0x000644, "Member 'UPyWidget_Squad_MatchInfo::Color_Btn_Cancel_Normal' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Color_Btn_Cancel_Hover) == 0x000654, "Member 'UPyWidget_Squad_MatchInfo::Color_Btn_Cancel_Hover' has a wrong offset!");
static_assert(offsetof(UPyWidget_Squad_MatchInfo, Color_Btn_Cancel_Click) == 0x000664, "Member 'UPyWidget_Squad_MatchInfo::Color_Btn_Cancel_Click' has a wrong offset!");
...
static_assert(sizeof(UPyWidget_ConsoleCheckBox) == 0x000930, "Wrong size on UPyWidget_ConsoleCheckBox");
