...
{
public:
	struct FFindBuildingPlace                     InBuildingPlace;                                   // 0x0000(0x0250)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(MarvelWallBuildingActor_AddSuccessorBuildingPlace) == 0x000250, "Wrong size on MarvelWallBuildingActor_AddSuccessorBuildingPlace");
...
static_assert(sizeof(MarvelWallBuildingActor_InitializeWallBuildingData) == 0x000188, "Wrong size on MarvelWallBuildingActor_InitializeWallBuildingData");
...
static_assert(offsetof(MarvelWallBuildingActor_InitializeWallBuildingData, ReturnValue) == 0x000180, "Member 'MarvelWallBuildingActor_InitializeWallBuildingData::ReturnValue' has a wrong offset!");
