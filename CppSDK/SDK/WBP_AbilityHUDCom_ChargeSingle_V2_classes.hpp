...
{
public:
	class UWidgetAnimation*                       Anim_FinishCharge;                                 // 0x0630(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, RepSkip, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_AbilityHUDCom_ChargeSingle_V2_C) == 0x000638, "Wrong size on UWBP_AbilityHUDCom_ChargeSingle_V2_C");
static_assert(offsetof(UWBP_AbilityHUDCom_ChargeSingle_V2_C, Anim_FinishCharge) == 0x000630, "Member 'UWBP_AbilityHUDCom_ChargeSingle_V2_C::Anim_FinishCharge' has a wrong offset!");
