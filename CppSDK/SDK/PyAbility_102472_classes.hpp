...
static_assert(sizeof(UPyUIController_102472) == 0x000CD0, "Wrong size on UPyUIController_102472");
...
{
public:
	bool                                          IsInAttacking;                                     // 0x2A38(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_102472) == 0x002A40, "Wrong size on UPyAbility_102472");
static_assert(offsetof(UPyAbility_102472, IsInAttacking) == 0x002A38, "Member 'UPyAbility_102472::IsInAttacking' has a wrong offset!");
...
static_assert(sizeof(APyCue_ProjectileLoop_10247201) == 0x000F70, "Wrong size on APyCue_ProjectileLoop_10247201");
