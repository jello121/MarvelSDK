...
// Parameters:
// struct FGameplayTag                     EventTag                                               (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TArray<struct FStoneRepInfo_105151>     Points                                                 (ConstParm, Parm, OutParm, ReferenceParm)
...
// Parameters:
// TArray<struct FStoneRepInfo_105151>     TargetPoint                                            (ConstParm, Parm, OutParm, ReferenceParm)

void APySummoned_10515101::OnSpawnRow__DelegateSignature(const TArray<struct FStoneRepInfo_105151>& TargetPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PySummoned_10515101", "OnSpawnRow__DelegateSignature");

	Params::PySummoned_10515101_OnSpawnRow__DelegateSignature Parms{};
