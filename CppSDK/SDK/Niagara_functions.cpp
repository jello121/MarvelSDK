...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int32                                   InNewForcedMipLevel                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNiagaraComponent::SetForceTextureMipLevel(int32 InNewForcedMipLevel)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraComponent", "SetForceTextureMipLevel");

	Params::NiagaraComponent_SetForceTextureMipLevel Parms{};

	Parms.InNewForcedMipLevel = InNewForcedMipLevel;
...
int32 UNiagaraComponent::GetForceTextureMipLevel() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraComponent", "GetForceTextureMipLevel");

	Params::NiagaraComponent_GetForceTextureMipLevel Parms{};
...
bool UNiagaraFunctionLibrary::IsNiagaraHasActiveParticles(class UNiagaraComponent* NiagaraComponent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("NiagaraFunctionLibrary", "IsNiagaraHasActiveParticles");

	Params::NiagaraFunctionLibrary_IsNiagaraHasActiveParticles Parms{};
