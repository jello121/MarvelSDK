...
static_assert(sizeof(UPyBattlePanel) == 0x000668, "Wrong size on UPyBattlePanel");
...
static_assert(offsetof(UPyBattlePanel, TrainingShowHoldTipsDelayTime) == 0x000660, "Member 'UPyBattlePanel::TrainingShowHoldTipsDelayTime' has a wrong offset!");
