...
static_assert(sizeof(UWBP_Setting_Content_Train_C) == 0x000650, "Wrong size on UWBP_Setting_Content_Train_C");
static_assert(offsetof(UWBP_Setting_Content_Train_C, VBox_Panel) == 0x000648, "Member 'UWBP_Setting_Content_Train_C::VBox_Panel' has a wrong offset!");
