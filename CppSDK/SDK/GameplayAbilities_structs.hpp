...
static_assert(sizeof(FPredictionKey) == 0x0000A0, "Wrong size on FPredictionKey");
...
public:
	...
	uint8                                         Pad_8[0x68];                                       // 0x0008(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlayRate;                                          // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Position;                                          // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BlendTime;                                         // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         NextSectionID;                                     // 0x007C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         PlayInstanceId;                                    // 0x007D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bRepPosition : 1;                                  // 0x007E(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         IsStopped : 1;                                     // 0x007E(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         SkipPositionCorrection : 1;                        // 0x007E(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSkipPlayRate : 1;                                 // 0x007E(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_7F[0x1];                                       // 0x007F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        OldAbilityID;                                      // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OldBlendTime;                                      // 0x0084(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         OldPlayInstanceId;                                 // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x1];                                       // 0x0089(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	uint16                                        IntMappedPosition;                                 // 0x008A(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPredictionKey                         PredictionKey;                                     // 0x0090(0x00A0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         SectionIdToPlay;                                   // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_131[0x3];                                      // 0x0131(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        AbilityID;                                         // 0x0134(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayAbilityRepAnimMontage) == 0x000008, "Wrong alignment on FGameplayAbilityRepAnimMontage");
static_assert(sizeof(FGameplayAbilityRepAnimMontage) == 0x000138, "Wrong size on FGameplayAbilityRepAnimMontage");
...
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PlayRate) == 0x000070, "Member 'FGameplayAbilityRepAnimMontage::PlayRate' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, Position) == 0x000074, "Member 'FGameplayAbilityRepAnimMontage::Position' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, BlendTime) == 0x000078, "Member 'FGameplayAbilityRepAnimMontage::BlendTime' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, NextSectionID) == 0x00007C, "Member 'FGameplayAbilityRepAnimMontage::NextSectionID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PlayInstanceId) == 0x00007D, "Member 'FGameplayAbilityRepAnimMontage::PlayInstanceId' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, OldAbilityID) == 0x000080, "Member 'FGameplayAbilityRepAnimMontage::OldAbilityID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, OldBlendTime) == 0x000084, "Member 'FGameplayAbilityRepAnimMontage::OldBlendTime' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, OldPlayInstanceId) == 0x000088, "Member 'FGameplayAbilityRepAnimMontage::OldPlayInstanceId' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, IntMappedPosition) == 0x00008A, "Member 'FGameplayAbilityRepAnimMontage::IntMappedPosition' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PredictionKey) == 0x000090, "Member 'FGameplayAbilityRepAnimMontage::PredictionKey' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, SectionIdToPlay) == 0x000130, "Member 'FGameplayAbilityRepAnimMontage::SectionIdToPlay' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, AbilityID) == 0x000134, "Member 'FGameplayAbilityRepAnimMontage::AbilityID' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueParameters) == 0x0001B8, "Wrong size on FGameplayCueParameters");
...
static_assert(offsetof(FGameplayCueParameters, UID) == 0x000178, "Member 'FGameplayCueParameters::UID' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, BuffID) == 0x00017C, "Member 'FGameplayCueParameters::BuffID' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, bPredictablyRemovePredictedCue) == 0x000180, "Member 'FGameplayCueParameters::bPredictablyRemovePredictedCue' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, TargetAttachComponent) == 0x000184, "Member 'FGameplayCueParameters::TargetAttachComponent' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, bReplicateLocationWhenUsingMinimalRepProxy) == 0x00018C, "Member 'FGameplayCueParameters::bReplicateLocationWhenUsingMinimalRepProxy' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, CustomDynamicDelegate) == 0x0001A0, "Member 'FGameplayCueParameters::CustomDynamicDelegate' has a wrong offset!");
...
public:
	...
	TFieldPath<struct FProperty>                  Attribute;                                         // 0x0010(0x0020)(Edit, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	bool                                          bUsePredictionEffectDuration;                      // 0x0723(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLocalUsePredictionEffectDuration;                 // 0x0724(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayEffectSpec) == 0x000760, "Wrong size on FGameplayEffectSpec");
...
static_assert(offsetof(FGameplayEffectSpec, bInvalidSyncBuff) == 0x000099, "Member 'FGameplayEffectSpec::bInvalidSyncBuff' has a wrong offset!");
...
static_assert(offsetof(FGameplayEffectSpec, UID) == 0x0000A4, "Member 'FGameplayEffectSpec::UID' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, DiffusionMode) == 0x0000A8, "Member 'FGameplayEffectSpec::DiffusionMode' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, DiffusionPeriod) == 0x0000AC, "Member 'FGameplayEffectSpec::DiffusionPeriod' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, CapturedSourceTags) == 0x0000B0, "Member 'FGameplayEffectSpec::CapturedSourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, CapturedTargetTags) == 0x000258, "Member 'FGameplayEffectSpec::CapturedTargetTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, DynamicGrantedTags) == 0x000400, "Member 'FGameplayEffectSpec::DynamicGrantedTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, CancelAbilitiesWithTag) == 0x000468, "Member 'FGameplayEffectSpec::CancelAbilitiesWithTag' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, BlockAbilitiesWithTag) == 0x0004D0, "Member 'FGameplayEffectSpec::BlockAbilitiesWithTag' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, DynamicAssetTags) == 0x000538, "Member 'FGameplayEffectSpec::DynamicAssetTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, Modifiers) == 0x0005A0, "Member 'FGameplayEffectSpec::Modifiers' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, StackCount) == 0x0005B0, "Member 'FGameplayEffectSpec::StackCount' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, GrantedAbilitySpecs) == 0x0005B8, "Member 'FGameplayEffectSpec::GrantedAbilitySpecs' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, DynamicGrantedAbilitySpecs) == 0x0005C8, "Member 'FGameplayEffectSpec::DynamicGrantedAbilitySpecs' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, bReplaceEffectAbilityIfNotChild) == 0x0005D8, "Member 'FGameplayEffectSpec::bReplaceEffectAbilityIfNotChild' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, bOverrideEffectStackRule) == 0x000720, "Member 'FGameplayEffectSpec::bOverrideEffectStackRule' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, bModifierCleanAutoRemove) == 0x000721, "Member 'FGameplayEffectSpec::bModifierCleanAutoRemove' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, bOwnerDeathAutoRemove) == 0x000722, "Member 'FGameplayEffectSpec::bOwnerDeathAutoRemove' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, bUsePredictionEffectDuration) == 0x000723, "Member 'FGameplayEffectSpec::bUsePredictionEffectDuration' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, bLocalUsePredictionEffectDuration) == 0x000724, "Member 'FGameplayEffectSpec::bLocalUsePredictionEffectDuration' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, EffectContext) == 0x000728, "Member 'FGameplayEffectSpec::EffectContext' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, Level) == 0x000740, "Member 'FGameplayEffectSpec::Level' has a wrong offset!");

// ScriptStruct GameplayAbilities.ActiveGameplayEffect
// 0x0910 (0x0928 - 0x0018)
...
public:
	...
	uint8                                         Pad_83D[0xEB];                                     // 0x083D(0x00EB)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveGameplayEffect) == 0x000008, "Wrong alignment on FActiveGameplayEffect");
static_assert(sizeof(FActiveGameplayEffect) == 0x000928, "Wrong size on FActiveGameplayEffect");
...
static_assert(offsetof(FActiveGameplayEffect, PredictionKey) == 0x000780, "Member 'FActiveGameplayEffect::PredictionKey' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, GrantedAbilityHandles) == 0x000820, "Member 'FActiveGameplayEffect::GrantedAbilityHandles' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, StartServerWorldTime) == 0x000830, "Member 'FActiveGameplayEffect::StartServerWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, CachedStartServerWorldTime) == 0x000834, "Member 'FActiveGameplayEffect::CachedStartServerWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, StartWorldTime) == 0x000838, "Member 'FActiveGameplayEffect::StartWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, bIsInhibited) == 0x00083C, "Member 'FActiveGameplayEffect::bIsInhibited' has a wrong offset!");
...
static_assert(sizeof(FActiveGameplayEffectsContainer) == 0x001318, "Wrong size on FActiveGameplayEffectsContainer");
...
static_assert(sizeof(FMinimalReplicationTagOperation) == 0x000140, "Wrong size on FMinimalReplicationTagOperation");
...
static_assert(offsetof(FMinimalReplicationTagOperation, Type) == 0x0000B8, "Member 'FMinimalReplicationTagOperation::Type' has a wrong offset!");
static_assert(offsetof(FMinimalReplicationTagOperation, Tag) == 0x0000BC, "Member 'FMinimalReplicationTagOperation::Tag' has a wrong offset!");
static_assert(offsetof(FMinimalReplicationTagOperation, Count) == 0x0000C8, "Member 'FMinimalReplicationTagOperation::Count' has a wrong offset!");
static_assert(offsetof(FMinimalReplicationTagOperation, Tags) == 0x0000D0, "Member 'FMinimalReplicationTagOperation::Tags' has a wrong offset!");
static_assert(offsetof(FMinimalReplicationTagOperation, Timestamp) == 0x000138, "Member 'FMinimalReplicationTagOperation::Timestamp' has a wrong offset!");
static_assert(offsetof(FMinimalReplicationTagOperation, Status) == 0x00013C, "Member 'FMinimalReplicationTagOperation::Status' has a wrong offset!");
...
static_assert(sizeof(FServerAbilityRPCBatch) == 0x000218, "Wrong size on FServerAbilityRPCBatch");
...
static_assert(offsetof(FServerAbilityRPCBatch, TargetData) == 0x0000A8, "Member 'FServerAbilityRPCBatch::TargetData' has a wrong offset!");
static_assert(offsetof(FServerAbilityRPCBatch, InputPressed) == 0x000210, "Member 'FServerAbilityRPCBatch::InputPressed' has a wrong offset!");
static_assert(offsetof(FServerAbilityRPCBatch, Ended) == 0x000211, "Member 'FServerAbilityRPCBatch::Ended' has a wrong offset!");
static_assert(offsetof(FServerAbilityRPCBatch, Started) == 0x000212, "Member 'FServerAbilityRPCBatch::Started' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityActivationInfo) == 0x000298, "Wrong size on FGameplayAbilityActivationInfo");
...
static_assert(offsetof(FGameplayAbilityActivationInfo, PredictionTimerKey) == 0x0000B0, "Member 'FGameplayAbilityActivationInfo::PredictionTimerKey' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityActivationInfo, PredictionDurationKey) == 0x000150, "Member 'FGameplayAbilityActivationInfo::PredictionDurationKey' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityActivationInfo, PredictionKeyWhenActivated) == 0x0001F8, "Member 'FGameplayAbilityActivationInfo::PredictionKeyWhenActivated' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1AA[0x16];                                     // 0x01AA(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayEffectQuery) == 0x000008, "Wrong alignment on FGameplayEffectQuery");
static_assert(sizeof(FGameplayEffectQuery) == 0x0001C0, "Wrong size on FGameplayEffectQuery");
...
static_assert(sizeof(FGameplayEffectSpecForRPC) == 0x000060, "Wrong size on FGameplayEffectSpecForRPC");
...
static_assert(offsetof(FGameplayEffectSpecForRPC, UID) == 0x000058, "Member 'FGameplayEffectSpecForRPC::UID' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpecForRPC, BuffID) == 0x00005C, "Member 'FGameplayEffectSpecForRPC::BuffID' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilitySpec) == 0x000480, "Wrong size on FGameplayAbilitySpec");
...
static_assert(offsetof(FGameplayAbilitySpec, Level) == 0x0000C8, "Member 'FGameplayAbilitySpec::Level' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, InputID) == 0x0000CC, "Member 'FGameplayAbilitySpec::InputID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, AbilityID) == 0x0000D0, "Member 'FGameplayAbilitySpec::AbilityID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, SourceObject) == 0x0000D4, "Member 'FGameplayAbilitySpec::SourceObject' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, ActiveCount) == 0x0000DC, "Member 'FGameplayAbilitySpec::ActiveCount' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, ActivationInfo) == 0x0000F0, "Member 'FGameplayAbilitySpec::ActivationInfo' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, DynamicAbilityTags) == 0x000388, "Member 'FGameplayAbilitySpec::DynamicAbilityTags' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, NonReplicatedInstances) == 0x0003F0, "Member 'FGameplayAbilitySpec::NonReplicatedInstances' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, ReplicatedInstances) == 0x000400, "Member 'FGameplayAbilitySpec::ReplicatedInstances' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, ActivateOnceImmediately) == 0x000410, "Member 'FGameplayAbilitySpec::ActivateOnceImmediately' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, bConfirmInit) == 0x000411, "Member 'FGameplayAbilitySpec::bConfirmInit' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, AbilityStatus) == 0x000414, "Member 'FGameplayAbilitySpec::AbilityStatus' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, bWasCancelled) == 0x000420, "Member 'FGameplayAbilitySpec::bWasCancelled' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, GameplayEffectHandle) == 0x000424, "Member 'FGameplayAbilitySpec::GameplayEffectHandle' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotifyActorClassArray) == 0x000010, "Wrong size on FGameplayCueNotifyActorClassArray");
...
static_assert(sizeof(FPreallocationInfo) == 0x0000C0, "Wrong size on FPreallocationInfo");
...
static_assert(offsetof(FPreallocationInfo, ClassesNeedingPreallocation) == 0x0000A0, "Member 'FPreallocationInfo::ClassesNeedingPreallocation' has a wrong offset!");
...
static_assert(sizeof(FReplicatedPredictionKeyItem) == 0x0000B8, "Wrong size on FReplicatedPredictionKeyItem");
...
static_assert(sizeof(FActiveGameplayCue) == 0x000288, "Wrong size on FActiveGameplayCue");
...
static_assert(offsetof(FActiveGameplayCue, Parameters) == 0x0000C8, "Member 'FActiveGameplayCue::Parameters' has a wrong offset!");
static_assert(offsetof(FActiveGameplayCue, SeverAddTime) == 0x000280, "Member 'FActiveGameplayCue::SeverAddTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayCue, bPredictivelyRemoved) == 0x000284, "Member 'FActiveGameplayCue::bPredictivelyRemoved' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityRepAnimTimeline) == 0x000030, "Wrong size on FGameplayAbilityRepAnimTimeline");
...
static_assert(sizeof(FGameplayCuePendingExecute) == 0x0002E8, "Wrong size on FGameplayCuePendingExecute");
...
static_assert(offsetof(FGameplayCuePendingExecute, PayloadType) == 0x0000C0, "Member 'FGameplayCuePendingExecute::PayloadType' has a wrong offset!");
static_assert(offsetof(FGameplayCuePendingExecute, OwningComponent) == 0x0000C8, "Member 'FGameplayCuePendingExecute::OwningComponent' has a wrong offset!");
static_assert(offsetof(FGameplayCuePendingExecute, FromSpec) == 0x0000D0, "Member 'FGameplayCuePendingExecute::FromSpec' has a wrong offset!");
static_assert(offsetof(FGameplayCuePendingExecute, CueParameters) == 0x000130, "Member 'FGameplayCuePendingExecute::CueParameters' has a wrong offset!");
...
static_assert(sizeof(FAbilityReconnectParams) == 0x000100, "Wrong size on FAbilityReconnectParams");
...
public:
	...
	bool                                          bHitReplaced;                                      // 0x0180(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayAbilityTargetData_SingleTargetHit) == 0x000188, "Wrong size on FGameplayAbilityTargetData_SingleTargetHit");
...
static_assert(offsetof(FGameplayAbilityTargetData_SingleTargetHit, bHitReplaced) == 0x000180, "Member 'FGameplayAbilityTargetData_SingleTargetHit::bHitReplaced' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotifyData) == 0x000048, "Wrong size on FGameplayCueNotifyData");
...
static_assert(sizeof(FGameplayEffectCustomExecutionParameters) == 0x0001C8, "Wrong size on FGameplayEffectCustomExecutionParameters");
