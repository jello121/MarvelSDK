...
static_assert(offsetof(UPyWidget_BanPickConfirmedUnitBase, IsEmpty) == 0x0005E2, "Member 'UPyWidget_BanPickConfirmedUnitBase::IsEmpty' has a wrong offset!");
...
public:
	...
	float                                         Default_NoStart_Opacity;                           // 0x0648(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_BanPickConfirmedUnit, Default_NoStart_Opacity) == 0x000648, "Member 'UPyWidget_BanPickConfirmedUnit::Default_NoStart_Opacity' has a wrong offset!");
