...
public:
	...
	struct FAttributeModifierParameter            ModifierParameter;                                 // 0x0010(0x06C0)(ConstParm, Parm, OutParm, ReferenceParm)
	struct FGlobalEventExtraData                  ExtraData;                                         // 0x06D0(0x0001)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor)
};
...
static_assert(sizeof(PyBattleStatisticsManager_PyOnActorTakeDamage) == 0x0006D8, "Wrong size on PyBattleStatisticsManager_PyOnActorTakeDamage");
...
static_assert(offsetof(PyBattleStatisticsManager_PyOnActorTakeDamage, ExtraData) == 0x0006D0, "Member 'PyBattleStatisticsManager_PyOnActorTakeDamage::ExtraData' has a wrong offset!");
...
public:
	class AActor*                                 InInstigator;                                      // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 InTarget;                                          // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FAttributeModifierParameter            InModifierParameter;                               // 0x0010(0x06C0)(ConstParm, Parm, OutParm, ReferenceParm)
	struct FGlobalEventExtraData                  ExtraData;                                         // 0x06D0(0x0001)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor)
};
...
static_assert(sizeof(PyBattleStatisticsManager_PyOnActorTakeHealth) == 0x0006D8, "Wrong size on PyBattleStatisticsManager_PyOnActorTakeHealth");
...
static_assert(offsetof(PyBattleStatisticsManager_PyOnActorTakeHealth, ExtraData) == 0x0006D0, "Member 'PyBattleStatisticsManager_PyOnActorTakeHealth::ExtraData' has a wrong offset!");
...
public:
	...
	struct FAttributeModifierParameter            ModifierParameter;                                 // 0x0018(0x06C0)(ConstParm, Parm, OutParm, ReferenceParm)
	struct FDestructionExtraInfo                  ExtraInfo;                                         // 0x06D8(0x0040)(ConstParm, Parm, OutParm, ReferenceParm)
};
...
static_assert(sizeof(PyBattleStatisticsManager_PyOnDestructionTakeDamage) == 0x000718, "Wrong size on PyBattleStatisticsManager_PyOnDestructionTakeDamage");
...
static_assert(offsetof(PyBattleStatisticsManager_PyOnDestructionTakeDamage, ExtraInfo) == 0x0006D8, "Member 'PyBattleStatisticsManager_PyOnDestructionTakeDamage::ExtraInfo' has a wrong offset!");
