...
static_assert(sizeof(FTargetChainSpeedPlantSettings) == 0x00001C, "Wrong size on FTargetChainSpeedPlantSettings");
...
static_assert(offsetof(FTargetChainSpeedPlantSettings, SpeedThreshold) == 0x000010, "Member 'FTargetChainSpeedPlantSettings::SpeedThreshold' has a wrong offset!");
static_assert(offsetof(FTargetChainSpeedPlantSettings, UnplantStiffness) == 0x000014, "Member 'FTargetChainSpeedPlantSettings::UnplantStiffness' has a wrong offset!");
static_assert(offsetof(FTargetChainSpeedPlantSettings, UnplantCriticalDamping) == 0x000018, "Member 'FTargetChainSpeedPlantSettings::UnplantCriticalDamping' has a wrong offset!");
...
static_assert(sizeof(FRetargetProfile) == 0x000110, "Wrong size on FRetargetProfile");
...
static_assert(offsetof(FRetargetProfile, bApplySourceRetargetPose) == 0x000010, "Member 'FRetargetProfile::bApplySourceRetargetPose' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, SourceRetargetPoseName) == 0x000014, "Member 'FRetargetProfile::SourceRetargetPoseName' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, bApplyChainSettings) == 0x000020, "Member 'FRetargetProfile::bApplyChainSettings' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, ChainSettings) == 0x000028, "Member 'FRetargetProfile::ChainSettings' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, bApplyRootSettings) == 0x000078, "Member 'FRetargetProfile::bApplyRootSettings' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, RootSettings) == 0x000080, "Member 'FRetargetProfile::RootSettings' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, bApplyGlobalSettings) == 0x0000E8, "Member 'FRetargetProfile::bApplyGlobalSettings' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, GlobalSettings) == 0x0000EC, "Member 'FRetargetProfile::GlobalSettings' has a wrong offset!");
...
static_assert(sizeof(FIKRigInputSkeleton) == 0x000040, "Wrong size on FIKRigInputSkeleton");
...
static_assert(sizeof(FRetargetChainMap) == 0x000018, "Wrong size on FRetargetChainMap");
static_assert(offsetof(FRetargetChainMap, SourceChain) == 0x000000, "Member 'FRetargetChainMap::SourceChain' has a wrong offset!");
static_assert(offsetof(FRetargetChainMap, TargetChain) == 0x00000C, "Member 'FRetargetChainMap::TargetChain' has a wrong offset!");
...
static_assert(sizeof(FBoneChain) == 0x000040, "Wrong size on FBoneChain");
static_assert(offsetof(FBoneChain, ChainName) == 0x000000, "Member 'FBoneChain::ChainName' has a wrong offset!");
static_assert(offsetof(FBoneChain, StartBone) == 0x00000C, "Member 'FBoneChain::StartBone' has a wrong offset!");
static_assert(offsetof(FBoneChain, EndBone) == 0x000020, "Member 'FBoneChain::EndBone' has a wrong offset!");
static_assert(offsetof(FBoneChain, IKGoalName) == 0x000034, "Member 'FBoneChain::IKGoalName' has a wrong offset!");
...
static_assert(sizeof(FRetargetDefinition) == 0x000020, "Wrong size on FRetargetDefinition");
static_assert(offsetof(FRetargetDefinition, RootBone) == 0x000000, "Member 'FRetargetDefinition::RootBone' has a wrong offset!");
static_assert(offsetof(FRetargetDefinition, BoneChains) == 0x000010, "Member 'FRetargetDefinition::BoneChains' has a wrong offset!");
...
static_assert(offsetof(FIKRigGoal, TransformSource) == 0x00000C, "Member 'FIKRigGoal::TransformSource' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, SourceBone) == 0x000010, "Member 'FIKRigGoal::SourceBone' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_IKRig) == 0x000200, "Wrong size on FAnimNode_IKRig");
static_assert(offsetof(FAnimNode_IKRig, Source) == 0x000070, "Member 'FAnimNode_IKRig::Source' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, RigDefinitionAsset) == 0x000080, "Member 'FAnimNode_IKRig::RigDefinitionAsset' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, Goals) == 0x000088, "Member 'FAnimNode_IKRig::Goals' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, bStartFromRefPose) == 0x000098, "Member 'FAnimNode_IKRig::bStartFromRefPose' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, AlphaInputType) == 0x000099, "Member 'FAnimNode_IKRig::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, bAlphaBoolEnabled) == 0x00009A, "Member 'FAnimNode_IKRig::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, Alpha) == 0x00009C, "Member 'FAnimNode_IKRig::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, AlphaScaleBias) == 0x0000A0, "Member 'FAnimNode_IKRig::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, AlphaBoolBlend) == 0x0000A8, "Member 'FAnimNode_IKRig::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, AlphaCurveName) == 0x0000F0, "Member 'FAnimNode_IKRig::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, AlphaScaleBiasClamp) == 0x0000FC, "Member 'FAnimNode_IKRig::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, IKRigProcessor) == 0x000130, "Member 'FAnimNode_IKRig::IKRigProcessor' has a wrong offset!");
static_assert(offsetof(FAnimNode_IKRig, ActualAlpha) == 0x0001F8, "Member 'FAnimNode_IKRig::ActualAlpha' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RetargetPoseFromMesh) == 0x000200, "Wrong size on FAnimNode_RetargetPoseFromMesh");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, SourceMeshComponent) == 0x000028, "Member 'FAnimNode_RetargetPoseFromMesh::SourceMeshComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, bUseAttachedParent) == 0x000030, "Member 'FAnimNode_RetargetPoseFromMesh::bUseAttachedParent' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, IKRetargeterAsset) == 0x000038, "Member 'FAnimNode_RetargetPoseFromMesh::IKRetargeterAsset' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, CustomRetargetProfile) == 0x000040, "Member 'FAnimNode_RetargetPoseFromMesh::CustomRetargetProfile' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, bSuppressWarnings) == 0x000150, "Member 'FAnimNode_RetargetPoseFromMesh::bSuppressWarnings' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, bCopyCurves) == 0x000151, "Member 'FAnimNode_RetargetPoseFromMesh::bCopyCurves' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, Processor) == 0x000158, "Member 'FAnimNode_RetargetPoseFromMesh::Processor' has a wrong offset!");
...
static_assert(sizeof(FGoalBone) == 0x000014, "Wrong size on FGoalBone");
