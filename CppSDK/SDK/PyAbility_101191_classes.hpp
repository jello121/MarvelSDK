...
static_assert(sizeof(APyCue_Ability_Loop_10119101) == 0x001058, "Wrong size on APyCue_Ability_Loop_10119101");
...
static_assert(sizeof(UPyUIController_101191) == 0x000DF0, "Wrong size on UPyUIController_101191");
...
// 0x0028 (0x2B30 - 0x2B08)
class UPyAbility_101191 : public UAbility_101191
{
public:
	bool                                          IsAttackEnd;                                       // 0x2B08(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B09[0x7];                                     // 0x2B09(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             DelegateGrabEnemyInAir;                            // 0x2B10(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             DelegateOnAttackEnd;                               // 0x2B20(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_101191) == 0x002B30, "Wrong size on UPyAbility_101191");
static_assert(offsetof(UPyAbility_101191, IsAttackEnd) == 0x002B08, "Member 'UPyAbility_101191::IsAttackEnd' has a wrong offset!");
static_assert(offsetof(UPyAbility_101191, DelegateGrabEnemyInAir) == 0x002B10, "Member 'UPyAbility_101191::DelegateGrabEnemyInAir' has a wrong offset!");
static_assert(offsetof(UPyAbility_101191, DelegateOnAttackEnd) == 0x002B20, "Member 'UPyAbility_101191::DelegateOnAttackEnd' has a wrong offset!");
...
{
public:
	float                                         MinActiveAbilityPer;                               // 0x05D8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_AbilityEnergy_101191) == 0x0005E0, "Wrong size on UPyWidget_AbilityEnergy_101191");
static_assert(offsetof(UPyWidget_AbilityEnergy_101191, MinActiveAbilityPer) == 0x0005D8, "Member 'UPyWidget_AbilityEnergy_101191::MinActiveAbilityPer' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           AbilityCueTag;                                     // 0x1478(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_AirGrab_101191) == 0x001488, "Wrong size on UPyAbility_AirGrab_101191");
static_assert(offsetof(UPyAbility_AirGrab_101191, AbilityCueTag) == 0x001478, "Member 'UPyAbility_AirGrab_101191::AbilityCueTag' has a wrong offset!");
...
static_assert(sizeof(APyCue_Ability_Loop_101191_AirGrab) == 0x000FF0, "Wrong size on APyCue_Ability_Loop_101191_AirGrab");
...
static_assert(sizeof(APyCue_Ability_Loop_10119103) == 0x001078, "Wrong size on APyCue_Ability_Loop_10119103");
