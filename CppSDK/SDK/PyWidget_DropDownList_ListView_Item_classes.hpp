...
public:
	...
	class FString                                 ItemCustomeTag;                                    // 0x0078(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	void OnItemClicked__DelegateSignature(int32 ItemId);
	void OnItemHovered__DelegateSignature(bool IsHover_0, int32 ItemId);
	void OnItemPressed__DelegateSignature(bool IsPressed, int32 ItemId);
	void OnInitialized();
	void Destruct();
