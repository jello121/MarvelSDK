...
void UPyWidget_BattlePass_Main::OnVisibleChanged(bool Visible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_BattlePass_Main", "OnVisibleChanged");

	Params::PyWidget_BattlePass_Main_OnVisibleChanged Parms{};
