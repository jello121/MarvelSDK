...
public:
	...
	FMulticastInlineDelegateProperty_             OnSettingsChanged;                                 // 0x0048(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSettingsApplied;                                 // 0x0058(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnhancedInputUserSettings) == 0x000140, "Wrong size on UEnhancedInputUserSettings");
...
static_assert(sizeof(UEnhancedInputComponent) == 0x0001B0, "Wrong size on UEnhancedInputComponent");
...
public:
	...
	FMulticastInlineDelegateProperty_             ControlMappingsRebuiltDelegate;                    // 0x01F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
// 0x0358 (0x0820 - 0x04C8)
class UEnhancedPlayerInput final : public UPlayerInput
{
public:
	TMap<class UInputAction*, struct FKeyConsumptionOptions> KeyConsumptionData;                                // 0x04C8(0x0050)(Protected, NativeAccessSpecifierProtected)
	TMap<class UInputMappingContext*, int32>      AppliedInputContexts;                              // 0x0518(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TArray<struct FEnhancedActionKeyMapping>      EnhancedActionMappings;                            // 0x0568(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_578[0x50];                                     // 0x0578(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UInputAction*, struct FInputActionInstance> ActionInstanceData;                                // 0x05C8(0x0050)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_618[0xA0];                                     // 0x0618(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FKey, struct FVector>             KeysPressedThisTick;                               // 0x06B8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<class UInputAction*, struct FInjectedInputArray> InputsInjectedThisTick;                            // 0x0708(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TSet<class UInputAction*>                     LastInjectedActions;                               // 0x0758(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_7A8[0x78];                                     // 0x07A8(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x000820, "Wrong size on UEnhancedPlayerInput");
static_assert(offsetof(UEnhancedPlayerInput, KeyConsumptionData) == 0x0004C8, "Member 'UEnhancedPlayerInput::KeyConsumptionData' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, AppliedInputContexts) == 0x000518, "Member 'UEnhancedPlayerInput::AppliedInputContexts' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, EnhancedActionMappings) == 0x000568, "Member 'UEnhancedPlayerInput::EnhancedActionMappings' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, ActionInstanceData) == 0x0005C8, "Member 'UEnhancedPlayerInput::ActionInstanceData' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, KeysPressedThisTick) == 0x0006B8, "Member 'UEnhancedPlayerInput::KeysPressedThisTick' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, InputsInjectedThisTick) == 0x000708, "Member 'UEnhancedPlayerInput::InputsInjectedThisTick' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, LastInjectedActions) == 0x000758, "Member 'UEnhancedPlayerInput::LastInjectedActions' has a wrong offset!");
