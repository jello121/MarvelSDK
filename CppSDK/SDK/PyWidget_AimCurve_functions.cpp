...
// PythonFunction PyWidget_AimCurve.PyWidget_GamepadTriggerDeadZoneWidget.OnInitialized
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_GamepadTriggerDeadZoneWidget::OnInitialized()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_GamepadTriggerDeadZoneWidget", "OnInitialized");
...
// PythonFunction PyWidget_AimCurve.PyWidget_DeadZoneExtraSensiCurve.OnInitialized
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_DeadZoneExtraSensiCurve::OnInitialized()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_DeadZoneExtraSensiCurve", "OnInitialized");
