...
static_assert(alignof(PyWidget_DropDownList_ListView_Item_OnItemClicked__DelegateSignature) == 0x000004, "Wrong alignment on PyWidget_DropDownList_ListView_Item_OnItemClicked__DelegateSignature");
static_assert(sizeof(PyWidget_DropDownList_ListView_Item_OnItemClicked__DelegateSignature) == 0x000004, "Wrong size on PyWidget_DropDownList_ListView_Item_OnItemClicked__DelegateSignature");
static_assert(offsetof(PyWidget_DropDownList_ListView_Item_OnItemClicked__DelegateSignature, ItemId) == 0x000000, "Member 'PyWidget_DropDownList_ListView_Item_OnItemClicked__DelegateSignature::ItemId' has a wrong offset!");
...
public:
	...
	int32                                         ItemId;                                            // 0x0004(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
