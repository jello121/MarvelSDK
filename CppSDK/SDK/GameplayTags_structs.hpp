...
static_assert(sizeof(FGameplayTagContainer) == 0x000068, "Wrong size on FGameplayTagContainer");
...
static_assert(sizeof(FGameplayTagTableRow) == 0x000030, "Wrong size on FGameplayTagTableRow");
static_assert(offsetof(FGameplayTagTableRow, Tag) == 0x000010, "Member 'FGameplayTagTableRow::Tag' has a wrong offset!");
static_assert(offsetof(FGameplayTagTableRow, DevComment) == 0x000020, "Member 'FGameplayTagTableRow::DevComment' has a wrong offset!");
...
{
public:
	bool                                          bAllowNonRestrictedChildren;                       // 0x0030(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRestrictedGameplayTagTableRow) == 0x000038, "Wrong size on FRestrictedGameplayTagTableRow");
static_assert(offsetof(FRestrictedGameplayTagTableRow, bAllowNonRestrictedChildren) == 0x000030, "Member 'FRestrictedGameplayTagTableRow::bAllowNonRestrictedChildren' has a wrong offset!");
...
static_assert(sizeof(FGameplayTagNode) == 0x0000B0, "Wrong size on FGameplayTagNode");
