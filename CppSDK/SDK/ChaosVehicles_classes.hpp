...
static_assert(offsetof(UChaosVehicleMovementComponent, Mass) == 0x0001E4, "Member 'UChaosVehicleMovementComponent::Mass' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, bEnableCenterOfMassOverride) == 0x0001E8, "Member 'UChaosVehicleMovementComponent::bEnableCenterOfMassOverride' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, CenterOfMassOverride) == 0x0001F0, "Member 'UChaosVehicleMovementComponent::CenterOfMassOverride' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, ChassisWidth) == 0x000208, "Member 'UChaosVehicleMovementComponent::ChassisWidth' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, ChassisHeight) == 0x00020C, "Member 'UChaosVehicleMovementComponent::ChassisHeight' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DragCoefficient) == 0x000210, "Member 'UChaosVehicleMovementComponent::DragCoefficient' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DownforceCoefficient) == 0x000214, "Member 'UChaosVehicleMovementComponent::DownforceCoefficient' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DragArea) == 0x000218, "Member 'UChaosVehicleMovementComponent::DragArea' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DebugDragMagnitude) == 0x00021C, "Member 'UChaosVehicleMovementComponent::DebugDragMagnitude' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, InertiaTensorScale) == 0x000220, "Member 'UChaosVehicleMovementComponent::InertiaTensorScale' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, SleepThreshold) == 0x000238, "Member 'UChaosVehicleMovementComponent::SleepThreshold' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, SleepSlopeLimit) == 0x00023C, "Member 'UChaosVehicleMovementComponent::SleepSlopeLimit' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, Aerofoils) == 0x000240, "Member 'UChaosVehicleMovementComponent::Aerofoils' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, Thrusters) == 0x000250, "Member 'UChaosVehicleMovementComponent::Thrusters' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, TorqueControl) == 0x000260, "Member 'UChaosVehicleMovementComponent::TorqueControl' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, TargetRotationControl) == 0x0002A0, "Member 'UChaosVehicleMovementComponent::TargetRotationControl' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, StabilizeControl) == 0x0002F8, "Member 'UChaosVehicleMovementComponent::StabilizeControl' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, NetworkPhysicsComponent) == 0x000320, "Member 'UChaosVehicleMovementComponent::NetworkPhysicsComponent' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, ReplicatedState) == 0x000360, "Member 'UChaosVehicleMovementComponent::ReplicatedState' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RawSteeringInput) == 0x00038C, "Member 'UChaosVehicleMovementComponent::RawSteeringInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RawThrottleInput) == 0x000390, "Member 'UChaosVehicleMovementComponent::RawThrottleInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RawBrakeInput) == 0x000394, "Member 'UChaosVehicleMovementComponent::RawBrakeInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RawPitchInput) == 0x000398, "Member 'UChaosVehicleMovementComponent::RawPitchInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RawRollInput) == 0x00039C, "Member 'UChaosVehicleMovementComponent::RawRollInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RawYawInput) == 0x0003A0, "Member 'UChaosVehicleMovementComponent::RawYawInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, SteeringInput) == 0x0003A4, "Member 'UChaosVehicleMovementComponent::SteeringInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, ThrottleInput) == 0x0003A8, "Member 'UChaosVehicleMovementComponent::ThrottleInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, BrakeInput) == 0x0003AC, "Member 'UChaosVehicleMovementComponent::BrakeInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, PitchInput) == 0x0003B0, "Member 'UChaosVehicleMovementComponent::PitchInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RollInput) == 0x0003B4, "Member 'UChaosVehicleMovementComponent::RollInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, YawInput) == 0x0003B8, "Member 'UChaosVehicleMovementComponent::YawInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, HandbrakeInput) == 0x0003BC, "Member 'UChaosVehicleMovementComponent::HandbrakeInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, bRequiresControllerForInputs) == 0x0003C0, "Member 'UChaosVehicleMovementComponent::bRequiresControllerForInputs' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, IdleBrakeInput) == 0x0003C4, "Member 'UChaosVehicleMovementComponent::IdleBrakeInput' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, StopThreshold) == 0x0003C8, "Member 'UChaosVehicleMovementComponent::StopThreshold' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, WrongDirectionThreshold) == 0x0003CC, "Member 'UChaosVehicleMovementComponent::WrongDirectionThreshold' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, ThrottleInputRate) == 0x0003D0, "Member 'UChaosVehicleMovementComponent::ThrottleInputRate' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, BrakeInputRate) == 0x000468, "Member 'UChaosVehicleMovementComponent::BrakeInputRate' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, SteeringInputRate) == 0x000500, "Member 'UChaosVehicleMovementComponent::SteeringInputRate' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, HandbrakeInputRate) == 0x000598, "Member 'UChaosVehicleMovementComponent::HandbrakeInputRate' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, PitchInputRate) == 0x000630, "Member 'UChaosVehicleMovementComponent::PitchInputRate' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, RollInputRate) == 0x0006C8, "Member 'UChaosVehicleMovementComponent::RollInputRate' has a wrong offset!");
...
public:
	...
	struct FVehicleTransmissionConfig             TransmissionSetup;                                 // 0x0AD8(0x0070)(Edit, NativeAccessSpecifierPublic)
	struct FVehicleSteeringConfig                 SteeringSetup;                                     // 0x0B48(0x00D8)(Edit, NativeAccessSpecifierPublic)
	TArray<class UChaosVehicleWheel*>             Wheels;                                            // 0x0C20(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DuplicateTransient, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_C30[0xB0];                                     // 0x0C30(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UChaosWheeledVehicleMovementComponent) == 0x000CE0, "Wrong size on UChaosWheeledVehicleMovementComponent");
...
static_assert(offsetof(UChaosWheeledVehicleMovementComponent, DifferentialSetup) == 0x000AC8, "Member 'UChaosWheeledVehicleMovementComponent::DifferentialSetup' has a wrong offset!");
static_assert(offsetof(UChaosWheeledVehicleMovementComponent, TransmissionSetup) == 0x000AD8, "Member 'UChaosWheeledVehicleMovementComponent::TransmissionSetup' has a wrong offset!");
static_assert(offsetof(UChaosWheeledVehicleMovementComponent, SteeringSetup) == 0x000B48, "Member 'UChaosWheeledVehicleMovementComponent::SteeringSetup' has a wrong offset!");
static_assert(offsetof(UChaosWheeledVehicleMovementComponent, Wheels) == 0x000C20, "Member 'UChaosWheeledVehicleMovementComponent::Wheels' has a wrong offset!");
...
static_assert(sizeof(UVehicleAnimationInstance) == 0x000C40, "Wrong size on UVehicleAnimationInstance");
static_assert(offsetof(UVehicleAnimationInstance, WheeledVehicleComponent) == 0x000C30, "Member 'UVehicleAnimationInstance::WheeledVehicleComponent' has a wrong offset!");
...
{
public:
	class USkeletalMeshComponent*                 Mesh;                                              // 0x0698(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UChaosVehicleMovementComponent*         VehicleMovementComponent;                          // 0x06A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AWheeledVehiclePawn) == 0x0006A8, "Wrong size on AWheeledVehiclePawn");
static_assert(offsetof(AWheeledVehiclePawn, Mesh) == 0x000698, "Member 'AWheeledVehiclePawn::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehiclePawn, VehicleMovementComponent) == 0x0006A0, "Member 'AWheeledVehiclePawn::VehicleMovementComponent' has a wrong offset!");
