...
{
public:
	int32                                         SniperRifleID;                                     // 0x2A38(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyAbility_103312) == 0x002A40, "Wrong size on UPyAbility_103312");
static_assert(offsetof(UPyAbility_103312, SniperRifleID) == 0x002A38, "Member 'UPyAbility_103312::SniperRifleID' has a wrong offset!");
