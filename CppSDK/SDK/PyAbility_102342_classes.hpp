...
static_assert(sizeof(UPyConfig_102342) == 0x000C48, "Wrong size on UPyConfig_102342");
static_assert(offsetof(UPyConfig_102342, DashInfo) == 0x000098, "Member 'UPyConfig_102342::DashInfo' has a wrong offset!");
static_assert(offsetof(UPyConfig_102342, RocketShoesSpeed_Vertical) == 0x000C40, "Member 'UPyConfig_102342::RocketShoesSpeed_Vertical' has a wrong offset!");
static_assert(offsetof(UPyConfig_102342, RocketShoesSpeed_Forward) == 0x000C44, "Member 'UPyConfig_102342::RocketShoesSpeed_Forward' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_102342) == 0x002A38, "Wrong size on UPyAbility_102342");
