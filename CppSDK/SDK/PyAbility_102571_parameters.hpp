...
// PythonFunction PyAbility_102571.PyCue_Scope_Loop_10257101.ReceiveTick
// 0x0004 (0x0004 - 0x0000)
struct PyCue_Scope_Loop_10257101_ReceiveTick final
{
public:
	float                                         DeltaTime;                                         // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PyCue_Scope_Loop_10257101_ReceiveTick) == 0x000004, "Wrong alignment on PyCue_Scope_Loop_10257101_ReceiveTick");
static_assert(sizeof(PyCue_Scope_Loop_10257101_ReceiveTick) == 0x000004, "Wrong size on PyCue_Scope_Loop_10257101_ReceiveTick");
static_assert(offsetof(PyCue_Scope_Loop_10257101_ReceiveTick, DeltaTime) == 0x000000, "Member 'PyCue_Scope_Loop_10257101_ReceiveTick::DeltaTime' has a wrong offset!");

// PythonFunction PyAbility_102571.PyCue_Scope_Loop_10257101.OnExecuteFX
// 0x01C0 (0x01C0 - 0x0000)
struct PyCue_Scope_Loop_10257101_OnExecuteFX final
{
public:
	class AActor*                                 MyTarget;                                          // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                 Parameters;                                        // 0x0008(0x01B8)(ConstParm, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(PyCue_Scope_Loop_10257101_OnExecuteFX) == 0x000008, "Wrong alignment on PyCue_Scope_Loop_10257101_OnExecuteFX");
static_assert(sizeof(PyCue_Scope_Loop_10257101_OnExecuteFX) == 0x0001C0, "Wrong size on PyCue_Scope_Loop_10257101_OnExecuteFX");
static_assert(offsetof(PyCue_Scope_Loop_10257101_OnExecuteFX, MyTarget) == 0x000000, "Member 'PyCue_Scope_Loop_10257101_OnExecuteFX::MyTarget' has a wrong offset!");
static_assert(offsetof(PyCue_Scope_Loop_10257101_OnExecuteFX, Parameters) == 0x000008, "Member 'PyCue_Scope_Loop_10257101_OnExecuteFX::Parameters' has a wrong offset!");
...
static_assert(alignof(PyCue_Ability_Loop_10257101_OnMontageEnded) == 0x000008, "Wrong alignment on PyCue_Ability_Loop_10257101_OnMontageEnded");
static_assert(sizeof(PyCue_Ability_Loop_10257101_OnMontageEnded) == 0x000010, "Wrong size on PyCue_Ability_Loop_10257101_OnMontageEnded");
static_assert(offsetof(PyCue_Ability_Loop_10257101_OnMontageEnded, NotifyName) == 0x000000, "Member 'PyCue_Ability_Loop_10257101_OnMontageEnded::NotifyName' has a wrong offset!");
...
static_assert(alignof(PyAbility_102571_OnSculptChanged) == 0x000004, "Wrong alignment on PyAbility_102571_OnSculptChanged");
static_assert(sizeof(PyAbility_102571_OnSculptChanged) == 0x000004, "Wrong size on PyAbility_102571_OnSculptChanged");
static_assert(offsetof(PyAbility_102571_OnSculptChanged, SculptID) == 0x000000, "Member 'PyAbility_102571_OnSculptChanged::SculptID' has a wrong offset!");
