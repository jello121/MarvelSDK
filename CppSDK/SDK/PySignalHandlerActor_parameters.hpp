...
static_assert(sizeof(PySignalHandlerActor_SetRequestResult) == 0x000198, "Wrong size on PySignalHandlerActor_SetRequestResult");
...
static_assert(sizeof(PySignalHandlerActor_StartHandlerSignal) == 0x000198, "Wrong size on PySignalHandlerActor_StartHandlerSignal");
...
static_assert(sizeof(PySignalHandlerActor_EndHandlerSignal) == 0x000198, "Wrong size on PySignalHandlerActor_EndHandlerSignal");
