...
public:
	...
	class UTexture2D*                             ImgBgMRC;                                          // 0x06D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             ImgBgClash;                                        // 0x06E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_LeagueMRC_RewardPreviewPanel) == 0x0006E8, "Wrong size on UPyWidget_LeagueMRC_RewardPreviewPanel");
...
static_assert(offsetof(UPyWidget_LeagueMRC_RewardPreviewPanel, ImgBgMRC) == 0x0006D8, "Member 'UPyWidget_LeagueMRC_RewardPreviewPanel::ImgBgMRC' has a wrong offset!");
static_assert(offsetof(UPyWidget_LeagueMRC_RewardPreviewPanel, ImgBgClash) == 0x0006E0, "Member 'UPyWidget_LeagueMRC_RewardPreviewPanel::ImgBgClash' has a wrong offset!");
