...
static_assert(sizeof(APyIronManChildActor) == 0x000C10, "Wrong size on APyIronManChildActor");
...
static_assert(sizeof(APyIronManCharacter) == 0x001C00, "Wrong size on APyIronManCharacter");
