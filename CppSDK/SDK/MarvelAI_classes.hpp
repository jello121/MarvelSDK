...
public:
	...
	TSubclassOf<class UAIAbilitySelectCheckBase>  SelectCheckClass;                                  // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         UseIndex;                                          // 0x00F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_FC[0x4];                                       // 0x00FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<TSubclassOf<class UAIAbilitySelectCheckBase>, class UAIAbilitySelectCheckBase*> CheckObjectMap;                                    // 0x0100(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAbilityTacticsTask) == 0x000150, "Wrong size on UAbilityTacticsTask");
static_assert(offsetof(UAbilityTacticsTask, SelectCheckClass) == 0x0000F0, "Member 'UAbilityTacticsTask::SelectCheckClass' has a wrong offset!");
static_assert(offsetof(UAbilityTacticsTask, UseIndex) == 0x0000F8, "Member 'UAbilityTacticsTask::UseIndex' has a wrong offset!");
static_assert(offsetof(UAbilityTacticsTask, CheckObjectMap) == 0x000100, "Member 'UAbilityTacticsTask::CheckObjectMap' has a wrong offset!");
...
public:
	...
	struct FGameplayAITag                         AITag;                                             // 0x0154(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_160[0x10];                                     // 0x0160(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UAIServerRequestServices*               AIServerRequestServices;                           // 0x0170(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxTimeOut;                                        // 0x0178(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAbilityTacticsTask_AILab) == 0x000180, "Wrong size on UAbilityTacticsTask_AILab");
static_assert(offsetof(UAbilityTacticsTask_AILab, AITag) == 0x000154, "Member 'UAbilityTacticsTask_AILab::AITag' has a wrong offset!");
static_assert(offsetof(UAbilityTacticsTask_AILab, AIServerRequestServices) == 0x000170, "Member 'UAbilityTacticsTask_AILab::AIServerRequestServices' has a wrong offset!");
static_assert(offsetof(UAbilityTacticsTask_AILab, MaxTimeOut) == 0x000178, "Member 'UAbilityTacticsTask_AILab::MaxTimeOut' has a wrong offset!");
...
static_assert(sizeof(UAbilityTacticsTask_AutoAbility) == 0x000150, "Wrong size on UAbilityTacticsTask_AutoAbility");
...
static_assert(sizeof(UAbilityTacticsTask_SingleAbility) == 0x000150, "Wrong size on UAbilityTacticsTask_SingleAbility");
...
public:
	...
	TMap<EBattleSide, int32>                      OwnedStateMap;                                     // 0x0628(0x0050)(Protected, NativeAccessSpecifierProtected)
	TArray<class AMarvelAIController*>            OwnedControllerList;                               // 0x0678(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_688[0x4];                                      // 0x0688(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   PointName;                                         // 0x068C(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   Description;                                       // 0x0698(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	EStandPointType                               StandPointType;                                    // 0x06B0(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAIStandPointTeamType                         TeamType;                                          // 0x06B1(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B2[0x2];                                      // 0x06B2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Weight;                                            // 0x06B4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RandomRadius;                                      // 0x06B8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLimitFlyHeight;                                   // 0x06BC(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6BD[0x3];                                      // 0x06BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinFlyHeight;                                      // 0x06C0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxFlyHeight;                                      // 0x06C4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AStandPointBase) == 0x0006C8, "Wrong size on AStandPointBase");
static_assert(offsetof(AStandPointBase, OwnedStateMap) == 0x000628, "Member 'AStandPointBase::OwnedStateMap' has a wrong offset!");
static_assert(offsetof(AStandPointBase, OwnedControllerList) == 0x000678, "Member 'AStandPointBase::OwnedControllerList' has a wrong offset!");
static_assert(offsetof(AStandPointBase, PointName) == 0x00068C, "Member 'AStandPointBase::PointName' has a wrong offset!");
static_assert(offsetof(AStandPointBase, Description) == 0x000698, "Member 'AStandPointBase::Description' has a wrong offset!");
static_assert(offsetof(AStandPointBase, StandPointType) == 0x0006B0, "Member 'AStandPointBase::StandPointType' has a wrong offset!");
static_assert(offsetof(AStandPointBase, TeamType) == 0x0006B1, "Member 'AStandPointBase::TeamType' has a wrong offset!");
static_assert(offsetof(AStandPointBase, Weight) == 0x0006B4, "Member 'AStandPointBase::Weight' has a wrong offset!");
static_assert(offsetof(AStandPointBase, RandomRadius) == 0x0006B8, "Member 'AStandPointBase::RandomRadius' has a wrong offset!");
static_assert(offsetof(AStandPointBase, bLimitFlyHeight) == 0x0006BC, "Member 'AStandPointBase::bLimitFlyHeight' has a wrong offset!");
static_assert(offsetof(AStandPointBase, MinFlyHeight) == 0x0006C0, "Member 'AStandPointBase::MinFlyHeight' has a wrong offset!");
static_assert(offsetof(AStandPointBase, MaxFlyHeight) == 0x0006C4, "Member 'AStandPointBase::MaxFlyHeight' has a wrong offset!");
...
{
public:
	TArray<struct FAbilityUsagePointData>         AbilityDataList;                                   // 0x06C8(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	EBattleSide                                   RequiredBattleSide;                                // 0x06D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bShouldCheckGameplayProgress;                      // 0x06D9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6DA[0x2];                                      // 0x06DA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayProgress                      RequiredGameplayProgress;                          // 0x06DC(0x000C)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FAbilityUsagePointData>         ProcessedAbilityDataList;                          // 0x06E8(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	int32                                         AbilityDataIndex;                                  // 0x06F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PointIndex;                                        // 0x06FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class AActor>                  TargetPositionActor;                               // 0x0700(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAbilityUsageStandPoint) == 0x000730, "Wrong size on AAbilityUsageStandPoint");
static_assert(offsetof(AAbilityUsageStandPoint, AbilityDataList) == 0x0006C8, "Member 'AAbilityUsageStandPoint::AbilityDataList' has a wrong offset!");
static_assert(offsetof(AAbilityUsageStandPoint, RequiredBattleSide) == 0x0006D8, "Member 'AAbilityUsageStandPoint::RequiredBattleSide' has a wrong offset!");
static_assert(offsetof(AAbilityUsageStandPoint, bShouldCheckGameplayProgress) == 0x0006D9, "Member 'AAbilityUsageStandPoint::bShouldCheckGameplayProgress' has a wrong offset!");
static_assert(offsetof(AAbilityUsageStandPoint, RequiredGameplayProgress) == 0x0006DC, "Member 'AAbilityUsageStandPoint::RequiredGameplayProgress' has a wrong offset!");
static_assert(offsetof(AAbilityUsageStandPoint, ProcessedAbilityDataList) == 0x0006E8, "Member 'AAbilityUsageStandPoint::ProcessedAbilityDataList' has a wrong offset!");
static_assert(offsetof(AAbilityUsageStandPoint, AbilityDataIndex) == 0x0006F8, "Member 'AAbilityUsageStandPoint::AbilityDataIndex' has a wrong offset!");
static_assert(offsetof(AAbilityUsageStandPoint, PointIndex) == 0x0006FC, "Member 'AAbilityUsageStandPoint::PointIndex' has a wrong offset!");
static_assert(offsetof(AAbilityUsageStandPoint, TargetPositionActor) == 0x000700, "Member 'AAbilityUsageStandPoint::TargetPositionActor' has a wrong offset!");
...
{
public:
	TArray<struct FNavigationLink>                Links;                                             // 0x0730(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bDoubleLink;                                       // 0x0740(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ALinkedAbilityUsageStandPoint) == 0x000748, "Wrong size on ALinkedAbilityUsageStandPoint");
static_assert(offsetof(ALinkedAbilityUsageStandPoint, Links) == 0x000730, "Member 'ALinkedAbilityUsageStandPoint::Links' has a wrong offset!");
static_assert(offsetof(ALinkedAbilityUsageStandPoint, bDoubleLink) == 0x000740, "Member 'ALinkedAbilityUsageStandPoint::bDoubleLink' has a wrong offset!");
...
{
public:
	class USimpleBoxPlayerCheckComponent*         AICheckArea;                                       // 0x05F8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AAbilityUsageStandPoint*>        RelatedUsagePointConfig;                           // 0x0600(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<int32, struct FAbilityUsagePointCollection> ProcessedUsagePointData;                           // 0x0610(0x0050)(BlueprintVisible, Transient, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AAIActionArea) == 0x000660, "Wrong size on AAIActionArea");
static_assert(offsetof(AAIActionArea, AICheckArea) == 0x0005F8, "Member 'AAIActionArea::AICheckArea' has a wrong offset!");
static_assert(offsetof(AAIActionArea, RelatedUsagePointConfig) == 0x000600, "Member 'AAIActionArea::RelatedUsagePointConfig' has a wrong offset!");
static_assert(offsetof(AAIActionArea, ProcessedUsagePointData) == 0x000610, "Member 'AAIActionArea::ProcessedUsagePointData' has a wrong offset!");
...
{
public:
	class FName                                   AreaName;                                          // 0x05F8(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_604[0x4];                                      // 0x0604(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   Description;                                       // 0x0608(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class UAIBattleAreaFilterBase*                BattleAreaFilter;                                  // 0x0620(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBattleAreaType                               BattleAreaType;                                    // 0x0628(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_629[0x7];                                      // 0x0629(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AStandPointBase*>                StandPointList;                                    // 0x0630(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAIBattleAreaBase) == 0x000640, "Wrong size on AAIBattleAreaBase");
static_assert(offsetof(AAIBattleAreaBase, AreaName) == 0x0005F8, "Member 'AAIBattleAreaBase::AreaName' has a wrong offset!");
static_assert(offsetof(AAIBattleAreaBase, Description) == 0x000608, "Member 'AAIBattleAreaBase::Description' has a wrong offset!");
static_assert(offsetof(AAIBattleAreaBase, BattleAreaFilter) == 0x000620, "Member 'AAIBattleAreaBase::BattleAreaFilter' has a wrong offset!");
static_assert(offsetof(AAIBattleAreaBase, BattleAreaType) == 0x000628, "Member 'AAIBattleAreaBase::BattleAreaType' has a wrong offset!");
static_assert(offsetof(AAIBattleAreaBase, StandPointList) == 0x000630, "Member 'AAIBattleAreaBase::StandPointList' has a wrong offset!");
...
{
public:
	float                                         SwitchPointProbability;                            // 0x0640(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAISniperBattleArea) == 0x000648, "Wrong size on AAISniperBattleArea");
static_assert(offsetof(AAISniperBattleArea, SwitchPointProbability) == 0x000640, "Member 'AAISniperBattleArea::SwitchPointProbability' has a wrong offset!");
...
static_assert(sizeof(AAIDefendBattleArea) == 0x000640, "Wrong size on AAIDefendBattleArea");
...
public:
	...
	TArray<class AActor*>                         SummonedAlliesInView;                              // 0x0120(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         AlliesInView;                                      // 0x0130(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         DangerAroundAllys;                                 // 0x0140(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         DangerAroundEnemies;                               // 0x0150(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	struct FWayPointPath                          WayPointPath;                                      // 0x0160(0x0048)(Edit, BlueprintVisible, EditConst, NativeAccessSpecifierPublic)
	float                                         LastReceiveAILabResponseTime;                      // 0x01A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AILabConnectTimeOutCount;                          // 0x01AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         KeepDistanceInBattle;                              // 0x01B0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAITeamAction                                 AITeamAction;                                      // 0x01B4(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsTeamActionFromSelf;                             // 0x01B5(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B6[0xA];                                      // 0x01B6(0x000A)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnTeamActionChanged;                               // 0x01C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	int32                                         ForbiddenSkillLevel;                               // 0x01D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D4[0x2D4];                                    // 0x01D4(0x02D4)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         AIComboIndex;                                      // 0x04A8(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4AC[0x4];                                      // 0x04AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FString, class UAIAbilityActivationExtraConfig*> ExtraConfigs;                                      // 0x04B0(0x0050)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_500[0xA0];                                     // 0x0500(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	class AMarvelAIController*                    OwnerController;                                   // 0x05A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAIControllerInfo) == 0x0005A8, "Wrong size on UAIControllerInfo");
...
static_assert(offsetof(UAIControllerInfo, SummonedAlliesInView) == 0x000120, "Member 'UAIControllerInfo::SummonedAlliesInView' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, AlliesInView) == 0x000130, "Member 'UAIControllerInfo::AlliesInView' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, DangerAroundAllys) == 0x000140, "Member 'UAIControllerInfo::DangerAroundAllys' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, DangerAroundEnemies) == 0x000150, "Member 'UAIControllerInfo::DangerAroundEnemies' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, WayPointPath) == 0x000160, "Member 'UAIControllerInfo::WayPointPath' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, LastReceiveAILabResponseTime) == 0x0001A8, "Member 'UAIControllerInfo::LastReceiveAILabResponseTime' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, AILabConnectTimeOutCount) == 0x0001AC, "Member 'UAIControllerInfo::AILabConnectTimeOutCount' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, KeepDistanceInBattle) == 0x0001B0, "Member 'UAIControllerInfo::KeepDistanceInBattle' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, AITeamAction) == 0x0001B4, "Member 'UAIControllerInfo::AITeamAction' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, bIsTeamActionFromSelf) == 0x0001B5, "Member 'UAIControllerInfo::bIsTeamActionFromSelf' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, OnTeamActionChanged) == 0x0001C0, "Member 'UAIControllerInfo::OnTeamActionChanged' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, ForbiddenSkillLevel) == 0x0001D0, "Member 'UAIControllerInfo::ForbiddenSkillLevel' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, AIComboIndex) == 0x0004A8, "Member 'UAIControllerInfo::AIComboIndex' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, ExtraConfigs) == 0x0004B0, "Member 'UAIControllerInfo::ExtraConfigs' has a wrong offset!");
static_assert(offsetof(UAIControllerInfo, OwnerController) == 0x0005A0, "Member 'UAIControllerInfo::OwnerController' has a wrong offset!");
...
{
public:
	struct FAIHeroTag                             IgnoreHeroTag;                                     // 0x05F8(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAIGroupInfoBase) == 0x000660, "Wrong size on AAIGroupInfoBase");
static_assert(offsetof(AAIGroupInfoBase, IgnoreHeroTag) == 0x0005F8, "Member 'AAIGroupInfoBase::IgnoreHeroTag' has a wrong offset!");
...
{
public:
	class AMarvelAIController*                    CacheAIOwner;                                      // 0x00F0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMarvelAbilitySystemCom*                CacheOwnerASC;                                     // 0x00F8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<struct FGameplayTag, struct FAIHeroTagLogicConfig> CacheBindingTagLogics;                             // 0x0100(0x0050)(Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAIHeroCustomComponent) == 0x000168, "Wrong size on UAIHeroCustomComponent");
static_assert(offsetof(UAIHeroCustomComponent, CacheAIOwner) == 0x0000F0, "Member 'UAIHeroCustomComponent::CacheAIOwner' has a wrong offset!");
static_assert(offsetof(UAIHeroCustomComponent, CacheOwnerASC) == 0x0000F8, "Member 'UAIHeroCustomComponent::CacheOwnerASC' has a wrong offset!");
static_assert(offsetof(UAIHeroCustomComponent, CacheBindingTagLogics) == 0x000100, "Member 'UAIHeroCustomComponent::CacheBindingTagLogics' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5C[0x1084];                                    // 0x005C(0x1084)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBehindShieldModify) == 0x0010E0, "Wrong size on UBehindShieldModify");
...
static_assert(sizeof(UAILabSubSystem) == 0x0002B0, "Wrong size on UAILabSubSystem");
...
static_assert(sizeof(AAISceneConfigActorBase) == 0x000620, "Wrong size on AAISceneConfigActorBase");
...
// 0x0008 (0x0048 - 0x0040)
class UAIScoreModule_MaxHP final : public UAIScoreModule
{
public:
...
{
public:
	bool                                          bUseBuffIDFilter;                                  // 0x0070(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_71[0x3];                                       // 0x0071(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAISelectTarget_BuffedCharacter, bUseBuffIDFilter) == 0x000070, "Member 'UAISelectTarget_BuffedCharacter::bUseBuffIDFilter' has a wrong offset!");
...
{
public:
	class UAISpawnDataConfig*                     SpawnDataConfig;                                   // 0x0620(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAISpawner) == 0x000628, "Wrong size on AAISpawner");
static_assert(offsetof(AAISpawner, SpawnDataConfig) == 0x000620, "Member 'AAISpawner::SpawnDataConfig' has a wrong offset!");
...
{
public:
	int32                                         MatchState;                                        // 0x0630(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EStrategyType                                 StrategyType;                                      // 0x0634(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EGroupState                                   GroupState;                                        // 0x0638(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AAIStrategyAreaVolume) == 0x000640, "Wrong size on AAIStrategyAreaVolume");
static_assert(offsetof(AAIStrategyAreaVolume, MatchState) == 0x000630, "Member 'AAIStrategyAreaVolume::MatchState' has a wrong offset!");
static_assert(offsetof(AAIStrategyAreaVolume, StrategyType) == 0x000634, "Member 'AAIStrategyAreaVolume::StrategyType' has a wrong offset!");
static_assert(offsetof(AAIStrategyAreaVolume, GroupState) == 0x000638, "Member 'AAIStrategyAreaVolume::GroupState' has a wrong offset!");
...
// 0x01C8 (0x07E0 - 0x0618)
class AMarvelAITeamManager : public AMarvelActorBase
{
public:
	TMap<class AActor*, struct FDateTime>         LowHpMark;                                         // 0x0618(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             AutoChangeHeroDelegate;                            // 0x0668(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMap<int32, struct FMarvelAITeamInfo>         TeamInfos;                                         // 0x0678(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bHasInitTeamInfo;                                  // 0x06C8(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsMatchStart;                                     // 0x06C9(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowRepeatHero;                                  // 0x06CA(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6CB[0x5];                                      // 0x06CB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UMarvelAISystem*                        CacheAISystem;                                     // 0x06D0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMarvelAIGameModeDefaultConfigAsset*    CacheAIGameModeConfig;                             // 0x06D8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<EHeroRole, int32>                        RoleLimits;                                        // 0x06E0(0x0050)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_730[0x50];                                     // 0x0730(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<int32>                                   BanHeroes;                                         // 0x0780(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AMarvelAITeamManager) == 0x0007E0, "Wrong size on AMarvelAITeamManager");
static_assert(offsetof(AMarvelAITeamManager, LowHpMark) == 0x000618, "Member 'AMarvelAITeamManager::LowHpMark' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, AutoChangeHeroDelegate) == 0x000668, "Member 'AMarvelAITeamManager::AutoChangeHeroDelegate' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, TeamInfos) == 0x000678, "Member 'AMarvelAITeamManager::TeamInfos' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, bHasInitTeamInfo) == 0x0006C8, "Member 'AMarvelAITeamManager::bHasInitTeamInfo' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, bIsMatchStart) == 0x0006C9, "Member 'AMarvelAITeamManager::bIsMatchStart' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, bAllowRepeatHero) == 0x0006CA, "Member 'AMarvelAITeamManager::bAllowRepeatHero' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, CacheAISystem) == 0x0006D0, "Member 'AMarvelAITeamManager::CacheAISystem' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, CacheAIGameModeConfig) == 0x0006D8, "Member 'AMarvelAITeamManager::CacheAIGameModeConfig' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, RoleLimits) == 0x0006E0, "Member 'AMarvelAITeamManager::RoleLimits' has a wrong offset!");
static_assert(offsetof(AMarvelAITeamManager, BanHeroes) == 0x000780, "Member 'AMarvelAITeamManager::BanHeroes' has a wrong offset!");
...
{
public:
	int32                                         GroupId;                                           // 0x0620(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsMainInGroup : 1;                                // 0x0624(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIsShelter : 1;                                    // 0x0624(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_625[0x3];                                      // 0x0625(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FShelterInstanceData                   ShelterData;                                       // 0x0628(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AStrategyPointActor) == 0x000630, "Wrong size on AStrategyPointActor");
static_assert(offsetof(AStrategyPointActor, GroupId) == 0x000620, "Member 'AStrategyPointActor::GroupId' has a wrong offset!");
static_assert(offsetof(AStrategyPointActor, ShelterData) == 0x000628, "Member 'AStrategyPointActor::ShelterData' has a wrong offset!");
...
public:
	...
	struct FMarvelAIAutoAbilityTable              UsageConfig;                                       // 0x0160(0x0240)(Edit, EditConst, NativeAccessSpecifierPublic)
	class UAIAbilityUsageObject*                  AbilityUsageObject;                                // 0x03A0(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FBlackboardKeySelector                 AbilityUsageBlackboardKey;                         // 0x03A8(0x0030)(Edit, EditConst, Protected, NativeAccessSpecifierProtected)
	struct FBlackboardKeySelector                 AttackTargetBlackboardKey;                         // 0x03D8(0x0030)(Edit, EditConst, Protected, NativeAccessSpecifierProtected)
	TArray<int32>                                 AbilityID;                                         // 0x0408(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTS_AutoInjection) == 0x000418, "Wrong size on UBTS_AutoInjection");
...
static_assert(offsetof(UBTS_AutoInjection, AbilityUsageObject) == 0x0003A0, "Member 'UBTS_AutoInjection::AbilityUsageObject' has a wrong offset!");
static_assert(offsetof(UBTS_AutoInjection, AbilityUsageBlackboardKey) == 0x0003A8, "Member 'UBTS_AutoInjection::AbilityUsageBlackboardKey' has a wrong offset!");
static_assert(offsetof(UBTS_AutoInjection, AttackTargetBlackboardKey) == 0x0003D8, "Member 'UBTS_AutoInjection::AttackTargetBlackboardKey' has a wrong offset!");
static_assert(offsetof(UBTS_AutoInjection, AbilityID) == 0x000408, "Member 'UBTS_AutoInjection::AbilityID' has a wrong offset!");
...
public:
	uint8                                         Pad_620[0x8];                                      // 0x0620(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GoalRandomRadius;                                  // 0x0628(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MinFlyHeight;                                      // 0x062C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MaxFlyHeight;                                      // 0x0630(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsPrepareArea;                                    // 0x0634(0x0001)(Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_635[0x3];                                      // 0x0635(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrepareAreaComponent*                  PrepareAreaComp;                                   // 0x0638(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<EWayPointMark>                         WaypointPathTypeMarks;                             // 0x0640(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FWayPointToWeight>              NextWayPointsWithWeight;                           // 0x0650(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FRange_FloatValue                      RequiredPayloadProgress;                           // 0x0660(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          EnableControlAIRotation;                           // 0x0668(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NeedWait;                                          // 0x0669(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_66A[0x2];                                      // 0x066A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WaitTime;                                          // 0x066C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AWayPoint) == 0x000670, "Wrong size on AWayPoint");
static_assert(offsetof(AWayPoint, GoalRandomRadius) == 0x000628, "Member 'AWayPoint::GoalRandomRadius' has a wrong offset!");
static_assert(offsetof(AWayPoint, MinFlyHeight) == 0x00062C, "Member 'AWayPoint::MinFlyHeight' has a wrong offset!");
static_assert(offsetof(AWayPoint, MaxFlyHeight) == 0x000630, "Member 'AWayPoint::MaxFlyHeight' has a wrong offset!");
static_assert(offsetof(AWayPoint, bIsPrepareArea) == 0x000634, "Member 'AWayPoint::bIsPrepareArea' has a wrong offset!");
static_assert(offsetof(AWayPoint, PrepareAreaComp) == 0x000638, "Member 'AWayPoint::PrepareAreaComp' has a wrong offset!");
static_assert(offsetof(AWayPoint, WaypointPathTypeMarks) == 0x000640, "Member 'AWayPoint::WaypointPathTypeMarks' has a wrong offset!");
static_assert(offsetof(AWayPoint, NextWayPointsWithWeight) == 0x000650, "Member 'AWayPoint::NextWayPointsWithWeight' has a wrong offset!");
static_assert(offsetof(AWayPoint, RequiredPayloadProgress) == 0x000660, "Member 'AWayPoint::RequiredPayloadProgress' has a wrong offset!");
static_assert(offsetof(AWayPoint, EnableControlAIRotation) == 0x000668, "Member 'AWayPoint::EnableControlAIRotation' has a wrong offset!");
static_assert(offsetof(AWayPoint, NeedWait) == 0x000669, "Member 'AWayPoint::NeedWait' has a wrong offset!");
static_assert(offsetof(AWayPoint, WaitTime) == 0x00066C, "Member 'AWayPoint::WaitTime' has a wrong offset!");
...
static_assert(sizeof(UNavEffectBoxComponent) == 0x000930, "Wrong size on UNavEffectBoxComponent");
...
class UBTS_UpdateControlState : public UBTS_UpdateMatchState_New
{
public:
...
public:
	...
	float                                         VisionHalfAngleEnemy;                              // 0x0080(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VisionHalfAngleAlly;                               // 0x0084(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VisionHalfAngleTooClose;                           // 0x0088(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VisionHalfAngleInSense;                            // 0x008C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxAge;                                            // 0x0090(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_94[0x4];                                       // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AMarvelAIController*                    AIOwner;                                           // 0x0098(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMarvelAIPerceptionComponent*           AIPerceptionComponent;                             // 0x00A0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAISenseConfig_Sight*                   SightConfig;                                       // 0x00A8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTS_UpdateSight) == 0x0000B0, "Wrong size on UBTS_UpdateSight");
...
static_assert(offsetof(UBTS_UpdateSight, VisionHalfAngleEnemy) == 0x000080, "Member 'UBTS_UpdateSight::VisionHalfAngleEnemy' has a wrong offset!");
static_assert(offsetof(UBTS_UpdateSight, VisionHalfAngleAlly) == 0x000084, "Member 'UBTS_UpdateSight::VisionHalfAngleAlly' has a wrong offset!");
static_assert(offsetof(UBTS_UpdateSight, VisionHalfAngleTooClose) == 0x000088, "Member 'UBTS_UpdateSight::VisionHalfAngleTooClose' has a wrong offset!");
static_assert(offsetof(UBTS_UpdateSight, VisionHalfAngleInSense) == 0x00008C, "Member 'UBTS_UpdateSight::VisionHalfAngleInSense' has a wrong offset!");
static_assert(offsetof(UBTS_UpdateSight, MaxAge) == 0x000090, "Member 'UBTS_UpdateSight::MaxAge' has a wrong offset!");
static_assert(offsetof(UBTS_UpdateSight, AIOwner) == 0x000098, "Member 'UBTS_UpdateSight::AIOwner' has a wrong offset!");
static_assert(offsetof(UBTS_UpdateSight, AIPerceptionComponent) == 0x0000A0, "Member 'UBTS_UpdateSight::AIPerceptionComponent' has a wrong offset!");
static_assert(offsetof(UBTS_UpdateSight, SightConfig) == 0x0000A8, "Member 'UBTS_UpdateSight::SightConfig' has a wrong offset!");
...
{
public:
	float                                         WarningRadius;                                     // 0x06C8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ASniperStandPoint) == 0x0006D0, "Wrong size on ASniperStandPoint");
static_assert(offsetof(ASniperStandPoint, WarningRadius) == 0x0006C8, "Member 'ASniperStandPoint::WarningRadius' has a wrong offset!");
...
public:
	...
	struct FMarvelAbilityTraceContext             TraceContext;                                      // 0x00E0(0x1080)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TMap<int32, int32>                            UltimateAbilityIDMap;                              // 0x1160(0x0050)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTT_PinPoint) == 0x0011B0, "Wrong size on UBTT_PinPoint");
...
static_assert(offsetof(UBTT_PinPoint, UltimateAbilityIDMap) == 0x001160, "Member 'UBTT_PinPoint::UltimateAbilityIDMap' has a wrong offset!");
...
{
public:
	TSet<int32>                                   HeroIDSet;                                         // 0x06C8(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TSet<EDefendStandPointHeroType>               HeroTypeSet;                                       // 0x0718(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	bool                                          bShared;                                           // 0x0768(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADefendStandPoint) == 0x000770, "Wrong size on ADefendStandPoint");
static_assert(offsetof(ADefendStandPoint, HeroIDSet) == 0x0006C8, "Member 'ADefendStandPoint::HeroIDSet' has a wrong offset!");
static_assert(offsetof(ADefendStandPoint, HeroTypeSet) == 0x000718, "Member 'ADefendStandPoint::HeroTypeSet' has a wrong offset!");
static_assert(offsetof(ADefendStandPoint, bShared) == 0x000768, "Member 'ADefendStandPoint::bShared' has a wrong offset!");
...
{
public:
	class AActor*                                 TestStartActor;                                    // 0x0620(0x0008)(Edit, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AActor*                                 TestTargetActor;                                   // 0x0628(0x0008)(Edit, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bOnlyTestValidPath;                                // 0x0630(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_631[0x3];                                      // 0x0631(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TestCategoryIndex;                                 // 0x0634(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         CertainTestCaseIndex;                              // 0x0638(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCheckPathLength;                                  // 0x063C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_63D[0x3];                                      // 0x063D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFloatRange                            AllowedPathLengthDiffRange;                        // 0x0640(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCheckPathIsTheSame;                               // 0x0650(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawDebugPath;                                    // 0x0651(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawDebugTargetPath;                              // 0x0652(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_653[0x1];                                      // 0x0653(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DrawDebugDuration;                                 // 0x0654(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         DrawDebugThickness;                                // 0x0658(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAllowGenerateTestCaseForSingleActor;              // 0x065C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_65D[0x3];                                      // 0x065D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ActorLocationRandomRadius;                         // 0x0660(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         TestCaseGenerateTryTimes;                          // 0x0664(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRequireTestCaseHavePath;                          // 0x0668(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bShouldTakeDataFromRuntimeDataVolume;              // 0x0669(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_66A[0x6];                                      // 0x066A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPathTestCaseCategory>          TestCaseCategories;                                // 0x0670(0x0010)(Edit, ZeroConstructor, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPathFindTestCase>              TestCaseList;                                      // 0x0680(0x0010)(Edit, ZeroConstructor, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
	bool                                          bShouldStoreStatData;                              // 0x0690(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_691[0x7];                                      // 0x0691(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<int32, struct FAStarStat>                StatForLastTestList;                               // 0x0698(0x0050)(Edit, Transient, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
	bool                                          bEnablePathPostProcess;                            // 0x06E8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6E9[0x7];                                      // 0x06E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USVONNavigationComponent*               SVONavComp;                                        // 0x06F0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ASVONPathFindTester) == 0x0006F8, "Wrong size on ASVONPathFindTester");
static_assert(offsetof(ASVONPathFindTester, TestStartActor) == 0x000620, "Member 'ASVONPathFindTester::TestStartActor' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, TestTargetActor) == 0x000628, "Member 'ASVONPathFindTester::TestTargetActor' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bOnlyTestValidPath) == 0x000630, "Member 'ASVONPathFindTester::bOnlyTestValidPath' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, TestCategoryIndex) == 0x000634, "Member 'ASVONPathFindTester::TestCategoryIndex' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, CertainTestCaseIndex) == 0x000638, "Member 'ASVONPathFindTester::CertainTestCaseIndex' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bCheckPathLength) == 0x00063C, "Member 'ASVONPathFindTester::bCheckPathLength' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, AllowedPathLengthDiffRange) == 0x000640, "Member 'ASVONPathFindTester::AllowedPathLengthDiffRange' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bCheckPathIsTheSame) == 0x000650, "Member 'ASVONPathFindTester::bCheckPathIsTheSame' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bDrawDebugPath) == 0x000651, "Member 'ASVONPathFindTester::bDrawDebugPath' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bDrawDebugTargetPath) == 0x000652, "Member 'ASVONPathFindTester::bDrawDebugTargetPath' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, DrawDebugDuration) == 0x000654, "Member 'ASVONPathFindTester::DrawDebugDuration' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, DrawDebugThickness) == 0x000658, "Member 'ASVONPathFindTester::DrawDebugThickness' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bAllowGenerateTestCaseForSingleActor) == 0x00065C, "Member 'ASVONPathFindTester::bAllowGenerateTestCaseForSingleActor' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, ActorLocationRandomRadius) == 0x000660, "Member 'ASVONPathFindTester::ActorLocationRandomRadius' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, TestCaseGenerateTryTimes) == 0x000664, "Member 'ASVONPathFindTester::TestCaseGenerateTryTimes' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bRequireTestCaseHavePath) == 0x000668, "Member 'ASVONPathFindTester::bRequireTestCaseHavePath' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bShouldTakeDataFromRuntimeDataVolume) == 0x000669, "Member 'ASVONPathFindTester::bShouldTakeDataFromRuntimeDataVolume' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, TestCaseCategories) == 0x000670, "Member 'ASVONPathFindTester::TestCaseCategories' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, TestCaseList) == 0x000680, "Member 'ASVONPathFindTester::TestCaseList' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bShouldStoreStatData) == 0x000690, "Member 'ASVONPathFindTester::bShouldStoreStatData' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, StatForLastTestList) == 0x000698, "Member 'ASVONPathFindTester::StatForLastTestList' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, bEnablePathPostProcess) == 0x0006E8, "Member 'ASVONPathFindTester::bEnablePathPostProcess' has a wrong offset!");
static_assert(offsetof(ASVONPathFindTester, SVONavComp) == 0x0006F0, "Member 'ASVONPathFindTester::SVONavComp' has a wrong offset!");
...
// 0x1230 (0x14B0 - 0x0280)
class UEnvQueryTest_EvadeTarget final : public UEnvQueryTest
{
public:
	struct FMarvelAbilityTraceContext             TraceContext;                                      // 0x0280(0x1080)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<struct FAITagMatchParameter>           TagMatchParameters;                                // 0x1300(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FAbilityCheckConfig                    Asset;                                             // 0x1310(0x0198)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryTest_EvadeTarget) == 0x0014B0, "Wrong size on UEnvQueryTest_EvadeTarget");
...
static_assert(offsetof(UEnvQueryTest_EvadeTarget, TagMatchParameters) == 0x001300, "Member 'UEnvQueryTest_EvadeTarget::TagMatchParameters' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_EvadeTarget, Asset) == 0x001310, "Member 'UEnvQueryTest_EvadeTarget::Asset' has a wrong offset!");
...
static_assert(sizeof(UMarvelNavArea_SpaceRift) == 0x000050, "Wrong size on UMarvelNavArea_SpaceRift");
...
// 0x03C8 (0x0BD0 - 0x0808)
class AMarvelAIController : public AMarvelAIControllerBase
{
public:
	TMap<TWeakObjectPtr<class AActor>, struct FDateTime> DamageSourceRecord;                                // 0x0808(0x0050)(Protected, NativeAccessSpecifierProtected)
	class UClass*                                 AbilityTacticClass;                                // 0x0858(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_860[0x18];                                     // 0x0860(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UBehaviorTree*                          OldBehaviorTree;                                   // 0x0878(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                FocalOffsetOnActor;                                // 0x0880(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UGameplayEffect>            QA_ChangeHeroEnergyAttribute;                      // 0x0898(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDisableMyPawnAsFocusTarget;                       // 0x08A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          UseSmoothRotationWhenFocusChange;                  // 0x08A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUpdateFocusSpeedWhenSet;                          // 0x08A2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8A3[0x5];                                      // 0x08A3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              FocusSpeedRange;                                   // 0x08A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         CurrentFocusSpeed;                                 // 0x08B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         FocusSpeedFactor;                                  // 0x08BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableFocusUpdateDelay;                           // 0x08C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8C1[0x3];                                      // 0x08C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RotatorToleranceToRegardAsMatched;                 // 0x08C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         FocusUpdateDelayForPrevMatched;                    // 0x08C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         FocusUpdateDelayForUnMatched;                      // 0x08CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8D0[0x58];                                     // 0x08D0(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         UseAIAbilityServer;                                // 0x0928(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_92C[0x24];                                     // 0x092C(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
	class UAIControllerInfo*                      AIInfo;                                            // 0x0950(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAIAutoAbilityComponent*                AutoAbilityComponent;                              // 0x0958(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAIMementoComponent*                    AIMementoComponent;                                // 0x0960(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAIAutoAbilitySolver*                   AbilitySolver;                                     // 0x0968(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAIHeroCustomComponent*                 HeroCustomComponent;                               // 0x0970(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAIAbilityExecutorManagerComponent*     AbilityExecutorManagerComponent;                   // 0x0978(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMarvelAgentHandleCom*                  AbilityAgentComponent;                             // 0x0980(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_988[0x10];                                     // 0x0988(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UAITask_MoveTo*                         TaskMoveTo;                                        // 0x0998(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_9A0[0x70];                                     // 0x09A0(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           BlockBodyTurnTag;                                  // 0x0A10(0x000C)(Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           BlockCameraLookUpTag;                              // 0x0A1C(0x000C)(Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           BlockCameraTurnTag;                                // 0x0A28(0x000C)(Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A34[0x4];                                      // 0x0A34(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UMarvelAIPerceptionComponent*           MarvelAIPerceptionComponent;                       // 0x0A38(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             ReceiveSVONMoveRequestFailed;                      // 0x0A40(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             ReceiveBehaviorTreeMoveTaskEnd;                    // 0x0A50(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bEnableUsageFocusClearDelay;                       // 0x0A60(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A61[0x3];                                      // 0x0A61(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         UsageFocusClearDelay;                              // 0x0A64(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A68[0x80];                                     // 0x0A68(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayerInput*                           PlayerInput;                                       // 0x0AE8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_AF0[0x19];                                     // 0x0AF0(0x0019)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEnableAutoChangeHero;                             // 0x0B09(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowPreSelectHero;                               // 0x0B0A(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B0B[0x1D];                                     // 0x0B0B(0x001D)(Fixing Size After Last Property [ Dumper-7 ])
	struct FActiveGameplayEffectHandle            TreatApplyGEHandler;                               // 0x0B28(0x0008)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurDynamicDifficultyFactor;                        // 0x0B30(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B34[0xC];                                      // 0x0B34(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEnableJump;                                       // 0x0B40(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B41[0x7];                                      // 0x0B41(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 LastEnemyTarget;                                   // 0x0B48(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class AActor*                                 LastAllyTarget;                                    // 0x0B50(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B58[0x40];                                     // 0x0B58(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	class UAISenseConfig_Sight*                   SightConfig;                                       // 0x0B98(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BA0[0x18];                                     // 0x0BA0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AILabRecommendedDuration;                          // 0x0BB8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_BBC[0x14];                                     // 0x0BBC(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AMarvelAIController) == 0x000BD0, "Wrong size on AMarvelAIController");
static_assert(offsetof(AMarvelAIController, DamageSourceRecord) == 0x000808, "Member 'AMarvelAIController::DamageSourceRecord' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AbilityTacticClass) == 0x000858, "Member 'AMarvelAIController::AbilityTacticClass' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, OldBehaviorTree) == 0x000878, "Member 'AMarvelAIController::OldBehaviorTree' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, FocalOffsetOnActor) == 0x000880, "Member 'AMarvelAIController::FocalOffsetOnActor' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, QA_ChangeHeroEnergyAttribute) == 0x000898, "Member 'AMarvelAIController::QA_ChangeHeroEnergyAttribute' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, bDisableMyPawnAsFocusTarget) == 0x0008A0, "Member 'AMarvelAIController::bDisableMyPawnAsFocusTarget' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, UseSmoothRotationWhenFocusChange) == 0x0008A1, "Member 'AMarvelAIController::UseSmoothRotationWhenFocusChange' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, bUpdateFocusSpeedWhenSet) == 0x0008A2, "Member 'AMarvelAIController::bUpdateFocusSpeedWhenSet' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, FocusSpeedRange) == 0x0008A8, "Member 'AMarvelAIController::FocusSpeedRange' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, CurrentFocusSpeed) == 0x0008B8, "Member 'AMarvelAIController::CurrentFocusSpeed' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, FocusSpeedFactor) == 0x0008BC, "Member 'AMarvelAIController::FocusSpeedFactor' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, bEnableFocusUpdateDelay) == 0x0008C0, "Member 'AMarvelAIController::bEnableFocusUpdateDelay' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, RotatorToleranceToRegardAsMatched) == 0x0008C4, "Member 'AMarvelAIController::RotatorToleranceToRegardAsMatched' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, FocusUpdateDelayForPrevMatched) == 0x0008C8, "Member 'AMarvelAIController::FocusUpdateDelayForPrevMatched' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, FocusUpdateDelayForUnMatched) == 0x0008CC, "Member 'AMarvelAIController::FocusUpdateDelayForUnMatched' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, UseAIAbilityServer) == 0x000928, "Member 'AMarvelAIController::UseAIAbilityServer' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AIInfo) == 0x000950, "Member 'AMarvelAIController::AIInfo' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AutoAbilityComponent) == 0x000958, "Member 'AMarvelAIController::AutoAbilityComponent' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AIMementoComponent) == 0x000960, "Member 'AMarvelAIController::AIMementoComponent' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AbilitySolver) == 0x000968, "Member 'AMarvelAIController::AbilitySolver' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, HeroCustomComponent) == 0x000970, "Member 'AMarvelAIController::HeroCustomComponent' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AbilityExecutorManagerComponent) == 0x000978, "Member 'AMarvelAIController::AbilityExecutorManagerComponent' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AbilityAgentComponent) == 0x000980, "Member 'AMarvelAIController::AbilityAgentComponent' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, TaskMoveTo) == 0x000998, "Member 'AMarvelAIController::TaskMoveTo' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, BlockBodyTurnTag) == 0x000A10, "Member 'AMarvelAIController::BlockBodyTurnTag' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, BlockCameraLookUpTag) == 0x000A1C, "Member 'AMarvelAIController::BlockCameraLookUpTag' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, BlockCameraTurnTag) == 0x000A28, "Member 'AMarvelAIController::BlockCameraTurnTag' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, MarvelAIPerceptionComponent) == 0x000A38, "Member 'AMarvelAIController::MarvelAIPerceptionComponent' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, ReceiveSVONMoveRequestFailed) == 0x000A40, "Member 'AMarvelAIController::ReceiveSVONMoveRequestFailed' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, ReceiveBehaviorTreeMoveTaskEnd) == 0x000A50, "Member 'AMarvelAIController::ReceiveBehaviorTreeMoveTaskEnd' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, bEnableUsageFocusClearDelay) == 0x000A60, "Member 'AMarvelAIController::bEnableUsageFocusClearDelay' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, UsageFocusClearDelay) == 0x000A64, "Member 'AMarvelAIController::UsageFocusClearDelay' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, PlayerInput) == 0x000AE8, "Member 'AMarvelAIController::PlayerInput' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, bEnableAutoChangeHero) == 0x000B09, "Member 'AMarvelAIController::bEnableAutoChangeHero' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, bAllowPreSelectHero) == 0x000B0A, "Member 'AMarvelAIController::bAllowPreSelectHero' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, TreatApplyGEHandler) == 0x000B28, "Member 'AMarvelAIController::TreatApplyGEHandler' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, CurDynamicDifficultyFactor) == 0x000B30, "Member 'AMarvelAIController::CurDynamicDifficultyFactor' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, bEnableJump) == 0x000B40, "Member 'AMarvelAIController::bEnableJump' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, LastEnemyTarget) == 0x000B48, "Member 'AMarvelAIController::LastEnemyTarget' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, LastAllyTarget) == 0x000B50, "Member 'AMarvelAIController::LastAllyTarget' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, SightConfig) == 0x000B98, "Member 'AMarvelAIController::SightConfig' has a wrong offset!");
static_assert(offsetof(AMarvelAIController, AILabRecommendedDuration) == 0x000BB8, "Member 'AMarvelAIController::AILabRecommendedDuration' has a wrong offset!");
...
static_assert(sizeof(UMarvelAIGlobalDataSubsystem) == 0x0001E0, "Wrong size on UMarvelAIGlobalDataSubsystem");
...
public:
	...
	uint8                                         Pad_217[0x2];                                      // 0x0217(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEnableVisLogWhenServerStart;                      // 0x0219(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUseCustomVisLogFilename;                          // 0x021A(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMarvelAISystem) == 0x0002D0, "Wrong size on UMarvelAISystem");
...
static_assert(offsetof(UMarvelAISystem, bEnableVisLogWhenServerStart) == 0x000219, "Member 'UMarvelAISystem::bEnableVisLogWhenServerStart' has a wrong offset!");
static_assert(offsetof(UMarvelAISystem, bUseCustomVisLogFilename) == 0x00021A, "Member 'UMarvelAISystem::bUseCustomVisLogFilename' has a wrong offset!");
...
{
public:
	uint8                                         bShouldCheckBlockWhenUpdateNavData : 1;            // 0x0648(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bShouldCheckBothSide : 1;                          // 0x0648(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(sizeof(AMarvelNavLinkProxy) == 0x000650, "Wrong size on AMarvelNavLinkProxy");
...
{
public:
	bool                                          bOverrideTileConfig;                               // 0x0648(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_649[0x1];                                      // 0x0649(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTileCustomGeneralConfig               TileCustomGeneralConfig;                           // 0x064A(0x0006)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AMarvelNavModifierVolume) == 0x000650, "Wrong size on AMarvelNavModifierVolume");
static_assert(offsetof(AMarvelNavModifierVolume, bOverrideTileConfig) == 0x000648, "Member 'AMarvelNavModifierVolume::bOverrideTileConfig' has a wrong offset!");
static_assert(offsetof(AMarvelNavModifierVolume, TileCustomGeneralConfig) == 0x00064A, "Member 'AMarvelNavModifierVolume::TileCustomGeneralConfig' has a wrong offset!");
...
{
public:
	class UBoxComponent*                          BlockCheckBoxComp;                                 // 0x0650(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMarvelObstacleNavLinkProxy) == 0x000658, "Wrong size on AMarvelObstacleNavLinkProxy");
static_assert(offsetof(AMarvelObstacleNavLinkProxy, BlockCheckBoxComp) == 0x000650, "Member 'AMarvelObstacleNavLinkProxy::BlockCheckBoxComp' has a wrong offset!");
...
{
public:
	TMap<TSoftObjectPtr<class AActor>, struct FPathSelectorData> PathSelectConfig;                                  // 0x0618(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, TSoftObjectPtr<class AStartWayPoint>> StartWayPointMap;                                  // 0x0668(0x0050)(Edit, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMarvelWayPointManager) == 0x0006B8, "Wrong size on AMarvelWayPointManager");
static_assert(offsetof(AMarvelWayPointManager, PathSelectConfig) == 0x000618, "Member 'AMarvelWayPointManager::PathSelectConfig' has a wrong offset!");
static_assert(offsetof(AMarvelWayPointManager, StartWayPointMap) == 0x000668, "Member 'AMarvelWayPointManager::StartWayPointMap' has a wrong offset!");
...
{
public:
	bool                                          bShouldModifyNavLinks;                             // 0x0620(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldModifyStrategyPoints;                       // 0x0621(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_622[0x6];                                      // 0x0622(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class ANavLinkProxy*>                  GeneratedNavLinks;                                 // 0x0628(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_638[0x10];                                     // 0x0638(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FTileRef, struct FTileData>       TileRefToData;                                     // 0x0648(0x0050)(Protected, NativeAccessSpecifierProtected)
	TArray<class AActor*>                         LevelKnockUpCache;                                 // 0x0698(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	class UMarvelAISystem*                        AISysCache;                                        // 0x06A8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6B0[0x4];                                      // 0x06B0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTileDebugDrawConfig                   DebugConfig;                                       // 0x06B4(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bPreviewLinkWithoutCreate;                         // 0x06BC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRefreshNavLinkIdAfterCreate;                      // 0x06BD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMarkWallAttachedAfterGenerate;                    // 0x06BE(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6BF[0x1];                                      // 0x06BF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FWallAttachCheckConfig                 WallAttachedCheckConfig;                           // 0x06C0(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	TSubclassOf<class ANavLinkProxy>              NavLinkProxyClass;                                 // 0x06E0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNavLinkGenerateConfig                 GenerateConfig;                                    // 0x06E8(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_720[0x38];                                     // 0x0720(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEnableRuntimeGeneration;                          // 0x0758(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_759[0x3];                                      // 0x0759(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RuntimeGenerationDelay;                            // 0x075C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableLinkPool;                                   // 0x0760(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_761[0x3];                                      // 0x0761(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         LinkPoolInitCapacity;                              // 0x0764(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_768[0x78];                                     // 0x0768(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	class ANavLinkProxy*                          ToCheckLink;                                       // 0x07E0(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AStrategyPointActor*>            GeneratedStrategyPoints;                           // 0x07E8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FStrategyPointGenerateConfig           StrategyPointGenerateConfig;                       // 0x07F8(0x0010)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class AStrategyPointActor>        StrategyPointClass;                                // 0x0808(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawHeightDetect;                                 // 0x0810(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ANavLinkAutoGenerator) == 0x000818, "Wrong size on ANavLinkAutoGenerator");
static_assert(offsetof(ANavLinkAutoGenerator, bShouldModifyNavLinks) == 0x000620, "Member 'ANavLinkAutoGenerator::bShouldModifyNavLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, bShouldModifyStrategyPoints) == 0x000621, "Member 'ANavLinkAutoGenerator::bShouldModifyStrategyPoints' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, GeneratedNavLinks) == 0x000628, "Member 'ANavLinkAutoGenerator::GeneratedNavLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, TileRefToData) == 0x000648, "Member 'ANavLinkAutoGenerator::TileRefToData' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, LevelKnockUpCache) == 0x000698, "Member 'ANavLinkAutoGenerator::LevelKnockUpCache' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, AISysCache) == 0x0006A8, "Member 'ANavLinkAutoGenerator::AISysCache' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, DebugConfig) == 0x0006B4, "Member 'ANavLinkAutoGenerator::DebugConfig' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, bPreviewLinkWithoutCreate) == 0x0006BC, "Member 'ANavLinkAutoGenerator::bPreviewLinkWithoutCreate' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, bRefreshNavLinkIdAfterCreate) == 0x0006BD, "Member 'ANavLinkAutoGenerator::bRefreshNavLinkIdAfterCreate' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, bMarkWallAttachedAfterGenerate) == 0x0006BE, "Member 'ANavLinkAutoGenerator::bMarkWallAttachedAfterGenerate' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, WallAttachedCheckConfig) == 0x0006C0, "Member 'ANavLinkAutoGenerator::WallAttachedCheckConfig' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, NavLinkProxyClass) == 0x0006E0, "Member 'ANavLinkAutoGenerator::NavLinkProxyClass' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, GenerateConfig) == 0x0006E8, "Member 'ANavLinkAutoGenerator::GenerateConfig' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, bEnableRuntimeGeneration) == 0x000758, "Member 'ANavLinkAutoGenerator::bEnableRuntimeGeneration' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, RuntimeGenerationDelay) == 0x00075C, "Member 'ANavLinkAutoGenerator::RuntimeGenerationDelay' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, bEnableLinkPool) == 0x000760, "Member 'ANavLinkAutoGenerator::bEnableLinkPool' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, LinkPoolInitCapacity) == 0x000764, "Member 'ANavLinkAutoGenerator::LinkPoolInitCapacity' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, ToCheckLink) == 0x0007E0, "Member 'ANavLinkAutoGenerator::ToCheckLink' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, GeneratedStrategyPoints) == 0x0007E8, "Member 'ANavLinkAutoGenerator::GeneratedStrategyPoints' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, StrategyPointGenerateConfig) == 0x0007F8, "Member 'ANavLinkAutoGenerator::StrategyPointGenerateConfig' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, StrategyPointClass) == 0x000808, "Member 'ANavLinkAutoGenerator::StrategyPointClass' has a wrong offset!");
static_assert(offsetof(ANavLinkAutoGenerator, bDrawHeightDetect) == 0x000810, "Member 'ANavLinkAutoGenerator::bDrawHeightDetect' has a wrong offset!");
...
static_assert(sizeof(UPrepareAreaComponent) == 0x000960, "Wrong size on UPrepareAreaComponent");
static_assert(offsetof(UPrepareAreaComponent, MyBattleSide) == 0x000930, "Member 'UPrepareAreaComponent::MyBattleSide' has a wrong offset!");
static_assert(offsetof(UPrepareAreaComponent, UpdateIsValidInterval) == 0x000934, "Member 'UPrepareAreaComponent::UpdateIsValidInterval' has a wrong offset!");
static_assert(offsetof(UPrepareAreaComponent, MarkToInvalidDuration) == 0x000938, "Member 'UPrepareAreaComponent::MarkToInvalidDuration' has a wrong offset!");
static_assert(offsetof(UPrepareAreaComponent, bIsValidArea) == 0x00093C, "Member 'UPrepareAreaComponent::bIsValidArea' has a wrong offset!");
...
{
public:
	TSubclassOf<class UShelterPathFinder>         PathFinderClass;                                   // 0x05F8(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                TargetLocation;                                    // 0x0600(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FVector>                        EnemiesLocation;                                   // 0x0618(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UShelterPathFinder*                     TempPathFinder;                                    // 0x0628(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AShelterPathTestActor) == 0x000630, "Wrong size on AShelterPathTestActor");
static_assert(offsetof(AShelterPathTestActor, PathFinderClass) == 0x0005F8, "Member 'AShelterPathTestActor::PathFinderClass' has a wrong offset!");
static_assert(offsetof(AShelterPathTestActor, TargetLocation) == 0x000600, "Member 'AShelterPathTestActor::TargetLocation' has a wrong offset!");
static_assert(offsetof(AShelterPathTestActor, EnemiesLocation) == 0x000618, "Member 'AShelterPathTestActor::EnemiesLocation' has a wrong offset!");
static_assert(offsetof(AShelterPathTestActor, TempPathFinder) == 0x000628, "Member 'AShelterPathTestActor::TempPathFinder' has a wrong offset!");
...
public:
	...
	struct FWayPointPath                          CurrentWayPointPath;                               // 0x0690(0x0048)(NativeAccessSpecifierPrivate)
	float                                         PathValidDurationAfterFetch;                       // 0x06D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AStartWayPoint) == 0x0006E0, "Wrong size on AStartWayPoint");
static_assert(offsetof(AStartWayPoint, CurrentWayPointPath) == 0x000690, "Member 'AStartWayPoint::CurrentWayPointPath' has a wrong offset!");
static_assert(offsetof(AStartWayPoint, PathValidDurationAfterFetch) == 0x0006D8, "Member 'AStartWayPoint::PathValidDurationAfterFetch' has a wrong offset!");
