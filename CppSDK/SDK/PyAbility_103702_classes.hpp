...
{
public:
	float                                         HoldTime;                                          // 0x0118(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(UPyConfig_103702) == 0x000008, "Wrong alignment on UPyConfig_103702");
static_assert(sizeof(UPyConfig_103702) == 0x000120, "Wrong size on UPyConfig_103702");
static_assert(offsetof(UPyConfig_103702, HoldTime) == 0x000118, "Member 'UPyConfig_103702::HoldTime' has a wrong offset!");
...
static_assert(sizeof(UPyAbility_103702) == 0x002A50, "Wrong size on UPyAbility_103702");
