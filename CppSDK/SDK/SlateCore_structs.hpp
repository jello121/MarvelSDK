...
static_assert(offsetof(FSlateBrush, UVRegion) == 0x0000A4, "Member 'FSlateBrush::UVRegion' has a wrong offset!");
...
static_assert(sizeof(FButtonStyle) == 0x000400, "Wrong size on FButtonStyle");
...
static_assert(offsetof(FButtonStyle, HoveredSlateSound) == 0x0003E0, "Member 'FButtonStyle::HoveredSlateSound' has a wrong offset!");
...
static_assert(offsetof(FFontOutlineSettings, MinimumScaledOutlineSize) == 0x000004, "Member 'FFontOutlineSettings::MinimumScaledOutlineSize' has a wrong offset!");
...
static_assert(offsetof(FSlateFontInfo, Size) == 0x000054, "Member 'FSlateFontInfo::Size' has a wrong offset!");
static_assert(offsetof(FSlateFontInfo, LetterSpacing) == 0x000058, "Member 'FSlateFontInfo::LetterSpacing' has a wrong offset!");
static_assert(offsetof(FSlateFontInfo, SkewAmount) == 0x00005C, "Member 'FSlateFontInfo::SkewAmount' has a wrong offset!");
...
static_assert(offsetof(FTextBlockStyle, ShadowOffset) == 0x000084, "Member 'FTextBlockStyle::ShadowOffset' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, MinimumScaledShadowOffset) == 0x00008C, "Member 'FTextBlockStyle::MinimumScaledShadowOffset' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, ShadowColorAndOpacity) == 0x000094, "Member 'FTextBlockStyle::ShadowColorAndOpacity' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, SelectedBackgroundColor) == 0x0000A4, "Member 'FTextBlockStyle::SelectedBackgroundColor' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, HighlightColor) == 0x0000B8, "Member 'FTextBlockStyle::HighlightColor' has a wrong offset!");
...
static_assert(offsetof(FTextBlockStyle, UnderlineOffset) == 0x000340, "Member 'FTextBlockStyle::UnderlineOffset' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, TransformPolicy) == 0x000348, "Member 'FTextBlockStyle::TransformPolicy' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, OverflowPolicy) == 0x000349, "Member 'FTextBlockStyle::OverflowPolicy' has a wrong offset!");
...
static_assert(sizeof(FCheckBoxStyle) == 0x000AE0, "Wrong size on FCheckBoxStyle");
...
static_assert(offsetof(FCheckBoxStyle, UncheckedSlateSound) == 0x000AA0, "Member 'FCheckBoxStyle::UncheckedSlateSound' has a wrong offset!");
static_assert(offsetof(FCheckBoxStyle, HoveredSlateSound) == 0x000AC0, "Member 'FCheckBoxStyle::HoveredSlateSound' has a wrong offset!");
...
static_assert(offsetof(FComboButtonStyle, DownArrowImage) == 0x000410, "Member 'FComboButtonStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, ShadowOffset) == 0x0004E0, "Member 'FComboButtonStyle::ShadowOffset' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, ShadowColorAndOpacity) == 0x0004E8, "Member 'FComboButtonStyle::ShadowColorAndOpacity' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, MenuBorderBrush) == 0x000500, "Member 'FComboButtonStyle::MenuBorderBrush' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, MenuBorderPadding) == 0x0005D0, "Member 'FComboButtonStyle::MenuBorderPadding' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, ContentPadding) == 0x0005E0, "Member 'FComboButtonStyle::ContentPadding' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, DownArrowPadding) == 0x0005F0, "Member 'FComboButtonStyle::DownArrowPadding' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, DownArrowAlign) == 0x000600, "Member 'FComboButtonStyle::DownArrowAlign' has a wrong offset!");
...
static_assert(sizeof(FToolBarStyle) == 0x003F10, "Wrong size on FToolBarStyle");
...
static_assert(offsetof(FToolBarStyle, ComboButtonStyle) == 0x001F40, "Member 'FToolBarStyle::ComboButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsButtonStyle) == 0x002550, "Member 'FToolBarStyle::SettingsButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsComboButton) == 0x002950, "Member 'FToolBarStyle::SettingsComboButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsToggleButton) == 0x002F60, "Member 'FToolBarStyle::SettingsToggleButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonStyle) == 0x003A40, "Member 'FToolBarStyle::ButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, LabelPadding) == 0x003E40, "Member 'FToolBarStyle::LabelPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockWidth) == 0x003E50, "Member 'FToolBarStyle::UniformBlockWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockHeight) == 0x003E54, "Member 'FToolBarStyle::UniformBlockHeight' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, NumColumns) == 0x003E58, "Member 'FToolBarStyle::NumColumns' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPadding) == 0x003E5C, "Member 'FToolBarStyle::IconPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SeparatorPadding) == 0x003E6C, "Member 'FToolBarStyle::SeparatorPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ComboButtonPadding) == 0x003E7C, "Member 'FToolBarStyle::ComboButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonPadding) == 0x003E8C, "Member 'FToolBarStyle::ButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, CheckBoxPadding) == 0x003E9C, "Member 'FToolBarStyle::CheckBoxPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BlockPadding) == 0x003EAC, "Member 'FToolBarStyle::BlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IndentedBlockPadding) == 0x003EBC, "Member 'FToolBarStyle::IndentedBlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BackgroundPadding) == 0x003ECC, "Member 'FToolBarStyle::BackgroundPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconSize) == 0x003EDC, "Member 'FToolBarStyle::IconSize' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, bShowLabels) == 0x003EE4, "Member 'FToolBarStyle::bShowLabels' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentMaxWidth) == 0x003EE8, "Member 'FToolBarStyle::ButtonContentMaxWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentFillWidth) == 0x003EEC, "Member 'FToolBarStyle::ButtonContentFillWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithVisibleLabel) == 0x003EF0, "Member 'FToolBarStyle::IconPaddingWithVisibleLabel' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithCollapsedLabel) == 0x003F00, "Member 'FToolBarStyle::IconPaddingWithCollapsedLabel' has a wrong offset!");
...
static_assert(sizeof(FPointerEvent) == 0x000080, "Wrong size on FPointerEvent");
...
static_assert(sizeof(FHyperlinkStyle) == 0x000770, "Wrong size on FHyperlinkStyle");
static_assert(offsetof(FHyperlinkStyle, UnderlineStyle) == 0x000010, "Member 'FHyperlinkStyle::UnderlineStyle' has a wrong offset!");
static_assert(offsetof(FHyperlinkStyle, TextStyle) == 0x000410, "Member 'FHyperlinkStyle::TextStyle' has a wrong offset!");
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x000760, "Member 'FHyperlinkStyle::Padding' has a wrong offset!");
...
static_assert(sizeof(FSegmentedControlStyle) == 0x002190, "Wrong size on FSegmentedControlStyle");
...
static_assert(offsetof(FSegmentedControlStyle, FirstControlStyle) == 0x000AF0, "Member 'FSegmentedControlStyle::FirstControlStyle' has a wrong offset!");
static_assert(offsetof(FSegmentedControlStyle, LastControlStyle) == 0x0015D0, "Member 'FSegmentedControlStyle::LastControlStyle' has a wrong offset!");
static_assert(offsetof(FSegmentedControlStyle, BackgroundBrush) == 0x0020B0, "Member 'FSegmentedControlStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FSegmentedControlStyle, UniformPadding) == 0x002180, "Member 'FSegmentedControlStyle::UniformPadding' has a wrong offset!");
...
static_assert(sizeof(FComboBoxStyle) == 0x000680, "Wrong size on FComboBoxStyle");
...
static_assert(offsetof(FComboBoxStyle, SelectionChangeSlateSound) == 0x000640, "Member 'FComboBoxStyle::SelectionChangeSlateSound' has a wrong offset!");
static_assert(offsetof(FComboBoxStyle, ContentPadding) == 0x000660, "Member 'FComboBoxStyle::ContentPadding' has a wrong offset!");
static_assert(offsetof(FComboBoxStyle, MenuRowPadding) == 0x000670, "Member 'FComboBoxStyle::MenuRowPadding' has a wrong offset!");
...
static_assert(sizeof(FDockTabStyle) == 0x000DA0, "Wrong size on FDockTabStyle");
static_assert(offsetof(FDockTabStyle, CloseButtonStyle) == 0x000010, "Member 'FDockTabStyle::CloseButtonStyle' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, NormalBrush) == 0x000410, "Member 'FDockTabStyle::NormalBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ColorOverlayTabBrush) == 0x0004E0, "Member 'FDockTabStyle::ColorOverlayTabBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ColorOverlayIconBrush) == 0x0005B0, "Member 'FDockTabStyle::ColorOverlayIconBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ForegroundBrush) == 0x000680, "Member 'FDockTabStyle::ForegroundBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, HoveredBrush) == 0x000750, "Member 'FDockTabStyle::HoveredBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ContentAreaBrush) == 0x000820, "Member 'FDockTabStyle::ContentAreaBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, TabWellBrush) == 0x0008F0, "Member 'FDockTabStyle::TabWellBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, TabTextStyle) == 0x0009C0, "Member 'FDockTabStyle::TabTextStyle' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, TabPadding) == 0x000D10, "Member 'FDockTabStyle::TabPadding' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, IconSize) == 0x000D20, "Member 'FDockTabStyle::IconSize' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, OverlapWidth) == 0x000D28, "Member 'FDockTabStyle::OverlapWidth' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, FlashColor) == 0x000D2C, "Member 'FDockTabStyle::FlashColor' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, NormalForegroundColor) == 0x000D40, "Member 'FDockTabStyle::NormalForegroundColor' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, HoveredForegroundColor) == 0x000D54, "Member 'FDockTabStyle::HoveredForegroundColor' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ActiveForegroundColor) == 0x000D68, "Member 'FDockTabStyle::ActiveForegroundColor' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ForegroundForegroundColor) == 0x000D7C, "Member 'FDockTabStyle::ForegroundForegroundColor' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, IconBorderPadding) == 0x000D90, "Member 'FDockTabStyle::IconBorderPadding' has a wrong offset!");
...
static_assert(sizeof(FEditableTextStyle) == 0x000300, "Wrong size on FEditableTextStyle");
...
static_assert(offsetof(FEditableTextStyle, BackgroundImageSelected) == 0x000090, "Member 'FEditableTextStyle::BackgroundImageSelected' has a wrong offset!");
static_assert(offsetof(FEditableTextStyle, BackgroundImageComposing) == 0x000160, "Member 'FEditableTextStyle::BackgroundImageComposing' has a wrong offset!");
static_assert(offsetof(FEditableTextStyle, CaretImage) == 0x000230, "Member 'FEditableTextStyle::CaretImage' has a wrong offset!");
...
static_assert(sizeof(FWindowStyle) == 0x001990, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, MaximizeButtonStyle) == 0x000410, "Member 'FWindowStyle::MaximizeButtonStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, RestoreButtonStyle) == 0x000810, "Member 'FWindowStyle::RestoreButtonStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, CloseButtonStyle) == 0x000C10, "Member 'FWindowStyle::CloseButtonStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, TitleTextStyle) == 0x001010, "Member 'FWindowStyle::TitleTextStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x001360, "Member 'FWindowStyle::ActiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x001430, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x001500, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x0015D0, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x0015F0, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x0016C0, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x0016E0, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderColor) == 0x0017B0, "Member 'FWindowStyle::BorderColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x0017D0, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x0018A0, "Member 'FWindowStyle::ChildBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, WindowCornerRadius) == 0x001970, "Member 'FWindowStyle::WindowCornerRadius' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderPadding) == 0x001974, "Member 'FWindowStyle::BorderPadding' has a wrong offset!");
...
static_assert(sizeof(FKeyEvent) == 0x000048, "Wrong size on FKeyEvent");
...
static_assert(sizeof(FSearchBoxStyle) == 0x001270, "Wrong size on FSearchBoxStyle");
...
static_assert(offsetof(FSearchBoxStyle, UpArrowImage) == 0x000F10, "Member 'FSearchBoxStyle::UpArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, DownArrowImage) == 0x000FE0, "Member 'FSearchBoxStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, GlassImage) == 0x0010B0, "Member 'FSearchBoxStyle::GlassImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ClearImage) == 0x001180, "Member 'FSearchBoxStyle::ClearImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImagePadding) == 0x001250, "Member 'FSearchBoxStyle::ImagePadding' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignButtons) == 0x001260, "Member 'FSearchBoxStyle::bLeftAlignButtons' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignSearchResultButtons) == 0x001261, "Member 'FSearchBoxStyle::bLeftAlignSearchResultButtons' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignGlassImageAndClearButton) == 0x001262, "Member 'FSearchBoxStyle::bLeftAlignGlassImageAndClearButton' has a wrong offset!");
