...
public:
	...
	struct FBondInstance                          InBondInstance;                                    // 0x06D0(0x0128)(ConstParm, Parm, OutParm, ReferenceParm)
};
...
static_assert(sizeof(PyMarvelBondManager_OnAssistKillCallback) == 0x0007F8, "Wrong size on PyMarvelBondManager_OnAssistKillCallback");
...
static_assert(offsetof(PyMarvelBondManager_OnAssistKillCallback, InBondInstance) == 0x0006D0, "Member 'PyMarvelBondManager_OnAssistKillCallback::InBondInstance' has a wrong offset!");
