...
static_assert(sizeof(ASummoned_10475101_BP_C) == 0x000A60, "Wrong size on ASummoned_10475101_BP_C");
static_assert(offsetof(ASummoned_10475101_BP_C, UberGraphFrame) == 0x000A50, "Member 'ASummoned_10475101_BP_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ASummoned_10475101_BP_C, SummonedMovement) == 0x000A58, "Member 'ASummoned_10475101_BP_C::SummonedMovement' has a wrong offset!");
