...
public:
	...
	TSubclassOf<class UAIAbilitySelectCheckBase>  OverrideSelectCheckClass;                          // 0x00B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTacticsTaskParam) == 0x000008, "Wrong alignment on FTacticsTaskParam");
static_assert(sizeof(FTacticsTaskParam) == 0x0000B8, "Wrong size on FTacticsTaskParam");
static_assert(offsetof(FTacticsTaskParam, TaskOwner) == 0x000008, "Member 'FTacticsTaskParam::TaskOwner' has a wrong offset!");
static_assert(offsetof(FTacticsTaskParam, OverrideSelectCheckClass) == 0x0000B0, "Member 'FTacticsTaskParam::OverrideSelectCheckClass' has a wrong offset!");
...
public:
	...
	struct FTacticsTaskParam                      RequestParam;                                      // 0x0008(0x00B8)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FAbilityTacticsRequest) == 0x000008, "Wrong alignment on FAbilityTacticsRequest");
static_assert(sizeof(FAbilityTacticsRequest) == 0x0000C0, "Wrong size on FAbilityTacticsRequest");
...
static_assert(sizeof(FAIServerRequestProtocol) == 0x0000B8, "Wrong size on FAIServerRequestProtocol");
...
static_assert(sizeof(FRequiredAIDataForAutoAbility) == 0x000030, "Wrong size on FRequiredAIDataForAutoAbility");
...
static_assert(sizeof(FAICommunicateRow) == 0x000028, "Wrong size on FAICommunicateRow");
static_assert(offsetof(FAICommunicateRow, AICommunicate) == 0x000010, "Member 'FAICommunicateRow::AICommunicate' has a wrong offset!");
...
static_assert(sizeof(FMarvelAIAbilityCounterTable) == 0x000038, "Wrong size on FMarvelAIAbilityCounterTable");
static_assert(offsetof(FMarvelAIAbilityCounterTable, Description) == 0x000010, "Member 'FMarvelAIAbilityCounterTable::Description' has a wrong offset!");
static_assert(offsetof(FMarvelAIAbilityCounterTable, FilterSide) == 0x000020, "Member 'FMarvelAIAbilityCounterTable::FilterSide' has a wrong offset!");
static_assert(offsetof(FMarvelAIAbilityCounterTable, CounterConfigList) == 0x000028, "Member 'FMarvelAIAbilityCounterTable::CounterConfigList' has a wrong offset!");
...
static_assert(offsetof(FAIAbilityActivateConfig, AbilityID) == 0x000004, "Member 'FAIAbilityActivateConfig::AbilityID' has a wrong offset!");
...
{
public:
	struct FAIAbilityUsageTag                     AbilityUsageTag;                                   // 0x0010(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FAIHitRateTagContainer                 HitRateTagContainer;                               // 0x0078(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	float                                         ChanceToHit;                                       // 0x00E0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E4[0x4];                                       // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIAbilityActivateConfig               ActivateConfig;                                    // 0x00E8(0x00B8)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FAIAbilityConditionConfig              ConditionConfig;                                   // 0x01A0(0x0064)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PriorityScore;                                     // 0x0204(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FComboConfig                           ComboConfig;                                       // 0x0208(0x0008)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	EAbilityCheckType                             AbilityCheckType;                                  // 0x0210(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_211[0x7];                                      // 0x0211(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAIAbilityButtonActivationConfig> ButtonConfig;                                      // 0x0218(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bHasCancelButton;                                  // 0x0228(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAbilityInputBinds                            CancelButton;                                      // 0x0229(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_22A[0x6];                                      // 0x022A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UAIAbilityFlowCheckLogicBase> FlowCheckLogic;                                    // 0x0230(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAIAbilityUsageAsset*                   UsageAsset;                                        // 0x0238(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMarvelAIAutoAbilityTable) == 0x000008, "Wrong alignment on FMarvelAIAutoAbilityTable");
static_assert(sizeof(FMarvelAIAutoAbilityTable) == 0x000240, "Wrong size on FMarvelAIAutoAbilityTable");
static_assert(offsetof(FMarvelAIAutoAbilityTable, AbilityUsageTag) == 0x000010, "Member 'FMarvelAIAutoAbilityTable::AbilityUsageTag' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, HitRateTagContainer) == 0x000078, "Member 'FMarvelAIAutoAbilityTable::HitRateTagContainer' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, ChanceToHit) == 0x0000E0, "Member 'FMarvelAIAutoAbilityTable::ChanceToHit' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, ActivateConfig) == 0x0000E8, "Member 'FMarvelAIAutoAbilityTable::ActivateConfig' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, ConditionConfig) == 0x0001A0, "Member 'FMarvelAIAutoAbilityTable::ConditionConfig' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, PriorityScore) == 0x000204, "Member 'FMarvelAIAutoAbilityTable::PriorityScore' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, ComboConfig) == 0x000208, "Member 'FMarvelAIAutoAbilityTable::ComboConfig' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, AbilityCheckType) == 0x000210, "Member 'FMarvelAIAutoAbilityTable::AbilityCheckType' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, ButtonConfig) == 0x000218, "Member 'FMarvelAIAutoAbilityTable::ButtonConfig' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, bHasCancelButton) == 0x000228, "Member 'FMarvelAIAutoAbilityTable::bHasCancelButton' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, CancelButton) == 0x000229, "Member 'FMarvelAIAutoAbilityTable::CancelButton' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, FlowCheckLogic) == 0x000230, "Member 'FMarvelAIAutoAbilityTable::FlowCheckLogic' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, UsageAsset) == 0x000238, "Member 'FMarvelAIAutoAbilityTable::UsageAsset' has a wrong offset!");
...
static_assert(alignof(FAIHeroTagLogicConfig) == 0x000008, "Wrong alignment on FAIHeroTagLogicConfig");
static_assert(sizeof(FAIHeroTagLogicConfig) == 0x000020, "Wrong size on FAIHeroTagLogicConfig");
static_assert(offsetof(FAIHeroTagLogicConfig, Tag) == 0x000000, "Member 'FAIHeroTagLogicConfig::Tag' has a wrong offset!");
static_assert(offsetof(FAIHeroTagLogicConfig, TagLogics) == 0x000010, "Member 'FAIHeroTagLogicConfig::TagLogics' has a wrong offset!");
...
static_assert(sizeof(FMarvelAIDifficultyTable) == 0x000208, "Wrong size on FMarvelAIDifficultyTable");
static_assert(offsetof(FMarvelAIDifficultyTable, DifficultyMode) == 0x000010, "Member 'FMarvelAIDifficultyTable::DifficultyMode' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, DifficultyLevel) == 0x000014, "Member 'FMarvelAIDifficultyTable::DifficultyLevel' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, ForbiddenSkillLevel) == 0x000018, "Member 'FMarvelAIDifficultyTable::ForbiddenSkillLevel' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, ApplyDamageRatio) == 0x000020, "Member 'FMarvelAIDifficultyTable::ApplyDamageRatio' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, TakingDamageRatio) == 0x000070, "Member 'FMarvelAIDifficultyTable::TakingDamageRatio' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, ApplyTreatRatio) == 0x0000C0, "Member 'FMarvelAIDifficultyTable::ApplyTreatRatio' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, TakingTreatRatio) == 0x000110, "Member 'FMarvelAIDifficultyTable::TakingTreatRatio' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, MaxHealthRatio) == 0x000160, "Member 'FMarvelAIDifficultyTable::MaxHealthRatio' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, MoveWaitTime) == 0x0001B0, "Member 'FMarvelAIDifficultyTable::MoveWaitTime' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, RandomJumpInterval) == 0x0001B4, "Member 'FMarvelAIDifficultyTable::RandomJumpInterval' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, ChangeToJump) == 0x0001B8, "Member 'FMarvelAIDifficultyTable::ChangeToJump' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, MoveRefreshInterval) == 0x0001BC, "Member 'FMarvelAIDifficultyTable::MoveRefreshInterval' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, MoveCloseRadiusRatio) == 0x0001C0, "Member 'FMarvelAIDifficultyTable::MoveCloseRadiusRatio' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, LowHealthMarkConfig) == 0x0001C4, "Member 'FMarvelAIDifficultyTable::LowHealthMarkConfig' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, ExtendAsset) == 0x0001D0, "Member 'FMarvelAIDifficultyTable::ExtendAsset' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, DynamicDifficultyAsset) == 0x0001D8, "Member 'FMarvelAIDifficultyTable::DynamicDifficultyAsset' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, IsSelected) == 0x0001E0, "Member 'FMarvelAIDifficultyTable::IsSelected' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, AILevelText) == 0x0001E8, "Member 'FMarvelAIDifficultyTable::AILevelText' has a wrong offset!");
static_assert(offsetof(FMarvelAIDifficultyTable, AILABRequestFrequency) == 0x000200, "Member 'FMarvelAIDifficultyTable::AILABRequestFrequency' has a wrong offset!");
...
static_assert(sizeof(FMarvelAISprayTable) == 0x000030, "Wrong size on FMarvelAISprayTable");
static_assert(offsetof(FMarvelAISprayTable, SprayID) == 0x000010, "Member 'FMarvelAISprayTable::SprayID' has a wrong offset!");
static_assert(offsetof(FMarvelAISprayTable, SprayDesc) == 0x000014, "Member 'FMarvelAISprayTable::SprayDesc' has a wrong offset!");
static_assert(offsetof(FMarvelAISprayTable, SprayWeight) == 0x000020, "Member 'FMarvelAISprayTable::SprayWeight' has a wrong offset!");
static_assert(offsetof(FMarvelAISprayTable, SprayValidTime) == 0x000028, "Member 'FMarvelAISprayTable::SprayValidTime' has a wrong offset!");
...
static_assert(sizeof(FMarvelAIStandPointGroupTable) == 0x000058, "Wrong size on FMarvelAIStandPointGroupTable");
static_assert(offsetof(FMarvelAIStandPointGroupTable, GroupId) == 0x000010, "Member 'FMarvelAIStandPointGroupTable::GroupId' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointGroupTable, LevelName) == 0x000018, "Member 'FMarvelAIStandPointGroupTable::LevelName' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointGroupTable, Desc) == 0x000028, "Member 'FMarvelAIStandPointGroupTable::Desc' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointGroupTable, StandPointNames) == 0x000038, "Member 'FMarvelAIStandPointGroupTable::StandPointNames' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointGroupTable, AssaultProgress) == 0x000048, "Member 'FMarvelAIStandPointGroupTable::AssaultProgress' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointGroupTable, EscortProgress) == 0x000049, "Member 'FMarvelAIStandPointGroupTable::EscortProgress' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointGroupTable, SubProgressRange) == 0x00004C, "Member 'FMarvelAIStandPointGroupTable::SubProgressRange' has a wrong offset!");
...
static_assert(sizeof(FMarvelAIStandPointTable) == 0x000060, "Wrong size on FMarvelAIStandPointTable");
static_assert(offsetof(FMarvelAIStandPointTable, Desc) == 0x000010, "Member 'FMarvelAIStandPointTable::Desc' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointTable, LevelName) == 0x000020, "Member 'FMarvelAIStandPointTable::LevelName' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointTable, HeroID) == 0x000030, "Member 'FMarvelAIStandPointTable::HeroID' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointTable, ShareType) == 0x000034, "Member 'FMarvelAIStandPointTable::ShareType' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointTable, BattleAreaName) == 0x000038, "Member 'FMarvelAIStandPointTable::BattleAreaName' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointTable, EscortProgress) == 0x000044, "Member 'FMarvelAIStandPointTable::EscortProgress' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointTable, SubProgressRange) == 0x000048, "Member 'FMarvelAIStandPointTable::SubProgressRange' has a wrong offset!");
static_assert(offsetof(FMarvelAIStandPointTable, StandPointNames) == 0x000050, "Member 'FMarvelAIStandPointTable::StandPointNames' has a wrong offset!");
...
static_assert(sizeof(FMarvelHeroAutoAITable) == 0x000020, "Wrong size on FMarvelHeroAutoAITable");
static_assert(offsetof(FMarvelHeroAutoAITable, HeroID) == 0x000010, "Member 'FMarvelHeroAutoAITable::HeroID' has a wrong offset!");
static_assert(offsetof(FMarvelHeroAutoAITable, BehaviorTree) == 0x000018, "Member 'FMarvelHeroAutoAITable::BehaviorTree' has a wrong offset!");
...
public:
	...
	TArray<struct FAIHeroTagLogicConfig>          GameplayTagLogics;                                 // 0x0100(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, HeroID) == 0x000010, "Member 'FMarvelHeroBehaviorTreeTable::HeroID' has a wrong offset!");
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, AIHeroType) == 0x000018, "Member 'FMarvelHeroBehaviorTreeTable::AIHeroType' has a wrong offset!");
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, NormalJumpAbilityID) == 0x000080, "Member 'FMarvelHeroBehaviorTreeTable::NormalJumpAbilityID' has a wrong offset!");
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, HeroSculptDataRemap) == 0x000088, "Member 'FMarvelHeroBehaviorTreeTable::HeroSculptDataRemap' has a wrong offset!");
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, BattleConfig) == 0x0000D8, "Member 'FMarvelHeroBehaviorTreeTable::BattleConfig' has a wrong offset!");
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, NavigationConfig) == 0x0000E0, "Member 'FMarvelHeroBehaviorTreeTable::NavigationConfig' has a wrong offset!");
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, bSelectable) == 0x0000F8, "Member 'FMarvelHeroBehaviorTreeTable::bSelectable' has a wrong offset!");
static_assert(offsetof(FMarvelHeroBehaviorTreeTable, GameplayTagLogics) == 0x000100, "Member 'FMarvelHeroBehaviorTreeTable::GameplayTagLogics' has a wrong offset!");
