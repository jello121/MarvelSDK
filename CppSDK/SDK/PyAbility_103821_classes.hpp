...
static_assert(sizeof(UPyAbility_103821) == 0x002A40, "Wrong size on UPyAbility_103821");
...
{
public:
	struct FGameplayTag                           UltraAbilityTag;                                   // 0x0CD0(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ShiftAbilityTag;                                   // 0x0CDC(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyUIController_103821) == 0x000CE8, "Wrong size on UPyUIController_103821");
static_assert(offsetof(UPyUIController_103821, UltraAbilityTag) == 0x000CD0, "Member 'UPyUIController_103821::UltraAbilityTag' has a wrong offset!");
static_assert(offsetof(UPyUIController_103821, ShiftAbilityTag) == 0x000CDC, "Member 'UPyUIController_103821::ShiftAbilityTag' has a wrong offset!");
