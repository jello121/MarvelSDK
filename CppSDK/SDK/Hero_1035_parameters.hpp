...
{
public:
	struct FHitResult                             InTraceResult;                                     // 0x0000(0x0178)(ConstParm, Parm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(Scope_10352101_ServerSetTraceResult) == 0x000178, "Wrong size on Scope_10352101_ServerSetTraceResult");
