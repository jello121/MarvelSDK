...
static_assert(sizeof(UKnockUp_200002_BP_C) == 0x0020A8, "Wrong size on UKnockUp_200002_BP_C");
static_assert(offsetof(UKnockUp_200002_BP_C, UberGraphFrame) == 0x0020A0, "Member 'UKnockUp_200002_BP_C::UberGraphFrame' has a wrong offset!");
