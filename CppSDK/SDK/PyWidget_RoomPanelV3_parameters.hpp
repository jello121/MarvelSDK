...
// PythonFunction PyWidget_RoomPanelV3.PyWidget_RoomPanel_V4.OnSelectMapVisibleChanged
// 0x0001 (0x0001 - 0x0000)
struct PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged final
{
public:
	bool                                          bVisible_0;                                        // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged) == 0x000001, "Wrong alignment on PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged");
static_assert(sizeof(PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged) == 0x000001, "Wrong size on PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged");
static_assert(offsetof(PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged, bVisible_0) == 0x000000, "Member 'PyWidget_RoomPanel_V4_OnSelectMapVisibleChanged::bVisible_0' has a wrong offset!");
