...
public:
	...
	struct FHitResult                             InHitResult;                                       // 0x0008(0x0178)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          BlockDash;                                         // 0x0180(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_181[0x7];                                      // 0x0181(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                ClientTargetLocation;                              // 0x0188(0x0018)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(Ability_105232_CallServerPlayTimeline) == 0x0001A0, "Wrong size on Ability_105232_CallServerPlayTimeline");
...
static_assert(offsetof(Ability_105232_CallServerPlayTimeline, BlockDash) == 0x000180, "Member 'Ability_105232_CallServerPlayTimeline::BlockDash' has a wrong offset!");
static_assert(offsetof(Ability_105232_CallServerPlayTimeline, ClientTargetLocation) == 0x000188, "Member 'Ability_105232_CallServerPlayTimeline::ClientTargetLocation' has a wrong offset!");
...
static_assert(sizeof(Ability_105232_K2_OnPlayTimeline) == 0x0001A0, "Wrong size on Ability_105232_K2_OnPlayTimeline");
...
static_assert(offsetof(Ability_105232_K2_OnPlayTimeline, BlockDash) == 0x000180, "Member 'Ability_105232_K2_OnPlayTimeline::BlockDash' has a wrong offset!");
static_assert(offsetof(Ability_105232_K2_OnPlayTimeline, ClientTargetLocation) == 0x000188, "Member 'Ability_105232_K2_OnPlayTimeline::ClientTargetLocation' has a wrong offset!");
...
static_assert(sizeof(Ability_105232_OnServerReceivePlayTimeline) == 0x0001A0, "Wrong size on Ability_105232_OnServerReceivePlayTimeline");
...
static_assert(offsetof(Ability_105232_OnServerReceivePlayTimeline, BlockDash) == 0x000180, "Member 'Ability_105232_OnServerReceivePlayTimeline::BlockDash' has a wrong offset!");
static_assert(offsetof(Ability_105232_OnServerReceivePlayTimeline, ClientTargetLocation) == 0x000188, "Member 'Ability_105232_OnServerReceivePlayTimeline::ClientTargetLocation' has a wrong offset!");
