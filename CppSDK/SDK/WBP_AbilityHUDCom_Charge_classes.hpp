...
{
public:
	class UMarvelOverlay*                         Overlay_Charge;                                    // 0x06D8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_AbilityHUDCom_Charge_C) == 0x0006E0, "Wrong size on UWBP_AbilityHUDCom_Charge_C");
static_assert(offsetof(UWBP_AbilityHUDCom_Charge_C, Overlay_Charge) == 0x0006D8, "Member 'UWBP_AbilityHUDCom_Charge_C::Overlay_Charge' has a wrong offset!");
