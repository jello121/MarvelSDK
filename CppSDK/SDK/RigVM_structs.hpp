...
static_assert(sizeof(FRigVMFunction_NameTruncate) == 0x000038, "Wrong size on FRigVMFunction_NameTruncate");
...
static_assert(offsetof(FRigVMFunction_NameTruncate, Count) == 0x000014, "Member 'FRigVMFunction_NameTruncate::Count' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameTruncate, FromEnd) == 0x000018, "Member 'FRigVMFunction_NameTruncate::FromEnd' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameTruncate, Remainder) == 0x00001C, "Member 'FRigVMFunction_NameTruncate::Remainder' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameTruncate, Chopped) == 0x000028, "Member 'FRigVMFunction_NameTruncate::Chopped' has a wrong offset!");
...
static_assert(offsetof(FRigVMDrawInstruction, PrimitiveType) == 0x00000C, "Member 'FRigVMDrawInstruction::PrimitiveType' has a wrong offset!");
...
static_assert(sizeof(FRigVMExtendedExecuteContext) == 0x0001C0, "Wrong size on FRigVMExtendedExecuteContext");
...
static_assert(offsetof(FRigVMExtendedExecuteContext, DeferredVMToCopy) == 0x000178, "Member 'FRigVMExtendedExecuteContext::DeferredVMToCopy' has a wrong offset!");
...
static_assert(offsetof(FRigVMGraphFunctionIdentifier, HostObject) == 0x000028, "Member 'FRigVMGraphFunctionIdentifier::HostObject' has a wrong offset!");
...
static_assert(sizeof(FRigVMExternalVariableDef) == 0x000038, "Wrong size on FRigVMExternalVariableDef");
...
static_assert(sizeof(FRigVMExternalVariable) == 0x000040, "Wrong size on FRigVMExternalVariable");
...
static_assert(sizeof(FRigVMGraphFunctionArgument) == 0x0000C8, "Wrong size on FRigVMGraphFunctionArgument");
...
static_assert(offsetof(FRigVMGraphFunctionArgument, DisplayName) == 0x00000C, "Member 'FRigVMGraphFunctionArgument::DisplayName' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, CPPType) == 0x000018, "Member 'FRigVMGraphFunctionArgument::CPPType' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, CPPTypeObject) == 0x000028, "Member 'FRigVMGraphFunctionArgument::CPPTypeObject' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, bIsArray) == 0x000058, "Member 'FRigVMGraphFunctionArgument::bIsArray' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, Direction) == 0x000059, "Member 'FRigVMGraphFunctionArgument::Direction' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, DefaultValue) == 0x000060, "Member 'FRigVMGraphFunctionArgument::DefaultValue' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, bIsConst) == 0x000070, "Member 'FRigVMGraphFunctionArgument::bIsConst' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, PathToTooltip) == 0x000078, "Member 'FRigVMGraphFunctionArgument::PathToTooltip' has a wrong offset!");
...
static_assert(sizeof(FRigVMGraphFunctionHeader) == 0x000128, "Wrong size on FRigVMGraphFunctionHeader");
...
static_assert(offsetof(FRigVMGraphFunctionHeader, Name) == 0x000050, "Member 'FRigVMGraphFunctionHeader::Name' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeTitle) == 0x000060, "Member 'FRigVMGraphFunctionHeader::NodeTitle' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeColor) == 0x000070, "Member 'FRigVMGraphFunctionHeader::NodeColor' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, ToolTip) == 0x000080, "Member 'FRigVMGraphFunctionHeader::ToolTip' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Category) == 0x000098, "Member 'FRigVMGraphFunctionHeader::Category' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Keywords) == 0x0000A8, "Member 'FRigVMGraphFunctionHeader::Keywords' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Arguments) == 0x0000B8, "Member 'FRigVMGraphFunctionHeader::Arguments' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Dependencies) == 0x0000C8, "Member 'FRigVMGraphFunctionHeader::Dependencies' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, ExternalVariables) == 0x000118, "Member 'FRigVMGraphFunctionHeader::ExternalVariables' has a wrong offset!");
...
static_assert(offsetof(FRigVMBranchInfo, InstructionIndex) == 0x000010, "Member 'FRigVMBranchInfo::InstructionIndex' has a wrong offset!");
static_assert(offsetof(FRigVMBranchInfo, ArgumentIndex) == 0x000014, "Member 'FRigVMBranchInfo::ArgumentIndex' has a wrong offset!");
static_assert(offsetof(FRigVMBranchInfo, FirstInstruction) == 0x000018, "Member 'FRigVMBranchInfo::FirstInstruction' has a wrong offset!");
static_assert(offsetof(FRigVMBranchInfo, LastInstruction) == 0x00001A, "Member 'FRigVMBranchInfo::LastInstruction' has a wrong offset!");
...
static_assert(sizeof(FRigVMPredicateBranch) == 0x000038, "Wrong size on FRigVMPredicateBranch");
...
static_assert(sizeof(FRigVMFunctionCompilationPropertyDescription) == 0x000060, "Wrong size on FRigVMFunctionCompilationPropertyDescription");
...
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, CPPType) == 0x000010, "Member 'FRigVMFunctionCompilationPropertyDescription::CPPType' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, CPPTypeObject) == 0x000020, "Member 'FRigVMFunctionCompilationPropertyDescription::CPPTypeObject' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, DefaultValue) == 0x000050, "Member 'FRigVMFunctionCompilationPropertyDescription::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FRigVMGraphFunctionData, CompilationData) == 0x000128, "Member 'FRigVMGraphFunctionData::CompilationData' has a wrong offset!");
...
static_assert(sizeof(FRigVMDecorator) == 0x000020, "Wrong size on FRigVMDecorator");
...
static_assert(sizeof(FRigVMFunction_NameConcat) == 0x000030, "Wrong size on FRigVMFunction_NameConcat");
static_assert(offsetof(FRigVMFunction_NameConcat, A) == 0x000008, "Member 'FRigVMFunction_NameConcat::A' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameConcat, B) == 0x000014, "Member 'FRigVMFunction_NameConcat::B' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameConcat, Result) == 0x000020, "Member 'FRigVMFunction_NameConcat::Result' has a wrong offset!");
...
static_assert(sizeof(FRigVMExecuteContext) == 0x000100, "Wrong size on FRigVMExecuteContext");
...
static_assert(sizeof(FRigVMStructMutable) == 0x000110, "Wrong size on FRigVMStructMutable");
...
static_assert(sizeof(FRigVMFunction_DebugBaseMutable) == 0x000110, "Wrong size on FRigVMFunction_DebugBaseMutable");
...
static_assert(sizeof(FRigVMFunction_MathMutableBase) == 0x000110, "Wrong size on FRigVMFunction_MathMutableBase");
...
static_assert(sizeof(FRigVMFunction_Sequence) == 0x000310, "Wrong size on FRigVMFunction_Sequence");
...
static_assert(offsetof(FRigVMFunction_Sequence, A) == 0x000110, "Member 'FRigVMFunction_Sequence::A' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_Sequence, B) == 0x000210, "Member 'FRigVMFunction_Sequence::B' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_SimBaseMutable) == 0x000110, "Wrong size on FRigVMFunction_SimBaseMutable");
...
static_assert(sizeof(FRigVMInvokeEntryOp) == 0x000010, "Wrong size on FRigVMInvokeEntryOp");
...
static_assert(sizeof(FRigVMTemplateArgumentType) == 0x000018, "Wrong size on FRigVMTemplateArgumentType");
...
static_assert(offsetof(FRigVMTemplateArgumentType, CPPTypeObject) == 0x000010, "Member 'FRigVMTemplateArgumentType::CPPTypeObject' has a wrong offset!");
...
static_assert(sizeof(FRigVMUserWorkflow) == 0x000060, "Wrong size on FRigVMUserWorkflow");
...
static_assert(offsetof(FRigVMUserWorkflow, OptionsClass) == 0x000058, "Member 'FRigVMUserWorkflow::OptionsClass' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugLineNoSpace) == 0x0001D0, "Wrong size on FRigVMFunction_DebugLineNoSpace");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, A) == 0x000110, "Member 'FRigVMFunction_DebugLineNoSpace::A' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, B) == 0x000128, "Member 'FRigVMFunction_DebugLineNoSpace::B' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, Color) == 0x000140, "Member 'FRigVMFunction_DebugLineNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, Thickness) == 0x000150, "Member 'FRigVMFunction_DebugLineNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, WorldOffset) == 0x000160, "Member 'FRigVMFunction_DebugLineNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, bEnabled) == 0x0001C0, "Member 'FRigVMFunction_DebugLineNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugLineStripNoSpace) == 0x0001B0, "Wrong size on FRigVMFunction_DebugLineStripNoSpace");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Points) == 0x000110, "Member 'FRigVMFunction_DebugLineStripNoSpace::Points' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Color) == 0x000120, "Member 'FRigVMFunction_DebugLineStripNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Thickness) == 0x000130, "Member 'FRigVMFunction_DebugLineStripNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, WorldOffset) == 0x000140, "Member 'FRigVMFunction_DebugLineStripNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, bEnabled) == 0x0001A0, "Member 'FRigVMFunction_DebugLineStripNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugPointMutable) == 0x0001C0, "Wrong size on FRigVMFunction_DebugPointMutable");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Vector) == 0x000110, "Member 'FRigVMFunction_DebugPointMutable::Vector' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Mode) == 0x000128, "Member 'FRigVMFunction_DebugPointMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Color) == 0x00012C, "Member 'FRigVMFunction_DebugPointMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Scale) == 0x00013C, "Member 'FRigVMFunction_DebugPointMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Thickness) == 0x000140, "Member 'FRigVMFunction_DebugPointMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Space) == 0x000144, "Member 'FRigVMFunction_DebugPointMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, WorldOffset) == 0x000150, "Member 'FRigVMFunction_DebugPointMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, bEnabled) == 0x0001B0, "Member 'FRigVMFunction_DebugPointMutable::bEnabled' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_DebugRectangle, Transform) == 0x000110, "Member 'FRigVMFunction_DebugRectangle::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Color) == 0x000170, "Member 'FRigVMFunction_DebugRectangle::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Scale) == 0x000180, "Member 'FRigVMFunction_DebugRectangle::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Thickness) == 0x000184, "Member 'FRigVMFunction_DebugRectangle::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Space) == 0x000188, "Member 'FRigVMFunction_DebugRectangle::Space' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugRectangleNoSpace) == 0x000200, "Wrong size on FRigVMFunction_DebugRectangleNoSpace");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Transform) == 0x000110, "Member 'FRigVMFunction_DebugRectangleNoSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Color) == 0x000170, "Member 'FRigVMFunction_DebugRectangleNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Scale) == 0x000180, "Member 'FRigVMFunction_DebugRectangleNoSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Thickness) == 0x000184, "Member 'FRigVMFunction_DebugRectangleNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, WorldOffset) == 0x000190, "Member 'FRigVMFunction_DebugRectangleNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, bEnabled) == 0x0001F0, "Member 'FRigVMFunction_DebugRectangleNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugArc) == 0x000210, "Wrong size on FRigVMFunction_DebugArc");
static_assert(offsetof(FRigVMFunction_DebugArc, Transform) == 0x000110, "Member 'FRigVMFunction_DebugArc::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Color) == 0x000170, "Member 'FRigVMFunction_DebugArc::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Radius) == 0x000180, "Member 'FRigVMFunction_DebugArc::Radius' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, MinimumDegrees) == 0x000184, "Member 'FRigVMFunction_DebugArc::MinimumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, MaximumDegrees) == 0x000188, "Member 'FRigVMFunction_DebugArc::MaximumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Thickness) == 0x00018C, "Member 'FRigVMFunction_DebugArc::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Detail) == 0x000190, "Member 'FRigVMFunction_DebugArc::Detail' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Space) == 0x000194, "Member 'FRigVMFunction_DebugArc::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, WorldOffset) == 0x0001A0, "Member 'FRigVMFunction_DebugArc::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, bEnabled) == 0x000200, "Member 'FRigVMFunction_DebugArc::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugArcNoSpace) == 0x000210, "Wrong size on FRigVMFunction_DebugArcNoSpace");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Transform) == 0x000110, "Member 'FRigVMFunction_DebugArcNoSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Color) == 0x000170, "Member 'FRigVMFunction_DebugArcNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Radius) == 0x000180, "Member 'FRigVMFunction_DebugArcNoSpace::Radius' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, MinimumDegrees) == 0x000184, "Member 'FRigVMFunction_DebugArcNoSpace::MinimumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, MaximumDegrees) == 0x000188, "Member 'FRigVMFunction_DebugArcNoSpace::MaximumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Thickness) == 0x00018C, "Member 'FRigVMFunction_DebugArcNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Detail) == 0x000190, "Member 'FRigVMFunction_DebugArcNoSpace::Detail' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, WorldOffset) == 0x0001A0, "Member 'FRigVMFunction_DebugArcNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, bEnabled) == 0x000200, "Member 'FRigVMFunction_DebugArcNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformMutableNoSpace) == 0x000200, "Wrong size on FRigVMFunction_DebugTransformMutableNoSpace");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Transform) == 0x000110, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Mode) == 0x000170, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Color) == 0x000174, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Thickness) == 0x000184, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Scale) == 0x000188, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, WorldOffset) == 0x000190, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, bEnabled) == 0x0001F0, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformArrayMutableNoSpace) == 0x0001C0, "Wrong size on FRigVMFunction_DebugTransformArrayMutableNoSpace");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Transforms) == 0x000110, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Transforms' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, ParentIndices) == 0x000120, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::ParentIndices' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Mode) == 0x000130, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Color) == 0x000134, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Thickness) == 0x000144, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Scale) == 0x000148, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, WorldOffset) == 0x000150, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, bEnabled) == 0x0001B0, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_ForLoopCount) == 0x000230, "Wrong size on FRigVMFunction_ForLoopCount");
static_assert(offsetof(FRigVMFunction_ForLoopCount, BlockToRun) == 0x000110, "Member 'FRigVMFunction_ForLoopCount::BlockToRun' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Count) == 0x00011C, "Member 'FRigVMFunction_ForLoopCount::Count' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Index) == 0x000120, "Member 'FRigVMFunction_ForLoopCount::Index' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Ratio) == 0x000124, "Member 'FRigVMFunction_ForLoopCount::Ratio' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Completed) == 0x000130, "Member 'FRigVMFunction_ForLoopCount::Completed' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_UserDefinedEvent) == 0x000120, "Wrong size on FRigVMFunction_UserDefinedEvent");
...
static_assert(offsetof(FRigVMFunction_UserDefinedEvent, EventName) == 0x000110, "Member 'FRigVMFunction_UserDefinedEvent::EventName' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_EndsWith) == 0x000028, "Wrong size on FRigVMFunction_EndsWith");
static_assert(offsetof(FRigVMFunction_EndsWith, Name) == 0x000008, "Member 'FRigVMFunction_EndsWith::Name' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_EndsWith, Ending) == 0x000014, "Member 'FRigVMFunction_EndsWith::Ending' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_EndsWith, Result) == 0x000020, "Member 'FRigVMFunction_EndsWith::Result' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_Contains) == 0x000028, "Wrong size on FRigVMFunction_Contains");
static_assert(offsetof(FRigVMFunction_Contains, Name) == 0x000008, "Member 'FRigVMFunction_Contains::Name' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_Contains, Search) == 0x000014, "Member 'FRigVMFunction_Contains::Search' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_Contains, Result) == 0x000020, "Member 'FRigVMFunction_Contains::Result' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_MathTransformMutableBase) == 0x000110, "Wrong size on FRigVMFunction_MathTransformMutableBase");
...
static_assert(sizeof(FRigVMFunction_MathTransformAccumulateArray) == 0x0001A0, "Wrong size on FRigVMFunction_MathTransformAccumulateArray");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, Transforms) == 0x000110, "Member 'FRigVMFunction_MathTransformAccumulateArray::Transforms' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, TargetSpace) == 0x000120, "Member 'FRigVMFunction_MathTransformAccumulateArray::TargetSpace' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, Root) == 0x000130, "Member 'FRigVMFunction_MathTransformAccumulateArray::Root' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, ParentIndices) == 0x000190, "Member 'FRigVMFunction_MathTransformAccumulateArray::ParentIndices' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_MathIntToName) == 0x000020, "Wrong size on FRigVMFunction_MathIntToName");
...
public:
	...
	struct FRigVMExecuteContext                   TURR;                                              // 0x0120(0x0100)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FRigVMExecuteContext                   FLASE;                                             // 0x0220(0x0100)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigVMFunction_ControlFlowBranch) == 0x000430, "Wrong size on FRigVMFunction_ControlFlowBranch");
...
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, Condition) == 0x000110, "Member 'FRigVMFunction_ControlFlowBranch::Condition' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, TURR) == 0x000120, "Member 'FRigVMFunction_ControlFlowBranch::TURR' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, FLASE) == 0x000220, "Member 'FRigVMFunction_ControlFlowBranch::FLASE' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, Completed) == 0x000320, "Member 'FRigVMFunction_ControlFlowBranch::Completed' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, BlockToRun) == 0x000420, "Member 'FRigVMFunction_ControlFlowBranch::BlockToRun' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_NameReplace) == 0x000038, "Wrong size on FRigVMFunction_NameReplace");
...
static_assert(offsetof(FRigVMFunction_NameReplace, Old) == 0x000014, "Member 'FRigVMFunction_NameReplace::Old' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameReplace, New) == 0x000020, "Member 'FRigVMFunction_NameReplace::New' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameReplace, Result) == 0x00002C, "Member 'FRigVMFunction_NameReplace::Result' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_StartsWith) == 0x000028, "Wrong size on FRigVMFunction_StartsWith");
static_assert(offsetof(FRigVMFunction_StartsWith, Name) == 0x000008, "Member 'FRigVMFunction_StartsWith::Name' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_StartsWith, Start) == 0x000014, "Member 'FRigVMFunction_StartsWith::Start' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_StartsWith, Result) == 0x000020, "Member 'FRigVMFunction_StartsWith::Result' has a wrong offset!");
