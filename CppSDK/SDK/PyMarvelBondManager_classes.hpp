...
static_assert(sizeof(APyMarvelBondManager) == 0x0007A0, "Wrong size on APyMarvelBondManager");
...
static_assert(sizeof(UPyMarvelDefaultBondAbility) == 0x002A38, "Wrong size on UPyMarvelDefaultBondAbility");
