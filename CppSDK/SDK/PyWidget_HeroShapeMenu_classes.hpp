...
public:
	...
	TSubclassOf<class UUserWidget>                HeroShapeMenuBtnClass;                             // 0x0640(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPyWidget_HeroShapeMenu, HeroShapeMenuBtnClass) == 0x000640, "Member 'UPyWidget_HeroShapeMenu::HeroShapeMenuBtnClass' has a wrong offset!");
