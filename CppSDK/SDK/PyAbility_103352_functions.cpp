...
void UPyCue_Scope_Start_10335201::SetExplosionNiagaraParameter(class UNiagaraComponent* InFXComponent, class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyCue_Scope_Start_10335201", "SetExplosionNiagaraParameter");

	Params::PyCue_Scope_Start_10335201_SetExplosionNiagaraParameter Parms{};
