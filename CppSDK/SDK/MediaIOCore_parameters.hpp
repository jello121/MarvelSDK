...
static_assert(alignof(MediaCapture_CaptureActiveSceneViewport) == 0x000008, "Wrong alignment on MediaCapture_CaptureActiveSceneViewport");
static_assert(sizeof(MediaCapture_CaptureActiveSceneViewport) == 0x0000C0, "Wrong size on MediaCapture_CaptureActiveSceneViewport");
...
static_assert(offsetof(MediaCapture_CaptureActiveSceneViewport, ReturnValue) == 0x0000B8, "Member 'MediaCapture_CaptureActiveSceneViewport::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MediaCapture_CaptureTextureRenderTarget2D) == 0x0000C8, "Wrong size on MediaCapture_CaptureTextureRenderTarget2D");
...
static_assert(offsetof(MediaCapture_CaptureTextureRenderTarget2D, ReturnValue) == 0x0000C0, "Member 'MediaCapture_CaptureTextureRenderTarget2D::ReturnValue' has a wrong offset!");
