...
// DelegateFunction PyWidget_SelectHero_Corona.PyWidget_SelectHero_Corona.OnLocalPreviewBanPickHero__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct PyWidget_SelectHero_Corona_OnLocalPreviewBanPickHero__DelegateSignature final
{
public:
	int32                                         HeroID;                                            // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PyWidget_SelectHero_Corona_OnLocalPreviewBanPickHero__DelegateSignature) == 0x000004, "Wrong alignment on PyWidget_SelectHero_Corona_OnLocalPreviewBanPickHero__DelegateSignature");
static_assert(sizeof(PyWidget_SelectHero_Corona_OnLocalPreviewBanPickHero__DelegateSignature) == 0x000004, "Wrong size on PyWidget_SelectHero_Corona_OnLocalPreviewBanPickHero__DelegateSignature");
static_assert(offsetof(PyWidget_SelectHero_Corona_OnLocalPreviewBanPickHero__DelegateSignature, HeroID) == 0x000000, "Member 'PyWidget_SelectHero_Corona_OnLocalPreviewBanPickHero__DelegateSignature::HeroID' has a wrong offset!");
